...
entryUrl: "https://github.com/jnMetaCode/superpowers-zh/blob/79ea5d262b7a1c7ce76a289390853bca51f940d4/skills/writing-skills/anthropic-best-practices.md"
sourceRel: "skills/writing-skills/anthropic-best-practices.md"
rawUrl: "/raw/10-context-memory/superpowers-zh/skills/writing-skills/anthropic-best-practices.md"
sourceSha256: "0b5c85d5b2ae26ac3a27ca7238f588ce2e078c1dc4cfa2359b2702d6eb3a2c52"
pageSha256: "0b5c85d5b2ae26ac3a27ca7238f588ce2e078c1dc4cfa2359b2702d6eb3a2c52"
...
关于技能工作原理的概念背景，请参阅[技能概述](https://github.com/jnMetaCode/superpowers-zh/blob/79ea5d262b7a1c7ce76a289390853bca51f940d4/en/docs/agents-and-tools/agent-skills/overview/README.md)。
...
## 技能结构
  ...
  * `description` - 技能做什么以及何时使用的一行描述（最多 1024 个字符）
  ...
  完整的技能结构细节请参阅[技能概述](https://github.com/jnMetaCode/superpowers-zh/blob/79ea5d262b7a1c7ce76a289390853bca51f940d4/en/docs/agents-and-tools/agent-skills/overview/README.md#skill-structure)。
...
SKILL.md 作为概述，按需指向详细材料，就像入门指南中的目录。关于渐进式披露如何工作的解释，请参阅概述中的[技能工作原理](https://github.com/jnMetaCode/superpowers-zh/blob/79ea5d262b7a1c7ce76a289390853bca51f940d4/en/docs/agents-and-tools/agent-skills/overview/README.md#how-skills-work)。
...
在 SKILL.md 中列出所需的包，并在[代码执行工具文档](https://github.com/jnMetaCode/superpowers-zh/blob/79ea5d262b7a1c7ce76a289390853bca51f940d4/en/docs/agents-and-tools/tool-use/code-execution-tool/README.md)中验证它们是否可用。

### 运行时环境

技能在具有文件系统访问、bash 命令和代码执行能力的代码执行环境中运行。关于此架构的概念解释，请参阅概述中的[技能架构](https://github.com/jnMetaCode/superpowers-zh/blob/79ea5d262b7a1c7ce76a289390853bca51f940d4/en/docs/agents-and-tools/agent-skills/overview/README.md#the-skills-architecture)。
...
完整的技术架构细节请参阅技能概述中的[技能工作原理](https://github.com/jnMetaCode/superpowers-zh/blob/79ea5d262b7a1c7ce76a289390853bca51f940d4/en/docs/agents-and-tools/agent-skills/overview/README.md#how-skills-work)。
...
SKILL.md 的 frontmatter 只包含 `name`（最多 64 字符）和 `description`（最多 1024 字符）字段。完整的结构细节请参阅[技能概述](https://github.com/jnMetaCode/superpowers-zh/blob/79ea5d262b7a1c7ce76a289390853bca51f940d4/en/docs/agents-and-tools/agent-skills/overview/README.md#skill-structure)。

### Token 预算

保持 SKILL.md 正文在 500 行以内以获得最佳性能。如果内容超过此限制，使用前面描述的渐进式披露模式将其拆分到独立文件。架构细节请参阅[技能概述](https://github.com/jnMetaCode/superpowers-zh/blob/79ea5d262b7a1c7ce76a289390853bca51f940d4/en/docs/agents-and-tools/agent-skills/overview/README.md#how-skills-work)。
