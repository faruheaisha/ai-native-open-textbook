---
title: "Issue-Driven Orchestration with GSD"
...
entryUrl: "https://github.com/gsd-build/get-shit-done/blob/bdcaab2c752d9a33a1a1ca9acf3a3c81fb991815/docs/issue-driven-orchestration.md"
sourceRel: "docs/issue-driven-orchestration.md"
rawUrl: "/raw/10-context-memory/get-shit-done/docs/issue-driven-orchestration.md"
sourceSha256: "689a3f3e8bb3ca81806d485ff5c8f46d637b0c6eae0208aea00d59263f048941"
pageSha256: "689a3f3e8bb3ca81806d485ff5c8f46d637b0c6eae0208aea00d59263f048941"
...
- [docs/USER-GUIDE.md](/lib/10-context-memory/get-shit-done/docs-USER-GUIDE/index) — task-oriented walkthroughs of
  individual commands referenced above.
- [docs/COMMANDS.md](/lib/10-context-memory/get-shit-done/docs-COMMANDS) — full reference for `/gsd-*`
  commands.
- [docs/FEATURES.md](/lib/10-context-memory/get-shit-done/docs-FEATURES/index) — feature-level capability matrix
  (workspaces, manager, autonomous, verify, review, ship).
- [docs/ARCHITECTURE.md](/lib/10-context-memory/get-shit-done/docs-ARCHITECTURE) — phase-artifact lifecycle
