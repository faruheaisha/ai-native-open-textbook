---
title: "Grok Build + GSD Compatibility & Local Multi-Runtime Sync (May 2026)"
...
entryUrl: "https://github.com/gsd-build/get-shit-done/blob/bdcaab2c752d9a33a1a1ca9acf3a3c81fb991815/docs/discussions/grok-build-support-2026-05.md"
sourceRel: "docs/discussions/grok-build-support-2026-05.md"
rawUrl: "/raw/10-context-memory/get-shit-done/docs/discussions/grok-build-support-2026-05.md"
sourceSha256: "5545e2e27df5c83663c95a177973d830da5aa3fe920e299d353540ed7ddc3e44"
pageSha256: "5545e2e27df5c83663c95a177973d830da5aa3fe920e299d353540ed7ddc3e44"
...
- **First-class 'grok' runtime added** (pragmatic choice: maps to `~/.agents/`):
  - [get-shit-done/bin/lib/runtime-homes.cjs](https://github.com/gsd-build/get-shit-done/blob/bdcaab2c752d9a33a1a1ca9acf3a3c81fb991815/home/cristian/bum/get-shit-done/get-shit-done/bin/lib/runtime-homes.cjs): Added `grok` case (honors `GROK_AGENTS_HOME` env, defaults to `~/.agents`).
  - [bin/install.js](https://github.com/gsd-build/get-shit-done/blob/bdcaab2c752d9a33a1a1ca9acf3a3c81fb991815/home/cristian/bum/get-shit-done/bin/install.js): Added `--grok` flag, `hasGrok`, `getDirName('grok') → '.agents'`, `getGlobalDir('grok')`, `getConfigDirFromHome`, inclusion in `--all` and help text. Reuses existing Codex conversion logic (skill adapters + agent .toml generation) because Grok Build uses the same invocation model.
  - [get-shit-done/workflows/sync-skills.md](https://github.com/gsd-build/get-shit-done/blob/bdcaab2c752d9a33a1a1ca9acf3a3c81fb991815/home/cristian/bum/get-shit-done/get-shit-done/workflows/sync-skills.md): Added `grok` to supported runtimes and the `--to all` list.
