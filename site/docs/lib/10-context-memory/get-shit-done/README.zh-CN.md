...
entryUrl: "https://github.com/gsd-build/get-shit-done/blob/bdcaab2c752d9a33a1a1ca9acf3a3c81fb991815/README.zh-CN.md"
sourceRel: "README.zh-CN.md"
rawUrl: "/raw/10-context-memory/get-shit-done/README.zh-CN.md"
sourceSha256: "70632afe1e0a55298c0216c32e357fdbbd20cb63f9036afbf45e507429658b19"
pageSha256: "70632afe1e0a55298c0216c32e357fdbbd20cb63f9036afbf45e507429658b19"
...
[English](/lib/10-context-memory/get-shit-done/overview) · [Português](https://github.com/gsd-build/get-shit-done/blob/bdcaab2c752d9a33a1a1ca9acf3a3c81fb991815/README.pt-BR.md) · **简体中文** · [日本語](https://github.com/gsd-build/get-shit-done/blob/bdcaab2c752d9a33a1a1ca9acf3a3c81fb991815/README.ja-JP.md) · [한국어](https://github.com/gsd-build/get-shit-done/blob/bdcaab2c752d9a33a1a1ca9acf3a3c81fb991815/README.ko-KR.md)
...
[我为什么做这个](#我为什么做这个) · [它是怎么工作的](#它是怎么工作的) · [命令](#命令) · [为什么它有效](#为什么它有效) · [用户指南](/lib/10-context-memory/get-shit-done/docs-USER-GUIDE/index)
...
> [!TIP]
> 基于源码安装或无法使用 npm 的环境，请参阅 **[docs/manual-update.md](https://github.com/gsd-build/get-shit-done/blob/bdcaab2c752d9a33a1a1ca9acf3a3c81fb991815/docs/manual-update.md)**。
...
GSD 将项目设置保存在 `.planning/config.json`。你可以在 `/gsd-new-project` 时配置，也可以稍后通过 `/gsd-settings` 修改。完整的配置 schema、工作流开关、git branching 选项以及各代理的模型分配，请查看[用户指南](/lib/10-context-memory/get-shit-done/docs-USER-GUIDE/index#configuration-reference)。
