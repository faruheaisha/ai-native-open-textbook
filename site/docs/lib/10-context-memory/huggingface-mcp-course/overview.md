...
<div align="center"> <a href="/lib/10-context-memory/huggingface-mcp-course/overview">🇺🇸 English</a> | <a href="https://github.com/huggingface/mcp-course/blob/e706ccc0d7abe73c31813979c3451c0e31c8a464/README_vi.md">🇻🇳 Tiếng Việt</a> </div>
...
<div class="tb-zh"><p>课程分为 4 个单元，将带你从 Model Context Protocol 的基础，走到在 AI 应用中实现 MCP 的最终项目。</p></div>
...
<div class="tb-zh"><p>对 AI 与大语言模型概念有基本了解；熟悉软件开发原则与 API 概念；至少掌握一门编程语言（课程示例以 Python 或 TypeScript 为主）</p></div>
