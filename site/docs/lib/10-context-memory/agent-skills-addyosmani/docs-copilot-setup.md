...
This guide covers Copilot in VS Code. For the standalone `copilot` command-line tool, see [copilot-cli-setup.md](/lib/10-context-memory/agent-skills-addyosmani/docs-copilot-cli-setup).
