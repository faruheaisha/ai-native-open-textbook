...
entryUrl: "https://github.com/addyosmani/agent-skills/blob/6ca0cd7db39b41b1c37e26d335c507ee92382c6d/skills/constraint-driven-development/SKILL.md"
sourceRel: "skills/constraint-driven-development/SKILL.md"
rawUrl: "/raw/10-context-memory/agent-skills-addyosmani/skills/constraint-driven-development/SKILL.md"
sourceSha256: "06479d4305f286d23cfb99f5dc85695896785269664e1f6a8d800e3b71e70c10"
pageSha256: "06479d4305f286d23cfb99f5dc85695896785269664e1f6a8d800e3b71e70c10"
...
Unlike the numbered dimensions, the floor has no de facto tool of its own, so an agent asked to enforce it tends to write a checker from scratch, and two agents write two different ones. A reference implementation of these five checks ships with this skill in [references/floor-guard.md](/lib/10-context-memory/agent-skills-addyosmani/skills-constraint-driven-development-references-floor-guard) (diff-scoped, exit `0`/`1`/`2`, patterns adaptable per ecosystem). Adapt that rather than reinventing it, for the same reason every dimension names a de facto tool: so the mechanism is the same across runs and stacks.
...
3. **Tool-backed.** A dedicated runner that handles diff scoping, budgets, ratchets, and the guard checks. Use when the config outgrows a shell script. The floor-guard reference in [references/floor-guard.md](/lib/10-context-memory/agent-skills-addyosmani/skills-constraint-driven-development-references-floor-guard) is the starting point for the guard-checks half of this.
