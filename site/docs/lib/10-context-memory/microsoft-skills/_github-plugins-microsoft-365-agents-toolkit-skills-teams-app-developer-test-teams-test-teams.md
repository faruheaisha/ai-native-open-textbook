...
entryUrl: "https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/microsoft-365-agents-toolkit/skills/teams-app-developer/test-teams/test-teams.md"
sourceRel: ".github/plugins/microsoft-365-agents-toolkit/skills/teams-app-developer/test-teams/test-teams.md"
rawUrl: "/raw/10-context-memory/microsoft-skills/.github/plugins/microsoft-365-agents-toolkit/skills/teams-app-developer/test-teams/test-teams.md"
sourceSha256: "84e2ce52bca478d27e0a11c645266413fddb35185828b648a6db215f0bafc248"
pageSha256: "84e2ce52bca478d27e0a11c645266413fddb35185828b648a6db215f0bafc248"
...
**Use this when user explicitly asks to run on Teams.** For quick local testing, recommend [Agents Playground](/lib/10-context-memory/microsoft-skills/_github-plugins-microsoft-365-agents-toolkit-skills-teams-app-developer-test-playground-test-playground) first.
...
| Host | URL |
|------|-----|
| Teams web | <code v-pre>https://teams.microsoft.com/l/app/${{TEAMS_APP_ID}}?installAppPackage=true&webjoin=true&appTenantId=${\{TENANT_ID}}&login_hint=${{USER_EMAIL}}</code> |
| Outlook web | <code v-pre>https://outlook.office.com/host/${\{M365_APP_ID}}</code> |
| Office web | <code v-pre>https://www.office.com/m365apps/${{M365_APP_ID}}</code> |
...
- For project file details → see [../toolkit/manifest-and-yaml.md](/lib/10-context-memory/microsoft-skills/_github-plugins-microsoft-365-agents-toolkit-skills-teams-app-developer-toolkit-manifest-and-yaml)
- If something goes wrong → see [../troubleshoot/troubleshoot.md](/lib/10-context-memory/microsoft-skills/_github-plugins-microsoft-365-agents-toolkit-skills-teams-app-developer-troubleshoot-troubleshoot)
...
| Topic | Expert |
|---|---|
| Sideloading URL anatomy, devtunnel, `TENANT_ID`/`TEAMS_APP_TENANT_ID` mapping, `skipAuth` | [../experts/teams/dev.debug-test-ts.md](/lib/10-context-memory/microsoft-skills/_github-plugins-microsoft-365-agents-toolkit-skills-teams-app-developer-experts-teams-dev.debug-test-ts) |
| Teams app manifest schema (scopes, valid domains, webApplicationInfo) | [../experts/teams/runtime.manifest-ts.md](/lib/10-context-memory/microsoft-skills/_github-plugins-microsoft-365-agents-toolkit-skills-teams-app-developer-experts-teams-runtime.manifest-ts) |
| OAuth/SSO flow for in-Teams sign-in scenarios | [../experts/teams/auth.oauth-sso-ts.md](/lib/10-context-memory/microsoft-skills/_github-plugins-microsoft-365-agents-toolkit-skills-teams-app-developer-experts-teams-auth.oauth-sso-ts) |
