...
entryUrl: "https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/azure-skills/skills/azure-app-onboard/scaffold/references/bicep-patterns.md"
sourceRel: ".github/plugins/azure-skills/skills/azure-app-onboard/scaffold/references/bicep-patterns.md"
rawUrl: "/raw/10-context-memory/microsoft-skills/.github/plugins/azure-skills/skills/azure-app-onboard/scaffold/references/bicep-patterns.md"
sourceSha256: "55b4b915647cb6c68f197fa76abaf861b42d90e7e7dd87851dfd9eae6a3a61f2"
pageSha256: "55b4b915647cb6c68f197fa76abaf861b42d90e7e7dd87851dfd9eae6a3a61f2"
...
> ⛔ **Do NOT use `uniqueString()` for secrets** — it is deterministic and predictable. See [bicep-patterns-security.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-bicep-patterns-security) § Secrets for correct secret patterns.
...
- **App Service / Functions:** [bicep-app-service.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-bicep-app-service) — module template, SCM/FTP auth, native module deploy strategy
- **Container Apps:** [bicep-container-apps.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-bicep-container-apps) — two-phase ACR wiring, ingress, secretRef, image parameter, multi-container DNS
- **Static Web Apps:** [bicep-swa.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-bicep-swa) — module template, detached deploy rule
...
> ⛔ **You MUST read [iac-generation-rules.md § Session Tags](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-iac-generation-rules).** All resources MUST include the 5 AppOnboard session tags. Pass `tags` object from `main.bicep` into every module.
...
Syntax differs by service — never mix. See [bicep-container-apps.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-bicep-container-apps) for Container Apps `secretRef` and [bicep-patterns-security.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-bicep-patterns-security) for App Service `@Microsoft.KeyVault()`. For Terraform, see [terraform-patterns.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-terraform-patterns).
