---
title: "Microsoft Foundry Private Networking"
...
entryUrl: "https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/azure-skills/skills/microsoft-foundry/resource/private-network/private-network.md"
sourceRel: ".github/plugins/azure-skills/skills/microsoft-foundry/resource/private-network/private-network.md"
rawUrl: "/raw/10-context-memory/microsoft-skills/.github/plugins/azure-skills/skills/microsoft-foundry/resource/private-network/private-network.md"
sourceSha256: "a0a2c5b532306008ea89e77e007c03561f623bf54d09ca1b14b7838ba5721518"
pageSha256: "a0a2c5b532306008ea89e77e007c03561f623bf54d09ca1b14b7838ba5721518"
...
**Do NOT use for:**
- Public Foundry setup without VNet → use [project/create](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-project-create-create-foundry-project)
- Bare Foundry resource without networking → use [resource/create](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-resource-create-create-foundry-resource)
...
Read [references/intake.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-resource-private-network-references-intake). One pass, three tiers:
...
Use the confirmed requirements from [references/intake.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-resource-private-network-references-intake).

**OFFICIAL path:** Load the template's README from its GitHub URL (via [references/template-index.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-resource-private-network-references-template-)). Run `microsoft_docs_search` for its prerequisites. Present a deployment plan using the user's actual values.
...
**EXTEND path:** Load [references/custom-template-adaptation.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-resource-private-network-references-custom-template-adaptation). Read the user's existing template. Follow the gap analysis framework to present what's covered, what's missing, and any issues. Get approval before modifying.
...
Read [references/scaffold.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-resource-private-network-references-scaffold).
...
**OFFICIAL / ADAPT path:** Read [references/deploy.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-resource-private-network-references-deploy) for deployment command, monitoring, and error recovery.

**EXTEND path:** Deploy using the user's existing deployment workflow (their CLI commands, pipeline, or CI/CD). The monitoring and error recovery guidance in [references/deploy.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-resource-private-network-references-deploy) still applies.

---

## Step 6 — Test & Validate

Read [references/post-deployment-validation.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-resource-private-network-references-post-deployment-validation). These checks apply to all paths — PE verification, RBAC audit, `publicNetworkAccess` audit, and end-to-end agent test work regardless of how the infrastructure was deployed.
