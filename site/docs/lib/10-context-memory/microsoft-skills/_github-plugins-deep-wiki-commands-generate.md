...
entryUrl: "https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/deep-wiki/commands/generate.md"
sourceRel: ".github/plugins/deep-wiki/commands/generate.md"
rawUrl: "/raw/10-context-memory/microsoft-skills/.github/plugins/deep-wiki/commands/generate.md"
sourceSha256: "cbfb747e0fe75128edf2a588b22c28d2c687a19c837418fec7462c225a2f7c48"
pageSha256: "cbfb747e0fe75128edf2a588b22c28d2c687a19c837418fec7462c225a2f7c48"
...
4. **Store the citation format** for use in all subsequent steps:
   - **Remote**: `[file_path:line_number](https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/deep-wiki/commands/REPO_URL/blob/BRANCH/file_path/README.md#Lline_number)` — e.g., `[src/auth.ts:42](https://github.com/org/repo/blob/main/src/auth.ts#L42)`
   ...
   - **Mermaid diagrams**: Every diagram MUST be followed by a `` comment block
...
- **Cross-references between pages**: When a page mentions a concept, component, or pattern documented on another wiki page, link to it with a relative Markdown link (e.g., `[Authentication](https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/deep-wiki/02-architecture/authentication.md)`). Add a "Related Pages" section at the end of each page listing connected wiki pages with one-line descriptions.
