---
title: "Manage Foundry Routines (azd ai routine)"
...
entryUrl: "https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/azure-skills/skills/microsoft-foundry/foundry-agent/routine/routine.md"
sourceRel: ".github/plugins/azure-skills/skills/microsoft-foundry/foundry-agent/routine/routine.md"
rawUrl: "/raw/10-context-memory/microsoft-skills/.github/plugins/azure-skills/skills/microsoft-foundry/foundry-agent/routine/routine.md"
sourceSha256: "f7fe5adf57792ff1e4380533ef465b8dc601ea6196e9422917fdf7e1f9d0d78f"
pageSha256: "f7fe5adf57792ff1e4380533ef465b8dc601ea6196e9422917fdf7e1f9d0d78f"
...
> A routine **references an agent**; it does not create one. Deploy or identify the target agent first (see [deploy](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-deploy-deploy) / [create](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-create-create-hosted)), then attach a routine to it.
...
Create the routine directly against the Foundry project with a single command — flags, or a `--file` manifest when it must carry a stored prompt/payload (`action.input`; there is no `--input` flag). Best for one-off scheduling, quick experiments, ad-hoc CRUD, and working **outside** an azd project — no `azure.yaml` required. → [CLI CRUD and Operations](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-routine-references-cli-crud)

### Way 2 — Declarative: `azure.yaml` + `azd deploy`

Declare the routine as a `host: azure.ai.routine` service in `azure.yaml`, then let `azd deploy` / `azd up` upsert it. Best when the routine should be **versioned with the agent in source control** and **reproduced per azd environment** — GitOps, multi-env, CI/CD. → [Declarative Routines](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-routine-references-azure-yaml)
...
Read, update, enable/disable, manually dispatch, inspect past runs, and delete are imperative-only operations that work on a routine regardless of how it was created — see [CLI CRUD and Operations](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-routine-references-cli-crud).
...
| Network isolation / `PublicNetworkAccessDisabled` / `403` | Project has public access disabled | See [Network Isolation Errors](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-SKILL#network-isolation-errors) |

## Additional Resources

- [CLI CRUD and Operations](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-routine-references-cli-crud)
- [Declarative Routines](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-routine-references-azure-yaml)
- [azd ai CLI Reference](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-azd-guidance-references-azd-ai-cli)
- [Deploy a Foundry Agent](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-deploy-deploy) - deploy the agent a routine will invoke
- [Invoke a Foundry Agent](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-invoke-invoke) - smoke-test the agent before scheduling it
- [Microsoft Foundry Skill (index)](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-SKILL)
