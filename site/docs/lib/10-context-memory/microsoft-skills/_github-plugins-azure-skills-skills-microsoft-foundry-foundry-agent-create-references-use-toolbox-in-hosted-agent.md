---
title: "Use a Toolbox from Your Agent Code"
...
entryUrl: "https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/azure-skills/skills/microsoft-foundry/foundry-agent/create/references/use-toolbox-in-hosted-agent.md"
sourceRel: ".github/plugins/azure-skills/skills/microsoft-foundry/foundry-agent/create/references/use-toolbox-in-hosted-agent.md"
rawUrl: "/raw/10-context-memory/microsoft-skills/.github/plugins/azure-skills/skills/microsoft-foundry/foundry-agent/create/references/use-toolbox-in-hosted-agent.md"
sourceSha256: "2da980440a43a9edd6057e6cfce8b198ae3db8fef5f087435b3aee1b3b0fa174"
pageSha256: "2da980440a43a9edd6057e6cfce8b198ae3db8fef5f087435b3aee1b3b0fa174"
...
A **toolbox** is a single MCP-compatible endpoint that exposes all the tools you've configured; your agent connects to that one URL and discovers every tool inside. For the concept, object model, and API/schema, see [toolbox.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-toolbox-toolbox).
...
> 💡 **This skill covers *consuming* an existing toolbox from agent code.** To add a tool (`web_search`, `file_search`, `azure_ai_search`, `code_interpreter`, `openapi`, `mcp`, `a2a_preview`, …), don't wire it to the agent — put it in a toolbox first, via the `azd ai` CLI ([toolbox.md → Create & use a toolbox](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-toolbox-toolbox#create--use-a-toolbox-happy-path)), [Foundry Toolkit (VS Code)](https://code.visualstudio.com/docs/intelligentapps/tool-catalog), or [Foundry Portal](https://ai.azure.com/). The agent only talks to the toolbox's MCP endpoint; add/remove/reconfigure tools there, not in agent code. For supported `type` values and adjacent capabilities (Agent Memory, Routines), see [toolbox.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-toolbox-toolbox).
...
Hosted agents read the MCP endpoint from one env var, conventionally **`TOOLBOX_ENDPOINT`** (not enforced, but prefer it). For the URL format, see [toolbox.md § MCP endpoint URL format](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-toolbox-toolbox#mcp-endpoint-url-format).

Set it in `.env` locally, or `azd env set TOOLBOX_ENDPOINT "<url>"` when deployed; get the URL via `azd ai toolbox show` (see [toolbox-azd.md § CLI surface](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-toolbox-references-toolbox-azd#cli-surface)).
...
For toolbox-composition / provisioning errors (`Multiple tools without identifiers`, `tools/list` returns zero, `403` on toolbox/connection writes), see [mcp-protocol.md § Troubleshooting (create / provision)](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-toolbox-references-mcp-protocol#troubleshooting-create--provision).
...
For the MCP protocol methods and tool-naming rules, see [mcp-protocol.md § MCP protocol](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-toolbox-references-mcp-protocol#mcp-protocol) and [§ Tool naming](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-toolbox-references-mcp-protocol#tool-naming).
