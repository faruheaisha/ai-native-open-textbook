...
entryUrl: "https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/microsoft-365-agents-toolkit/skills/declarative-agent-developer/references/localization.md"
sourceRel: ".github/plugins/microsoft-365-agents-toolkit/skills/declarative-agent-developer/references/localization.md"
rawUrl: "/raw/10-context-memory/microsoft-skills/.github/plugins/microsoft-365-agents-toolkit/skills/declarative-agent-developer/references/localization.md"
sourceSha256: "5d84be4f63c62e3fd5fbcd52f9db65848ad3f6ee5e6d51d615c4a61b5a1dbca0"
pageSha256: "5d84be4f63c62e3fd5fbcd52f9db65848ad3f6ee5e6d51d615c4a61b5a1dbca0"
...
| Leaving instructions inline in `declarativeAgent.json` when localizing | Instructions must be separated from localizable content. Inline instructions block proper tokenization. | Create `appPackage/instructions.txt` and set `"instructions": "$[file](https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/microsoft-365-agents-toolkit/skills/declarative-agent-developer/references/%27instructions.txt%27)"`. |
...
| Using `[[token]]` for the instructions field | Instructions are NOT localizable. The LLM consumes them in a single language. | Use `$[file](https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/microsoft-365-agents-toolkit/skills/declarative-agent-developer/references/%27instructions.txt%27)` for instructions. Never tokenize them. |
...
- [ ] `instructions` field is NOT tokenized (it should remain as `$[file](https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/microsoft-365-agents-toolkit/skills/declarative-agent-developer/references/%27instructions.txt%27)` or inline text — never `[[token]]`)
...
3. **Do NOT localize instructions** — externalize to `instructions.txt` via `$[file](https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/microsoft-365-agents-toolkit/skills/declarative-agent-developer/references/%27instructions.txt%27)`. Never use `[[tokens]]` for instructions.
