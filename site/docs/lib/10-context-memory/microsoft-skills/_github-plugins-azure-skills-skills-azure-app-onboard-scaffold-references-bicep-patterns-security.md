---
title: "Bicep Patterns — Security Defaults"
...
entryUrl: "https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/azure-skills/skills/azure-app-onboard/scaffold/references/bicep-patterns-security.md"
sourceRel: ".github/plugins/azure-skills/skills/azure-app-onboard/scaffold/references/bicep-patterns-security.md"
rawUrl: "/raw/10-context-memory/microsoft-skills/.github/plugins/azure-skills/skills/azure-app-onboard/scaffold/references/bicep-patterns-security.md"
sourceSha256: "28a9a99ed93b59841d28e962510c12a134c304150fa8ccb8f64f1bd985e88367"
pageSha256: "28a9a99ed93b59841d28e962510c12a134c304150fa8ccb8f64f1bd985e88367"
...
For core patterns (file structure, skeleton, naming, tagging), see [bicep-patterns.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-bicep-patterns). For data module templates (PostgreSQL, Redis), see [subagent-iac-gen.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-subagent-iac-gen) Step 6.
...
>
> **Container Apps exception:** Phase 1 of two-phase deployment uses `secrets: []` — NO secrets at all (not plaintext, not KV). KV `secretRef` entries are activated in Phase 2 after RBAC propagates. See [bicep-container-apps.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-bicep-container-apps) § Two-Phase Wiring.
>
...
⛔ Cosmos DB uses its own role system — see [rbac-roles.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-rbac-roles) § Cosmos DB for role IDs and behavioral rules. Do NOT use `Microsoft.Authorization/roleAssignments` for Cosmos data access.

### RBAC — Deterministic Role Assignments

For the common roles GUID table, see [rbac-roles.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-rbac-roles).
