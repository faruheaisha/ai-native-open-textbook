---
title: "Tool — Tool Search (preview) (type: toolboxsearchpreview)"
...
entryUrl: "https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/azure-skills/skills/microsoft-foundry/foundry-agent/toolbox/references/tool-tool-search.md"
sourceRel: ".github/plugins/azure-skills/skills/microsoft-foundry/foundry-agent/toolbox/references/tool-tool-search.md"
rawUrl: "/raw/10-context-memory/microsoft-skills/.github/plugins/azure-skills/skills/microsoft-foundry/foundry-agent/toolbox/references/tool-tool-search.md"
sourceSha256: "663218423040132bcd2ae5c81d69c8a06b19de69a7caf3a96ee2d8c473113d4b"
pageSha256: "663218423040132bcd2ae5c81d69c8a06b19de69a7caf3a96ee2d8c473113d4b"
...
Tool Search is a **connectionless directive** — it's declared under a `tools:` block (like `web_search`); **no project connection required**. It is **not** a standalone toolbox: pair it with the tools it should index (see [Behavior](#behavior) and the [Multi-tool rule](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-toolbox-references-toolbox-azd#multi-tool-rule)).
...
After creating the toolbox either way, verify its MCP endpoint end-to-end — with Tool Search enabled, `tools/list` returns only `tool_search` + `call_tool` (the indexed tools are hidden until a `tool_search` call surfaces them). See [test-endpoint.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-toolbox-references-test-endpoint).
...
- [toolbox.md § Enable Tool Search](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-microsoft-foundry-foundry-agent-toolbox-toolbox#enable-tool-search)
