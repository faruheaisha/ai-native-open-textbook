---
title: "Consumption Plan to Flex Consumption Plan Upgrade"
...
entryUrl: "https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/azure-skills/skills/azure-upgrade/references/services/functions/consumption-to-flex.md"
sourceRel: ".github/plugins/azure-skills/skills/azure-upgrade/references/services/functions/consumption-to-flex.md"
rawUrl: "/raw/10-context-memory/microsoft-skills/.github/plugins/azure-skills/skills/azure-upgrade/references/services/functions/consumption-to-flex.md"
sourceSha256: "b13898a2a86218dc6acbb0c7ab4cef17861f86d457689c3a4320c079209e1843"
pageSha256: "b13898a2a86218dc6acbb0c7ab4cef17861f86d457689c3a4320c079209e1843"
...
Run all checks from [assessment.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-upgrade-references-services-functions-assessment). Use the automated eligibility check:
...
This returns `eligible_apps` and `ineligible_apps` arrays with specific reasons for any incompatibilities. For detailed manual checks, see [automation.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-upgrade-references-services-functions-automation).

### Phase 2: Pre-migration (Collect Everything)

Collect all settings and configurations from the existing app before creating the new one. See **Step-by-step scripts** in [automation.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-upgrade-references-services-functions-automation):
...
Run the automated migration command from [automation.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-upgrade-references-services-functions-automation) — Step 4.
...
The `flex-migration start` command handles most configuration. Verify the results and manually configure anything it doesn't cover (see [automation.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-upgrade-references-services-functions-automation)):
...
After user selects an option, execute the corresponding deployment method from [automation.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-upgrade-references-services-functions-automation) — Step 5.
...
- When confident, delete using the command in [automation.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-upgrade-references-services-functions-automation) — Step 7
