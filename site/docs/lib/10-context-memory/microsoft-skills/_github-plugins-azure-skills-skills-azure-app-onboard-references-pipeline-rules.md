---
title: "Pipeline Rules — Reference"
...
entryUrl: "https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/azure-skills/skills/azure-app-onboard/references/pipeline-rules.md"
sourceRel: ".github/plugins/azure-skills/skills/azure-app-onboard/references/pipeline-rules.md"
rawUrl: "/raw/10-context-memory/microsoft-skills/.github/plugins/azure-skills/skills/azure-app-onboard/references/pipeline-rules.md"
sourceSha256: "ff6c8128788661b2493b117b6b28615d9a7da644f588a13b2fb750162896f757"
pageSha256: "ff6c8128788661b2493b117b6b28615d9a7da644f588a13b2fb750162896f757"
...
Cross-cutting rules enforced across all workflow steps. Referenced from [SKILL.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-SKILL) `## Pipeline Rules`.
...
See [`pipeline-rules-runtime.md`](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-references-pipeline-rules-runtime) § Known Platform Bugs for the full bug table and workarounds.
...
See [iac-generation-rules.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-iac-generation-rules) § Security Patterns and [bicep-patterns-security.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-bicep-patterns-security). Flag `AllowAzureServices` firewall rule as a security warning.

## azure.yaml prohibition

⛔ **NEVER generate `azure.yaml`. NEVER use `azd up`/`azd provision`/`azd deploy`.** AppOnboard deploys via `az deployment sub create` (Bicep) or `terraform apply` (Terraform). Repos with existing `azure.yaml` → route per [`azd-template-routing.md`](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-references-azd-template-routing).
