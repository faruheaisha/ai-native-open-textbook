---
title: "App Onboard Prepare — Pricing Guide"
...
entryUrl: "https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/azure-skills/skills/azure-app-onboard/prepare/references/pricing-guide.md"
sourceRel: ".github/plugins/azure-skills/skills/azure-app-onboard/prepare/references/pricing-guide.md"
rawUrl: "/raw/10-context-memory/microsoft-skills/.github/plugins/azure-skills/skills/azure-app-onboard/prepare/references/pricing-guide.md"
sourceSha256: "1000c4d89e090d954c42bf3abe31b13676bf493a4c7bc12269077cca95ce8d8f"
pageSha256: "1000c4d89e090d954c42bf3abe31b13676bf493a4c7bc12269077cca95ce8d8f"
...
1. Pick SKU from [sku-matrix.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-prepare-references-sku-matrix) based on budget intent.
2. Find service section in [pricing-guide-services.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-prepare-references-pricing-guide-services) for filter strings and formulas.
...
See [pricing-guide-services.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-prepare-references-pricing-guide-services) for per-service filter strings, meter names, and monthly formulas.
...
- Default `isPrimaryMeterRegion eq true` + `priceType eq 'Consumption'` — but check the service section in [pricing-guide-services.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-prepare-references-pricing-guide-services) first; some drop `isPrimaryMeterRegion` (Service Bus, Cosmos 100 RU/s, Redis Basic).
- Service names are case-sensitive

## Troubleshooting

When `pricing_get` returns empty: (1) Check `armSkuName` populated/case-sensitive? (2) HTTP fallback: `https://prices.azure.com/api/retail/prices?$filter=\{filter\}`. (3) After 2 failures, use [pricing-guide-services.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-prepare-references-pricing-guide-services) with disclaimer. (4) Log to `costEstimate.apiFailures[]`.
