...
entryUrl: "https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/azure-sdk-python/skills/azure-ai-projects-py/references/built-in-evaluators.md"
sourceRel: ".github/plugins/azure-sdk-python/skills/azure-ai-projects-py/references/built-in-evaluators.md"
rawUrl: "/raw/10-context-memory/microsoft-skills/.github/plugins/azure-sdk-python/skills/azure-ai-projects-py/references/built-in-evaluators.md"
sourceSha256: "12407200b755179be7e72399cfba331b7bd636f5a65f5bda273509465726eab0"
pageSha256: "12407200b755179be7e72399cfba331b7bd636f5a65f5bda273509465726eab0"
...
**Note:** Use <code v-pre>{{sample.output_items}}</code> for agent responses to include tool call information.
...
|-------------|------------------|----------|
| JSONL dataset | <code v-pre>{{item.response}}</code> | Pre-recorded query/response pairs |
| Agent target | <code v-pre>{{sample.output_text}}</code> | Plain text response |
| Agent target | <code v-pre>{{sample.output_items}}</code> | Structured JSON with tool calls |
