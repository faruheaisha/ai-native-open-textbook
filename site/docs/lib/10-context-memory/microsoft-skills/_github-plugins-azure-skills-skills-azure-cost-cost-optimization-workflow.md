...
entryUrl: "https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/azure-skills/skills/azure-cost/cost-optimization/workflow.md"
sourceRel: ".github/plugins/azure-skills/skills/azure-cost/cost-optimization/workflow.md"
rawUrl: "/raw/10-context-memory/microsoft-skills/.github/plugins/azure-skills/skills/azure-cost/cost-optimization/workflow.md"
sourceSha256: "911fd64c240f65dd5db7a086b481292a834b9c863cb24e296b0dc2b403cbe3c7"
pageSha256: "911fd64c240f65dd5db7a086b481292a834b9c863cb24e296b0dc2b403cbe3c7"
...
> **Important:** Always present the total bill and cost breakdown (from the [Cost Query Workflow](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-cost-cost-query-workflow)) alongside optimization recommendations.
...
- Azure Quick Review (azqr) installed — See [Azure Quick Review](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-cost-cost-optimization-azure-quick-review)
...
**Reference**: [Azure Redis Cost Optimization](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-cost-cost-optimization-services-redis-azure-cache-for-redis)
...
**If the user requests Storage cost optimization**, load: [Azure Storage Cost Optimization](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-cost-cost-optimization-services-storage-azure-storage)
...
- [Cost Analysis Add-on](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-cost-cost-optimization-azure-aks-cost-addon) — enable namespace-level cost visibility
- [Anomaly Investigation](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-cost-cost-optimization-azure-aks-anomalies) — cost spikes, scaling events, budget alerts
...
**Reference**: [Azure Quick Review](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-cost-cost-optimization-azure-quick-review)
...
Use Azure Resource Graph for efficient cross-subscription resource discovery. See [Azure Resource Graph Queries](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-cost-cost-optimization-azure-resource-graph) for orphaned resource detection patterns.
...
Get actual cost data from Azure Cost Management API (last 30 days). Use the [Cost Query Workflow](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-cost-cost-query-workflow) with this configuration:
...
> 💡 **Tip:** Also run a cost-by-service query (grouping by `ServiceName`) to present the total bill breakdown alongside optimization recommendations. See [examples.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-cost-cost-query-examples).
...
For the complete report template, see [report-template.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-cost-cost-optimization-report-template).
