---
title: "EF Core Migrations Deployment"
...
entryUrl: "https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/azure-skills/skills/azure-deploy/references/recipes/azd/ef-migrations.md"
sourceRel: ".github/plugins/azure-skills/skills/azure-deploy/references/recipes/azd/ef-migrations.md"
rawUrl: "/raw/10-context-memory/microsoft-skills/.github/plugins/azure-skills/skills/azure-deploy/references/recipes/azd/ef-migrations.md"
sourceSha256: "03373921a7590b9ee7be247d54c884c564d87a1226610edd1a894a4717c9f7ed"
pageSha256: "03373921a7590b9ee7be247d54c884c564d87a1226610edd1a894a4717c9f7ed"
...
**Copy the pre-built scripts** — Read [scripts/apply-migrations.sh](https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/azure-skills/skills/azure-deploy/references/recipes/azd/scripts/apply-migrations.sh) and [scripts/apply-migrations.ps1](https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/azure-skills/skills/azure-deploy/references/recipes/azd/scripts/apply-migrations.ps1) and write them verbatim to the project's `scripts/` folder. Adjust `APP_PROJECT_PATH` / `$AppProjectPath` in the script to the location of the `.csproj` directory.
...
**Copy the pre-built scripts** — Read [scripts/grant-and-migrate.sh](https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/azure-skills/skills/azure-deploy/references/recipes/azd/scripts/grant-and-migrate.sh) and [scripts/grant-and-migrate.ps1](https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/azure-skills/skills/azure-deploy/references/recipes/azd/scripts/grant-and-migrate.ps1) and write them verbatim to the project's `scripts/` folder. Adjust `APP_PROJECT_PATH` / `$AppProjectPath` in the script to the location of the `.csproj` directory.
...
| Login failed | Grant SQL access per [sql-managed-identity.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-deploy-references-recipes-azd-sql-managed-identity) |
