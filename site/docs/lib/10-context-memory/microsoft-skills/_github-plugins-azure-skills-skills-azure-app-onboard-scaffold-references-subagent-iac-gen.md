---
title: "Subagent Template — IaC Generation (Steps 5–8)"
...
entryUrl: "https://github.com/microsoft/skills/blob/cf77b1efbf3117501f4727c476894751311ee885/.github/plugins/azure-skills/skills/azure-app-onboard/scaffold/references/subagent-iac-gen.md"
sourceRel: ".github/plugins/azure-skills/skills/azure-app-onboard/scaffold/references/subagent-iac-gen.md"
rawUrl: "/raw/10-context-memory/microsoft-skills/.github/plugins/azure-skills/skills/azure-app-onboard/scaffold/references/subagent-iac-gen.md"
sourceSha256: "8442932dd20d964696b6f1988d8001c0846477ed35c2803f3ae1e0a18bf6a5d7"
pageSha256: "8442932dd20d964696b6f1988d8001c0846477ed35c2803f3ae1e0a18bf6a5d7"
...
Read [bicep-patterns.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-bicep-patterns) (Bicep) OR [terraform-patterns.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-terraform-patterns) (Terraform) — NOT both.
...
- If plan has App Service/Functions → read [bicep-app-service.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-bicep-app-service).
- If plan has Container Apps → read [bicep-container-apps.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-bicep-container-apps).
- If plan has Static Web Apps → read [bicep-swa.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-bicep-swa).
...
⛔ **You MUST read [bicep-patterns-security.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-bicep-patterns-security).** It contains Key Vault config, managed identity, HTTPS/TLS, and credential hygiene rules. Apply to every generated module.

### Step 4 — Read generation rules

Read [iac-generation-rules.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-iac-generation-rules).
...
Read [env-var-secrets.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-env-var-secrets).
...
Wire connection strings via Key Vault `secretRef` (Container Apps) or `@Microsoft.KeyVault()` (App Service). ⛔ **Container Apps:** KV `secretRef` entries MUST be gated behind `isPlaceholder` — Phase 1 deploys with `secrets: []`. See [bicep-container-apps.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-bicep-container-apps) § Two-Phase Wiring.
...
4. `infra/modules/\{service\}.bicep` — one module per service from the plan, PLUS `role-assignments.bicep` (KV Secrets Officer for deployer, KV Secrets User for app identity if MI enabled — see [bicep-patterns-security.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-bicep-patterns-security) § Key Vault Deployer RBAC).
5. If `buildRequirements.hasBuildKitSyntax == true`: ⛔ create `\{component\}/Dockerfile.azure` per [dockerfile-generation.md § ACR Build Compatibility](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-dockerfile-generation).
6. If Container Apps and component has NO Dockerfile: read [dockerfile-generation.md](/lib/10-context-memory/microsoft-skills/_github-plugins-azure-skills-skills-azure-app-onboard-scaffold-references-dockerfile-generation) and generate one. Follow the layer ordering, port alignment, and security defaults from that reference — do NOT generate from memory.
