...
> **Full Example**: For a complete, runnable AI agent built with this framework, see the [Hybrid Search RAG Agent](/lib/10-context-memory/context-engineering-intro/use-cases-agent-factory-with-subagents-agents-rag_agent) which includes full setup instructions and documentation.
