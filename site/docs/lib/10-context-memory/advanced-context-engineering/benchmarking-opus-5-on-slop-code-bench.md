...
entryUrl: "https://github.com/humanlayer/advanced-context-engineering-for-coding-agents/blob/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/benchmarking-opus-5-on-slop-code-bench.md"
sourceRel: "benchmarking-opus-5-on-slop-code-bench.md"
rawUrl: "/raw/10-context-memory/advanced-context-engineering/benchmarking-opus-5-on-slop-code-bench.md"
sourceSha256: "29e7d062212b5f6d8ba4d075e7c8e8dc233582d0c6b9e2be9d65a9cdd1420b6c"
pageSha256: "29e7d062212b5f6d8ba4d075e7c8e8dc233582d0c6b9e2be9d65a9cdd1420b6c"
...
![Benchmarking Opus 5 on SlopCodeBench](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/scb-title-card.png)
...
Last Friday I dug into [SlopCodeBench](https://arxiv.org/html/2603.24755v1), a new-ish (March 2026) long-horizon coding benchmark from [@GOrlanski](https://x.com/GOrlanski)'s lab at UW Madison. It addresses the thing that bothers me most about coding benchmarks - that even "larger" more complex benchmarks still divulge the whole problem up front:
...
![table of results from initial paper](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/results-scb.png)
...
![strict pass rate — opus 5 at 4 of 17, opus 4.8 and sonnet 5 at 1 of 17 each, against the paper's opus 4.6 at 17% and gpt-5.4 at 11%](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/scb-strict.png)
...
![defects left open per checkpoint on circuit_eval — opus 4.8 climbs 1 to 10, sonnet 5 stays flat, opus 5 opens with four clean checkpoints](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/scb-defect-trajectory.png)

for the first two hours opus 5 was the only model with any strict passes at all — three in a row to start.

![the live progress page at 12:12pm — 8 of 51 checkpoints done, $12.31 spent, and both of the run's two strict passes belong to opus 5](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/scb-progress-early.png)

Things evolved as we went. Claude diligently updated the html.

![the same progress page later in the run, with more of the grid filled in](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/scb-progress-later.png)
...
![defects left open at the end of each problem](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/scb-defects.png)
...
![cost vs defects, one point per model per problem](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/scb-cost-defects.png)
...
![source lines written — opus 5 wrote 29,065 against roughly 9,000 each for the other two](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/scb-volume.png)

But a lot of that was "more tests" - the actual production volume is closer to 1.8x for opus 5 vs opus 4.8. 

![the same source lines split into production and test code — opus 5 is 51% tests, opus 4.8 is 11%, sonnet 5 is 24%](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/scb-testsplit.png)
...
![findings per KSLOC — the Synclayer TypeScript monorepo at 15.06, Opus 5's pooled checkpoints at 174.88 and its three final snapshots at 178.88, so 11.6x and 11.9x the density](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/scb-ts-slop-density.png)
...
![single-use functions as a share of all callables — opus 5 at 14.9%, opus 4.8 at 49.1%, sonnet 5 at 71.5%](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/scb-single-use.png)
...
![mean cyclomatic complexity and duplicated-line percentage across all eight circuit_eval checkpoints, one line per model](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/scb-complexity.png)
...
![callables written against mean cyclomatic complexity, one point per model per problem — opus 5 sits low-right with many small functions, opus 4.8 high-left with few big ones](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/scb-fnscatter.png)
...
![three lanes of the same eight checkpoints — fable 5, gpt-5.6-sol and opus 5 each build ck1 through ck7, then hand the codebase to sonnet 5 for ck8](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/scb-handoff.png)
