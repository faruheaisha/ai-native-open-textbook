...
entryUrl: "https://github.com/humanlayer/advanced-context-engineering-for-coding-agents/blob/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/wsff.md"
sourceRel: "wsff.md"
rawUrl: "/raw/10-context-memory/advanced-context-engineering/wsff.md"
sourceSha256: "55fa3b344bc1cc8b2134d7329e3e216d8e66c139568345d1b3d683c6daf64bf7"
pageSha256: "55fa3b344bc1cc8b2134d7329e3e216d8e66c139568345d1b3d683c6daf64bf7"
...
> [!NOTE]
> I run a company ([HumanLayer](https://humanlayer.com?utm_source=wsff)) building tools in the human/agent collaboration space, so what I'm gonna say below may be a tad biased. Perhaps in spite of that, I hope you find the subject helpful or at the very least that you find it as interesting as I do. -Dex
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/loop-engineering-shadow.png" width="50%" alt="Loop engineering -- just write more loops"></div>
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/ryan-lop-shadow.png" width="50%" alt="Ryan Lopopolo of OpenAI on harness engineering"></div>
...
| ![Faros AI: code quality before merge is declining -- +25% more review comments, +22.7% longer comments, +31.3% of PRs skip review entirely](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/faros-code-review-shadow.png) | ![Faros AI: production quality is declining -- incidents per PR +242.7%, monthly incidents +57.9%, bugs per developer +54%](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/faros-incidents-and-bugs-shadow.png) |
|---|---|
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/software-factory-leverage-wm-shadow.png" width="70%" alt="Both build and review take hours or days"></div>
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/software-factory-leverage-review-wm-shadow.png" width="70%" alt="Front-loading planning: ~1 hour up front decreases rework and cuts review from 6hr to 20m"></div>
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/software-factory-agentic-1-wm-shadow.png" width="70%" alt="The agentic software factory -- an agent builds the thing"></div>
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/software-factory-agentic-2-wm-shadow.png" width="70%" alt="Building is now minutes or hours; review is still hours or days"></div>
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/software-factory-agentic-3-wm-shadow.png" width="70%" alt="Agentic review and regression testing -- faster, but still the bottleneck"></div>
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/software-factory-agentic-4-wm-shadow.png" width="70%" alt="Route incidents into the factory"></div>

We can also route user feedback into the factory. People ask for stuff, it gets built.

<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/software-factory-agentic-5-wm-shadow.png" width="70%" alt="Route user feedback into the factory"></div>
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/software-factory-agentic-6-wm-shadow.png" width="70%" alt="How much can you stuff into the queue, and how fast can you review the changes"></div>
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/software-factory-lights-off-1-wm-shadow.png" width="70%" alt="The lights-off software factory -- human review scribbled out"></div>
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/software-factory-lights-off-2-wm-shadow.png" width="70%" alt="Invest into testing, monitoring, and rollout instead"></div>
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/software-factory-lights-off-3-wm-shadow.png" width="70%" alt="The job is now one question -- how much can you stuff into the queue"></div>
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/better-dimensions-wm-shadow.png" height="380" alt="Solving one-off problems shot up from 2025 to 2026; improving codebase quality barely moved"></div>
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/claude-code-revenue-shadow.png" width="70%" alt="Claude Code run-rate"></div>
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/swe-agent-tools-shadow.png" width="70%" alt="SWE-Agent tool design comparison: no edit tool vs. edit without linting vs. edit with linting -- small changes in tool shape make big differences in agent behavior"></div>
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/bench-task-wm-shadow.png" alt="How one SWE-bench Multilingual task is graded, on the real fastlane row: the agent gets a bug report and codebase, writes a patch, then in a sandbox the benchmark's test patch is applied on top and run -- pass → 1, else 0"></div>
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/bad-code-1-shadow.png" width="50%" alt="try catch around json parse"></div>

And lazy type casts that undermine the whole benefit of having a type system in the first place

<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/bad-code-2-shadow.png" width="50%" alt="lazy type casts"></div>
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/sota-backprop-wm-shadow.png" width="70%" alt="A bad decision leads to random slop leads to a bug/incident weeks or months later -- and there's no way to backprop the incident to the decision that caused it"></div>
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/sota-changes-wm-shadow.png" width="70%" alt="Software is discovering problems as you go, but even most modern benchmarks disclose the whole problem up front -- no reason to optimize for 'is this easy to change/adjust later'"></div>
...
<div align="center"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/lights-on-agentic-1-wm-shadow.png" width="70%" alt="lights-on-agentic-1"></div>
...
| ![Product-review doc: a JSON workflow outline defining the steps and exits](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/product-review-workflow-json-shadow.png) | ![HTML mockup: the new-task screen with a graph preview of the workflow steps](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/product-review-mockup-new-task-shadow.png) | ![HTML mockup: in-chat handoff suggestions when the agent stops](https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/product-review-mockup-handoffs-shadow.png) |
|---|---|---|
...
<div align="center"><a href="https://x.com/dillon_mulroy/status/2059985696148849025"><img src="https://gh-proxy.com/https://raw.githubusercontent.com/humanlayer/advanced-context-engineering-for-coding-agents/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/images/dillon_tweet-shadow.png" height="380" alt="Dillon Mulroy on using call graphs in planning"></a></div>
...
To spare you time (we're almost at the end), I rambled more about this in a side quest: ["where does the time go"](/lib/10-context-memory/advanced-context-engineering/side-quests-where-does-the-time-go)
...
We're building [humanlayer.com](https://humanlayer.com?utm_source=wsff), an agentic IDE and collaboration platform to help you move 2-3x faster while maintaining a human (or pretty-dang-close-to-human) level of code quality.
...
[^1]: https://github.com/humanlayer/advanced-context-engineering-for-coding-agents/blob/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/The/README.md loop, as an AI technique, was more or less discovered by an [alleged goat farmer](https://ghuntley.com/ralph/) on a remote island off the coast of Australia.

[^1b]: https://github.com/humanlayer/advanced-context-engineering-for-coding-agents/blob/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/i%27ve/README.md been doing this for what feels like too long, but it's widely accepted that the big uptick was in december 2025 going into the new year

[^3]: https://github.com/humanlayer/advanced-context-engineering-for-coding-agents/blob/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/yes/README.md of course you can get gpt-5.5 xhigh to do BRILLIANT refactors. But you had to tell it to do that. And to tell it to do that you had to understand your codebase well enough to know it needed doing. We're here talking about why lights-off wont work.

[^5]: https://github.com/humanlayer/advanced-context-engineering-for-coding-agents/blob/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/back/README.md at sprout social in ~2013, my boss told me about a game he liked to play where you see how many lines of code you can delete from the python monolith without any of the thousands of unit tests failing

[^6]: https://github.com/humanlayer/advanced-context-engineering-for-coding-agents/blob/f2bc7aec4575418d2d2e83fec078266cc56d3e6a/yes/README.md i chose that word and typed it out one character at a time because it's appropriate here. if you thought the code was bad, don't even get me started on trash agent prose
