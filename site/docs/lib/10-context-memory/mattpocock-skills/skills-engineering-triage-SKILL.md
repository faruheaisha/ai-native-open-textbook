...
entryUrl: "https://github.com/mattpocock/skills/blob/3cca18b368ae95cdbdebbff572ccafa662551015/skills/engineering/triage/SKILL.md"
sourceRel: "skills/engineering/triage/SKILL.md"
rawUrl: "/raw/10-context-memory/mattpocock-skills/skills/engineering/triage/SKILL.md"
sourceSha256: "623a2ed692bdc77d2090e2a3dea3b627dd722ad3bbaca0be83aada75292c8fc4"
pageSha256: "623a2ed692bdc77d2090e2a3dea3b627dd722ad3bbaca0be83aada75292c8fc4"
...
- [AGENT-BRIEF.md](/lib/10-context-memory/mattpocock-skills/skills-engineering-triage-AGENT-BRIEF): how to write durable agent briefs
- [OUT-OF-SCOPE.md](/lib/10-context-memory/mattpocock-skills/skills-engineering-triage-OUT-OF-SCOPE): how the `.out-of-scope/` knowledge base works
...
5. **Apply the outcome:**
   - `ready-for-agent`: post an agent brief comment ([AGENT-BRIEF.md](/lib/10-context-memory/mattpocock-skills/skills-engineering-triage-AGENT-BRIEF)).
   ...
   - For `wontfix`, close the issue, with the comment depending on *why*:
     ...
     - **Rejected (enhancement)**: write to `.out-of-scope/`, link to it from a comment, then close ([OUT-OF-SCOPE.md](/lib/10-context-memory/mattpocock-skills/skills-engineering-triage-OUT-OF-SCOPE)).
