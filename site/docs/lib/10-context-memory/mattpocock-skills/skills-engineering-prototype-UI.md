...
entryUrl: "https://github.com/mattpocock/skills/blob/3cca18b368ae95cdbdebbff572ccafa662551015/skills/engineering/prototype/UI.md"
sourceRel: "skills/engineering/prototype/UI.md"
rawUrl: "/raw/10-context-memory/mattpocock-skills/skills/engineering/prototype/UI.md"
sourceSha256: "723211e878acbc7b6ff09755263f3295cde724ba902ff0064da41eed51d45ad3"
pageSha256: "723211e878acbc7b6ff09755263f3295cde724ba902ff0064da41eed51d45ad3"
...
If the question is about logic/state rather than what something looks like, this is the wrong branch. Use [LOGIC.md](/lib/10-context-memory/mattpocock-skills/skills-engineering-prototype-LOGIC).
...
Once a variant has won, capture the answer (which variant and why), then capture the prototype the way the [SKILL](/lib/10-context-memory/mattpocock-skills/skills-engineering-prototype-SKILL) describes. Fold the winner into the real code and move the rest onto the throwaway branch, not into main:
...
- **Sharing too much code between variants.** A shared `` is fine; a shared `<Layout>` defeats the point. Each variant should be free to throw out the layout.
