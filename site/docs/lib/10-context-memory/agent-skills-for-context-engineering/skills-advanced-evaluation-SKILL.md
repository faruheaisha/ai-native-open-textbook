...
entryUrl: "https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/blob/6dbe1a1d868eab51a3bc9011b0f55e2891513e40/skills/advanced-evaluation/SKILL.md"
sourceRel: "skills/advanced-evaluation/SKILL.md"
rawUrl: "/raw/10-context-memory/agent-skills-for-context-engineering/skills/advanced-evaluation/SKILL.md"
sourceSha256: "8b9e3d9de07a0505ae2b42df2e15dd75bab5f2486e336194481c558e0648ded0"
pageSha256: "8b9e3d9de07a0505ae2b42df2e15dd75bab5f2486e336194481c558e0648ded0"
...
Build production evaluation systems with these layers: Criteria Loader (rubrics + weights) -> Primary Scorer (direct or pairwise) -> Bias Mitigation (position swap, etc.) -> Confidence Scoring (calibration) -> Output (scores + justifications + confidence). See [Evaluation Pipeline Diagram](/lib/10-context-memory/agent-skills-for-context-engineering/skills-advanced-evaluation-references-evaluation-pipeline) for the full visual layout.
...
Internal reference:
- [LLM-as-Judge Implementation Patterns](/lib/10-context-memory/agent-skills-for-context-engineering/skills-advanced-evaluation-references-implementation-patterns) - Read when: building an evaluation pipeline from scratch or integrating LLM judges into CI/CD
- [Bias Mitigation Techniques](/lib/10-context-memory/agent-skills-for-context-engineering/skills-advanced-evaluation-references-bias-mitigation) - Read when: evaluation results show inconsistent or suspicious scoring patterns
- [Metric Selection Guide](/lib/10-context-memory/agent-skills-for-context-engineering/skills-advanced-evaluation-references-metrics-guide) - Read when: choosing statistical metrics to validate evaluation reliability
- [Evaluation Pipeline Diagram](/lib/10-context-memory/agent-skills-for-context-engineering/skills-advanced-evaluation-references-evaluation-pipeline) - Read when: designing the architecture of a multi-stage evaluation system
