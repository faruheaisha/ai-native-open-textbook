...
2. **Use paragraph-level extraction** - Extract from `` tags to preserve breaks
...
Internal references:
- [Segmentation Strategies](/lib/10-context-memory/agent-skills-for-context-engineering/examples-book-sft-pipeline-references-segmentation-strategies) - Text chunking patterns
- [Tinker Format Specification](/lib/10-context-memory/agent-skills-for-context-engineering/examples-book-sft-pipeline-references-tinker-format) - Datum structure
- [Tinker API Documentation](https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/blob/6dbe1a1d868eab51a3bc9011b0f55e2891513e40/examples/book-sft-pipeline/references/tinker.txt) - Full API reference
