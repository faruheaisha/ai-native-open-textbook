...
- [Agent skills](/lib/10-context-memory/context-engineering-book/ch02-agent-skills-README): Reusable packages of instructions and resources.
- [Instruction artifacts](/lib/10-context-memory/context-engineering-book/ch02-python-instruction-artifacts-README): Project-specific guidance files (e.g., `AGENTS.md`).
