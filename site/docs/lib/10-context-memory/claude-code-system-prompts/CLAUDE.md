...
See the [Extraction section in README.md](/lib/10-context-memory/claude-code-system-prompts/overview#extraction) for details on the extraction method.
...
- The [CHANGELOG.md](https://github.com/Piebald-AI/claude-code-system-prompts/blob/3af4c6139aaabb0470440961ca8c8fb871099234/CHANGELOG.md) tracks prompt changes across Claude Code versions
