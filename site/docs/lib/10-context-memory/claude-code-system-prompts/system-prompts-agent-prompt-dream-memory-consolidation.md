...
entryUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/3af4c6139aaabb0470440961ca8c8fb871099234/system-prompts/agent-prompt-dream-memory-consolidation.md"
sourceRel: "system-prompts/agent-prompt-dream-memory-consolidation.md"
rawUrl: "/raw/10-context-memory/claude-code-system-prompts/system-prompts/agent-prompt-dream-memory-consolidation.md"
sourceSha256: "57b344e572f5215cf2fc96e7fd2acd6aa70e5e0c82ca16868d56c7965cdcd939"
pageSha256: "57b344e572f5215cf2fc96e7fd2acd6aa70e5e0c82ca16868d56c7965cdcd939"
...
Update `${INDEX_FILE}` so it stays under ${INDEX_MAX_LINES\} lines AND under ~25KB. It's an **index**, not a dump — each entry should be one line under ~150 characters: `- [Title](https://github.com/Piebald-AI/claude-code-system-prompts/blob/3af4c6139aaabb0470440961ca8c8fb871099234/system-prompts/file.md) — one-line hook`. Never write memory content directly into it.
