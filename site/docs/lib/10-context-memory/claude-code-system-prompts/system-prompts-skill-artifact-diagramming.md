...
entryUrl: "https://github.com/Piebald-AI/claude-code-system-prompts/blob/3af4c6139aaabb0470440961ca8c8fb871099234/system-prompts/skill-artifact-diagramming.md"
sourceRel: "system-prompts/skill-artifact-diagramming.md"
rawUrl: "/raw/10-context-memory/claude-code-system-prompts/system-prompts/skill-artifact-diagramming.md"
sourceSha256: "061d2dd7d831d5f0f3d2e5dacc3954f88d128e133514d5a7c2d48101f6a4e565"
pageSha256: "061d2dd7d831d5f0f3d2e5dacc3954f88d128e133514d5a7c2d48101f6a4e565"
...
- **One figure, one claim.** Wrap the `<svg>` in `` with a `` that states what the picture shows, and give the `<svg>` `role="img"` plus an `aria-label` carrying the same claim for readers who cannot see it.
