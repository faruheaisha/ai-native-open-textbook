...
entryUrl: "https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/cloudflare-deploy/references/durable-objects/api.md"
sourceRel: "skills/.curated/cloudflare-deploy/references/durable-objects/api.md"
rawUrl: "/raw/10-context-memory/openai-skills/skills/.curated/cloudflare-deploy/references/durable-objects/api.md"
sourceSha256: "ada50c598680f4d1e50d3e0588a1a6c0f4875346e583e34b87956ededff12e22"
pageSha256: "ada50c598680f4d1e50d3e0588a1a6c0f4875346e583e34b87956ededff12e22"
...
See **[DO Storage](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-do-storage)** for complete storage API reference.
...
**Limit:** 1 alarm per DO. Use queue pattern for multiple events (see [Patterns](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-durable-objects-patterns)).

## Storage APIs

For detailed storage documentation including SQLite queries, KV operations, transactions, and Point-in-Time Recovery, see **[DO Storage](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-do-storage)**.
...
- Use queue pattern for multiple scheduled events (see [Patterns](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-durable-objects-patterns))
...
- **[DO Storage](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-do-storage)** - Complete storage API reference
- **[Patterns](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-durable-objects-patterns)** - Real-world usage patterns
- **[Gotchas](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-durable-objects-gotchas)** - Hibernation caveats and limits
