...
entryUrl: "https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/cloudflare-deploy/references/email-workers/README.md"
sourceRel: "skills/.curated/cloudflare-deploy/references/email-workers/README.md"
rawUrl: "/raw/10-context-memory/openai-skills/skills/.curated/cloudflare-deploy/references/email-workers/README.md"
sourceSha256: "a0bc3bf064ca3c2352e92a16bf81fbdc30691b4afac6503e2b212ee2f336efe4"
pageSha256: "a0bc3bf064ca3c2352e92a16bf81fbdc30691b4afac6503e2b212ee2f336efe4"
...
|------|-------------|------------|
| [api.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-email-workers-api) | Complete API reference | ForwardableEmailMessage, SendEmail bindings, reply() method, postal-mime/mimetext APIs |
| [configuration.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-email-workers-configuration) | Setup and configuration | wrangler.jsonc, bindings, deployment, dependencies |
| [patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-email-workers-patterns) | Real-world examples | Allowlists from KV, auto-reply with threading, attachment extraction, webhook notifications |
| [gotchas.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-email-workers-gotchas) | Pitfalls and debugging | Stream consumption, ctx.waitUntil errors, security, limits |
...
See [gotchas.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-email-workers-gotchas#readablestream-can-only-be-consumed-once) for details.
...
See [gotchas.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-email-workers-gotchas#limits-reference) for complete limits table.
...
See [configuration.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-email-workers-configuration) for detailed setup.
