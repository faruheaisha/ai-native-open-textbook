...
entryUrl: "https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-use/references/working-with-design-systems/wwds-components.md"
sourceRel: "skills/.curated/figma-use/references/working-with-design-systems/wwds-components.md"
rawUrl: "/raw/10-context-memory/openai-skills/skills/.curated/figma-use/references/working-with-design-systems/wwds-components.md"
sourceSha256: "90c99d03e849b127b4144725d38b37ad5e456dd6e29c2e9c28690646dcc97b96"
pageSha256: "90c99d03e849b127b4144725d38b37ad5e456dd6e29c2e9c28690646dcc97b96"
...
- [Creating components](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-working-with-design-systems-wwds-components--creating): What you must consider when creating new components.
- [Using components](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-working-with-design-systems-wwds-components--using): What you must consider when trying to use the right components.

## Code patterns

For runnable code examples (creating, importing, discovering, inspecting components), see [component-patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-component-patterns).
