---
title: "Cloudflare Workers Smart Placement"
...
entryUrl: "https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/cloudflare-deploy/references/smart-placement/README.md"
sourceRel: "skills/.curated/cloudflare-deploy/references/smart-placement/README.md"
rawUrl: "/raw/10-context-memory/openai-skills/skills/.curated/cloudflare-deploy/references/smart-placement/README.md"
sourceSha256: "2a41285bae05a8772a6b52b292c28aa87bd4f65c6b984ba85e2733fec104567d"
pageSha256: "2a41285bae05a8772a6b52b292c28aa87bd4f65c6b984ba85e2733fec104567d"
...
2. [configuration.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-smart-placement-configuration) - set up wrangler.jsonc and understand limitations
3. [patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-smart-placement-patterns) - see practical examples for your use case
4. [api.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-smart-placement-api) - monitor and verify Smart Placement is working
5. [gotchas.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-smart-placement-gotchas) - troubleshoot common issues

**Quick lookup:**
- "Should I enable Smart Placement?" → See "When to Use" above
- "How do I configure it?" → [configuration.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-smart-placement-configuration)
- "How do I split frontend/backend?" → [patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-smart-placement-patterns)
- "Why isn't it working?" → [gotchas.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-smart-placement-gotchas)

## In This Reference

- [configuration.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-smart-placement-configuration) - wrangler.jsonc setup, mode values, validation rules
- [api.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-smart-placement-api) - Placement Status API, cf-placement header, monitoring
- [patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-smart-placement-patterns) - Frontend/backend split, database workers, SSR patterns
- [gotchas.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-smart-placement-gotchas) - Troubleshooting INSUFFICIENT_INVOCATIONS, performance issues
...
- [d1](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-d1) - D1 database that benefits from Smart Placement
- [durable-objects](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-durable-objects) - Durable Objects with backend logic
- [bindings](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-bindings) - Service bindings for frontend/backend split
