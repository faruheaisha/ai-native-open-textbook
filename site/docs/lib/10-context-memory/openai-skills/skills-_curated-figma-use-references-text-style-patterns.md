...
entryUrl: "https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-use/references/text-style-patterns.md"
sourceRel: "skills/.curated/figma-use/references/text-style-patterns.md"
rawUrl: "/raw/10-context-memory/openai-skills/skills/.curated/figma-use/references/text-style-patterns.md"
sourceSha256: "d22ebefd9e2f9e5c3c1aacd144c225c4a333c043bb57b115c5c5a9477d3eaec7"
pageSha256: "d22ebefd9e2f9e5c3c1aacd144c225c4a333c043bb57b115c5c5a9477d3eaec7"
...
> Part of the [use_figma skill](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-SKILL). How to create, apply, and inspect text styles using the Plugin API.
>
> For design system context (when to create text styles, how they relate to tokens, headless limitations), see [wwds-text-styles](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-working-with-design-systems-wwds-text-styles).
