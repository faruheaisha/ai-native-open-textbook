---
title: "Cloudflare Bindings Skill Reference"
...
entryUrl: "https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/cloudflare-deploy/references/bindings/README.md"
sourceRel: "skills/.curated/cloudflare-deploy/references/bindings/README.md"
rawUrl: "/raw/10-context-memory/openai-skills/skills/.curated/cloudflare-deploy/references/bindings/README.md"
sourceSha256: "5ba09af5a3ce0b8ea090f60b87a0660f56d6252e256a36eff86ec1dfcd8c69a0"
pageSha256: "5ba09af5a3ce0b8ea090f60b87a0660f56d6252e256a36eff86ec1dfcd8c69a0"
...
2. **[api.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-bindings-api)** - TypeScript types and env access patterns
3. **[configuration.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-bindings-configuration)** - Complete wrangler.jsonc examples
4. **[patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-bindings-patterns)** - Best practices and common patterns
5. **[gotchas.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-bindings-gotchas)** - Critical pitfalls and troubleshooting
...
Bindings are fully typed via `wrangler types`. See [api.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-bindings-api) for details.

## Limits

- 64 bindings max per Worker (all types combined)
- See [gotchas.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-bindings-gotchas) for per-binding limits
