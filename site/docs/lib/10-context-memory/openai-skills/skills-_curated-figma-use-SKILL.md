---
title: "usefigma — Figma Plugin API Skill"
...
entryUrl: "https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-use/SKILL.md"
sourceRel: "skills/.curated/figma-use/SKILL.md"
rawUrl: "/raw/10-context-memory/openai-skills/skills/.curated/figma-use/SKILL.md"
sourceSha256: "afa9c4ae068a18b93e4914b2d224180ace113db7713dd66f4df397f16ba9c4b4"
pageSha256: "afa9c4ae068a18b93e4914b2d224180ace113db7713dd66f4df397f16ba9c4b4"
...
**If the task involves building or updating a full page, screen, or multi-section layout in Figma from code**, also load [figma-generate-design](/lib/10-context-memory/openai-skills/skills-_curated-figma-generate-design-SKILL). It provides the workflow for discovering design system components via `search_design_system`, importing them, and assembling screens incrementally. Both skills work together: this one for the API rules, that one for the screen-building workflow.

Before anything, load [plugin-api-standalone.index.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-plugin-api-standalone.) to understand what is possible. When you are asked to write plugin API code, use this context to grep [plugin-api-standalone.d.ts](https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-use/references/plugin-api-standalone.d.ts) for relevant types, methods, and properties. This is the definitive source of truth for the API surface. It is a large typings file, so do not load it all at once, grep for relevant sections as needed.

IMPORTANT: Whenever you work with design systems, start with [working-with-design-systems/wwds.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-working-with-design-systems-wwds) to understand the key concepts, processes, and guidelines for working with design systems in Figma. Then load the more specific references for components, variables, text styles, and effect styles as needed.
...
16. **Always set `variable.scopes` explicitly when creating variables.** The default `ALL_SCOPES` pollutes every property picker — almost never what you want. Use specific scopes like `["FRAME_FILL", "SHAPE_FILL"]` for backgrounds, `["TEXT_FILL"]` for text colors, `["GAP"]` for spacing, etc. See [variable-patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-variable-patterns) for the full list.
...
> For detailed WRONG/CORRECT examples of each rule, see [Gotchas & Common Mistakes](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-gotchas).
...
> For the full validation workflow, see [Validation & Error Recovery](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-validation-and-recovery).
...
|-----|-------------|----------------|
| [gotchas.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-gotchas) | Before any `use_figma` | Every known pitfall with WRONG/CORRECT code examples |
| [common-patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-common-patterns) | Need working code examples | Script scaffolds: shapes, text, auto-layout, variables, components, multi-step workflows |
| [plugin-api-patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-plugin-api-patterns) | Creating/editing nodes | Fills, strokes, Auto Layout, effects, grouping, cloning, styles |
| [api-reference.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-api-reference) | Need exact API surface | Node creation, variables API, core properties, what works and what doesn't |
| [validation-and-recovery.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-validation-and-recovery) | Multi-step writes or error recovery | `get_metadata` vs `get_screenshot` workflow, mandatory error recovery steps |
| [component-patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-component-patterns) | Creating components/variants | combineAsVariants, component properties, INSTANCE_SWAP, variant layout, discovering existing components, metadata traversal |
| [variable-patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-variable-patterns) | Creating/binding variables | Collections, modes, scopes, aliasing, binding patterns, discovering existing variables |
| [text-style-patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-text-style-patterns) | Creating/applying text styles | Type ramps, font probing, listing styles, applying styles to nodes |
| [effect-style-patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-effect-style-patterns) | Creating/applying effect styles | Drop shadows, listing styles, applying styles to nodes |
| [plugin-api-standalone.index.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-plugin-api-standalone.) | Need to understand the full API surface | Index of all types, methods, and properties in the Plugin API |
| [plugin-api-standalone.d.ts](https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-use/references/plugin-api-standalone.d.ts) | Need exact type signatures | Full typings file — grep for specific symbols, don't load all at once |
