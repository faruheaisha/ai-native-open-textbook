---
title: "Design System Builder — Figma MCP Skill"
...
entryUrl: "https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-generate-library/SKILL.md"
sourceRel: "skills/.curated/figma-generate-library/SKILL.md"
rawUrl: "/raw/10-context-memory/openai-skills/skills/.curated/figma-generate-library/SKILL.md"
sourceSha256: "7f42103c59fc181d7081404a56545f321c458d97f5ee7f7a0ab2af75ea69a85f"
pageSha256: "7f42103c59fc181d7081404a56545f321c458d97f5ee7f7a0ab2af75ea69a85f"
...
> Full naming reference: [naming-conventions.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-generate-library-references-naming-conventions)
...
| 200+ tokens | **Advanced**: Multiple semantic collections, 4–8 modes (Light/Dark × Contrast × Brand). See M3 pattern in [token-creation.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-generate-library-references-token-creation) |
...
|-----|-------|---------------------|-----------|
| [discovery-phase.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-generate-library-references-discovery-phase) | 0 | **Required** | Starting any build — codebase analysis + Figma inspection |
| [token-creation.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-generate-library-references-token-creation) | 1 | **Required** | Creating variables, collections, modes, styles |
| [documentation-creation.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-generate-library-references-documentation-creation) | 2 | Required | Creating cover page, foundations docs, swatches |
| [component-creation.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-generate-library-references-component-creation) | 3 | **Required** | Creating any component or variant |
| [code-connect-setup.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-generate-library-references-code-connect-setup) | 3–4 | Required | Setting up Code Connect or variable code syntax |
| [naming-conventions.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-generate-library-references-naming-conventions) | Any | Optional | Naming anything — variables, pages, variants, styles |
| [error-recovery.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-generate-library-references-error-recovery) | Any | **Required on error** | Script fails, multi-step workflow recovery, cleanup of abandoned workflow state |
...
| Script | Purpose |
|--------|---------|
| [inspectFileStructure.js](https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-generate-library/scripts/inspectFileStructure.js) | Discover all pages, components, variables, styles; returns full inventory |
| [createVariableCollection.js](https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-generate-library/scripts/createVariableCollection.js) | Create a named collection with modes; returns `\{collectionId, modeIds\}` |
| [createSemanticTokens.js](https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-generate-library/scripts/createSemanticTokens.js) | Create aliased semantic variables from a token map |
| [createComponentWithVariants.js](https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-generate-library/scripts/createComponentWithVariants.js) | Build a component set from a variant matrix; handles grid layout |
| [bindVariablesToComponent.js](https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-generate-library/scripts/bindVariablesToComponent.js) | Bind design tokens to all component visual properties |
| [createDocumentationPage.js](https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-generate-library/scripts/createDocumentationPage.js) | Create a page with title + description + section structure |
| [validateCreation.js](https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-generate-library/scripts/validateCreation.js) | Verify created nodes match expected counts, names, structure |
| [cleanupOrphans.js](https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-generate-library/scripts/cleanupOrphans.js) | Remove orphaned nodes by name convention or state ledger IDs |
| [rehydrateState.js](https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-generate-library/scripts/rehydrateState.js) | Scan file for all pages, components, variables by name; returns full `\{key → nodeId\}` map for state reconstruction |
