---
title: "Build / Update Screens from Design System"
...
entryUrl: "https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-generate-design/SKILL.md"
sourceRel: "skills/.curated/figma-generate-design/SKILL.md"
rawUrl: "/raw/10-context-memory/openai-skills/skills/.curated/figma-generate-design/SKILL.md"
sourceSha256: "45d2b97103bdeb31cb2744fca2c79bcefb659c88faca626bea30ec2f9342dcc9"
pageSha256: "45d2b97103bdeb31cb2744fca2c79bcefb659c88faca626bea30ec2f9342dcc9"
...
**MANDATORY**: You MUST also load [figma-use](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-SKILL) before any `use_figma` call. That skill contains critical rules (color ranges, font loading, etc.) that apply to every script you write.
...
- If the user wants to generate **code from a Figma design**, switch to [figma-implement-design](/lib/10-context-memory/openai-skills/skills-_curated-figma-implement-design-SKILL).
- If the user wants to create **new reusable components or variants**, use [figma-use](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-SKILL) directly.
- If the user wants to write **Code Connect mappings**, switch to [figma-code-connect-components](/lib/10-context-memory/openai-skills/skills-_curated-figma-code-connect-components-SKILL).
...
See [variable-patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-variable-patterns) for binding patterns.
...
See [text-style-patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-text-style-patterns) and [effect-style-patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-effect-style-patterns) for details.
...
For detailed API patterns and gotchas, load these from the [figma-use](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-SKILL) references as needed:

- [component-patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-component-patterns) — importing by key, finding variants, setProperties, text overrides, working with instances
- [variable-patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-variable-patterns) — creating/binding variables, importing library variables, scopes, aliasing, discovering existing variables
- [text-style-patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-text-style-patterns) — creating/applying text styles, importing library text styles, type ramps
- [effect-style-patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-effect-style-patterns) — creating/applying effect styles (shadows), importing library effect styles
- [gotchas.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-gotchas) — layout pitfalls (HUG/FILL interactions, counterAxisAlignItems, sizing order), paint/color issues, page context resets

## Error Recovery

Follow the error recovery process from [figma-use](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-SKILL#6-error-recovery--self-correction):
