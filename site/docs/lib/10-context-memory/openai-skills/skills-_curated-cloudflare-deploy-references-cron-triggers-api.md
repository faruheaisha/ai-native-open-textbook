...
entryUrl: "https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/cloudflare-deploy/references/cron-triggers/api.md"
sourceRel: "skills/.curated/cloudflare-deploy/references/cron-triggers/api.md"
rawUrl: "/raw/10-context-memory/openai-skills/skills/.curated/cloudflare-deploy/references/cron-triggers/api.md"
sourceSha256: "2768dedd364f5424f5a5b4e6ab579f5d8b9de8c5d7fb32924cee73404450c64c"
pageSha256: "2768dedd364f5424f5a5b4e6ab579f5d8b9de8c5d7fb32924cee73404450c64c"
...
**Production security:** The `/__scheduled` endpoint is available in production and can be triggered by anyone. Block it or implement authentication - see [gotchas.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-cron-triggers-gotchas#security-concerns)
...
- [README.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-cron-triggers) - Overview
- [patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-cron-triggers-patterns) - Use cases, examples
- [gotchas.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-cron-triggers-gotchas) - Common errors, testing issues
