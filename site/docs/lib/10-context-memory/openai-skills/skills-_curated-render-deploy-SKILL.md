...
entryUrl: "https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/render-deploy/SKILL.md"
sourceRel: "skills/.curated/render-deploy/SKILL.md"
rawUrl: "/raw/10-context-memory/openai-skills/skills/.curated/render-deploy/SKILL.md"
sourceSha256: "c17c75adeb1834ed5cee1e440a651ae476c4101cd63762fcd9a58eada917552d"
pageSha256: "c17c75adeb1834ed5cee1e440a651ae476c4101cd63762fcd9a58eada917552d"
...
Analyze the codebase to determine framework/runtime, build and start commands, required env vars, datastores, and port binding. Use the detailed checklists in [references/codebase-analysis.md](/lib/10-context-memory/openai-skills/skills-_curated-render-deploy-references-codebase-analysis).

### Step 2: Generate render.yaml

Create a `render.yaml` Blueprint file following the Blueprint specification.

Complete specification: [references/blueprint-spec.md](/lib/10-context-memory/openai-skills/skills-_curated-render-deploy-references-blueprint-spec)
...
- Use appropriate runtime: [references/runtimes.md](/lib/10-context-memory/openai-skills/skills-_curated-render-deploy-references-runtimes)
...
Service type details: [references/service-types.md](/lib/10-context-memory/openai-skills/skills-_curated-render-deploy-references-service-types)
Runtime options: [references/runtimes.md](/lib/10-context-memory/openai-skills/skills-_curated-render-deploy-references-runtimes)
Template examples: [assets/](https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/render-deploy/assets/README.md)
...
Configuration guide: [references/configuration-guide.md](/lib/10-context-memory/openai-skills/skills-_curated-render-deploy-references-configuration-guide)
