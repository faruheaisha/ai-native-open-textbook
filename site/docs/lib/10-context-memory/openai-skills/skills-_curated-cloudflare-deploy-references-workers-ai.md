...
entryUrl: "https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/cloudflare-deploy/references/workers-ai/README.md"
sourceRel: "skills/.curated/cloudflare-deploy/references/workers-ai/README.md"
rawUrl: "/raw/10-context-memory/openai-skills/skills/.curated/cloudflare-deploy/references/workers-ai/README.md"
sourceSha256: "e1f1fae0a795cbf975d4751e36f28a2b9eb48ad9cd10a9edf48cc9211581c241"
pageSha256: "e1f1fae0a795cbf975d4751e36f28a2b9eb48ad9cd10a9edf48cc9211581c241"
...
- [configuration.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-workers-ai-configuration) - wrangler.jsonc setup, TypeScript types, bindings, environment variables
- [api.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-workers-ai-api) - env.AI.run(), streaming, function calling, REST API, response types
- [patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-workers-ai-patterns) - RAG with Vectorize, prompt engineering, batching, error handling, caching
- [gotchas.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-workers-ai-gotchas) - Deprecated @cloudflare/ai package, rate limits, pricing, common errors

## See Also

- [vectorize](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-vectorize) - Vector database for RAG patterns
- [ai-gateway](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-ai-gateway) - Caching, rate limiting, analytics for AI requests
- [workers](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-workers) - Worker runtime and fetch handler patterns
