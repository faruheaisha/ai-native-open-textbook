---
title: "Working with design systems: Variables"
...
entryUrl: "https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-use/references/working-with-design-systems/wwds-variables.md"
sourceRel: "skills/.curated/figma-use/references/working-with-design-systems/wwds-variables.md"
rawUrl: "/raw/10-context-memory/openai-skills/skills/.curated/figma-use/references/working-with-design-systems/wwds-variables.md"
sourceSha256: "95ca62876167a7afd87cc30c8f7e76d31fef1b253e4cd6dd20954a27d66066b1"
pageSha256: "95ca62876167a7afd87cc30c8f7e76d31fef1b253e4cd6dd20954a27d66066b1"
...
One gap is the lack of composite tokens. You can't put a box shadow behind a single variable. That is an [effect style](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-working-with-design-systems-wwds-effect-styles), but style values can be bound to variables. Similarly for a type ramp, you have to use [Text Styles](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-working-with-design-systems-wwds-text-styles).
...
- [Creating variables](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-working-with-design-systems-wwds-variables--creating): What you must consider when creating new variables.
- [Using variables](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-working-with-design-systems-wwds-variables--using): What you must consider when trying to use the right variables.

## Code patterns

For runnable code examples (creating collections, binding variables, scopes, aliasing, discovering existing variables), see [variable-patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-variable-patterns).
