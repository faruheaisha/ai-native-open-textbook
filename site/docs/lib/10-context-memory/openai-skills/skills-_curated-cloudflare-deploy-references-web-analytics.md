...
entryUrl: "https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/cloudflare-deploy/references/web-analytics/README.md"
sourceRel: "skills/.curated/cloudflare-deploy/references/web-analytics/README.md"
rawUrl: "/raw/10-context-memory/openai-skills/skills/.curated/cloudflare-deploy/references/web-analytics/README.md"
sourceSha256: "bff5f576b9fc55ee7f3c448a7e5aff30e653bcc214d4040f476f392a69213218"
pageSha256: "bff5f576b9fc55ee7f3c448a7e5aff30e653bcc214d4040f476f392a69213218"
...
1. **[configuration.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-web-analytics-configuration)** - Setup for proxied vs non-proxied sites
2. **[integration.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-web-analytics-integration)** - Framework-specific beacon integration (React, Next.js, Vue, Nuxt, etc.)
3. **[patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-web-analytics-patterns)** - Common use cases (performance monitoring, GDPR consent, multi-site tracking)
4. **[gotchas.md](/lib/10-context-memory/openai-skills/skills-_curated-cloudflare-deploy-references-web-analytics-gotchas)** - Troubleshooting (SPA tracking, CSP issues, hash routing limitations)
