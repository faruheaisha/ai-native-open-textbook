...
entryUrl: "https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-code-connect-components/SKILL.md"
sourceRel: "skills/.curated/figma-code-connect-components/SKILL.md"
rawUrl: "/raw/10-context-memory/openai-skills/skills/.curated/figma-code-connect-components/SKILL.md"
sourceSha256: "0f19edad8aed28063a3517c419fbcbef5421d024f189fd02a17fae25093ec69d"
pageSha256: "0f19edad8aed28063a3517c419fbcbef5421d024f189fd02a17fae25093ec69d"
...
- If the task requires writing to the Figma canvas with Plugin API scripts, switch to [figma-use](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-SKILL).
- If the task is building or updating a full-page screen in Figma from code or a description, switch to [figma-generate-design](/lib/10-context-memory/openai-skills/skills-_curated-figma-generate-design-SKILL).
- If the task is implementing product code from Figma, switch to [figma-implement-design](/lib/10-context-memory/openai-skills/skills-_curated-figma-implement-design-SKILL).
