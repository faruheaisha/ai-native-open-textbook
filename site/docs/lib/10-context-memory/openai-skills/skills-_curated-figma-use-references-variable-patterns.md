---
title: "Variable & Token API Patterns"
...
entryUrl: "https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/figma-use/references/variable-patterns.md"
sourceRel: "skills/.curated/figma-use/references/variable-patterns.md"
rawUrl: "/raw/10-context-memory/openai-skills/skills/.curated/figma-use/references/variable-patterns.md"
sourceSha256: "8d0539a6c53cd534864fb5b49379b5024249445c0eb7728c7c3641e386fd9945"
pageSha256: "8d0539a6c53cd534864fb5b49379b5024249445c0eb7728c7c3641e386fd9945"
...
> Part of the [use_figma skill](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-SKILL). How to correctly create, bind, scope, and alias variables using the Plugin API.
>
> For design system context (aliasing strategy, mode decisions, code syntax philosophy, grouping conventions), see [wwds-variables](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-working-with-design-systems-wwds-variables).
...
Shadows can't be stored as variables. Use effect styles. For comprehensive patterns, see [effect-style-patterns.md](/lib/10-context-memory/openai-skills/skills-_curated-figma-use-references-effect-style-patterns).
