...
entryUrl: "https://github.com/rohitg00/ai-engineering-from-scratch/blob/d18b8fe5a913c46011a3b06cb6ebd6a924414fd3/phases/19-capstone-projects/13-mcp-server-with-registry/docs/en.md"
sourceRel: "phases/19-capstone-projects/13-mcp-server-with-registry/docs/en.md"
rawUrl: "/raw/07-coding/ai-engineering-from-scratch/phases/19-capstone-projects/13-mcp-server-with-registry/docs/en.md"
sourceSha256: "bd60a561a61ae1e84a48c79c33d1b18c44b2249b38ad3e752f1abdd6ca6b4fe3"
pageSha256: "bd60a561a61ae1e84a48c79c33d1b18c44b2249b38ad3e752f1abdd6ca6b4fe3"
...
**Required MCP deep dives:** [Lesson 28: Tool Contracts](/lib/07-coding/ai-engineering-from-scratch/phases-13-tools-and-protocols-28-mcp-tool-contracts-and-content-docs-en), [Lesson 29: Reliability](/lib/07-coding/ai-engineering-from-scratch/phases-13-tools-and-protocols-29-mcp-reliability-cancellation-and-flow-control-docs-en), [Lesson 30: Registry Supply Chain](/lib/07-coding/ai-engineering-from-scratch/phases-13-tools-and-protocols-30-mcp-registry-supply-chain-and-drift-docs-en), and [Lesson 31: Conformance Operations](/lib/07-coding/ai-engineering-from-scratch/phases-13-tools-and-protocols-31-mcp-conformance-versioning-and-operations-docs-en)
...
1. [Lesson 28](/lib/07-coding/ai-engineering-from-scratch/phases-13-tools-and-protocols-28-mcp-tool-contracts-and-content-docs-en) defines the tool, schema, content, pagination, completion, routing, and error contracts this server must expose.
2. [Lesson 29](/lib/07-coding/ai-engineering-from-scratch/phases-13-tools-and-protocols-29-mcp-reliability-cancellation-and-flow-control-docs-en) defines cancellation races, deadlines, idempotency, backpressure, retry, and reconnect behavior.
3. [Lesson 30](/lib/07-coding/ai-engineering-from-scratch/phases-13-tools-and-protocols-30-mcp-registry-supply-chain-and-drift-docs-en) defines namespace, provenance, admission pin, Registry status, drift, ledger, and rollback evidence.
4. [Lesson 31](/lib/07-coding/ai-engineering-from-scratch/phases-13-tools-and-protocols-31-mcp-conformance-versioning-and-operations-docs-en) defines golden and negative transcripts, strict version eras, SDK differential checks, proxy proof, redaction, health, and release gating.
...
|---|---|---|
| Wire | Redacted raw headers and JSON-RPC bodies for golden and negative cases, including metadata type failure, header mismatch, unsupported version, missing or unknown `resultType`, notification no-response, and response ID matching | [Lesson 31](/lib/07-coding/ai-engineering-from-scratch/phases-13-tools-and-protocols-31-mcp-conformance-versioning-and-operations-docs-en) |
| Proxy | The same stable case run directly and through the deployed intermediary, with ingress, origin, and egress status and body digests; prove protocol errors are not collapsed into generic 500 responses and streaming is not buffered | [Lessons 29](/lib/07-coding/ai-engineering-from-scratch/phases-13-tools-and-protocols-29-mcp-reliability-cancellation-and-flow-control-docs-en) and [31](/lib/07-coding/ai-engineering-from-scratch/phases-13-tools-and-protocols-31-mcp-conformance-versioning-and-operations-docs-en) |
| Admission | Verified publisher namespace, immutable Registry record digest, artifact or remote provenance, live `server/discover` identity and capability observation, descriptor pin, current Registry status, and admission-ledger event | [Lesson 30](/lib/07-coding/ai-engineering-from-scratch/phases-13-tools-and-protocols-30-mcp-registry-supply-chain-and-drift-docs-en) |
| Retry | A cancellation-versus-completion race, explicit timeout, safe read retry, mutation idempotency key, reconnect refetch, and proof that request cancellation cannot silently become durable task cancellation | [Lesson 29](/lib/07-coding/ai-engineering-from-scratch/phases-13-tools-and-protocols-29-mcp-reliability-cancellation-and-flow-control-docs-en) |
| Rollback | Exact previous version, admission and artifact digests, descriptor pin, active Registry status, current health window, route restoration result, and redacted decision evidence | [Lessons 30](/lib/07-coding/ai-engineering-from-scratch/phases-13-tools-and-protocols-30-mcp-registry-supply-chain-and-drift-docs-en) and [31](/lib/07-coding/ai-engineering-from-scratch/phases-13-tools-and-protocols-31-mcp-conformance-versioning-and-operations-docs-en) |
