...
entryUrl: "https://github.com/fancyboi999/ai-engineering-from-scratch-zh/blob/109181ce68128c1bf27ec20867177007a8bace89/phases/19-capstone-projects/36-training-loop-eval/docs/zh.md"
sourceRel: "phases/19-capstone-projects/36-training-loop-eval/docs/zh.md"
rawUrl: "/raw/07-coding/ai-engineering-from-scratch-zh/phases/19-capstone-projects/36-training-loop-eval/docs/zh.md"
sourceSha256: "20f86c021075b6d4e7a056188bed745a4369d0dec3e9ae1a2d4854da926cb6b9"
pageSha256: "20f86c021075b6d4e7a056188bed745a4369d0dec3e9ae1a2d4854da926cb6b9"
...
```mermaid
flowchart TB
  D[(Token 张量<br/>训练 + 验证)] --> B[构造 batch<br/>输入 + 目标左移一位]
  B --> F[前向<br/>logits]
  F --> L[交叉熵<br/>展平 batch 和时间维]
  L --> Bw[反向传播]
  Bw --> Cg[梯度范数裁剪]
  Cg --> Step[AdamW 步进]
  Step --> Sched[Cosine 学习率调度]
