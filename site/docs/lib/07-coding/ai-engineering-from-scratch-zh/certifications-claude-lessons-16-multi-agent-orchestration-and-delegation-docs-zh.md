...
**类型：** Reference
**语言：** Python
**前置要求：** [工具循环是受控委派](https://github.com/fancyboi999/ai-engineering-from-scratch-zh/blob/109181ce68128c1bf27ec20867177007a8bace89/certifications/claude/lessons/10-tool-use-and-agentic-loops/README.md)；阶段 14 第 12 课和第 28 课
**预计时间：** 约 135 分钟
...
填写后的 [`outputs/orchestration-contract.md`](/lib/07-coding/ai-engineering-from-scratch-zh/certifications-claude-lessons-16-multi-agent-orchestration-and-delegation-outputs-orchestration-contract) 应成为一份具体的 research pipeline 交接，不能只是空白 worksheet。
