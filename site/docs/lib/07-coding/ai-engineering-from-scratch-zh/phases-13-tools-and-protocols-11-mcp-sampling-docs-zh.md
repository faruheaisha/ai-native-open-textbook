---
title: "MCP Model Input：Sampling 迁移与无状态 MRTR"
...
entryUrl: "https://github.com/fancyboi999/ai-engineering-from-scratch-zh/blob/109181ce68128c1bf27ec20867177007a8bace89/phases/13-tools-and-protocols/11-mcp-sampling/docs/zh.md"
sourceRel: "phases/13-tools-and-protocols/11-mcp-sampling/docs/zh.md"
rawUrl: "/raw/07-coding/ai-engineering-from-scratch-zh/phases/13-tools-and-protocols/11-mcp-sampling/docs/zh.md"
sourceSha256: "84acbf4daa3352a35b9984ee1416ac6f74308ba5c0ab8dbd9cfe1fcd3a158ed2"
pageSha256: "84acbf4daa3352a35b9984ee1416ac6f74308ba5c0ab8dbd9cfe1fcd3a158ed2"
...
server 在每条请求上校验 revision。缺失或非字符串 version 属于 invalid params，返回 `-32602`。不支持的字符串返回 `-32022`，其精确 data 为 `\{"supported":["2026-07-28"],"requested":"<client version>"\}`。缺少 Sampling capability 返回 `-32021`，其 `data.requiredCapabilities` 设为 <code v-pre>\{"sampling":\{}}</code>。
