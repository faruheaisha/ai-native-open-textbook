...
entryUrl: "https://github.com/fancyboi999/ai-engineering-from-scratch-zh/blob/109181ce68128c1bf27ec20867177007a8bace89/phases/19-capstone-projects/47-checkpoint-save-resume/docs/zh.md"
sourceRel: "phases/19-capstone-projects/47-checkpoint-save-resume/docs/zh.md"
rawUrl: "/raw/07-coding/ai-engineering-from-scratch-zh/phases/19-capstone-projects/47-checkpoint-save-resume/docs/zh.md"
sourceSha256: "404085332156aedc5c58af17bafada476a84724bef1daf53a8fd02000053e473"
pageSha256: "404085332156aedc5c58af17bafada476a84724bef1daf53a8fd02000053e473"
...
```mermaid
flowchart TD
  ckpt[checkpoint 载荷] --> m[模型 state_dict]
...
```mermaid
flowchart LR
  state[state_dict] --> split[按轮询方式拆分 key 到 N 个分片]
