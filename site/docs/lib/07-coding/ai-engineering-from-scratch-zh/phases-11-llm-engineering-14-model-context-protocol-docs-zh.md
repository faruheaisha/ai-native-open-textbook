...
entryUrl: "https://github.com/fancyboi999/ai-engineering-from-scratch-zh/blob/109181ce68128c1bf27ec20867177007a8bace89/phases/11-llm-engineering/14-model-context-protocol/docs/zh.md"
sourceRel: "phases/11-llm-engineering/14-model-context-protocol/docs/zh.md"
rawUrl: "/raw/07-coding/ai-engineering-from-scratch-zh/phases/11-llm-engineering/14-model-context-protocol/docs/zh.md"
sourceSha256: "bc42d290d0b1fde8bd6bc114e25c9f59a8d0a53c188fe7e65ccaa96149e3701b"
pageSha256: "bc42d290d0b1fde8bd6bc114e25c9f59a8d0a53c188fe7e65ccaa96149e3701b"
...
![MCP host、无状态请求和 server 原语](/mirror/8e/8e9503dde85d852abc680d9ddfb7eeeb14bc3b16.svg)
...
1. [MCP Tool Contracts and Content](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-28-mcp-tool-contracts-and-content-docs-zh) 讲解封闭输入 schema、结构化内容、路由元数据、不透明分页、完成授权，以及协议错误和 tool 领域错误的区别。
2. [MCP Reliability, Cancellation, and Flow Control](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-29-mcp-reliability-cancellation-and-flow-control-docs-zh) 讲解请求取消、持久任务取消、截止时间、幂等性、背压、代理缓冲和重连行为。
3. [MCP Registry Supply Chain, Admission, Drift, and Rollback](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-30-mcp-registry-supply-chain-and-drift-docs-zh) 讲解命名空间证明、产物溯源、不可变 pin、实时漂移、Registry 状态、准入证据和回滚。
4. [MCP Conformance Engineering](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-31-mcp-conformance-versioning-and-operations-docs-zh) 讲解 golden 和负向 wire transcript、严格版本时代、SDK 差分、代理证据、脱敏、健康门槛和发布回滚。
