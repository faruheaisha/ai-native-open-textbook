...
entryUrl: "https://github.com/fancyboi999/ai-engineering-from-scratch-zh/blob/109181ce68128c1bf27ec20867177007a8bace89/phases/14-agent-engineering/13-langgraph-stateful-graphs/docs/zh.md"
sourceRel: "phases/14-agent-engineering/13-langgraph-stateful-graphs/docs/zh.md"
rawUrl: "/raw/07-coding/ai-engineering-from-scratch-zh/phases/14-agent-engineering/13-langgraph-stateful-graphs/docs/zh.md"
sourceSha256: "1767daf0dc7eed2ae173e910fd1e10efa980c3455bd05aa0e9968eb05566fa1a"
pageSha256: "1767daf0dc7eed2ae173e910fd1e10efa980c3455bd05aa0e9968eb05566fa1a"
...
> agent 是一个状态机；节点是函数；边是转移；每个节点后都保存状态检查点。遇到失败时，从最后一个成功检查点恢复。LangGraph 是这种底层有状态编排模型在 2026 年的参考实现。
