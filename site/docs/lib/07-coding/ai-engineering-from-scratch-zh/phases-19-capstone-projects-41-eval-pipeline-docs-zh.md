...
entryUrl: "https://github.com/fancyboi999/ai-engineering-from-scratch-zh/blob/109181ce68128c1bf27ec20867177007a8bace89/phases/19-capstone-projects/41-eval-pipeline/docs/zh.md"
sourceRel: "phases/19-capstone-projects/41-eval-pipeline/docs/zh.md"
rawUrl: "/raw/07-coding/ai-engineering-from-scratch-zh/phases/19-capstone-projects/41-eval-pipeline/docs/zh.md"
sourceSha256: "28db8dde72c506522beb8c32e28a7475174c3a6cedef39a5907d0b408dc08bb9"
pageSha256: "28db8dde72c506522beb8c32e28a7475174c3a6cedef39a5907d0b408dc08bb9"
...
```mermaid
flowchart LR
  Model[已训练模型] --> PPL[困惑度评估<br/>留出集 LM]
  Model --> EM[精确匹配评估<br/>事实类短答]
  Model --> F1[token F1 评估<br/>开放式]
  Model --> J[mock 评审<br/>1-5 打分]
  PPL --> R[报告]
  EM --> R
  F1 --> R
  J --> R
