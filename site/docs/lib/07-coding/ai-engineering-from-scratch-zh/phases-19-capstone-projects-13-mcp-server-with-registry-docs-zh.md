---
title: "顶点项目 13：带 Registry 和治理的无状态 MCP 服务器"
...
entryUrl: "https://github.com/fancyboi999/ai-engineering-from-scratch-zh/blob/109181ce68128c1bf27ec20867177007a8bace89/phases/19-capstone-projects/13-mcp-server-with-registry/docs/zh.md"
sourceRel: "phases/19-capstone-projects/13-mcp-server-with-registry/docs/zh.md"
rawUrl: "/raw/07-coding/ai-engineering-from-scratch-zh/phases/19-capstone-projects/13-mcp-server-with-registry/docs/zh.md"
sourceSha256: "8b841f23e813b6755b6011e7aa2f5868d489f261da6fcf0b8d8842c38269ab37"
pageSha256: "8b841f23e813b6755b6011e7aa2f5868d489f261da6fcf0b8d8842c38269ab37"
...
**必修 MCP 深入课程：** [第 28 课：工具契约](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-28-mcp-tool-contracts-and-content-docs-zh)、[第 29 课：可靠性](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-29-mcp-reliability-cancellation-and-flow-control-docs-zh)、[第 30 课：Registry 供应链](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-30-mcp-registry-supply-chain-and-drift-docs-zh) 和 [第 31 课：一致性运维](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-31-mcp-conformance-versioning-and-operations-docs-zh)
**协议目标：** MCP `2026-07-28`
**预计时间：** 约 25 小时
...
1. [第 28 课](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-28-mcp-tool-contracts-and-content-docs-zh) 定义本服务器必须暴露的工具、schema、内容、分页、完成、路由和错误契约。
2. [第 29 课](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-29-mcp-reliability-cancellation-and-flow-control-docs-zh) 定义取消竞争、截止时间、幂等性、背压、重试和重连行为。
3. [第 30 课](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-30-mcp-registry-supply-chain-and-drift-docs-zh) 定义命名空间、溯源、准入 pin、Registry 状态、漂移、账本和回滚证据。
4. [第 31 课](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-31-mcp-conformance-versioning-and-operations-docs-zh) 定义 golden 与负向 transcript、严格版本时期、SDK 差异检查、代理证明、脱敏、健康检查和发布门禁。
...
| 证据 | 最低证明 | 来源课程 |
|---|---|---|
| Wire | golden 和负向场景的脱敏原始 headers 与 JSON-RPC bodies，包括 metadata 类型失败、header 不匹配、不支持版本、缺失或未知 `resultType`、通知无响应以及响应 ID 匹配 | [第 31 课](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-31-mcp-conformance-versioning-and-operations-docs-zh) |
| 代理 | 同一稳定场景直接运行，并经部署的中介运行，附 ingress、origin 和 egress status 与 body digests；证明协议错误没有被折叠成通用 500 响应，且 streaming 未被缓冲 | [第 29 课](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-29-mcp-reliability-cancellation-and-flow-control-docs-zh) 和 [第 31 课](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-31-mcp-conformance-versioning-and-operations-docs-zh) |
| 准入 | 经验证的发布者命名空间、不可变 Registry 记录 digest、artifact 或 remote provenance、实时 `server/discover` identity 与 capability observation、descriptor pin、当前 Registry status 和 admission-ledger event | [第 30 课](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-30-mcp-registry-supply-chain-and-drift-docs-zh) |
| 重试 | 取消与完成的竞争、明确 timeout、安全的 read retry、mutation idempotency key、重连后的重新获取，以及证明请求取消不会静默变成持久任务取消 | [第 29 课](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-29-mcp-reliability-cancellation-and-flow-control-docs-zh) |
| 回滚 | 精确的前一版本、admission 与 artifact digests、descriptor pin、活跃 Registry status、当前健康窗口、路由恢复结果和脱敏决策证据 | [第 30 课](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-30-mcp-registry-supply-chain-and-drift-docs-zh) 和 [第 31 课](/lib/07-coding/ai-engineering-from-scratch-zh/phases-13-tools-and-protocols-31-mcp-conformance-versioning-and-operations-docs-zh) |
