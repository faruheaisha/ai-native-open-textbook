...
**类型：** Reference
**语言：** Python
**前置要求：** [Agent SDK 提供运行框架，权限另行控制](https://github.com/fancyboi999/ai-engineering-from-scratch-zh/blob/109181ce68128c1bf27ec20867177007a8bace89/certifications/claude/lessons/12-claude-agent-sdk-and-hooks/README.md)、[多 Agent 编排与委派](https://github.com/fancyboi999/ai-engineering-from-scratch-zh/blob/109181ce68128c1bf27ec20867177007a8bace89/certifications/claude/lessons/16-multi-agent-orchestration-and-delegation/README.md)；阶段 14 第 17 课
**预计时间：** 约 120 分钟
...
填写完整的 [`outputs/session-recovery-packet.md`](/lib/07-coding/ai-engineering-from-scratch-zh/certifications-claude-lessons-17-agent-sdk-sessions-subagents-and-context-outputs-session-recovery-packet) 记录了一次中断的迁移，包含 hash、一次未知副作用和安全的下一步操作。
