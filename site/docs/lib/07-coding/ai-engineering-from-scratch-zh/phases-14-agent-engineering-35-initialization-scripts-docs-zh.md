...
entryUrl: "https://github.com/fancyboi999/ai-engineering-from-scratch-zh/blob/109181ce68128c1bf27ec20867177007a8bace89/phases/14-agent-engineering/35-initialization-scripts/docs/zh.md"
sourceRel: "phases/14-agent-engineering/35-initialization-scripts/docs/zh.md"
rawUrl: "/raw/07-coding/ai-engineering-from-scratch-zh/phases/14-agent-engineering/35-initialization-scripts/docs/zh.md"
sourceSha256: "d3fd70997bcfbfa3fb67825e55214a06afddd0acb5701282b996369b2d2ab1aa"
pageSha256: "d3fd70997bcfbfa3fb67825e55214a06afddd0acb5701282b996369b2d2ab1aa"
...
flowchart TD
  ...
  Init --> Probes[探测运行时 / 依赖 / 路径 / 环境变量 / 测试]
  Probes --> Report[init_report.json]
  Report --> Decision{健康?}
  Decision -- yes --> Agent[Agent 循环]
  Decision -- no --> Halt[大声失败、停下、暴露给人]
```
