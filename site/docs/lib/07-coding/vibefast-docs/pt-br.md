...
[English](/lib/07-coding/vibefast-docs/en) · [繁中](/lib/07-coding/vibefast-docs/zh) · [Español](/lib/07-coding/vibefast-docs/es) · [日本語](/lib/07-coding/vibefast-docs/jp) · [Português (BR)](/lib/07-coding/vibefast-docs/pt-br)
...
Se você quer um ponto de partida já configurado — para poder focar em construir seu produto em vez de configurar infraestrutura — é para isso que o vibefast.app existe.
...
👉 [Voltar ao índice do curso](https://github.com/vibefast-app/vibefast-docs/blob/2a34bc50576f3f74fda6196ca9bebf851187bcf9/README-pt-br.md)
