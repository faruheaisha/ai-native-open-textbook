...
entryUrl: "https://github.com/liyupi/ai-guide/blob/539082c1df5743bb34d72a17857a02735b38c866/Vibe%20Coding%20零基础教程/10%20编程工具/DeepSeek%20Harness/DeepSeek%20Harness%20精选插件推荐.md"
sourceRel: "Vibe Coding 零基础教程/10 编程工具/DeepSeek Harness/DeepSeek Harness 精选插件推荐.md"
rawUrl: "/raw/07-coding/liyupi-ai-guide/Vibe Coding 零基础教程/10 编程工具/DeepSeek Harness/DeepSeek Harness 精选插件推荐.md"
sourceSha256: "a0016658084c467034d9e33e3b828d859ba0acaf952c7c6031f1c5474a4b1419"
pageSha256: "a0016658084c467034d9e33e3b828d859ba0acaf952c7c6031f1c5474a4b1419"
contentMode: "local-full"
zh: ""
---

# DeepSeek Harness 精选插件推荐

> 一次性鉴赏 DSH 社区热门插件，从实用工具到整活神器，量大管饱。
...
这篇文章我就来带大家鉴赏一大波 DeepSeek Harness 热门插件，有实用的、也有好看的。
...
最直接的方法是看 GitHub 的 [dsh-plugin 主题专区](https://github.com/topics/dsh-plugin)。很多开发者发布插件后都会给仓库打上 `dsh-plugin` 这个标签，新出的插件基本都能在这里看到。

这个方法的优点是更新快、数量多；缺点就是鱼龙混杂，因为谁都可以给仓库加这个标签，不代表这些插件经过审核，也不能按照质量来排序。

![](https://pic.yupi.icu/chengfang/03DSH.png)

如果懒得一个个翻仓库，可以看看 [Awesome DSH Plugin](https://awesome-dsh-plugin.com/zh/)。它是社区整理出来的一份优质插件清单，按照用途做分类，便于你快速发现一些热门插件。不过它同样属于社区维护，适合拿来找插件、看热度，不能当做是官方推荐的。
...
也就是说，以后 DSH 在电脑上跑一个耗时较长的任务，出去吃饭的时候掏出手机还能继续看进度、发消息。
...
最后，我把这次测试过的精选 DSH 插件按照使用场景整理成了一张图，供大家参考：
...
如果你想系统学习 DeepSeek Harness 的基础用法，可以阅读本教程编程工具板块 DeepSeek Harness 目录中的《DeepSeek Harness 保姆级入门教程》，从安装到实战一篇搞定。
