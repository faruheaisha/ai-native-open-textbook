...
entryUrl: "https://github.com/liyupi/ai-guide/blob/539082c1df5743bb34d72a17857a02735b38c866/Vibe%20Coding%20零基础教程/10%20编程工具/00%20AI%20编程工具大全.md"
sourceRel: "Vibe Coding 零基础教程/10 编程工具/00 AI 编程工具大全.md"
rawUrl: "/raw/07-coding/liyupi-ai-guide/Vibe Coding 零基础教程/10 编程工具/00 AI 编程工具大全.md"
sourceSha256: "ebe3943cc76f1964df2706fa8d216da88fd4bc27f1975b48e1795ba00fb8791d"
pageSha256: "ebe3943cc76f1964df2706fa8d216da88fd4bc27f1975b48e1795ba00fb8791d"
...
除了主线内容外，还有按工具分类的专题教程和通用工具实战，可以根据需要选择性学习。

**Cursor 专题**（`Cursor/` 目录）：

Cursor 是目前最主流的 AI 代码编辑器之一，这个专题收录与 Cursor 相关的使用教程、进阶技巧和新功能体验。不管你是刚上手还是想深挖高级用法，都可以在这里找到对应的内容。比如从安装到实战的保姆级教程、Agent 模式和 Rules 配置的进阶玩法等。

**Codex 专题**（`Codex/` 目录）：

Codex 是 OpenAI 推出的 AI 编程工具，能力远不止写代码，还能操作你的电脑、浏览器甚至手机。这个专题收录 Codex 的使用教程、核心特性讲解和新功能体验。比如涵盖 Browser Use、Computer Use、Skills、MCP、定时自动化等核心特性的保姆级教程，以及 Record & Replay 录制功能等新特性的实测。

**Claude Code 专题**（`Claude Code/` 目录）：

Claude Code 是 Anthropic 推出的命令行 AI 编程工具，以极高的自主性和代码质量著称。这个专题收录 Claude Code 的深度使用教程、配置方法和生态工具。比如常用斜杠命令大全、CLAUDE.md 的写法和最佳实践、官方推荐的七种配置方式全解析（CLAUDE.md、Rules、Skills、Subagents、Hooks 等）、对接国内模型的教程，以及封号机制的原理分析和应对方案等。

**DeepSeek Harness 专题**（`DeepSeek Harness/` 目录）：

DeepSeek Harness（DSH）是 DeepSeek 官方开源的 AI Agent 运行环境，核心理念是「一切皆插件」，对标 Claude Code 和 Codex。这个专题收录 DSH 的保姆级入门教程、极简模式性能实测、Agent 预设详解、精选社区插件推荐、服务器部署教程，以及三大进阶玩法（斜杠命令、自定义工具、多 Agent 军团），帮你从零上手并深度使用这个国产 AI 编程工具。

**通用工具实战**（`工具实战/` 目录）：

除了上面几个主力工具之外，AI 编程生态中还有大量值得了解的工具。这个专题收录各类 AI 编程工具的实战教程、横向测评和生态工具介绍。比如 VSCode + GitHub Copilot 实战、GitHub Copilot 云端自动开发、Gemini CLI / TRAE SOLO / OpenCode 等命令行工具实测、在 IDEA 中使用 AI 编程、规范驱动开发框架（Spec-kit / OpenSpec）、AI 技能库（Agent Skills / Superpowers / Matt Pocock Skills）、AI 数字员工 OpenClaw、Dify 零代码平台，以及 32 个 AI 编程工具的全景盘点等。
