...
更详细的贡献指南和内容规范，请阅读 [CONTRIBUTING.md](https://github.com/liyupi/ai-guide/blob/539082c1df5743bb34d72a17857a02735b38c866/CONTRIBUTING.md)。

## 开源协议

本项目采用双协议：

- **教程文档内容**（所有 Markdown 文件及配图）采用 [CC BY-NC-SA 4.0](https://github.com/liyupi/ai-guide/blob/539082c1df5743bb34d72a17857a02735b38c866/LICENSE/README.md) 协议：可以自由分享和改编，但需要署名、**禁止商业使用**，且衍生作品需采用相同协议。
- **建站代码**（`.vuepress` 目录下的主题、组件和构建脚本）采用 [MIT](https://github.com/liyupi/ai-guide/blob/539082c1df5743bb34d72a17857a02735b38c866/LICENSE-CODE/README.md) 协议：可以自由使用，包括商业用途。
