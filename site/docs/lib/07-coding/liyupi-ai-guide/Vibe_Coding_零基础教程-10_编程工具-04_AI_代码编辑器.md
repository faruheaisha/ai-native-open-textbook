...
entryUrl: "https://github.com/liyupi/ai-guide/blob/539082c1df5743bb34d72a17857a02735b38c866/Vibe%20Coding%20零基础教程/10%20编程工具/04%20AI%20代码编辑器.md"
sourceRel: "Vibe Coding 零基础教程/10 编程工具/04 AI 代码编辑器.md"
rawUrl: "/raw/07-coding/liyupi-ai-guide/Vibe Coding 零基础教程/10 编程工具/04 AI 代码编辑器.md"
sourceSha256: "e497dd65b1d3fe20274efdf416389dd251d36b8e98da756ea0c7c65aa5d4b484"
pageSha256: "e497dd65b1d3fe20274efdf416389dd251d36b8e98da756ea0c7c65aa5d4b484"
...
[ZCode](https://zcode.z.ai/cn) 是智谱推出的官方 AI 编程工具，也就是 GLM 系列模型的「角色专武」。

它的界面和交互跟 Codex 长得几乎一模一样，都是 Agent 优先的工作台，上手基本没有学习成本。登录授权后（国内选择连接 BigModel 平台），就能在对话框中直接切换使用 GLM 系列模型。

![](https://pic.yupi.icu/1/1787794882221-e6429c57-d14d-457d-a37e-365f58a571e1.png)

ZCode 最大的特点是对自家模型的多模态能力支持得最好，而且内置了浏览器控制和电脑控制功能。授权辅助功能和屏幕录制权限之后，AI 就能自己打开浏览器截图验证效果、操作桌面应用，写完前端代码自己看一眼、发现问题自己修，不需要你一步步人工验收。

如果你平时主要用 GLM 系列模型来 AI 编程，那 ZCode 会比通用工具更省心。具体的实战效果可以阅读本教程模型动态板块中的《GLM-5.3-Flash 编程能力实测 - 3 个项目案例》。
...
另外还有一个选择思路：如果你已经确定主要用某一家的模型，可以优先试试这家厂商的官方工具，比如用 GLM 系列就试试 ZCode。官方工具对自家模型的新特性（尤其是多模态能力）支持得最及时，套餐订阅往往也更划算。
