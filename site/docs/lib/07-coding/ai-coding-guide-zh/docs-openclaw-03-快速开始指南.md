...
entryUrl: "https://github.com/KimYx0207/AI-Coding-Guide-Zh/blob/7a7c21b8e7dc976e8ade33b79ee000a172e63daf/docs/openclaw/03-快速开始指南.md"
sourceRel: "docs/openclaw/03-快速开始指南.md"
rawUrl: "/raw/07-coding/ai-coding-guide-zh/docs/openclaw/03-快速开始指南.md"
sourceSha256: "d9611af9532f2030b0206004f1253db8030f433528e65fd7d25a3bd05eabdcb2"
pageSha256: "d9611af9532f2030b0206004f1253db8030f433528e65fd7d25a3bd05eabdcb2"
...
> ✅ **检查点：** 如果你看到了 `🦞 OpenClaw is ready!` 的输出，说明一切正常。如果没有，去看 [11-常见问题FAQ](/lib/07-coding/ai-coding-guide-zh/docs-openclaw-11-常见问题FAQ/index) 的 Q1-Q5。
...
| 我想要... | 去哪里 |
|-----------|--------|
| 接入更多 AI 模型 | [04. AI 模型配置](/lib/07-coding/ai-coding-guide-zh/docs-openclaw-04-模型配置指南) — 多提供商、故障转移、预算控制 |
| 连接更多消息平台 | [05. 消息平台集成](/lib/07-coding/ai-coding-guide-zh/docs-openclaw-05-消息平台接入指南) — 30+ 平台、消息路由 |
| 解锁 AI 超能力 | [06. 技能系统](/lib/07-coding/ai-coding-guide-zh/docs-openclaw-06-技能系统指南) — 技能生态、自定义技能 |
| AI 记住我的偏好 | [07. 记忆系统](/lib/07-coding/ai-coding-guide-zh/docs-openclaw-07-记忆系统指南) — 长期记忆、每日日志 |
| 运行多个 AI 助手 | [08. 多 Agent 路由](/lib/07-coding/ai-coding-guide-zh/docs-openclaw-08-多Agent协作指南/index) — 多 Agent、消息路由 |
| 容器化部署 | [09. Docker 部署](/lib/07-coding/ai-coding-guide-zh/docs-openclaw-09-Docker部署指南) — Docker Compose 一键部署 |
| 加固安全 | [10. 安全配置](/lib/07-coding/ai-coding-guide-zh/docs-openclaw-10-安全配置指南) — Token、TLS、沙箱隔离 |
| 遇到问题 | [11. 常见问题 FAQ](/lib/07-coding/ai-coding-guide-zh/docs-openclaw-11-常见问题FAQ/index) — 别人踩过的坑 |
