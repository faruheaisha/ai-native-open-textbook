---
title: "Principles of Frontend Frameworks"
...
entryUrl: "https://github.com/datawhalechina/easy-vibe/blob/130e9b75b28b524e8cc74e615fd9733a4e2b330d/docs/en/appendix/3-browser-and-frontend/frontend-framework-nature.md"
sourceRel: "docs/en/appendix/3-browser-and-frontend/frontend-framework-nature.md"
rawUrl: "/raw/07-coding/easy-vibe/docs/en/appendix/3-browser-and-frontend/frontend-framework-nature.md"
sourceSha256: "8856f3431c1f22b8309207fb18ee0642a8aaa83224e5ca26e11a14dc2168b634"
pageSha256: "8856f3431c1f22b8309207fb18ee0642a8aaa83224e5ca26e11a14dc2168b634"
...
- **HTML**: The skeleton of web pages, defining what elements are on the page (headings, paragraphs, buttons, images...). See [HTML and CSS Layout](/lib/07-coding/easy-vibe/docs-en-appendix-3-browser-and-frontend-html-css-layout).
- **JavaScript**: The programming language that makes web pages "come alive," able to modify page content and respond to user actions. See [JavaScript Deep Dive](/lib/07-coding/easy-vibe/docs-en-appendix-3-browser-and-frontend-javascript-deep-dive).
...
In the framework's HTML template, you use syntax like <code v-pre>{{ count }}</code> to mark "display count's value here":

```html

<span>Shopping Cart: {{ count }} items</span>    
<span>Total: ¥{{ count * 99 }}</span>   
<span>{{ count > 5 ? 'Too many' : 'Normal' }}</span>  
```
...
This is why "only frameworks can automatically sync" — there's fundamentally no connection between native HTML's `<span>` and JS variables. The framework's template syntax (<code v-pre>{{ }}</code>) is the key to establishing this connection. When you write <code v-pre>{{ count }}</code>, the framework knows this location should display count; only then can the framework precisely find and update it when count changes.
