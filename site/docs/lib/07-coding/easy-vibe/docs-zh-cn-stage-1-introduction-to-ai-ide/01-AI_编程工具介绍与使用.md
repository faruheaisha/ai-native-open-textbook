...
pageSha256: "bf295b1cb0be7891803f768631e3681957d4e045836e524202e03a2098153bb8"
...
::: tip 💡 最重要的学习原则：有问题，先问 AI
从现在开始，请把 AI 当成你的**第一求助对象**。无论是概念没听懂、工具不会装、命令不会写、程序报错，还是不知道下一步该怎么做，**先问 AI，再自己动手尝试**。

凡是你原本会问老师、同学或群友的问题，都应该优先问 AI。它响应更快，可以随时追问，也能结合你的报错信息和项目上下文立即给出下一步建议。不要等到卡住很久才想起 AI，也不要只在“让 AI 写代码”时才使用它。

**真正的 AI 原生学习，不只是用 AI 完成任务，而是让 AI 参与学习的全过程：遇到问题就问，得到答案就试，出现新问题再继续问。**
:::

### AI 原生学习闭环

AI 主动学习不是“把任务丢给 AI，自己等结果”，而是让 AI 帮你缩短等待答案的时间，把更多精力用在**动手、验证和理解**上。下面这个闭环可以用在本课程的每一章：

```mermaid
flowchart LR
  A["① 遇到问题<br/>说清目标和现象"] --> B["② 立即问 AI<br/>带上上下文"]
  B --> C["③ 自己动手<br/>照着建议尝试"]
  C --> D{"结果符合预期吗？"}
  D -- "还没有" --> E["④ 把结果或完整报错<br/>继续交给 AI"]
  E --> B
  D -- "符合" --> F["⑤ 用自己的话复述<br/>总结为什么有效"]
  F --> G["形成可以迁移到<br/>新问题的能力"]
```
...
| 你遇到的情况 | 可以直接对 AI 说 |
| --- | --- |
| **概念看不懂** | “我没有编程基础，请用生活中的类比解释什么是 API，再给我一个最小示例。” |
| **环境不会安装** | “我使用 macOS，想运行这个项目。请先检查需要哪些环境，再一次只带我完成一步，并解释这一步的作用。” |
| **命令运行报错** | “这是我执行的命令和完整报错。请先判断最可能的原因，再给我最小修改方案；如果信息不够，请告诉我还要提供什么。” |
| **不知道下一步做什么** | “我的目标是做一个贪吃蛇，目前已经能显示游戏画面。请告诉我接下来最小的一步，以及完成标准。” |
| **AI 写了代码但看不懂** | “先不要继续改代码。请按模块解释刚才的修改，每一部分解决了什么问题？” |
| **有多个方案不会选** | “请根据我是初学者、希望快速做出可运行版本这两个条件，对比方案 A 和 B，并明确推荐一个。” |
| **结果和预期不一样** | “我希望页面是这样的：……，现在实际是这样的：……。请比较差异，先只修复最明显的一处。” |

::: info 一个通用的提问模板
**我的目标是……；我目前做到……；我尝试了……；实际结果或完整报错是……；请先解释原因，再告诉我下一步最小的操作。**

信息越具体，AI 越容易给出真正适合你的回答。第一次回答没解决问题也很正常，把新结果继续发给它，这本身就是 AI 原生学习的一部分。
:::
...
::: tip 💡 进阶提示
如果你有一定的编程基础，想要提前使用更强大的工具，可以结合参考 [现代 CLI Coding 工具](https://github.com/datawhalechina/easy-vibe/blob/130e9b75b28b524e8cc74e615fd9733a4e2b330d/docs/zh-cn/stage-2/backend/modern-cli/README.md) 使用命令行方式进行开发。
:::
...
::: info 预习提示
如果你还不熟悉 IDE 是什么、各个界面元素有什么作用，建议先阅读 [IDE 简介](https://github.com/datawhalechina/easy-vibe/blob/130e9b75b28b524e8cc74e615fd9733a4e2b330d/zh-cn/appendix/2-development-tools/ide-basics/README.md) 进行预习，了解 IDE 的基本概念和常见功能。
:::
...
更具体的详细内容解释，请查看[附录中的 虚拟 IDE 可视化 IDE 原理部分](https://github.com/datawhalechina/easy-vibe/blob/130e9b75b28b524e8cc74e615fd9733a4e2b330d/zh-cn/appendix/2-development-tools/ide-basics/README.md)。
