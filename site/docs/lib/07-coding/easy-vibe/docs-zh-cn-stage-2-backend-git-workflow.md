...
entryUrl: "https://github.com/datawhalechina/easy-vibe/blob/130e9b75b28b524e8cc74e615fd9733a4e2b330d/docs/zh-cn/stage-2/backend/git-workflow/index.md"
sourceRel: "docs/zh-cn/stage-2/backend/git-workflow/index.md"
rawUrl: "/raw/07-coding/easy-vibe/docs/zh-cn/stage-2/backend/git-workflow/index.md"
sourceSha256: "8584375180d9adf2c110ca5f74d6245361f2a5a826b109212dbbe7285683a568"
pageSha256: "8584375180d9adf2c110ca5f74d6245361f2a5a826b109212dbbe7285683a568"
...
2. 双击安装程序并按照安装向导说明进行操作：
   ![](/mirror/82/82b8b412d001ef315cddcd2d74cb0f3aaeac42ea.png)
   1. 建议保持默认选项。如果你需要自定义，请注意以下几点：（在大多数情况下，你可以一直点击"Next"）
      - 选择 Git 使用的默认编辑器：选择你喜欢的编辑器（如 VS Code）。你可以默认选择第一个选项，即 Vim（一个文本编辑器），或选择"Visual Studio Code as Git's default editor"选项（需要预先安装 VS Code）。你可以保持默认选择并点击"Next"继续。
        ![](/mirror/41/412b81dc3170c7c45cf6333d19d238df43803a1a.png)
      - 选择如何使用 Git：这三个选项控制 Git 在系统中的可访问性。建议选择选项 2（"from command line and 3rd-party software"）——它将基本的 Git 工具添加到 PATH 中，让你可以在 Git Bash、命令提示符、PowerShell 和 IDE 中使用 Git，而不会使系统混乱。
        ![](/mirror/a8/a8f11964352dde283fa4e899090833207b1b5ea9.png)

3. 安装后，在桌面上右键单击。如果在菜单中看到"Git Bash Here"，则安装成功。

![](/mirror/e9/e9982659eae0bac238441009bbb26c55d092aa04.png)
...
1. 访问 [GitHub 官网](https://github.com/) 并点击右上角的"Sign up"。
   ![](/mirror/bb/bb85688d21e025fb6d33b26a3209d17e180e5ec3.png)
...
![](/mirror/5a/5aade75a37d675c212d77b226b7bc0e74aff50ce.png)![](/mirror/68/68baaf7aa5330f5a9516ca16730e85931458610a.png)

![](/mirror/86/86cb7f54a4a3ec86287931b4be205234166ee318.png)
...
![](/mirror/d8/d8e589b07c587316f5f5068a35e5d9e5a1d24a12.png)

之后，你将拥有一个没有任何额外文件的干净仓库。接下来你可以开始上传文件了。

![](/mirror/5d/5da0b8f53b2799c638c68b7ace91e6f48dc6a124.png)

获取仓库的命令是 `git clone`，但它需要仓库地址。你可以通过点击绿色的"Code"按钮找到仓库地址，你会看到 HTTPS 和 SSH 选项。通常，你可以使用这两种方法中的任何一种将仓库下载到本地机器（只有这样你才能修改和上传文件）。

![](/mirror/01/01914154189ea56283ba7d8e8b423785c3a1d410.png)
...
2. 登录 GitHub 并进入"SSH Key Management"页面：
   1. 点击右上角头像 → Settings → 左侧菜单 SSH and GPG keys → 点击 New SSH key。
      ![](/mirror/0f/0f8b4d217ebd2b949e3f4bd2e68559a4a6733a40.png)![](/mirror/21/21483a37b8e075024ffe6f8626cd3debcb3f7818.png)
   2. 输入任何标题（例如，your local computer's SSH），然后将你刚刚获取的 SSH 公钥粘贴到这里。

![](/mirror/e0/e0da1413f259af562309fb603355efaa28158f6e.png)

![](/mirror/93/93d53614a5702925e3ed140c458611f70cfff1b3.png)
...
![](/mirror/1c/1cc3b09a0ad792f85652d4973c4cd264c0cd25bc.png)
...
![](/mirror/4a/4aff5405bcccac22e306fee311d4ecea5892c27e.png)
