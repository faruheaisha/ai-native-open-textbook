...
- **[算法导论](/lib/07-coding/easy-vibe/docs-zh-cn-appendix-1-computer-fundamentals-algorithm-thinking)**：学会用排序、搜索、递归、动态规划等算法设计范式解决问题
- **[编程语言](/lib/07-coding/easy-vibe/docs-zh-cn-appendix-1-computer-fundamentals-programming-languages)**：了解不同编程语言如何实现这些数据结构
