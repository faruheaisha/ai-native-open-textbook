---
title: "Principles of Backend Layered Architecture"
...
entryUrl: "https://github.com/datawhalechina/easy-vibe/blob/130e9b75b28b524e8cc74e615fd9733a4e2b330d/docs/en/appendix/4-server-and-backend/backend-layered-architecture.md"
sourceRel: "docs/en/appendix/4-server-and-backend/backend-layered-architecture.md"
rawUrl: "/raw/07-coding/easy-vibe/docs/en/appendix/4-server-and-backend/backend-layered-architecture.md"
sourceSha256: "f673a3d699f80a8aa4521ac5310c60569962ec8e5ff22fbb9a1e6dbba4df377d"
pageSha256: "f673a3d699f80a8aa4521ac5310c60569962ec8e5ff22fbb9a1e6dbba4df377d"
...
- **Monolithic Architecture**: See the companion article [`backend-project-architecture.md`](/lib/07-coding/easy-vibe/docs-en-appendix-4-server-and-backend-backend-project-architecture) for the evolution from scripts to monoliths
- **Microservices Architecture**: See [From Monolith to Microservices](https://github.com/datawhalechina/easy-vibe/blob/130e9b75b28b524e8cc74e615fd9733a4e2b330d/en/appendix/6-architecture-and-system-design/monolith-to-microservices/README.md)
