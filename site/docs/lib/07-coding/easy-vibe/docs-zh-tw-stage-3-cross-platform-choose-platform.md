...
entryUrl: "https://github.com/datawhalechina/easy-vibe/blob/130e9b75b28b524e8cc74e615fd9733a4e2b330d/docs/zh-tw/stage-3/cross-platform/choose-platform/index.md"
sourceRel: "docs/zh-tw/stage-3/cross-platform/choose-platform/index.md"
rawUrl: "/raw/07-coding/easy-vibe/docs/zh-tw/stage-3/cross-platform/choose-platform/index.md"
sourceSha256: "9d5c0d3eb927ac4b5ffceac11aca349824e4511edf6c1f20fe0b80dc2890704a"
pageSha256: "9d5c0d3eb927ac4b5ffceac11aca349824e4511edf6c1f20fe0b80dc2890704a"
...
- **如何構建微信小程式** — 從零構建微信小程式，掌握核心開發工作流程

- **如何構建 Android 應用** — 使用現代跨平台框架構建 Android 原生應用

- **如何構建 iOS 應用** — 以 Apple 生態最佳實踐開發和發佈 iOS 應用

- **如何構建本地 PWA 應用** — 將網站變成真正的應用，支援離線使用和桌面安裝

- **如何構建瀏覽器 AI 助手擴展** — 一鍵摘要任何網頁，構建你的瀏覽器 AI 助手

- **如何構建跨平台 Electron 桌面應用** — 構建語音轉文字桌面應用，支援 Windows、macOS 和 Linux

- **如何構建 VS Code 擴展** — 創建你的 AI 專案助手，支援多文件問答和自定義快捷鍵

- **如何構建 Qt 工業 HMI** — 構建工業級人機介面，連接真實硬體
