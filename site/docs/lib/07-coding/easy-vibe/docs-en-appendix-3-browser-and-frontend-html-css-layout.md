---
title: "Fundamentals of HTML/CSS Layout"
...
entryUrl: "https://github.com/datawhalechina/easy-vibe/blob/130e9b75b28b524e8cc74e615fd9733a4e2b330d/docs/en/appendix/3-browser-and-frontend/html-css-layout.md"
sourceRel: "docs/en/appendix/3-browser-and-frontend/html-css-layout.md"
rawUrl: "/raw/07-coding/easy-vibe/docs/en/appendix/3-browser-and-frontend/html-css-layout.md"
sourceSha256: "5ee6d495ae5b3adcf16f5b3dfca1645229d02b6aeb70580d0f7810d19b7de0b5"
pageSha256: "5ee6d495ae5b3adcf16f5b3dfca1645229d02b6aeb70580d0f7810d19b7de0b5"
...
|----------|-------------|-------------------|
| `` | Big box | Any content, used for grouping |
...
```html
[Click here to navigate](https://example.com)
...
`` and `` seem to produce the same visual effect, so why use the latter?
...
3. **Code readability**: Seeing `` tells you immediately it's a header
...
| `` | Navigation | Navigation link area |
| `` | Main | Main content of the page (only one per page) |
| `` | Article | Independent content block (still meaningful if taken out alone) |
| `` | Section | Thematic content grouping |
| `` | Aside | Sidebar, supplementary content |
| `` | Foot | Footer of a page or section |
...
| `` | Paragraph | A block of text |
| ``/``/`` | Unordered/Ordered/List Item | Lists |
...
| Tag | Memory Aid | Purpose |
|-----|-----------|---------|
| `` | Big box | Block-level container, takes up a full row |
...
> "What does the `` tag in HTML mean? When should I use it?"

#### Don't Memorize Tags Deliberately

**The real workflow goes like this**:

1. You know you need a "container" → Write ``
2. Later you realize it's a "navigation area" → Change to ``
3. Later you realize it's an "independent article" → Change to ``
