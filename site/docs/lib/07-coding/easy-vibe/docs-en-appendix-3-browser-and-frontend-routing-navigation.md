---
title: "An Introduction to Routing and Navigation"
...
entryUrl: "https://github.com/datawhalechina/easy-vibe/blob/130e9b75b28b524e8cc74e615fd9733a4e2b330d/docs/en/appendix/3-browser-and-frontend/routing-navigation.md"
sourceRel: "docs/en/appendix/3-browser-and-frontend/routing-navigation.md"
rawUrl: "/raw/07-coding/easy-vibe/docs/en/appendix/3-browser-and-frontend/routing-navigation.md"
sourceSha256: "25e67cdf44a6023833102ded3cf9182f017420872bb1c332d05b9e10e1f0fb2e"
pageSha256: "25e67cdf44a6023833102ded3cf9182f017420872bb1c332d05b9e10e1f0fb2e"
...
The answer lies in the nature of SPAs: an SPA has only one HTML page, and all "page transitions" are really just component swaps within that single page. If you use a traditional `<a href="https://github.com/datawhalechina/easy-vibe/blob/130e9b75b28b524e8cc74e615fd9733a4e2b330d/user/123/README.md">`, the browser will actually request the `/user/123` path, causing a page refresh or a 404 error. The router's job is to intercept those navigation actions and dynamically swap components via JavaScript, enabling refresh-free transitions.
...
- **Navigation**: Using `<a href="https://github.com/datawhalechina/easy-vibe/blob/130e9b75b28b524e8cc74e615fd9733a4e2b330d/products/123/README.md">`, triggering a full page refresh
