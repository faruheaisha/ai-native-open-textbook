...
entryUrl: "https://github.com/datawhalechina/easy-vibe/blob/130e9b75b28b524e8cc74e615fd9733a4e2b330d/docs/zh-cn/stage-3/cross-platform/wechat-miniprogram/index.md"
sourceRel: "docs/zh-cn/stage-3/cross-platform/wechat-miniprogram/index.md"
rawUrl: "/raw/07-coding/easy-vibe/docs/zh-cn/stage-3/cross-platform/wechat-miniprogram/index.md"
sourceSha256: "566fd1020d744e4a3f6b4c8b5a47b63a0bd6db4064396802ff1fbce432268574"
pageSha256: "566fd1020d744e4a3f6b4c8b5a47b63a0bd6db4064396802ff1fbce432268574"
...
![Uber 微信小程序中的真实叫车页面](/mirror/91/91a103de7074d778b69c84e1b839240ba796f7f5.png)
...
![微信小程序操作截图](/mirror/03/03beb6a3e3dd36555268b8f5dbfa56d6a2229598.png)

2. 在首页选择「小程序」，按照页面提示完成注册流程，填写邮箱、手机号以及主体类型（个人或企业）。
   ![微信小程序操作截图](/mirror/1d/1d0b5a8107f4dcb5f5186a2840d9f792c5b3d0f0.png)
3. 注册成功并进入后台后，找到「开发管理」或「开发设置」页面，就能看到一个唯一的编号，名字叫 AppID 。这个编号后面会用在项目配置里，相当于你这个小程序在微信里的身份证。

![微信小程序操作截图](/mirror/4f/4f75e65309302682d8ac844cc830777fd5f3bd00.png)
...
![微信小程序操作截图](/mirror/5c/5cf6f722d792e40306d4f9ff18c08bfc35ecd0fc.png)![微信小程序操作截图](/mirror/6a/6ad133d4c8f7059cbd5bd9a0aa10fd86943d4e4e.png)
...
![微信小程序操作截图](/mirror/f3/f3f18cac80394974eeb7522b14caa3c3eafd97a4.png)

接着从 [HBuilderX 官网](https://www.dcloud.io/hbuilderx.html) 下载对应版本。安装后能进入欢迎页即可，暂时不用研究其他功能。

![微信小程序操作截图](/mirror/89/89442b78aa32570f16e00619f920cbe0fe2536cd.png)
...
![微信小程序操作截图](/mirror/e3/e3049a47277d6ff513d590cce27a1e65190bd8f4.png)

2. 选择 uni-app 默认模板，填写项目名和保存位置，然后点击右下角“创建”。

![微信小程序操作截图](/mirror/a5/a5d50730f301fc3408c1c1b0dafc50ba5ffdc1fa.png)

3. 等待 HBuilderX 创建项目。

![微信小程序操作截图](/mirror/44/44dfd526ea8c4b149ca6daed46f8ba68fcb8adb3.png)

4. 在 Trae 中打开刚才创建的项目文件夹。左侧能看到项目文件，说明准备完成。

![微信小程序操作截图](/mirror/14/1427d8280bc2c2eef71e04f334e80fe544098792.png)
...
![微信小程序操作截图](/mirror/81/81447c8d309844d57c0decf6cd26153f36bfa3c3.png)![微信小程序操作截图](/mirror/ec/ec46fb725b229919a26471ef1d3afb7008b8b2af.png)
...
![微信小程序操作截图](/mirror/25/25a297b85a555a931b625b6d90c3e0977b34c48d.png)

![微信小程序操作截图](/mirror/62/629c7257326527cbbb8412566d365936b9a41ba7.png)

### 3.3 在 HBuilderX 和微信开发者工具中查看效果

回到 HBuilderX，选择“运行 → 运行到小程序模拟器 → 微信开发者工具”。HBuilderX 会先构建项目，再把结果交给微信开发者工具。

![微信小程序操作截图](/mirror/cf/cf11454bb427bfc9a396bc02721ee8e1cb58dd86.png)

底部输出窗口出现 `ready` 且没有红色错误后，再切到微信开发者工具。

![微信小程序操作截图](/mirror/11/112c4cb0c76667d3154c7bd3711679b3e33ccc15.png)
...
![微信小程序操作截图](/mirror/84/847fc185eee234966f5befbbb7e07e7f9311c795.png)
...
![微信小程序操作截图](/mirror/62/620c15ff41b6c666ba1586b33aac5bb4793e40c0.png)

修改完成后重新运行。没有看到变化时，先停止 HBuilderX 当前任务，再执行一次“运行到小程序模拟器”，不要只反复刷新旧构建。

![微信小程序操作截图](/mirror/51/516095994f90a7c9c6db174afd0593dd08e3ac53.png)
...
![微信小程序操作截图](/mirror/eb/eb5c273c3a57acdc5d5c51821158a9387b0892ee.png)

### 3.6 最终成品

最后得到首页、游戏页和结束状态。蛇能移动、吃食物和计分，摇杆松开后仍会沿最后方向继续移动。

![微信小程序操作截图](/mirror/c8/c804da72a8c4a1b32df151603eac0c51a82d0053.png)![微信小程序操作截图](/mirror/79/793d5bca89dd27d9de29744dda0636851446339a.png)![微信小程序操作截图](/mirror/91/91e21e8830ce16523b55095b76d5208f400b3b40.png)
...
![微信小程序操作截图](/mirror/34/340d8f5a5437fa688b27abeeef7d7e095a8b29fb.png)
...
4. 把刚才在公众平台上看到的 AppID 原样粘贴进来，保存文件。
   ![微信小程序操作截图](/mirror/f1/f1c7e3c9625174df8fc5c3dc1eb07e9ae91cf954.png)
...
![微信小程序操作截图](/mirror/be/be7ed54de16414474f8e9351877a72c1b169d67b.png)

![微信小程序操作截图](/mirror/f3/f36efcd4420ab028ef52d3111e84b1c477616781.png)

![微信小程序操作截图](/mirror/a6/a652d2aea9933e2ede94fbbbb1f8263d8ba8db40.png)![微信小程序操作截图](/mirror/06/069b8fd89e3dd7c5ba3779e49885f06ea5482b23.png)
...
4. 在这一行右侧选择「设为体验版」。如果后台要求先补充主营类目，按实际功能选择后再回来操作。
   ...
   ![微信小程序操作截图](/mirror/14/148ea420aef8567db8aa96b21928e9aa187bb6fe.png)

   ![微信小程序操作截图](/mirror/d0/d0bc582064b93c9ec9c189992649c67081263356.png)
...
![微信小程序操作截图](/mirror/1f/1f50a60856b754c44956f662c41029a69ba98485.png)
...
![微信小程序操作截图](/mirror/4c/4c759aec092e3c4b51f24c8d2ef735f938f6cf9a.png)
...
![微信小程序操作截图](/mirror/1f/1fa7b387b11e3f881598a0ad3966fe2a9573daff.png)

点击“添加类目”后，后台会显示当前账号可以选择的分类：

![微信小程序操作截图](/mirror/6c/6c978c75aac435a85a18f0f15318f5c59233ddc3.png)

下面的截图只展示类目选择界面，不代表贪吃蛇应该选择“教育器具”。如果准备公开运营游戏，应先确认是否需要使用微信小游戏账号、对应类目和额外规则；不要为了通过审核把游戏描述成教育工具。

![微信小程序操作截图](/mirror/3f/3ff8e2f5694d511ce5af9b60c43ad29fde111529.png)

![微信小程序操作截图](/mirror/57/570b3d637a40273a7d14b7eb77b928ec79b3c37b.png)
...
![微信小程序操作截图](/mirror/f3/f33033b29d75a660ee002920fd1fa50273098114.png)

1. 选择与注册账号一致的主体类型。
2. 按后台提示填写主体和负责人信息。
3. 上传当前页面要求的证明材料并完成核验。
   ![微信小程序操作截图](/mirror/d5/d547f283927d123a90b079af606a1300795c1506.png)

身份证、手机号、验证码和证件照片都不要发给 AI，也不要出现在教程截图里。提交后回到后台查看实际状态；需要短信或工信部核验时，按收到的官方通知在有效期内完成。

![微信小程序操作截图](/mirror/22/22bf85baac3f228c5c71350846ba8525c2ea2b1b.png)
...
![微信小程序操作截图](/mirror/fe/fea1e87ff8b891ee104628a2fff1e18fcbd287d9.png)
