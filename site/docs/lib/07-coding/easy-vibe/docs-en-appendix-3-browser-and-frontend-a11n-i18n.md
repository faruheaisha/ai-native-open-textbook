---
title: "The Hidden Dimensions of Web: Internationalization and Accessibility"
...
entryUrl: "https://github.com/datawhalechina/easy-vibe/blob/130e9b75b28b524e8cc74e615fd9733a4e2b330d/docs/en/appendix/3-browser-and-frontend/a11n-i18n.md"
sourceRel: "docs/en/appendix/3-browser-and-frontend/a11n-i18n.md"
rawUrl: "/raw/07-coding/easy-vibe/docs/en/appendix/3-browser-and-frontend/a11n-i18n.md"
sourceSha256: "d6c359a61e53e58b2d174e536d228a9dadf72cc7fbbda478fc8ad84c584fda59"
pageSha256: "d6c359a61e53e58b2d174e536d228a9dadf72cc7fbbda478fc8ad84c584fda59"
contentMode: "local-full"
zh: ""
---

# The Hidden Dimensions of Web: Internationalization and Accessibility
...
### 1.2 The Constraint of Typography: Text Length and RTL Mirroring
...
If a developer uses a plain `` tag with CSS styling to create a visually impeccable button, it is perfect in the conventional render tree. But in the AOM tree connected to the screen reader, it is just a meaningless plain text node. Visually impaired users can neither hear a "button" prompt nor select it with the `Tab` key.

So why do we repeatedly emphasize **"always use semantic HTML tags"**? Because when you use `<button>`, ``, or `<a>` tags, the browser engine automatically fills in their built-in focus management and role information in the AOM tree. Semantics is essentially a high-quality blueprint drawn for assistive tools.
