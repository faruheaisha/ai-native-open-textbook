...
entryUrl: "https://github.com/datawhalechina/easy-vibe/blob/130e9b75b28b524e8cc74e615fd9733a4e2b330d/docs/zh-cn/stage-3/cross-platform/wechat-miniprogram-backend/index.md"
sourceRel: "docs/zh-cn/stage-3/cross-platform/wechat-miniprogram-backend/index.md"
rawUrl: "/raw/07-coding/easy-vibe/docs/zh-cn/stage-3/cross-platform/wechat-miniprogram-backend/index.md"
sourceSha256: "86e9cd437ef5a406db0e30e6ec8d8afb15c01264da1c7ba46ce95d2616257fbd"
pageSha256: "86e9cd437ef5a406db0e30e6ec8d8afb15c01264da1c7ba46ce95d2616257fbd"
...
![Uber 微信小程序中的路线、订单和支付页面](/mirror/91/91a103de7074d778b69c84e1b839240ba796f7f5.png)
...
![腾讯云当前推荐的 CloudBase AI 一键插件页面（本次实际打开并截图）](/mirror/65/65d67bb713b8d5bf7d09c720af898ce694a1a017.jpg)
...
![在微信开发者工具中扫码登录](/mirror/6a/6ad133d4c8f7059cbd5bd9a0aa10fd86943d4e4e.png)

![在 Trae 中打开真实项目](/mirror/f3/f3f18cac80394974eeb7522b14caa3c3eafd97a4.png)
...
![在微信公众平台查看小程序 AppID](/mirror/4f/4f75e65309302682d8ac844cc830777fd5f3bd00.png)
...
![腾讯云当前的 Trae 配置指南（本次实际打开并截图）](/mirror/70/70804d1cb44f8b7c0fd08c2d1906382eeef1a4ea.jpg)
...
![腾讯云当前的创建云开发环境指南（本次实际打开并截图）](/mirror/6f/6f2af296c68a61957934833c8db98cf013fd383c.jpg)

如果你从 CloudBase 控制台进入，会先看到下面的登录页。这里可以使用腾讯云账号，也可以使用当前小程序所属的微信公众平台账号登录。

![CloudBase 控制台当前登录页（本次实际打开并截图，未代替用户登录）](/mirror/9c/9c7e2d046bd19e8bfbe4ad9ba283eb8fa4c908ee.jpg)
...
![在 Trae 中确认小程序基础文件已经准备好](/mirror/14/1427d8280bc2c2eef71e04f334e80fe544098792.png)
...
![Trae 读取项目并说明修改计划](/mirror/81/81447c8d309844d57c0decf6cd26153f36bfa3c3.png)

![Trae 修改完成后提供变更摘要](/mirror/ec/ec46fb725b229919a26471ef1d3afb7008b8b2af.png)

如果你发现 AI 准备新建另一个项目，可以马上告诉它：“不要另建项目，只修改当前工作区。”

如果这一轮结果不满意，也不用紧张。Trae 仍然提供回退能力，可以把工程恢复到本次修改之前。

![使用回退恢复到 AI 修改之前](/mirror/25/25a297b85a555a931b625b6d90c3e0977b34c48d.png)
...
![从 HBuilderX 运行到微信小程序模拟器](/mirror/cf/cf11454bb427bfc9a396bc02721ee8e1cb58dd86.png)

底部输出窗口会显示编译过程。如果最终没有报错，就可以切到微信开发者工具查看首页、创建工单和我的工单页面。

![等待项目编译完成](/mirror/11/112c4cb0c76667d3154c7bd3711679b3e33ccc15.png)

![在微信开发者工具中查看运行效果](/mirror/84/847fc185eee234966f5befbbb7e07e7f9311c795.png)
...
![Northstar Service Hub 企业客户服务小程序：会员、快速服务与售后工单](/mirror/3b/3b77f5975228636212906f7aaa51946678983293.png)
...
![腾讯云当前的文档型数据库操作页（本次实际打开并截图）](/mirror/b1/b191ff808d1f3f2acd270f81aa7daf238f9ed9e3.jpg)
...
![腾讯云当前的日志检索操作页（本次实际打开并截图）](/mirror/e6/e6a48ec991fba2a9bf9570e562c67bbdd5da1d00.jpg)
...
![在微信开发者工具中填写上传版本信息](/mirror/be/be7ed54de16414474f8e9351877a72c1b169d67b.png)

![等待小程序代码上传完成](/mirror/a6/a652d2aea9933e2ede94fbbbb1f8263d8ba8db40.png)

上传完成后，回到微信公众平台的“版本管理”，把刚上传的开发版本设为体验版。

![在公众平台查看开发版本](/mirror/14/148ea420aef8567db8aa96b21928e9aa187bb6fe.png)

![将上传版本设置为体验版](/mirror/d0/d0bc582064b93c9ec9c189992649c67081263356.png)
