...
entryUrl: "https://github.com/datawhalechina/easy-vibe/blob/130e9b75b28b524e8cc74e615fd9733a4e2b330d/docs/zh-cn/appendix/3-browser-and-frontend/routing-navigation.md"
sourceRel: "docs/zh-cn/appendix/3-browser-and-frontend/routing-navigation.md"
rawUrl: "/raw/07-coding/easy-vibe/docs/zh-cn/appendix/3-browser-and-frontend/routing-navigation.md"
sourceSha256: "8584749fd165735b82fccefd091e435f03ac241688175f23708903d9b09a7039"
pageSha256: "8584749fd165735b82fccefd091e435f03ac241688175f23708903d9b09a7039"
...
答案在于"单页应用"的本质：SPA 只有一个 HTML 页面，所有的页面切换其实都是在同一个页面内替换组件。如果你用传统的 `<a href="https://github.com/datawhalechina/easy-vibe/blob/130e9b75b28b524e8cc74e615fd9733a4e2b330d/user/123/README.md">`，浏览器会真的去请求 `/user/123` 这个路径，导致页面刷新或 404 错误。路由的作用就是拦截这些跳转行为，用 JavaScript 动态替换组件，从而实现无刷新切换。
...
- **页面跳转**：使用 `<a href="https://github.com/datawhalechina/easy-vibe/blob/130e9b75b28b524e8cc74e615fd9733a4e2b330d/products/123/README.md">`，触发完整的页面刷新
