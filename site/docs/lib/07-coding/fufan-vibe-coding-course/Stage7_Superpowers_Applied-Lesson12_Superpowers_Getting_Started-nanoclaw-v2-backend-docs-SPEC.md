...
entryUrl: "https://github.com/fufankeji/FuFan-VibeCodingCourse/blob/5336ede159a7ac2ce0ee136324fe5bffd56970ca/Stage7_Superpowers_Applied/Lesson12_Superpowers_Getting_Started/nanoclaw-v2-backend/docs/SPEC.md"
sourceRel: "Stage7_Superpowers_Applied/Lesson12_Superpowers_Getting_Started/nanoclaw-v2-backend/docs/SPEC.md"
rawUrl: "/raw/07-coding/fufan-vibe-coding-course/Stage7_Superpowers_Applied/Lesson12_Superpowers_Getting_Started/nanoclaw-v2-backend/docs/SPEC.md"
sourceSha256: "24cf194adb866522f2b68c9956da69dd1622a476d1ed991f7159eaf0bfdb3f59"
pageSha256: "24cf194adb866522f2b68c9956da69dd1622a476d1ed991f7159eaf0bfdb3f59"
...
Files with <code v-pre>{{PLACEHOLDER}}</code> values need to be configured:
- <code v-pre>{{PROJECT_ROOT}}</code> - Absolute path to your nanoclaw installation
- <code v-pre>{{NODE_PATH}}</code> - Path to node binary (detected via `which node`)
- <code v-pre>{{HOME}}</code> - User's home directory
