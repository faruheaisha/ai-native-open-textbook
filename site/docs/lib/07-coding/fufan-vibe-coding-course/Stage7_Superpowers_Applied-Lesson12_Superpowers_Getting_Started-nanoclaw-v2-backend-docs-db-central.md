---
title: "NanoClaw — Central DB Schema"
...
entryUrl: "https://github.com/fufankeji/FuFan-VibeCodingCourse/blob/5336ede159a7ac2ce0ee136324fe5bffd56970ca/Stage7_Superpowers_Applied/Lesson12_Superpowers_Getting_Started/nanoclaw-v2-backend/docs/db-central.md"
sourceRel: "Stage7_Superpowers_Applied/Lesson12_Superpowers_Getting_Started/nanoclaw-v2-backend/docs/db-central.md"
rawUrl: "/raw/07-coding/fufan-vibe-coding-course/Stage7_Superpowers_Applied/Lesson12_Superpowers_Getting_Started/nanoclaw-v2-backend/docs/db-central.md"
sourceSha256: "668fdb02ff888eb72dcc9e86a400d12c7f5f0bd9a75db3cc1e2c2e72397032bc"
pageSha256: "668fdb02ff888eb72dcc9e86a400d12c7f5f0bd9a75db3cc1e2c2e72397032bc"
...
Complete reference for `data/v2.db`, the host-owned admin-plane database. Start with [db.md](/lib/07-coding/fufan-vibe-coding-course/Stage7_Superpowers_Applied-Lesson12_Superpowers_Getting_Started-nanoclaw-v2-backend-docs-db) for the three-DB overview, the map, and the cross-mount rules.
...
Wiring: which agent group handles which messaging group. Many-to-many — the same channel can route to multiple agents (see [isolation-model.md](/lib/07-coding/fufan-vibe-coding-course/Stage7_Superpowers_Applied-Lesson12_Superpowers_Getting_Started-nanoclaw-v2-backend-docs-isolation-model)).
...
- Creating a session also provisions the session folder and both session DBs via `initSessionFolder()` — see [db-session.md](/lib/07-coding/fufan-vibe-coding-course/Stage7_Superpowers_Applied-Lesson12_Superpowers_Getting_Started-nanoclaw-v2-backend-docs-db-session).
...
State backing the `SqliteStateAdapter` used by the Chat SDK bridge (see [api-details.md](/lib/07-coding/fufan-vibe-coding-course/Stage7_Superpowers_Applied-Lesson12_Superpowers_Getting_Started-nanoclaw-v2-backend-docs-api-details)). NanoClaw code rarely touches these directly — they're owned by `src/state-sqlite.ts`.
