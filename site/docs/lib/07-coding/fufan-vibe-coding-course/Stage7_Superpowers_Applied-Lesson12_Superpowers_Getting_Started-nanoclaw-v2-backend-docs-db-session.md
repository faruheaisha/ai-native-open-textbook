---
title: "NanoClaw — Per-Session DB Schema"
...
entryUrl: "https://github.com/fufankeji/FuFan-VibeCodingCourse/blob/5336ede159a7ac2ce0ee136324fe5bffd56970ca/Stage7_Superpowers_Applied/Lesson12_Superpowers_Getting_Started/nanoclaw-v2-backend/docs/db-session.md"
sourceRel: "Stage7_Superpowers_Applied/Lesson12_Superpowers_Getting_Started/nanoclaw-v2-backend/docs/db-session.md"
rawUrl: "/raw/07-coding/fufan-vibe-coding-course/Stage7_Superpowers_Applied/Lesson12_Superpowers_Getting_Started/nanoclaw-v2-backend/docs/db-session.md"
sourceSha256: "491e00d024334309e7c7be9970e346e25f493af2fd1328aef40194fa47008fb1"
pageSha256: "491e00d024334309e7c7be9970e346e25f493af2fd1328aef40194fa47008fb1"
...
Reference for the two SQLite files each session owns: `inbound.db` (host writes, container reads) and `outbound.db` (container writes, host reads). Start with [db.md](/lib/07-coding/fufan-vibe-coding-course/Stage7_Superpowers_Applied-Lesson12_Superpowers_Getting_Started-nanoclaw-v2-backend-docs-db) for the three-DB overview, the single-writer rule, and the cross-mount visibility constraints.
...
Content shapes: see [api-details.md §Session DB Schema Details](/lib/07-coding/fufan-vibe-coding-course/Stage7_Superpowers_Applied-Lesson12_Superpowers_Getting_Started-nanoclaw-v2-backend-docs-api-details#session-db-schema-details).
...
Projection of the central `agent_destinations` table (see [db-central.md §1.10](/lib/07-coding/fufan-vibe-coding-course/Stage7_Superpowers_Applied-Lesson12_Superpowers_Getting_Started-nanoclaw-v2-backend-docs-db-central#110-agent_destinations)) for this session's agent. The container resolves `to="name"` against this table; if the row is absent, the send is rejected as `unknown destination`.
