...
entryUrl: "https://github.com/fufankeji/FuFan-VibeCodingCourse/blob/5336ede159a7ac2ce0ee136324fe5bffd56970ca/Stage3_Claude_Code_Engineering/Lesson05_Claude_Code_Architecture/GraphRAGAgent/docs/mineru_specification-v1.0.md"
sourceRel: "Stage3_Claude_Code_Engineering/Lesson05_Claude_Code_Architecture/GraphRAGAgent/docs/mineru_specification-v1.0.md"
rawUrl: "/raw/07-coding/fufan-vibe-coding-course/Stage3_Claude_Code_Engineering/Lesson05_Claude_Code_Architecture/GraphRAGAgent/docs/mineru_specification-v1.0.md"
sourceSha256: "f2e8cd436ae9d1d87627821a73d8c835a7b6bfb7fe9a48a252b728580ba1609e"
pageSha256: "f2e8cd436ae9d1d87627821a73d8c835a7b6bfb7fe9a48a252b728580ba1609e"
...
| `table_body` | `string` | 是 | HTML 表格（`` 标签，无 `<html>/<body>` 外层包裹） |
| `table_caption` | `string[]` | 是 | 表格标题（可为空数组 `[]`） |
| `table_footnote` | `string[]` | 是 | 表格脚注（可为空数组 `[]`） |

> **实测发现：** `table_body` 的 HTML 直接以 `` 开头，**不含** `<html><body>` 外层包裹（官方文档示例中有外层包裹，以实测为准）。
