---
title: "合同审核 LangChain HITL 工作流规范 v1.0"
...
entryUrl: "https://github.com/fufankeji/FuFan-VibeCodingCourse/blob/5336ede159a7ac2ce0ee136324fe5bffd56970ca/Stage4_Enterprise_Practice/Lesson07_Document_Review_Agent/AgentTeamProject/docs/06_architecture/langchain_hitl_workflow-v1.0.md"
sourceRel: "Stage4_Enterprise_Practice/Lesson07_Document_Review_Agent/AgentTeamProject/docs/06_architecture/langchain_hitl_workflow-v1.0.md"
rawUrl: "/raw/07-coding/fufan-vibe-coding-course/Stage4_Enterprise_Practice/Lesson07_Document_Review_Agent/AgentTeamProject/docs/06_architecture/langchain_hitl_workflow-v1.0.md"
sourceSha256: "9a6c578ca9c053c58502b8aaaf965a975c8b39c80b697d4ae543686055d6f181"
pageSha256: "9a6c578ca9c053c58502b8aaaf965a975c8b39c80b697d4ae543686055d6f181"
...
>
> "thread_id is your pointer: set <code v-pre>config=\{"configurable": \{"thread_id": ...}}</code> to tell the checkpointer which state to load. Reusing it resumes the same checkpoint; using a new value starts a brand-new thread with an empty state."
>
...
| 操作 | 使用方式 |
|------|---------|
| 启动 LangGraph 工作流 | 以 <code v-pre>\{"configurable": \{"thread_id": session.langgraph_thread_id}}</code> 作为 config 调用 `graph.invoke()` 或 `graph.stream()` |
