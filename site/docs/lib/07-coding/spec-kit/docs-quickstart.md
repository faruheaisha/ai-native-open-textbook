...
entryUrl: "https://github.com/github/spec-kit/blob/c173bf19a6654e3b05386ec3599349a55282b897/docs/quickstart.md"
sourceRel: "docs/quickstart.md"
rawUrl: "/raw/07-coding/spec-kit/docs/quickstart.md"
sourceSha256: "f8127be564694bf291bce22c36317e24ae2ce5e58c4efbf926197c65f2aef46f"
pageSha256: "f8127be564694bf291bce22c36317e24ae2ce5e58c4efbf926197c65f2aef46f"
...
**In your terminal**, install the CLI from PyPI (requires [uv](/lib/07-coding/spec-kit/docs-install-uv)), then initialize your project:
...
> [!NOTE]
> Prefer `pipx`, one-time `uvx` runs, a pinned release, or an offline/air-gapped setup? See the [Installation Guide](/lib/07-coding/spec-kit/docs-installation) for all supported methods.
> Adding Spec Kit to a repository that already contains code? Follow
> [Adopting Spec Kit in an Existing Project](/lib/07-coding/spec-kit/docs-guides-existing-projects) before
...
> [!TIP]
> For a full reference on each command — arguments, output, phased implementation, and how they interact — see [Agentic SDD](/lib/07-coding/spec-kit/docs-reference-agentic-sdd).
...
- See the [Agentic SDD](/lib/07-coding/spec-kit/docs-reference-agentic-sdd) reference for full detail on every command
...
- Compare the [core templates](https://github.com/github/spec-kit/tree/main/templates) with
  [community walkthroughs](/lib/07-coding/spec-kit/docs-community-walkthroughs) to see how Spec-Driven Development is used in real projects
