...
entryUrl: "https://github.com/github/spec-kit/blob/c173bf19a6654e3b05386ec3599349a55282b897/docs/reference/agentic-sdd.md"
sourceRel: "docs/reference/agentic-sdd.md"
rawUrl: "/raw/07-coding/spec-kit/docs/reference/agentic-sdd.md"
sourceSha256: "29a92531ad8bd56a62222851629cd08700b11cee9a54645fcd2aa9383f05010c"
pageSha256: "29a92531ad8bd56a62222851629cd08700b11cee9a54645fcd2aa9383f05010c"
...
The `/speckit.*` slash commands drive the core Spec-Driven Development (SDD) process — an **agentic process** your coding agent runs step by step. For a guided, end-to-end run see the [Quick Start Guide](/lib/07-coding/spec-kit/docs-quickstart); this page is the detailed reference for each command — including arguments, output, and how they interact. For the philosophy behind the process, see [What is SDD?](/lib/07-coding/spec-kit/docs-concepts-sdd). For bug triage, see [Agentic Bug Fix](/lib/07-coding/spec-kit/docs-reference-agentic-bugfix).
