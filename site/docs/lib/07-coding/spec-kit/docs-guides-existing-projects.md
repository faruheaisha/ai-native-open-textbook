...
The [Spec Persistence Models](/lib/07-coding/spec-kit/docs-concepts-spec-persistence) page compares
these choices. The [Evolving Specs guide](/lib/07-coding/spec-kit/docs-guides-evolving-specs) provides the
maintenance loop for each model.

## Existing-Project Examples

The [community walkthroughs](/lib/07-coding/spec-kit/docs-community-walkthroughs) include brownfield
...
[extension catalog](/lib/07-coding/spec-kit/docs-community-extensions).
