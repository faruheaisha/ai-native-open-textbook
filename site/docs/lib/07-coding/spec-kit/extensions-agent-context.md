---
title: "Coding Agent Context Extension"
...
entryUrl: "https://github.com/github/spec-kit/blob/c173bf19a6654e3b05386ec3599349a55282b897/extensions/agent-context/README.md"
sourceRel: "extensions/agent-context/README.md"
rawUrl: "/raw/07-coding/spec-kit/extensions/agent-context/README.md"
sourceSha256: "a156f3e8683e3763ea0d5edf91a7663b566d396692621d7fb663971f499dfcf7"
pageSha256: "a156f3e8683e3763ea0d5edf91a7663b566d396692621d7fb663971f499dfcf7"
...
- **Customize the markers** by editing `.specify/extensions/agent-context/agent-context-config.yml` ([agent-context-config.yml](https://github.com/github/spec-kit/blob/c173bf19a6654e3b05386ec3599349a55282b897/extensions/agent-context/agent-context-config.yml) in this repo) - the bundled scripts honor the `context_markers` value.
...
- **Refresh on demand** by running the `speckit.agent-context.update` command in your agent, or automatically through the hooks declared in [extension.yml](https://github.com/github/spec-kit/blob/c173bf19a6654e3b05386ec3599349a55282b897/extensions/agent-context/extension.yml) (`after_specify`, `after_plan`).
...
All configuration flows through the extension's own config file at `.specify/extensions/agent-context/agent-context-config.yml` ([agent-context-config.yml](https://github.com/github/spec-kit/blob/c173bf19a6654e3b05386ec3599349a55282b897/extensions/agent-context/agent-context-config.yml) in the repo).
