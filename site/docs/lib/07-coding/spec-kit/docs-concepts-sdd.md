...
[Spec Persistence Models](/lib/07-coding/spec-kit/docs-concepts-spec-persistence) for the concepts and
[Evolving Specs in Existing Projects](/lib/07-coding/spec-kit/docs-guides-evolving-specs) for the
