...
> [!NOTE]
> The command below requires **[uv](https://docs.astral.sh/uv/)**. If you see `command not found: uv`, [install uv first](/lib/07-coding/spec-kit/docs-install-uv).
...
To install a specific release, pin the version — for example `uv tool install specify-cli==0.12.11`. See the [PyPI installation guide](/lib/07-coding/spec-kit/docs-install-pypi) for details, including how to upgrade and how to [install from a custom or private package index](/lib/07-coding/spec-kit/docs-install-pypi#install-from-a-custom-or-private-package-index).

### One-time Usage

Run directly without installing — see the [One-time usage (uvx)](/lib/07-coding/spec-kit/docs-install-one-time) guide.

### Alternative Package Managers

- **PyPI** — see the [PyPI installation guide](/lib/07-coding/spec-kit/docs-install-pypi)
- **pipx** — see the [pipx installation guide](/lib/07-coding/spec-kit/docs-install-pipx)
- **Enterprise / Air-Gapped** — see the [air-gapped installation guide](/lib/07-coding/spec-kit/docs-install-air-gapped)
...
If your environment blocks access to PyPI or GitHub, see the [Enterprise / Air-Gapped Installation](/lib/07-coding/spec-kit/docs-install-air-gapped) guide for step-by-step instructions on creating portable wheel bundles.

### Git Credential Manager on Linux

If you're having issues with Git authentication on Linux, see the [Air-Gapped Installation guide](/lib/07-coding/spec-kit/docs-install-air-gapped#git-credential-manager-on-linux) for Git Credential Manager setup instructions.
