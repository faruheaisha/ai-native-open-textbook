...
> 📚 **系列导航**：上一篇 [05 接入第三方 / 国产模型](/lib/07-coding/ai-coding-guide-stormzhang/claude-code-05-third-party-models) 教你把 DeepSeek、Kimi、GLM 接进 Claude Code。这一篇把账算清楚——**到底该订哪个套餐、钱怎么花的、怎么查用量、怎么省**。
