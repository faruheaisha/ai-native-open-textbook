---
title: "09 · 配置 DeepSeek 官方 Provider 与默认模型"
...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/deepseek-harness/09-deepseek-provider.md"
sourceRel: "deepseek-harness/09-deepseek-provider.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/deepseek-harness/09-deepseek-provider.md"
sourceSha256: "fe5cc011c250e2a7e895be507a215857e283bbb31062f4bccf729d5b85a55f25"
pageSha256: "fe5cc011c250e2a7e895be507a215857e283bbb31062f4bccf729d5b85a55f25"
...
> 📚 **系列导航**：上一篇 [08 · Web UI 界面与工作区](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-08-web-ui-workspace) 已经确定项目位置。这一篇配置 DeepSeek 官方 Provider，但不会把「界面有模型」冒充成「真实 API 已跑通」。
...
![DeepSeek 官方 Provider 设置页：只写凭据状态、保存入口与默认模型目录](/mirror/27/272ec04f7a84f19eaba3c77d11f0e15ee2b6668d.png)
...
此外，官方模型最大输出与 Harness 默认请求值也不是一回事：当前官方模型页面标注最大输出 384K，固定版适配器默认 `maxTokens` 是 256,000。详细价格与规格集中维护在 [05 · DeepSeek 模型目录、API Key、价格与调用方式](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-05-models-api-pricing)，这里不复制易过期价格表。
...
下一篇：[10 · 配置第三方与自定义 Provider](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-10-custom-provider)。等真实 Key 补齐后，B3 会继续把官方 Provider、第三方 Provider 和第一次完整代码任务串成同一条验收链。
