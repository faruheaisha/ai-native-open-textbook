...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/claude-code/39-getting-started-practice.md"
sourceRel: "claude-code/39-getting-started-practice.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/claude-code/39-getting-started-practice.md"
sourceSha256: "f0abadf23df220a80256997a1e3e342df217e4e9fb124bb08acd9c4e17471752"
pageSha256: "f0abadf23df220a80256997a1e3e342df217e4e9fb124bb08acd9c4e17471752"
...
> 📚 **系列导航**：上一篇 [38 插件参考手册](/lib/07-coding/ai-coding-guide-stormzhang/claude-code-38-plugins-reference) 教你把自己那套配置打成一个能发出去的包。这一篇彻底换挡——**前面三十八篇全在「一件件拆功能」，这一篇第一次把它们串成一条完整的实战路径**：拿一个真实的小需求，从打开项目、写 CLAUDE.md、提问、审查改动到验证交付，一口气走完。学过的招，这回拧成一股绳用。
...
![Claude Code 实战六步法：开工 → 探索 → 规划 → 动手 → 验证 → 交付](/mirror/5e/5e4bd41f762d753c8dd390ff81869c585629136c.png)
