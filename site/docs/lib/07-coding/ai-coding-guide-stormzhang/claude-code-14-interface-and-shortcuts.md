...
> 📚 **系列导航**：上一篇 [13 项目结构](/lib/07-coding/ai-coding-guide-stormzhang/claude-code-13-project-structure) 带你看清 Claude Code 在你项目里都摆了哪些文件。这一篇换个视角——回到那个终端窗口本身，搞懂界面每一块是干嘛的，再把几个能让你「快一倍」的键盘动作焊进肌肉记忆。
...
![交互界面分区与高频快捷键](/mirror/a4/a4406d7da12c1349ca77e91a987e4605a5b83ae1.webp)
...
下一篇 [**15「怎么提问和给指令」**](/lib/07-coding/ai-coding-guide-stormzhang/claude-code-15-prompting)——手放对地方了，接下来就是「嘴」的功夫了。同样一个需求，会问的人三句话搞定，不会问的人来回扯五轮还跑偏。下一篇咱们就聊：**到底怎么跟 Claude 说话，它才听得准、干得对？**
