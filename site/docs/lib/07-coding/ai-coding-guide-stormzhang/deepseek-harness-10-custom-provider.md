...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/deepseek-harness/10-custom-provider.md"
sourceRel: "deepseek-harness/10-custom-provider.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/deepseek-harness/10-custom-provider.md"
sourceSha256: "cf1ad97eb9fa5cefa12ab25f3962b627ff0ea3d1d1a2a4ddc62ece8ef6e487c0"
pageSha256: "cf1ad97eb9fa5cefa12ab25f3962b627ff0ea3d1d1a2a4ddc62ece8ef6e487c0"
...
> 📚 **系列导航**：上一篇 [09 · 配置 DeepSeek 官方 Provider 与默认模型](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-09-deepseek-provider) 已经走通官方路由的配置方法。这一篇把模型通道扩展到目录 Provider、公司网关和自建兼容服务。
...
![自定义 Provider 表单：Provider ID、Base URL、API 协议、只写凭据与模型列表](/mirror/1b/1be54a4aabb154f05a04db62d3e57855e3c3afda.png)
...
下一篇：[11 · 跑通第一个代码任务](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-11-first-task)。Provider 准备好以后，咱们不再用一句聊天判断成功，而是用一个故意失败的测试建立第一条可验收闭环。
