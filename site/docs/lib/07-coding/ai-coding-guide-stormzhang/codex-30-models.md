...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/codex/30-models.md"
sourceRel: "codex/30-models.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/codex/30-models.md"
sourceSha256: "8c6db5a4d37813fd2bac3d46bac6d861ecf0621e606653141a9ce52b99cc400b"
pageSha256: "8c6db5a4d37813fd2bac3d46bac6d861ecf0621e606653141a9ce52b99cc400b"
...
> 📚 **系列导航**：上一篇〔[29 Slack / Linear 与 SDK 集成](/lib/07-coding/ai-coding-guide-stormzhang/codex-29-integrations)〕讲的是「在别处召唤 Codex、把它嵌进自己产品」的进阶玩法。这一篇把镜头拉回本地最日常的一个决定——**你敲下回车那一刻，背后到底是哪个模型、用多大力气在帮你干活**。下一篇〔[31 进阶技巧与提速](/lib/07-coding/ai-coding-guide-stormzhang/codex-31-speed)〕再讲怎么让整条流程更快更省。
...
![模型档位怎么挑](/mirror/59/59ac40bfbb3f3017404bdd30eee2eb8d2b915f3b.png)
...
**④ 给子代理单独配（分工干活）。** 主代理用旗舰统筹，把简单的批量活儿派给挂着 `gpt-5.6-luna` 的子代理——这是性价比最高的打法，细节见〔[21 子代理（Subagents）](/lib/07-coding/ai-coding-guide-stormzhang/codex-21-subagents) 〕。
...
下一篇〔[31 进阶技巧与提速](/lib/07-coding/ai-coding-guide-stormzhang/codex-31-speed) 〕，咱们从「派谁、用多大力」往前再走一步：聊聊那些能让整条工作流更快、更省、更少返工的进阶技巧。留个小思考——你有没有发现，**很多时候拖慢你的不是模型不够强，而是你给的上下文太乱、让它走了冤枉路**？这恰恰是下一篇要解的题。
