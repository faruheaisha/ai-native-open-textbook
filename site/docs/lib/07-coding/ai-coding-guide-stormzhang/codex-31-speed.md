...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/codex/31-speed.md"
sourceRel: "codex/31-speed.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/codex/31-speed.md"
sourceSha256: "ce59a64068599a6f2f8f85ad6df0d1e8cc296431ce3c0710cfd8ce74fe91ce0f"
pageSha256: "ce59a64068599a6f2f8f85ad6df0d1e8cc296431ce3c0710cfd8ce74fe91ce0f"
...
> 📚 **系列导航**：上一篇「[30 怎么选模型](/lib/07-coding/ai-coding-guide-stormzhang/codex-30-models)」讲的是「同一句话该派哪个模型、配多大推理强度去跑」。这一篇接着往下走——光选对模型还不够，**真正决定你一天能干多少活的，是你怎么喂上下文、怎么管会话、怎么让多条线同时跑**。下一篇「[32 从 Claude Code 迁移](/lib/07-coding/ai-coding-guide-stormzhang/codex-32-migrate-from-claude-code)」再聊老用户怎么平滑搬家。
...
下一篇〔[32 从 Claude Code 迁移](/lib/07-coding/ai-coding-guide-stormzhang/codex-32-migrate-from-claude-code) 〕给一类特定读者：**你是从 Claude Code 转过来的老用户。** `CLAUDE.md` 对应这边的什么？权限模式、Skill、子代理这些概念怎么平移？哪些习惯能直接搬、哪些得改？留个小思考——你在 Claude Code 里养成的哪个习惯，到了 Codex 这边可能反而拖你后腿？下一篇见分晓。
