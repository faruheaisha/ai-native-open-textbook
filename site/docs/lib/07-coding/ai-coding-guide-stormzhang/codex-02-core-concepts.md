...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/codex/02-core-concepts.md"
sourceRel: "codex/02-core-concepts.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/codex/02-core-concepts.md"
sourceSha256: "45b03133090276619dfd2eadcc9fb713aa9de6a3e6ff6da58e1844b0d1d2b6db"
pageSha256: "45b03133090276619dfd2eadcc9fb713aa9de6a3e6ff6da58e1844b0d1d2b6db"
...
> 📚 **系列导航**：上一篇 [01 · 认识 Codex 与四种入口](/lib/07-coding/ai-coding-guide-stormzhang/codex-01-what-is-codex) 带你认全了 Codex 的四张脸——桌面 App、命令行、IDE 扩展、云端。这一篇往里走一层，把后面所有章节都要反复用到的几个核心概念，一次性讲透。下一篇 [03 · 安装与登录](/lib/07-coding/ai-coding-guide-stormzhang/codex-03-install) 再正式动手装。
...
平台上各有各的实现，这点你装的时候会碰到（细节留到 [03 安装与登录](/lib/07-coding/ai-coding-guide-stormzhang/codex-03-install) 讲）：
...
怎么切？日常你不用碰配置文件，在 CLI 会话里一句 `/permissions` 就能当场换模式（桌面 App 和 IDE 里则是输入框旁边的权限选择器）。想让它每次启动都用同一套，再去写配置文件——那是 [18 config.toml 配置详解](/lib/07-coding/ai-coding-guide-stormzhang/codex-18-config) 的活，这里先知道有这么个开关。

下面这张图把沙箱和审批的关系理一遍：

![Codex 审批策略的两层决策三种终态：圈内直接做 / 出圈看策略 / 问你看答案](/mirror/05/05214e768a1d9a6e727893d36f04447e23fbdd58.png)
...
![五个核心概念怎么搭在一起](/mirror/d2/d2bea2012e7f80bacca9ddb0ffbcab063531dc6e.png)
...
> 还没装 Codex？没关系，这一篇先建立概念，[03 安装与登录](/lib/07-coding/ai-coding-guide-stormzhang/codex-03-install) 会手把手带你装好再回来跑。
