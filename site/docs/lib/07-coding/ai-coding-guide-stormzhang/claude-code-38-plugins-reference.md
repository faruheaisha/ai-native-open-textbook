...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/claude-code/38-plugins-reference.md"
sourceRel: "claude-code/38-plugins-reference.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/claude-code/38-plugins-reference.md"
sourceSha256: "248cf0d057bada3d45a62165090ee44af2d22bfe81c0e813468b3fe8f3b15add"
pageSha256: "248cf0d057bada3d45a62165090ee44af2d22bfe81c0e813468b3fe8f3b15add"
...
> 📚 **系列导航**：上一篇 [37 检查点（Checkpoints）](/lib/07-coding/ai-coding-guide-stormzhang/claude-code-37-checkpoints) 教你怎么给会话「存档读档」，改坏了一键回到上一个安全点。这一篇换个层面——**第 24 篇教你「用别人的插件」，这一篇教你「造自己的插件」**：插件的目录到底怎么摆、`plugin.json` 每个字段管什么、能打包哪些组件、依赖怎么写、怎么建市场把它发给团队。这是插件的「参考手册」深度版。
