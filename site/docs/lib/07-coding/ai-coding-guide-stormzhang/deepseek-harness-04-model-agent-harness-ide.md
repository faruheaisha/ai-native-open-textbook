---
title: "04 · 模型、Agent、Harness、IDE 之间是什么关系"
...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/deepseek-harness/04-model-agent-harness-ide.md"
sourceRel: "deepseek-harness/04-model-agent-harness-ide.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/deepseek-harness/04-model-agent-harness-ide.md"
sourceSha256: "9d5713434b8a89675b85651acd3617b340ece266d4385ff6a8a691484b24dd9a"
pageSha256: "9d5713434b8a89675b85651acd3617b340ece266d4385ff6a8a691484b24dd9a"
...
> 📚 **系列导航**：上一篇 [03 · DeepSeek Harness、Claude Code、Codex、OpenCode 怎么选](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-03-model-harness-comparison) 用「模型 + Harness」的尺子量了四款产品。这一篇把视野再拉远：模型、Agent、Harness、IDE、Provider 和执行环境到底怎样连成一条链。
...
![IDE/UI、Harness、Provider、Model、Execution World 与 Session 的六层地图](/mirror/01/01ba6f27440bc00094c8b9a1d451fb9af81c21e2.png)
...
下一篇：[05 · DeepSeek 模型目录、API Key、价格与调用方式](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-05-models-api-pricing)。咱们把实时变化最快的模型和价格集中到一页，并分清官方 API 能力与 Harness 固定版本目录。
