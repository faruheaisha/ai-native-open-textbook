---
title: "18 · PTC 模式（Code Mode）：让模型用代码编排工具"
...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/deepseek-harness/18-ptc-code-mode.md"
sourceRel: "deepseek-harness/18-ptc-code-mode.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/deepseek-harness/18-ptc-code-mode.md"
sourceSha256: "a84613db47eb62125853e14a330c26bbdf6c321720e50eecefaa42169767327a"
pageSha256: "a84613db47eb62125853e14a330c26bbdf6c321720e50eecefaa42169767327a"
...
> 📚 **系列导航**：上一篇 [17 · Standard Mode](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-17-standard-mode) 已经验证固定版向模型直接暴露 25 个原生工具。这一篇保持任务和能力不变，只把工具呈现切到 PTC 模式，观察一个 `run_code` 怎样编排内部调用。
...
![Standard 的 25 个 Native schema 与 PTC 的 run_code 入口共享底层工具注册表与审批执行管线](/mirror/2d/2d1040d18f72f2ecc27cd506254b5d4d3fea2cb2.png)
...
![PTC 轨迹：外层 run_code 展开后可见 description、内部 SUBTOOL dispatch 与外层返回](/mirror/94/9419f6176f5d0df617aedff53918c2d8f0e11e37.png)
...
下一篇：[19 · Minimal 模式](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-19-minimal-mode)。我们会继续缩小变量，只保留最小工具面，看看它为何适合边界测试与能力评测。
