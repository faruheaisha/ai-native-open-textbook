---
title: "13 · Session 与 Trajectory 轨迹"
...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/deepseek-harness/13-session-trajectory.md"
sourceRel: "deepseek-harness/13-session-trajectory.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/deepseek-harness/13-session-trajectory.md"
sourceSha256: "cc8aed5cd269622e1166ad3aaade63d5da5b9d448b33ccf1c3add6639a6d1d08"
pageSha256: "cc8aed5cd269622e1166ad3aaade63d5da5b9d448b33ccf1c3add6639a6d1d08"
...
> 📚 **系列导航**：上一篇 [12 · 查看文件修改、命令执行与审批](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-12-files-shell-approval) 已经把 Tool Call、审批和 Tool Result 串起来。这一篇回答最后一个问题：这些事实保存在哪里，重启后为什么还能看见。
...
![first-task 完整轨迹：Turn 与 Step 标记、Tool Call 与 Tool Result 配对、Token 与耗时统计](/mirror/bc/bc1016d98356e6771ef21fe1f160ff8518b89a45.png)
...
![Session Event Log 派生 Chat、Trajectory、Projection 与冷恢复的关系](/mirror/5c/5cb904ac84dae9183cf886a0a3e252ad32d52b3a.png)
...
下一篇：[16 · 怎么给 Harness 下达任务](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-16-task-instructions)。首个 Agent 闭环完成后，下一步会把任务说明拆成可复用的日常工作方法。
