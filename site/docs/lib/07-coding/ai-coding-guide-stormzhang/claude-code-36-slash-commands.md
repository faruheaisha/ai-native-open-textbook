...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/claude-code/36-slash-commands.md"
sourceRel: "claude-code/36-slash-commands.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/claude-code/36-slash-commands.md"
sourceSha256: "5ab4699019e56ad24d0f8d1d145288d29ec7c527a10a7869e6fb4fe471c828c8"
pageSha256: "5ab4699019e56ad24d0f8d1d145288d29ec7c527a10a7869e6fb4fe471c828c8"
...
> 📚 **系列导航**：上一篇 [35 控制与模式](/lib/07-coding/ai-coding-guide-stormzhang/claude-code-35-modes-and-control) 教你怎么在会话里给 Claude 收紧或放开缰绳（权限模式、`/model`、`/effort` 这些开关）。这一篇把视角拉回到那个你每天都在敲、却未必真摸透的入口——**斜杠命令**。打一个 `/`，从切模型、清上下文到你自己刻的一键流程，全在这一个菜单里。我带你把内置的那批认全，再教你刻几个自己的。
