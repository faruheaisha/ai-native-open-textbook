---
title: "20 · Creator／创造模式：让 Harness 帮你开发 Harness"
...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/deepseek-harness/20-creator-mode.md"
sourceRel: "deepseek-harness/20-creator-mode.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/deepseek-harness/20-creator-mode.md"
sourceSha256: "9e5734fa21ca87080ddbab45f5a9a7d9d4a0ca2e3f37c2ee07feaf67bcfc6f87"
pageSha256: "9e5734fa21ca87080ddbab45f5a9a7d9d4a0ca2e3f37c2ee07feaf67bcfc6f87"
...
> 📚 **系列导航**：上一篇 [19 · Minimal Mode](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-19-minimal-mode) 把工具面压缩到两个。这一篇走到另一个极端：Creator 在 Standard 之上加入运行时检查与动态插件工具，让 Agent 开始观察和扩展 Harness 本身。
...
![Define、Run、Update、回退、Stop、Undefine 与 DSH 重启组成的动态插件生命周期](/mirror/60/60599dd1938b0eef68734e36885777c677fa40f6.png)
...
![Creator 回归轨迹：Inspect 查询、Define 登记、Run 激活、hello 工具返回、Self 诊断与 Stop 撤回](/mirror/eb/eb171c1e869a4cc044af143906b6382eab05ba1f.png)
...
下一篇：[21 · 四种模式应该怎么选](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-21-mode-selection)。我们会把 Standard、PTC、Minimal 和 Creator 放进同一张选择树，不再按名字猜模式。
