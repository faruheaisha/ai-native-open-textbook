...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/claude-code/05-third-party-models.md"
sourceRel: "claude-code/05-third-party-models.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/claude-code/05-third-party-models.md"
sourceSha256: "9d2489a658332a6a96ba36ae0af1f1a110ea7e5fa14b0803363b80e1671a11f1"
pageSha256: "9d2489a658332a6a96ba36ae0af1f1a110ea7e5fa14b0803363b80e1671a11f1"
...
> 📚 **系列导航**：上一篇 [04 · API 配置](/lib/07-coding/ai-coding-guide-stormzhang/claude-code-04-api-config) 讲了怎么用官方 API Key 接通 Claude Code。这一篇换个思路——**把后面那个「大脑」整个换掉**，用 DeepSeek 之类的国产模型来省钱。
...
前提是你已经装好了 Claude Code（没装的回去看 [02 · 安装与使用](/lib/07-coding/ai-coding-guide-stormzhang/claude-code-02-install)）。然后：
...
下一篇 **[06 · Coding Plan：订阅套餐与计费](/lib/07-coding/ai-coding-guide-stormzhang/claude-code-06-coding-plan)**——既然这篇一直在说「省钱」，那就把账算到底：**Claude 的订阅套餐（Pro / Max）和按量付费的 API，到底哪个划算？** 留个问题给你先想想：如果你每天都重度用 Claude Code，是该买订阅，还是接第三方 API 更省？看完下一篇你就有答案了。
