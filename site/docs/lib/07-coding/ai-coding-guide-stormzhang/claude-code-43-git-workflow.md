...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/claude-code/43-git-workflow.md"
sourceRel: "claude-code/43-git-workflow.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/claude-code/43-git-workflow.md"
sourceSha256: "e244265cbd2477c597f05f6c36d23fce85679fe229ae0f894a523c4f5541fb11"
pageSha256: "e244265cbd2477c597f05f6c36d23fce85679fe229ae0f894a523c4f5541fb11"
...
> 📚 **系列导航**：上一篇 [42 环境变量](/lib/07-coding/ai-coding-guide-stormzhang/claude-code-42-env-vars) 把那一堆 `ANTHROPIC_*`、`MCP_*` 开关的作用和优先级理清了。这一篇换个更日常的场景——**怎么让 Claude Code 接手你天天在干的 git 杂活**：看 diff、写 commit、开 PR、解冲突，外加跟 `gh` CLI 打配合。重点不是「它能不能干」，而是**哪些放心交给它、哪一步钥匙必须攥在你自己手里**。
...
![Claude Code Git 工作流：看 diff → 写 commit → 开 PR；push 永远你亲手敲（deny 焊死）](/mirror/67/672f33ed8485545e45005205b2c76de12eff6b41.png)
