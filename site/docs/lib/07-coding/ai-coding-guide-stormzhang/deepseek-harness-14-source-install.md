...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/deepseek-harness/14-source-install.md"
sourceRel: "deepseek-harness/14-source-install.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/deepseek-harness/14-source-install.md"
sourceSha256: "421de45309d444f5c0eff1a895b712b82445974cde2a9a516e583ed10c169b1e"
pageSha256: "421de45309d444f5c0eff1a895b712b82445974cde2a9a516e583ed10c169b1e"
...
> 📚 **系列导航**：上一篇 [44 · 沙箱、fail-closed、文件系统边界与命令安全](https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/deepseek-harness/44-sandbox-security.md) 划清了执行边界。本篇进入开发者路径：不再只运行 npm 成品，而是把固定版本的整个 Harness 仓库装起来、构建出来并确认你运行的确实是自己的源码产物。
...
如果只是使用 DeepSeek Harness，[第 07 篇](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-07-npx-start) 的固定版本 `npx` 是更短、更稳的入口。源码安装不是高级感更强的替代命令，它会把 246 个 workspace、937 个依赖包、构建顺序、Git Hook 和本机类型解析一起带进来。
...
![固定 tag、冻结安装、类型检查、两种构建到 CLI 与 Web 验收的证据链](/mirror/d9/d96aa6b6cd3959171f5362f2bf6826fcc28908bf.png)
...
下一篇：[15 · 升级、降级、卸载与安装排错](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-15-version-maintenance)。
