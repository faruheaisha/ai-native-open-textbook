...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/codex/17-computer-use.md"
sourceRel: "codex/17-computer-use.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/codex/17-computer-use.md"
sourceSha256: "99dfbf9148b6f676c28b07f4de30863e34f537767f97f67f81589fdf0bfc76f1"
pageSha256: "99dfbf9148b6f676c28b07f4de30863e34f537767f97f67f81589fdf0bfc76f1"
...
> 📚 **系列导航**：上一篇 [16 · 安全与风险边界](/lib/07-coding/ai-coding-guide-stormzhang/codex-16-security) 把「Codex 能闯多大祸、边界在哪」这条线画清楚了。这一篇给它再开一扇门——**让 Codex 直接看你的屏幕、点你的桌面应用、开你的浏览器**：测一个原生 App、复现一个只在界面上才出现的 bug、在你登录好的网站里替你点几下。前面所有篇章里 Codex 干的活都在「文件 + 命令行」那一亩三分地，这篇是它头一回伸手碰图形界面。下一篇 [18 · config.toml 配置详解](/lib/07-coding/ai-coding-guide-stormzhang/codex-18-config) 再回到配置文件，把那一摞旋钮一次拧明白。
...
![Codex 电脑操控三条路：公开页用浏览器 / 登录态用 Chrome 扩展 / 桌面 App 才用电脑操控](/mirror/5d/5da49fd8e3bb44b4d6f15ea9379c44ef8d88138c.png)
