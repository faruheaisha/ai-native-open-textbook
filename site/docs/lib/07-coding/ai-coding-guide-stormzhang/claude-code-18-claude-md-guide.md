...
> 📚 **系列导航**：上一篇 [17 图片与多模态](/lib/07-coding/ai-coding-guide-stormzhang/claude-code-17-images-multimodal) 让你学会把截图、报错图直接喂给 Claude。这一篇换个方向——把项目的「规矩」一次性写进它的记忆，让它每次开工都自动遵守，不用你天天复读。
...
![CLAUDE.md 三层级加载：拼接不覆盖](https://gh-proxy.com/https://raw.githubusercontent.com/stormzhang/ai-coding-guide/d187dbdb83fa1be051a850074eb518e30e2eb47c/claude-code/assets/18-claude-md-layers@2x.png)
