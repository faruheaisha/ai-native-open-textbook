...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/deepseek-harness/12-files-shell-approval.md"
sourceRel: "deepseek-harness/12-files-shell-approval.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/deepseek-harness/12-files-shell-approval.md"
sourceSha256: "5697235c492d1a5de5f16df6012425100cf27c0fd0ebe9ccea813e354706a48c"
pageSha256: "5697235c492d1a5de5f16df6012425100cf27c0fd0ebe9ccea813e354706a48c"
...
> 📚 **系列导航**：上一篇 [11 · 跑通第一个代码任务](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-11-first-task) 已经完成「读文件、改代码、跑测试」闭环。这一篇不再只看结果，而是解释每次工具调用如何被检查、拒绝、审批、执行和记录。
...
![Tool Call 经记录、守卫、审批、执行到唯一 Tool Result 的管线](/mirror/2f/2f7096198b3d86b15bac713057c1f3a3c2f79f96.png)
...
![Read Only 下写入被沙箱拒绝后弹出的审批面板：运行中命令、升级理由、拒绝与允许一次](/mirror/3f/3f191b5c0c4571c4e64df11077141b957815d45a.png)
...
下一篇：[13 · Session 与 Trajectory 轨迹](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-13-session-trajectory)。工具管线产生的每一条事实，接下来都会回到同一个持久事件账本里。
