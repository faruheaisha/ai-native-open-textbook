---
title: "17 · Standard Mode：完整编码 Agent"
...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/deepseek-harness/17-standard-mode.md"
sourceRel: "deepseek-harness/17-standard-mode.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/deepseek-harness/17-standard-mode.md"
sourceSha256: "0a7370e8dd515ce92d82f6f951a17fafb113d6d484194181e6f0f55d65f8df5e"
pageSha256: "0a7370e8dd515ce92d82f6f951a17fafb113d6d484194181e6f0f55d65f8df5e"
...
> 📚 **系列导航**：上一篇 [16 · 怎么给 Harness 下达任务](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-16-task-instructions) 已经把目标、范围和验证写成执行合同。这一篇进入默认的 Standard Mode，看看模型收到的 25 个原生工具怎样把合同变成行动。
...
Standard 的 25 个直接 schema 与 PTC 单一 `run_code` 入口如何落到同一套底层工具与安全管线，见下一篇 [18 · PTC 模式（Code Mode）](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-18-ptc-code-mode) 的「Native 与 Code Mode 工具呈现对照」图。
...
下一篇：[18 · PTC 模式（Code Mode）](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-18-ptc-code-mode)。工具能力不变，但模型看到的入口会从 25 个 Native schema 收敛成一个 `run_code`。
