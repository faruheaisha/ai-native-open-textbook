...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/codex/03-install.md"
sourceRel: "codex/03-install.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/codex/03-install.md"
sourceSha256: "6f923ec25a5a8d03184f0e48ff3efd99cccb324b1448427d826e2fb7e9006b68"
pageSha256: "6f923ec25a5a8d03184f0e48ff3efd99cccb324b1448427d826e2fb7e9006b68"
...
> 📚 **系列导航**：上一篇 [02 · 核心概念速览](/lib/07-coding/ai-coding-guide-stormzhang/codex-02-core-concepts) 把 Codex 的几个关键词（代理、沙箱、审批、本地 / 云端）讲明白了。这一篇带你真正把它装到自己电脑上——**桌面 App 和 CLI 两条线都覆盖**，登录授权、三平台差异、常见装机故障一次说透。下一篇 [04 · 订阅与计费](/lib/07-coding/ai-coding-guide-stormzhang/codex-04-pricing) 再聊钱的事。
...
账号和计费的细节，下一篇 [04 · 订阅与计费](/lib/07-coding/ai-coding-guide-stormzhang/codex-04-pricing) 专门展开。本篇默认你手里有一个能用的 ChatGPT 套餐或 API key。
...
![Codex 桌面 App 主界面：左侧导航、中间任务输入、连接卡片](/mirror/24/24d4c529791f61d8be56ecc1530892a43c609f11.png)
...
![两条安装线：桌面 App 与 CLI](/mirror/a8/a8898cefa62d55e20101cc48e9f8372ea0fcd2b8.png)
...
![Windows 装 Codex 的三条路：WSL2 / 原生 elevated 沙箱 / 原生 unelevated 沙箱](/mirror/bc/bc92070080ca90713ac600dc26709820f3cf0f97.png)
...
![第一次跑通 Codex 的完整循环：mkdir → codex 登录 → 大白话指令 → 审批 → Git 检查点](/mirror/f5/f58664c9f7e7eb8cf5a1ca21aca4b7c0626f4e34.png)
...
下一篇 **[04 · 订阅与计费](/lib/07-coding/ai-coding-guide-stormzhang/codex-04-pricing)**——把钱的事说透：ChatGPT 各档套餐分别给多少 Codex 额度？API key 按量付费到底怎么算？跟 Claude Code 比哪个更划算？刚装好正想撒欢用，先搞清楚自己手里的账号每天能用多少，免得跑到一半被限额拦下来。
