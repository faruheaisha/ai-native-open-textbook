...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/codex/22-skills.md"
sourceRel: "codex/22-skills.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/codex/22-skills.md"
sourceSha256: "8e4e9f2ce9a18dd8cb3b47ec37fbb597180ab054859e512beb61a4e07a69e7ac"
pageSha256: "8e4e9f2ce9a18dd8cb3b47ec37fbb597180ab054859e512beb61a4e07a69e7ac"
...
> 📚 **系列导航**：上一篇〔[21 子代理（Subagents）](/lib/07-coding/ai-coding-guide-stormzhang/codex-21-subagents)〕讲的是「把一个重活拆出去、丢给一个独立上下文的小助手干完再收结果」。这一篇换个角度：不拆任务，而是**封装能力**——把一套你反复交代的固定流程打包成 Agent Skills，让 Codex 在该用的时候自己调出来。下一篇〔[23 插件（Plugins）](/lib/07-coding/ai-coding-guide-stormzhang/codex-23-plugins)〕再讲怎么把这身本事打包、分发给别人装。
...
![Skills 渐进式披露两阶段](/mirror/83/83e9d6586c2e211414986dfb5e28090c5e5887cd.png)
...
下一篇 **〔[23 插件（Plugins）](/lib/07-coding/ai-coding-guide-stormzhang/codex-23-plugins) 〕**——这一篇你学会了把一套活儿封成 Skill，可它默认只在你自己机器、你自己仓库里转。要是想把这身本事**打包好、让队友或社区一键装上**呢？官方给的答案就是 Plugins——「Skill 是编写格式，Plugin 是分发格式」。下一篇就讲怎么把一个或多个 Skill 连同配置一起打成插件、装到别人那儿去。留个小思考：你这一篇写的 `explain-self`，要是想让整个团队都用上，光提交进仓库够不够，还差哪一步？
