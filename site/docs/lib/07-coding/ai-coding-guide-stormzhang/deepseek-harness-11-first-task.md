...
entryUrl: "https://github.com/stormzhang/ai-coding-guide/blob/d187dbdb83fa1be051a850074eb518e30e2eb47c/deepseek-harness/11-first-task.md"
sourceRel: "deepseek-harness/11-first-task.md"
rawUrl: "/raw/07-coding/ai-coding-guide-stormzhang/deepseek-harness/11-first-task.md"
sourceSha256: "68ecf267e738c2dbf68666a2977b22165facc49bd402923668b6994afbe5f553"
pageSha256: "68ecf267e738c2dbf68666a2977b22165facc49bd402923668b6994afbe5f553"
...
> 📚 **系列导航**：上一篇 [10 · 配置第三方与自定义 Provider](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-10-custom-provider) 已经把模型通道准备好。这一篇用一个故意写错的函数，把「发消息」升级成「有失败基线、有文件改动、有测试结果」的代码任务。
...
![从创建错误项目、失败基线、Agent 修复到用户独立复验的闭环](/mirror/f4/f4a870b946ef3da1a83f31257c4de93b613b0bc1.png)
...
下一篇：[12 · 查看文件修改、命令执行与审批](/lib/07-coding/ai-coding-guide-stormzhang/deepseek-harness-12-files-shell-approval)。第一次任务跑通后，咱们把背后的工具管线和权限决定逐层拆开。
