---
title: "Chapter 6: Going Live — Deployment, Sharing, and the First Round of Real Feedback"
...
entryUrl: "https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/en/Basic/06-launch/index.md"
sourceRel: "docs/en/Basic/06-launch/index.md"
rawUrl: "/raw/07-coding/vibe-vibe/docs/en/Basic/06-launch/index.md"
sourceSha256: "fa1440e39e3baf4a4dd07437d2e9d8662c1d9b8ed2de0d8544ff66b2c52c374e"
pageSha256: "fa1440e39e3baf4a4dd07437d2e9d8662c1d9b8ed2de0d8544ff66b2c52c374e"
...
|------|----------------|
| [6.1 Why “going live” comes last, and the pre-launch checklist](/lib/07-coding/vibe-vibe/docs-en-Basic-06-launch-6.1-preflight) | Confirm that the current version is ready to be shown to others |
| [6.2 Push your code to a remote repository, and deploy with EdgeOne Pages](/lib/07-coding/vibe-vibe/docs-en-Basic-06-launch-6.2-deploy) | Complete the minimal publishing loop from local project to public link |
| [6.3 Run post-launch self-tests and gather the first round of real feedback](/lib/07-coding/vibe-vibe/docs-en-Basic-06-launch-6.3-feedback) | Confirm that your project works in a real environment and get the first batch of external signals |
| [6.4 Wrapping up the basic edition: you’ve gone from “having an idea” to “having a project”](/lib/07-coding/vibe-vibe/docs-en-Basic-06-launch-6.4-wrap-up) | Look back on how far you’ve come, and see where you can go next |
...
[Go to 6.1: Why “going live” comes last, and the pre-launch checklist →](/lib/07-coding/vibe-vibe/docs-en-Basic-06-launch-6.1-preflight)
