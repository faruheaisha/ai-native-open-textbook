...
entryUrl: "https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/en/Advanced/01-environment-setup/06-models-and-tools.md"
sourceRel: "docs/en/Advanced/01-environment-setup/06-models-and-tools.md"
rawUrl: "/raw/07-coding/vibe-vibe/docs/en/Advanced/01-environment-setup/06-models-and-tools.md"
sourceSha256: "e7c9a558897a66dd698691e79366ed9b4de9e6c8868a55c5b82cfdcf7626e28a"
pageSha256: "e7c9a558897a66dd698691e79366ed9b4de9e6c8868a55c5b82cfdcf7626e28a"
...
If you haven't installed Claude Code and configured a model yet, please refer to [1.0 Quick Start](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-00-quick-start) to complete the installation and setup.
...
If you have already configured the GLM model by following [1.0 Quick Start](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-00-quick-start), you can skip this section.
...
- See also: [Chapter 2 AI Prompting Guide](https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/en/Advanced/02-ai-tuning-guide/README.md)
- See also: [2.2 Detailed VibeCoding Workflow](/lib/07-coding/vibe-vibe/docs-en-Advanced-02-ai-tuning-guide-02-vibecoding-workflow)
- Prerequisite: [1.0 Quick Start](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-00-quick-start)
- Prerequisite: [1.4 Getting Started with the Terminal](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-04-terminal-basics)
- Prerequisite: [1.5 Package Management and Project Configuration](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-05-package-manager-and-config)
