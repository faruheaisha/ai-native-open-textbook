...
entryUrl: "https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/Advanced/04-dev-fundamentals/index.md"
sourceRel: "docs/Advanced/04-dev-fundamentals/index.md"
rawUrl: "/raw/07-coding/vibe-vibe/docs/Advanced/04-dev-fundamentals/index.md"
sourceSha256: "6c83b4dd1bdfdc37a6cb28f818be4d5a36e307d112b119b424241b9d581a315a"
pageSha256: "6c83b4dd1bdfdc37a6cb28f818be4d5a36e307d112b119b424241b9d581a315a"
...
> [4.0 代码运行的三种状态](/lib/07-coding/vibe-vibe/docs-Advanced-04-dev-fundamentals-00-build-basics) 🟢 - 理解 Dev、Build、Production 三种运行模式
...
> [4.1 技术栈决策框架](/lib/07-coding/vibe-vibe/docs-Advanced-04-dev-fundamentals-01-tech-stack-decision) 🟡 - 系统化地选择合适的技术栈
...
> [4.3 如何读懂 AI 生成的代码](/lib/07-coding/vibe-vibe/docs-Advanced-04-dev-fundamentals-03-programming-basics) 🟢 - 理解代码的四个核心概念
...
> [4.2 从 PRD 到技术文档](/lib/07-coding/vibe-vibe/docs-Advanced-04-dev-fundamentals-02-prd-and-tech-docs) 🟢 - 理解产品文档与技术文档的分工
...
> [4.4 API与HTTP基础](/lib/07-coding/vibe-vibe/docs-Advanced-04-dev-fundamentals-04-api-and-http) 🟢 - 掌握 API 和 HTTP 协议的工作原理
...
> [4.5 前后端分离概念](/lib/07-coding/vibe-vibe/docs-Advanced-04-dev-fundamentals-05-frontend-backend-separation) 🟢 - 理解前后端分离的架构与交互
...
> [4.6 配置文件格式](/lib/07-coding/vibe-vibe/docs-Advanced-04-dev-fundamentals-06-config-formats) 🟢 - 理解 JSON 和 YAML 配置格式
...
> [4.7 API集成实战](/lib/07-coding/vibe-vibe/docs-Advanced-04-dev-fundamentals-07-api-integration) 🟢 - 从零开始集成外部 API
...
> [4.8 项目说明书结构](/lib/07-coding/vibe-vibe/docs-Advanced-04-dev-fundamentals-08-readme-structure) 🟢 - 编写完整的项目 README.md 文档
...
**上一章**：[第三章：产品思维与文档驱动](/lib/07-coding/vibe-vibe/docs-Advanced-03-prd-doc-driven)

**下一章**：[第五章：界面(UI)与交互(UX)](/lib/07-coding/vibe-vibe/docs-Advanced-05-ui-ux)
