...
entryUrl: "https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/en/Advanced/07-backend-api/index.md"
sourceRel: "docs/en/Advanced/07-backend-api/index.md"
rawUrl: "/raw/07-coding/vibe-vibe/docs/en/Advanced/07-backend-api/index.md"
sourceSha256: "d7d8f108de918cdf9062547c47ad1df100aa612942fdaf72def78a732878261e"
pageSha256: "d7d8f108de918cdf9062547c47ad1df100aa612942fdaf72def78a732878261e"
...
| Section | Content |
|------|------|
| [7.0 Get Your First Full-Stack App Working](/lib/07-coding/vibe-vibe/docs-en-Advanced-07-backend-api-00-crud-example) | Build a Todo app hands-on and experience the complete full-stack data flow |
| [7.1 One Endpoint Is No Longer Enough](/lib/07-coding/vibe-vibe/docs-en-Advanced-07-backend-api-01-api-growing-pains) | Relational queries, pagination, filtering, and sorting—what to do when data volume and requirements grow |
| [7.2 When an Endpoint Breaks](/lib/07-coding/vibe-vibe/docs-en-Advanced-07-backend-api-02-when-things-go-wrong) | Parameter validation, idempotency, and error handling—the first pitfalls after going live |
| [7.3 Making Endpoints Easier to Use](/lib/07-coding/vibe-vibe/docs-en-Advanced-07-backend-api-03-api-as-product) | Versioning, API documentation, and batch operations—treating APIs like products and refining them |
