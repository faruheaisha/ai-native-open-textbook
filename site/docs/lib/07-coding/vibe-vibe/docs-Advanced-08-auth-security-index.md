...
**上一章**：[第七章：后端API开发](/lib/07-coding/vibe-vibe/docs-Advanced-07-backend-api-index)

**下一章**：[第九章：功能测试流程与自动化脚本](/lib/07-coding/vibe-vibe/docs-Advanced-09-testing-automation-index)
