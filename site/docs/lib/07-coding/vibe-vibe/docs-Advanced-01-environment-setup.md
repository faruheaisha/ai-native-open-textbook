...
> **想直接开始？** 查看 **[1.0 快速开始](/lib/07-coding/vibe-vibe/docs-Advanced-01-environment-setup-00-quick-start)**，5 分钟完成环境安装。
...
→ **[1.2 认识技术栈](/lib/07-coding/vibe-vibe/docs-Advanced-01-environment-setup-02-tech-stack)** 和 **[1.3 浏览器与服务器基础](/lib/07-coding/vibe-vibe/docs-Advanced-01-environment-setup-03-browser-server)** 会帮你建立这些认知。
...
→ **[1.4 终端入门](/lib/07-coding/vibe-vibe/docs-Advanced-01-environment-setup-04-terminal-basics)** 会教你掌握命令行的基本操作，**[1.5 包管理与项目配置](/lib/07-coding/vibe-vibe/docs-Advanced-01-environment-setup-05-package-manager-and-config)** 会带你完成这些配置。
...
→ **[1.5 包管理与项目配置](/lib/07-coding/vibe-vibe/docs-Advanced-01-environment-setup-05-package-manager-and-config)** 会详细讲解 nvm 和 pnpm 的工作原理。
...
→ **[1.6 模型与工具](/lib/07-coding/vibe-vibe/docs-Advanced-01-environment-setup-06-models-and-tools)** 会详细介绍各类开发工具的选择和配置。

### 文件夹命名

现在，你拥有了完整的现代化开发环境，可以处理任何 AI 生成的 TS 代码了。老师傅特意叮嘱：**新建项目时，务必新建一个不含有中文、空格的文件夹**。这是因为许多底层的开发工具对非英文字符支持不佳，中文路径往往是各种离奇报错的根源。

→ **[1.7 创建项目](/lib/07-coding/vibe-vibe/docs-Advanced-01-environment-setup-07-creating-project)** 会教你从文件夹命名规范到项目模板创建。
...
→ **[1.8 Localhost 与端口](/lib/07-coding/vibe-vibe/docs-Advanced-01-environment-setup-08-localhost-and-ports)** 会详细讲解这些网络基础。
