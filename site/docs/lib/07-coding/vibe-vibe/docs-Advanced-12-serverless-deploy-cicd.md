...
entryUrl: "https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/Advanced/12-serverless-deploy-cicd/index.md"
sourceRel: "docs/Advanced/12-serverless-deploy-cicd/index.md"
rawUrl: "/raw/07-coding/vibe-vibe/docs/Advanced/12-serverless-deploy-cicd/index.md"
sourceSha256: "bfdecd56eb3885de71c1f6bdfdf031e9b92c3336c3578b6be552a103d15ca1d9"
pageSha256: "bfdecd56eb3885de71c1f6bdfdf031e9b92c3336c3578b6be552a103d15ca1d9"
...
1. [部署到 EdgeOne Pages](/lib/07-coding/vibe-vibe/docs-Advanced-12-serverless-deploy-cicd-01-deploy-edgeone) → 手把手完成第一次部署，拿到公网链接
2. [部署到类 Vercel 平台](/lib/07-coding/vibe-vibe/docs-Advanced-12-serverless-deploy-cicd-02-deploy-vercel-platforms) → 了解更多平台选择，找到最适合你的
3. [CI/CD 与自动化](/lib/07-coding/vibe-vibe/docs-Advanced-12-serverless-deploy-cicd-03-cicd-automation) → 推送即部署，让自动化接管重复劳动
4. [运维基础与成本优化](/lib/07-coding/vibe-vibe/docs-Advanced-12-serverless-deploy-cicd-04-operations-cost) → 上线之后谁来看着它，怎么控制成本

**AI 编程时代的部署**：告诉 AI 目标平台，它会帮你完成配置和部署。

---

**上一章**：[第十一章：Git 版本控制与跨平台协作](/lib/07-coding/vibe-vibe/docs-Advanced-11-git-collaboration)

**下一章**：[第十三章：域名、DNS 与 HTTPS](/lib/07-coding/vibe-vibe/docs-Advanced-13-domain-dns)
