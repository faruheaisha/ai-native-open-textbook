...
entryUrl: "https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/en/Advanced/04-dev-fundamentals/02-prd-and-tech-docs.md"
sourceRel: "docs/en/Advanced/04-dev-fundamentals/02-prd-and-tech-docs.md"
rawUrl: "/raw/07-coding/vibe-vibe/docs/en/Advanced/04-dev-fundamentals/02-prd-and-tech-docs.md"
sourceSha256: "99ed310fb77e7310ef0d8cb0667f927d2ba880aef1da7b36466d4eaa77450b01"
pageSha256: "99ed310fb77e7310ef0d8cb0667f927d2ba880aef1da7b36466d4eaa77450b01"
...
- Prerequisite: [3.3 PRD Writing in Practice](/lib/07-coding/vibe-vibe/docs-en-Advanced-03-prd-doc-driven-03-prd-template-guide)
- Prerequisite: [4.1 Technology Stack Decision Framework](/lib/07-coding/vibe-vibe/docs-en-Advanced-04-dev-fundamentals-01-tech-stack-decision)
- Details: [4.3 How to Read AI-Generated Code](/lib/07-coding/vibe-vibe/docs-en-Advanced-04-dev-fundamentals-03-programming-basics)
- Details: [4.4 API and HTTP Fundamentals](/lib/07-coding/vibe-vibe/docs-en-Advanced-04-dev-fundamentals-04-api-and-http)
- Details: [4.5 Frontend-Backend Separation Concepts](/lib/07-coding/vibe-vibe/docs-en-Advanced-04-dev-fundamentals-05-frontend-backend-separation)
- Details: [4.6 Configuration File Formats](/lib/07-coding/vibe-vibe/docs-en-Advanced-04-dev-fundamentals-06-config-formats)
- Details: [4.7 API Integration in Practice](/lib/07-coding/vibe-vibe/docs-en-Advanced-04-dev-fundamentals-07-api-integration)
