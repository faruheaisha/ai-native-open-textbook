...
entryUrl: "https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/Advanced/happy-coder.md"
sourceRel: "docs/Advanced/happy-coder.md"
rawUrl: "/raw/07-coding/vibe-vibe/docs/Advanced/happy-coder.md"
sourceSha256: "33936427a3d24b110f82f3b9ea8f8fb967d61aa3051dc0d66f4fa8104aa970a0"
pageSha256: "33936427a3d24b110f82f3b9ea8f8fb967d61aa3051dc0d66f4fa8104aa970a0"
...
![img](/mirror/0d/0d24c37ab0ebab52d1d49e70da9de9785f6fb152.png)
...
![AA332EC147F2DC33DBF646428A1BFDDC](/mirror/d1/d12931ab09378f0a1574c5528a98af3bd7ad0deb.jpg)
...
![image-20260131001148941](/mirror/67/679c60cd9e03b11bd7120e9087c473daf6f59797.png)
...
![image-20260131021033116](/mirror/db/db1c4693edae62b9fbe5680621a358dad76f2874.png)
...
![image-20260131034907440](/mirror/f8/f8b6492ab4e3241516514515393df40c4869dd62.png)
...
![image-20260121191356935](/mirror/ab/ab68299fdaa81c5948434bf3f1fb1bea7dc9a6d5.png)

运行 `happy claude` 指令后，选择什么终端进行身份验证（Mobile App 或 Web Browser）

![image-20260122210939700](/mirror/47/4714414087107054b253eede39d59ad32413b2d3.png)
...
![image-20260122210432625](/mirror/b9/b917cfc6650746ce05d42ec9c77be516048b9fc2.png)

当选择 `Web Browser` 后，会自动跳转弹出浏览器窗口，如下图

![image-20260121181508114](/mirror/17/17122f3685ba0bf48cc8364866702c56b4bee3ad.png)

### 3.1、第一次接受连接会失败

第一次点击 “接受连接” 可能会连接终端失败，不过不要慌 ！

![image-20260121182200139](/mirror/75/75510c4315134edf7baa29571e7f96db7a3bf4c1.png)

只需要打开 Happy Coder 的官网 [https://happy.engineering](https://happy.engineering/) 点击 “Launch Web App” （启动 Web 应用）

![image-20260121182844980](/mirror/40/408eadf943e6cad17c536ce8b9ebf85813b1615c.png)

### 3.2、创建账户

点击 “Launch Web App” 按钮后会跳转 应用登录页面，先创建账户

![image-20260121182628650](/mirror/b9/b98add7d9ac189a0ee60e08870ab9ecbf69ca1d9.png)

点击 “创建账户” 后，会进入 “Web Browser” （网页浏览器）模式，会显示终端连接成功

![image-20260121185336273](/mirror/4b/4b4fbaf25a74ef6cf985e4366ebbe4b349164728.png)

点击 “启动新会话” 后，在文本框中输入 “你好” 测试，错误提示 “选择一台设备以启动会话”

![image-20260121190528627](/mirror/89/89ecc21efd91ba47af2835403958890290116188.png)

再返回浏览器 “连接终端页面”，右键选择 “重新加载” 刷新一次当前页面，再次点击 “连接终端” 按钮

![image-20260122133741436](/mirror/b7/b7aa331aad0fb539cbcc3a40e47c29f6368b1c7d.png)

### 3.2、终端连接成功

刷新浏览器页面后，重新点击 “接受连接” 按钮，显示 “终端连接成功”，终端也发生了变化

![image-20260122174624545](/mirror/b0/b0b82f37c88fd524e3ea9cbcac91480d7ffc173c.png)

当点击 “确定按钮” 后，再次点击左侧对话列表中的，当前终端目录就可以进入对话模式

![image-20260122175007857](/mirror/ec/eca0a1f882388c8421222b3594b0eb9a47255e8e.png)

### 3.3、开启会话，发送指令即可在浏览器中随意使用 Claude Code

点击左侧列表的当前对话后，页面即进入对话模式，同时终端也会实时同步

![image-20260122180649958](/mirror/fc/fc961641c208a8ccbc9a2bfb29975fbb5fcd9edd.png)

接下来就跟之前在 Claude Code 终端中开发项目一样，就不用那个黑窗口终端了（记住：终端不能关闭）

![image-20260122180854765](/mirror/77/7723283f02ef1d013bf7410edce309b9ef04612c.png)

当我们在终端按下 `Ctrl + C` 时，happy claude 就会退出会话，同时浏览器网页端也会退出会话

![image-20260122204025422](/mirror/b4/b41fd48a69cf0d445207b4bab482f2352481a858.png)

再次连接，只需要在终端输入 `happy claude` 指令，浏览器端就会自动连接开启会话，终端也会自动进入 Claude Code 开启会话，无需再做任何验证。

![image-20260122205314503](/mirror/97/97650bea05c9a59698eb049b7bf9df6812ef8d31.png)
...
![image-20260125235204925](/mirror/86/86890eaa149bc7fd58f4ca4ed03b2afc9636647c.png)

选择 "y" ，确认退出登录

![image-20260126030118571](/mirror/ad/ad4ff509281058a6b79671da309d6ca6ea8556b8.png)
...
![image-20260122210244474](/mirror/a3/a38765391a6c72db57bf514c7be82b33dabdc1db.png)
...
![image-20260126030816690](/mirror/0b/0b14d8bf42718b4875eb9833a3d1674b460b73c2.png)
...
<img src="/mirror/28/288f3af9825239b3aa03a4a5349be1ea100d3a76.png" alt="image-20260126040729755" style="zoom: 20%;" />
...
<img src="/mirror/89/8988c7bf4c83a7e0d05750cb6b3613485f95b03e.png" alt="image-20260126041817239" style="zoom:20%;" />
...
<img src="/mirror/cc/ccc731cb76fc22d2091c1fa3e8f605edc1687693.png" alt="image-20260126044357499" style="zoom: 50%;" />

当用户在移动端发出指令后，会实时同步到电脑端的 Claude Code 完成与模型的会话

![image-20260126044604246](/mirror/a6/a6f39161a7f065e20e703f4a48e89c6cb9384e4a.png)
...
![image-20260201045344280](/mirror/82/820ac387e726c7392cadb4325153a180ff5f2eb9.png)
...
![image-20260201040412804](/mirror/8a/8af78d4b4cd40be793f4343533e0601b071fcc2c.png)
...
![image-20260201044503810](/mirror/db/dba00db2eb1b799da05d7981d7792a500d13cde1.png)
...
![image-20260201040810890](/mirror/c2/c237d51874754de0a2d0f0bbf55f5f69214d8f96.png)
...
![image-20260201042041634](/mirror/06/06203f020700443dc91ad0b70600166b2f733716.png)
...
![image-20260201042214018](/mirror/dc/dc64bcbba240031b2bec0113b125e78efd7dd341.png)
...
![image-20260206210230299](/mirror/13/1350488ee38b8b2706e7e14d29af96d9797a794f.png)

选择个人版，使用支付宝登录

![image-20260202222641438](/mirror/13/1370fa99c57d562a717524efac753f120399ae38.png)

新用户第一次注册，可免费试用一个月（学习使用完全够用）

![image-20260203190342789](/mirror/05/05389513fdeee96f36574d6003bf00514d3693c4.png)
...
![image-20260203224450286](/mirror/25/25427498bc6fc7ee7d4310d79b5fda97189dda0d.png)
...
![image-20260203224822787](/mirror/c4/c4ccba2de01c400f24fff2ccea1b0b9197c6bb7b.png)

点击立即下单即可

![image-20260203230146847](/mirror/48/4825664cdec4b5bef3195971bdf19276dd5fef70.png)

下单成功后，扫描开通免密支付

> 注：自动续费可以去支付宝取消即可。不影响新注册免费用政策，后续不用也不会继续收费，不用担心

![image-20260203235745450](/mirror/d2/d2aa878fa4468f0362a71bd0fa5405ef7bf98b23.png)

支付宝扫码成功后，点击 “已完成开通并授权扣款” 按钮

![image-20260204000019220](/mirror/02/02a3bd4b2ad677e5594d3c768f1339c77ec3e7ac.png)

进入订购成功页面

![image-20260204000140841](/mirror/d0/d06f9a27665c07c8c32982177efce24ff7dda69f.png)

可关闭订购成功页面，进入无影云电脑客户端首页，直接点击 “连接” 按钮 即可进入云电脑

![image-20260204000837531](/mirror/d7/d7e9c91b4a5dd10a3eb190cdf53bc5b6a4a31bec.png)

第一次进入默认是 Windows 系统，所有操作跟本地电脑一模一样

![image-20260204001044451](/mirror/eb/eba5b16f8226ba819d0783e1045740bc8cc2c65e.png)
...
![image-20260204002406928](/mirror/b9/b9c512469fd3f0fa11fc9b50dcabd1f7bb56ad2c.png)

确定后，再次确认即可切换操作系统

![image-20260204002601380](/mirror/79/7980adaec18001ee3cbdb07d218bfd5161ecd1e8.png)

系统切换成功后，进入 Linux 系统

![image-20260204210109896](/mirror/da/daa42d9b29a659c3856874d03fd8cb24b28005e7.png)
...
![image-20260204220317499](/mirror/d4/d4c247600364c22787369d68d86a61eddf0d9786.png)
...
![image-20260205223928504](/mirror/42/42f17d5f142a640f99dae88f8c8c8f547f1cb8e2.png)
...
![image-20260205194841161](/mirror/1e/1e20d27da544785481ccc18f5111bdc5033a58ef.png)

- 安装成功后，使用 `happy claude` 选择 Mobile App 终端进行身份验证，回车确认

![image-20260205195159053](/mirror/41/4126e73710849d56ed462ca87420da892bf9c161.png)
...
![image-20260205202715658](/mirror/14/14454c2d68ba33a2c0f2164f0e39c7bfc706fc57.png)

### 5.1、在手机端 Happy App 上连接云电脑终端

打开手机端 Happy App 通过扫描二维码 或 手动输入 URL 进行身份验证，输入提示词即可连接云电脑上 Claude Code 进行项目的开发

![image-20260205205229841](/mirror/62/6239f1a87b7616aaca0c22b7fe36f1f301599664.png)

同时云电脑端的 Claude Code 也会同步

![image-20260205205508549](/mirror/07/0732d4fa0122d33b21fc20820826e7944621e0e7.png)
...
![image-20260205210533916](/mirror/e5/e5f015897bd1907c6c89f88e5ae357c6bab0780f.png)
