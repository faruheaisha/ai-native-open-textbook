...
entryUrl: "https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/Advanced/14-vps-ops-deploy/index.md"
sourceRel: "docs/Advanced/14-vps-ops-deploy/index.md"
rawUrl: "/raw/07-coding/vibe-vibe/docs/Advanced/14-vps-ops-deploy/index.md"
sourceSha256: "bd08215f8223a3f58dbf82e66f5531bb55e74250518980ab50cf8f5aa9c6e86c"
pageSha256: "bd08215f8223a3f58dbf82e66f5531bb55e74250518980ab50cf8f5aa9c6e86c"
...
1. [14.1 VPS 选购指南](/lib/07-coding/vibe-vibe/docs-Advanced-14-vps-ops-deploy-01-vps-selection) — 主流云厂商对比、配置选择、机房位置、操作系统选择
2. [14.2 VPS 初始化与安全配置](/lib/07-coding/vibe-vibe/docs-Advanced-14-vps-ops-deploy-02-vps-setup) — SSH 连接、安全组设置、1Panel 安装、安全加固
3. [14.3.1 应用商店与 Docker 基础](/lib/07-coding/vibe-vibe/docs-Advanced-14-vps-ops-deploy-03-1-docker-apps) — Docker 核心概念、应用商店、容器管理、数据持久化、容器网络
4. [14.3.2 部署 Next.js 应用](/lib/07-coding/vibe-vibe/docs-Advanced-14-vps-ops-deploy-03-2-deploy-nextjs) — 运行环境配置、环境变量、构建启动、端口映射
5. [14.3.3 部署静态网站](/lib/07-coding/vibe-vibe/docs-Advanced-14-vps-ops-deploy-03-3-deploy-static) — OpenResty 静态站点、文件上传、SPA 路由、缓存策略
6. [14.3.4 部署前后端分离应用](/lib/07-coding/vibe-vibe/docs-Advanced-14-vps-ops-deploy-03-4-deploy-fullstack) — 多容器编排、反向代理、环境变量管理、数据备份
7. [14.4 配置域名与证书](/lib/07-coding/vibe-vibe/docs-Advanced-14-vps-ops-deploy-04-domain-ssl) — DNS 解析、SSL 证书申请、HTTPS 跳转、证书续期
8. [14.5 其他好玩的应用](/lib/07-coding/vibe-vibe/docs-Advanced-14-vps-ops-deploy-05-cool-apps) — Umami 统计、n8n 自动化、Uptime Kuma 监控

---

**上一章**：[第十三章：域名、DNS 与网络接入](/lib/07-coding/vibe-vibe/docs-Advanced-13-domain-dns)

**下一章**：[第十五章：SEO、分享与数据统计](/lib/07-coding/vibe-vibe/docs-Advanced-15-seo-analytics)
