...
entryUrl: "https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/en/Advanced/08-auth-security/index.md"
sourceRel: "docs/en/Advanced/08-auth-security/index.md"
rawUrl: "/raw/07-coding/vibe-vibe/docs/en/Advanced/08-auth-security/index.md"
sourceSha256: "121bc82567b7c4b161231e9aa91f3b0ef925ab94340dbdf01c630ad6a1db0c26"
pageSha256: "121bc82567b7c4b161231e9aa91f3b0ef925ab94340dbdf01c630ad6a1db0c26"
...
| Section | Content |
|------|------|
| [8.0 Quick User System Example](/lib/07-coding/vibe-vibe/docs-en-Advanced-08-auth-security-00-user-system-example) | Use Better Auth to get registration, login, and protected pages working, and build intuition for authentication |
| [8.1 Secret Management and Environment Variables](/lib/07-coding/vibe-vibe/docs-en-Advanced-08-auth-security-01-env-and-secrets) | `.env`, `.gitignore`, Server vs Client boundaries, and cloud configuration |
| [8.2 Authentication Methods and Choosing an Approach](/lib/07-coding/vibe-vibe/docs-en-Advanced-08-auth-security-02-auth-methods) | Session vs Token, OAuth, Passkeys, Better Auth vs other approaches |
| [8.3 Route Protection and Access Control](/lib/07-coding/vibe-vibe/docs-en-Advanced-08-auth-security-03-route-protection) | Middleware, CORS, page-level vs API-level protection, and role permissions |
| [8.4 Security Checks and Troubleshooting](/lib/07-coding/vibe-vibe/docs-en-Advanced-08-auth-security-04-security-checklist) | Checklists for before/during/after development + a symptom → cause → solution diagnostic guide |
| [8.5 Advanced Security Protection](/lib/07-coding/vibe-vibe/docs-en-Advanced-08-auth-security-05-advanced-security) | Protection against SQL injection/XSS/CSRF, AI application security, and dependency auditing |

---

**Previous Chapter**:[Chapter 7: Backend API Development](/lib/07-coding/vibe-vibe/docs-en-Advanced-07-backend-api)

**Next Chapter**:[Chapter 9: Functional Testing Workflows and Automation Scripts](/lib/07-coding/vibe-vibe/docs-en-Advanced-09-testing-automation)
