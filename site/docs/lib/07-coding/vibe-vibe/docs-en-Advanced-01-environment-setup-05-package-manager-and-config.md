...
entryUrl: "https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/en/Advanced/01-environment-setup/05-package-manager-and-config.md"
sourceRel: "docs/en/Advanced/01-environment-setup/05-package-manager-and-config.md"
rawUrl: "/raw/07-coding/vibe-vibe/docs/en/Advanced/01-environment-setup/05-package-manager-and-config.md"
sourceSha256: "919eb5cb574788a2f14afbb8fb345cf037956b92da7e5e21fb29d3d527877d49"
pageSha256: "919eb5cb574788a2f14afbb8fb345cf037956b92da7e5e21fb29d3d527877d49"
...
If you haven't installed Node.js and pnpm yet, please refer to [1.0 Quick Start](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-00-quick-start) to complete the installation.
...
If you completed the installation by following [1.0 Quick Start](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-00-quick-start), then nvm is already installed (automatically installed via script on Mac/Linux; Windows users can choose to install it).
...
- See also: [1.4 Terminal Basics](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-04-terminal-basics)
...
- Prerequisite: [1.2 Tech Stack Concepts](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-02-tech-stack)
