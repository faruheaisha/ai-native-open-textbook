...
entryUrl: "https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/Advanced/16-user-feedback-iteration/index.md"
sourceRel: "docs/Advanced/16-user-feedback-iteration/index.md"
rawUrl: "/raw/07-coding/vibe-vibe/docs/Advanced/16-user-feedback-iteration/index.md"
sourceSha256: "7677ca948d24cafe5fe3a6fdf312004beab4045b0d569fd0a0dba770f44eb927"
pageSha256: "7677ca948d24cafe5fe3a6fdf312004beab4045b0d569fd0a0dba770f44eb927"
...
- 16.1 [面对真实用户](/lib/07-coding/vibe-vibe/docs-Advanced-16-user-feedback-iteration-01-facing-real-users)——上线后的心理调适与反馈渠道建设
- 16.2 [反馈分类与优先级](/lib/07-coding/vibe-vibe/docs-Advanced-16-user-feedback-iteration-02-feedback-prioritization)——用 RICE 框架给反馈排优先级
- 16.3 [理解用户](/lib/07-coding/vibe-vibe/docs-Advanced-16-user-feedback-iteration-03-understanding-users)——用户访谈与数据驱动的结合
- 16.4 [迭代与成长](/lib/07-coding/vibe-vibe/docs-Advanced-16-user-feedback-iteration-04-iteration-and-growth)——建立可持续的迭代节奏与产品思维

---

**上一章**：[第十五章：SEO、分享与数据统计](/lib/07-coding/vibe-vibe/docs-Advanced-15-seo-analytics)
