...
entryUrl: "https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/en/Advanced/01-environment-setup/index.md"
sourceRel: "docs/en/Advanced/01-environment-setup/index.md"
rawUrl: "/raw/07-coding/vibe-vibe/docs/en/Advanced/01-environment-setup/index.md"
sourceSha256: "dfa04fe0a9830dd0f0c5b795375f353463be8411948335bc71355da0c485006c"
pageSha256: "dfa04fe0a9830dd0f0c5b795375f353463be8411948335bc71355da0c485006c"
...
> **Want to jump right in?** Check out **[1.0 Quick Start](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-00-quick-start)** to finish installing your environment in 5 minutes.
...
→ **[1.1 How Code Formats Evolved](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-01-code-formats)** will walk you from single-file HTML to modern modular development.
...
→ **[1.2 Understanding the Tech Stack](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-02-tech-stack)** and **[1.3 Browser and Server Basics](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-03-browser-server)** will help you build that understanding.
...
→ **[1.4 Terminal Basics](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-04-terminal-basics)** will teach you the basics of the command line, and **[1.5 Package Management and Project Configuration](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-05-package-manager-and-config)** will guide you through these setup steps.
...
→ **[1.5 Package Management and Project Configuration](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-05-package-manager-and-config)** explains in detail how nvm and pnpm work.
...
→ **[1.6 Models and Tools](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-06-models-and-tools)** will introduce the selection and configuration of different development tools in detail.
...
→ **[1.7 Creating a Project](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-07-creating-project)** will teach you everything from folder naming conventions to creating a project template.
...
→ **[1.8 Localhost and Ports](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-08-localhost-and-ports)** explains these networking basics in detail.
