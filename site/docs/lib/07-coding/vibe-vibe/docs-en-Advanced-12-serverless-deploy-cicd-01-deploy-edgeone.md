...
entryUrl: "https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/en/Advanced/12-serverless-deploy-cicd/01-deploy-edgeone.md"
sourceRel: "docs/en/Advanced/12-serverless-deploy-cicd/01-deploy-edgeone.md"
rawUrl: "/raw/07-coding/vibe-vibe/docs/en/Advanced/12-serverless-deploy-cicd/01-deploy-edgeone.md"
sourceSha256: "055b7a97ae243a0bd3bd6185e14e9a8a386f8aa1f5ad33ae03d968935158150d"
pageSha256: "055b7a97ae243a0bd3bd6185e14e9a8a386f8aa1f5ad33ae03d968935158150d"
...
If you selected the "Global (excluding Mainland China)" acceleration region, the default domain may have access restrictions (a 3-hour validity period). **This restriction disappears once you bind a custom domain**. For domain setup details, see [Chapter 13](/lib/07-coding/vibe-vibe/docs-en-Advanced-13-domain-dns).
:::
...
After connecting GitHub, every time you `git push` to the main branch, EdgeOne Pages will automatically trigger a redeployment. You don't need to do anything manually—this is the beginning of CI/CD, which we'll cover in more detail in [12.3](/lib/07-coding/vibe-vibe/docs-en-Advanced-12-serverless-deploy-cicd-03-cicd-automation).
...
::: info Next step
EdgeOne deployment is done. If your users are mainly overseas, or you want to learn about more platform options, continue to [12.2 Deploy to Vercel-like Platforms](/lib/07-coding/vibe-vibe/docs-en-Advanced-12-serverless-deploy-cicd-02-deploy-vercel-platforms).
:::
