...
::: tip 和第 15 章的内容呼应
Umami 的详细配置和使用技巧，在 [第十五章：SEO、分享与数据统计](/lib/07-coding/vibe-vibe/docs-Advanced-15-seo-analytics-index) 中有更深入的讲解。这里先装上，后面再细调。
:::
...
::: info 下一章
下一章，我们让更多人发现你的网站——SEO、社交分享和数据分析。[第十五章：SEO、分享与数据统计](/lib/07-coding/vibe-vibe/docs-Advanced-15-seo-analytics-index)。
:::
