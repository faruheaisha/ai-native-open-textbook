...
entryUrl: "https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/en/Advanced/12-serverless-deploy-cicd/index.md"
sourceRel: "docs/en/Advanced/12-serverless-deploy-cicd/index.md"
rawUrl: "/raw/07-coding/vibe-vibe/docs/en/Advanced/12-serverless-deploy-cicd/index.md"
sourceSha256: "934008543fe295414e46a73a5b4de8b2fe96b23a94a4a5122a22e4d2e59f009f"
pageSha256: "934008543fe295414e46a73a5b4de8b2fe96b23a94a4a5122a22e4d2e59f009f"
...
![img](https://gh-proxy.com/https://raw.githubusercontent.com/datawhalechina/vibe-vibe/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/public/images/Advanced/mll089oi-6566edafa4114ef0.jpg)
...
1. [Deploy to EdgeOne Pages](/lib/07-coding/vibe-vibe/docs-en-Advanced-12-serverless-deploy-cicd-01-deploy-edgeone) → Complete your first deployment step by step and get a public link
2. [Deploy to Vercel-like platforms](/lib/07-coding/vibe-vibe/docs-en-Advanced-12-serverless-deploy-cicd-02-deploy-vercel-platforms) → Explore more platform options and find the one that suits you best
3. [CI/CD and automation](/lib/07-coding/vibe-vibe/docs-en-Advanced-12-serverless-deploy-cicd-03-cicd-automation) → Push to deploy and let automation take over repetitive work
4. [Operations basics and cost optimization](/lib/07-coding/vibe-vibe/docs-en-Advanced-12-serverless-deploy-cicd-04-operations-cost) → Who watches it after launch, and how to control costs
...
**Previous chapter**: [Chapter 11: Git Version Control and Cross-platform Collaboration](/lib/07-coding/vibe-vibe/docs-en-Advanced-11-git-collaboration)

**Next chapter**: [Chapter 13: Domain Names, DNS, and HTTPS](/lib/07-coding/vibe-vibe/docs-en-Advanced-13-domain-dns)
