...
entryUrl: "https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/en/Advanced/04-dev-fundamentals/05-frontend-backend-separation.md"
sourceRel: "docs/en/Advanced/04-dev-fundamentals/05-frontend-backend-separation.md"
rawUrl: "/raw/07-coding/vibe-vibe/docs/en/Advanced/04-dev-fundamentals/05-frontend-backend-separation.md"
sourceSha256: "b676a1ffdd03b3c723dedab3dcd803312d447d058875db2299b7827a74be5e8f"
pageSha256: "b676a1ffdd03b3c723dedab3dcd803312d447d058875db2299b7827a74be5e8f"
...
- Placeholders (such as <code v-pre>{{ username }}</code>) for inserting dynamic data
...
- Prerequisite: [1.3 Browser and Server Basics](/lib/07-coding/vibe-vibe/docs-en-Advanced-01-environment-setup-03-browser-server)
- Prerequisite: [4.4 API and HTTP Basics](/lib/07-coding/vibe-vibe/docs-en-Advanced-04-dev-fundamentals-04-api-and-http)
- See also: [4.6 Configuration File Formats](/lib/07-coding/vibe-vibe/docs-en-Advanced-04-dev-fundamentals-06-config-formats)
