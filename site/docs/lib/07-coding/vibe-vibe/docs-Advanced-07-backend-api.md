...
entryUrl: "https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/Advanced/07-backend-api/index.md"
sourceRel: "docs/Advanced/07-backend-api/index.md"
rawUrl: "/raw/07-coding/vibe-vibe/docs/Advanced/07-backend-api/index.md"
sourceSha256: "aff88cfef06bccbe1f7cf0a5948b013fdcf13c1e5e839726bba320fa950896e2"
pageSha256: "aff88cfef06bccbe1f7cf0a5948b013fdcf13c1e5e839726bba320fa950896e2"
...
| 小节 | 内容 |
|------|------|
| [7.0 跑通你的第一个全栈应用](/lib/07-coding/vibe-vibe/docs-Advanced-07-backend-api-00-crud-example) | 动手做一个 Todo 应用，体验完整的全栈数据流 |
| [7.1 一个接口不够用了](/lib/07-coding/vibe-vibe/docs-Advanced-07-backend-api-01-api-growing-pains) | 关联查询、分页、过滤排序——当数据量和需求增长时怎么办 |
| [7.2 当接口出了问题](/lib/07-coding/vibe-vibe/docs-Advanced-07-backend-api-02-when-things-go-wrong) | 参数校验、幂等性、错误处理——上线后的第一批坑 |
| [7.3 让接口更好用](/lib/07-coding/vibe-vibe/docs-Advanced-07-backend-api-03-api-as-product) | 版本管理、接口文档、批量操作——把接口当产品来打磨 |
