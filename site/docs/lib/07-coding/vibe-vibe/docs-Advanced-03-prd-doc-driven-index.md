...
> [3.1 想法验证实战](/lib/07-coding/vibe-vibe/docs-Advanced-03-prd-doc-driven-01-product-validation) 🔴 - 掌握产品验证三步法，避免做没人要的东西
...
> [3.2 与 AI 确认需求](/lib/07-coding/vibe-vibe/docs-Advanced-03-prd-doc-driven-02-discuss-with-ai) 🔴 - 主动让 AI 确认理解，发现盲点
...
> [3.3 PRD 编写实战](/lib/07-coding/vibe-vibe/docs-Advanced-03-prd-doc-driven-03-prd-template-guide) 🔴 - 完整模板 + 细节→代码因果关系 + 可视化技巧
...
> [3.4 从 PRD 到代码](/lib/07-coding/vibe-vibe/docs-Advanced-03-prd-doc-driven-04-coding-agents) 🟡 - 理解 AI 的"阅读"方式、PRD→代码的因果关系
...
**上一章**：[第二章：AI 使用说明书](/lib/07-coding/vibe-vibe/docs-Advanced-02-ai-tuning-guide-index)

**下一章**：[第四章：你必须知道的开发基础](/lib/07-coding/vibe-vibe/docs-Advanced-04-dev-fundamentals-index)
