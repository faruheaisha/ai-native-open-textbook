...
entryUrl: "https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/en/Advanced/04-dev-fundamentals/index.md"
sourceRel: "docs/en/Advanced/04-dev-fundamentals/index.md"
rawUrl: "/raw/07-coding/vibe-vibe/docs/en/Advanced/04-dev-fundamentals/index.md"
sourceSha256: "701361a4e23c8ca2f6d796fa04a09756fec2fa62a0bd3784ba8063979082e881"
pageSha256: "701361a4e23c8ca2f6d796fa04a09756fec2fa62a0bd3784ba8063979082e881"
...
> [4.0 The Three States of Running Code](/lib/07-coding/vibe-vibe/docs-en-Advanced-04-dev-fundamentals-00-build-basics) 🟢 - Understand the three runtime modes: Dev, Build, and Production
...
> [4.1 Tech Stack Decision Framework](/lib/07-coding/vibe-vibe/docs-en-Advanced-04-dev-fundamentals-01-tech-stack-decision) 🟡 - Systematically choose the right tech stack
...
> [4.3 How to Read AI-Generated Code](/lib/07-coding/vibe-vibe/docs-en-Advanced-04-dev-fundamentals-03-programming-basics) 🟢 - Understand the four core concepts of code
...
> [4.2 From PRD to Technical Documentation](/lib/07-coding/vibe-vibe/docs-en-Advanced-04-dev-fundamentals-02-prd-and-tech-docs) 🟢 - Understand the division of responsibility between product docs and technical docs
...
> [4.4 API and HTTP Basics](/lib/07-coding/vibe-vibe/docs-en-Advanced-04-dev-fundamentals-04-api-and-http) 🟢 - Master how APIs and the HTTP protocol work
...
> [4.5 The Concept of Frontend-Backend Separation](/lib/07-coding/vibe-vibe/docs-en-Advanced-04-dev-fundamentals-05-frontend-backend-separation) 🟢 - Understand the architecture and interaction model of frontend-backend separation
...
> [4.6 Configuration File Formats](/lib/07-coding/vibe-vibe/docs-en-Advanced-04-dev-fundamentals-06-config-formats) 🟢 - Understand JSON and YAML configuration formats
...
> [4.7 Hands-On API Integration](/lib/07-coding/vibe-vibe/docs-en-Advanced-04-dev-fundamentals-07-api-integration) 🟢 - Integrate an external API from scratch
...
> [4.8 Project Manual Structure](/lib/07-coding/vibe-vibe/docs-en-Advanced-04-dev-fundamentals-08-readme-structure) 🟢 - Write a complete project README.md document
...
**Previous Chapter**: [Chapter 3: Product Thinking and Document-Driven Development](/lib/07-coding/vibe-vibe/docs-en-Advanced-03-prd-doc-driven)

**Next Chapter**: [Chapter 5: Interface (UI) and Interaction (UX)](/lib/07-coding/vibe-vibe/docs-en-Advanced-05-ui-ux)
