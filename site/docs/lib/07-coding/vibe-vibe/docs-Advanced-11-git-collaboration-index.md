...
**上一章**：[第十章：Localhost 与公网访问](/lib/07-coding/vibe-vibe/docs-Advanced-10-localhost-public-access-index)

**下一章**：[第十二章：无服务器部署与 CI/CD 自动化](/lib/07-coding/vibe-vibe/docs-Advanced-12-serverless-deploy-cicd-index)
