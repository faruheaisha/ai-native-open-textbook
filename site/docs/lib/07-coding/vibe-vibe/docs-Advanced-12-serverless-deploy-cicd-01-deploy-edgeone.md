...
entryUrl: "https://github.com/datawhalechina/vibe-vibe/blob/f2e121d9b6c689c0e682921df60d73e279c5e316/docs/Advanced/12-serverless-deploy-cicd/01-deploy-edgeone.md"
sourceRel: "docs/Advanced/12-serverless-deploy-cicd/01-deploy-edgeone.md"
rawUrl: "/raw/07-coding/vibe-vibe/docs/Advanced/12-serverless-deploy-cicd/01-deploy-edgeone.md"
sourceSha256: "0fb1b64c4ee371cd5fa6ea347bfeed41329a169c1931d732f3a68c976b8ad162"
pageSha256: "0fb1b64c4ee371cd5fa6ea347bfeed41329a169c1931d732f3a68c976b8ad162"
...
::: warning 预览链接的限制
如果你选的是"全球（不含中国大陆）"加速区域，默认域名可能有访问限制（3 小时有效期）。**绑定自定义域名后就没有这个限制了**。域名配置详见 [第十三章](/lib/07-coding/vibe-vibe/docs-Advanced-13-domain-dns)。
:::
...
连接 GitHub 后，每次你 `git push` 到主分支，EdgeOne Pages 会自动触发重新部署。你不需要手动操作——这就是 CI/CD 的雏形，我们在 [12.3](/lib/07-coding/vibe-vibe/docs-Advanced-12-serverless-deploy-cicd-03-cicd-automation) 会详细展开。
...
::: info 下一步
EdgeOne 部署搞定了。如果你的用户主要在海外，或者想了解更多平台选择，继续看 [12.2 部署到类 Vercel 平台](/lib/07-coding/vibe-vibe/docs-Advanced-12-serverless-deploy-cicd-02-deploy-vercel-platforms)。
:::
