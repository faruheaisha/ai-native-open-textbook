---
title: "AI Agents for Beginners - Study Guide"
...
entryUrl: "https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/STUDY_GUIDE.md"
sourceRel: "STUDY_GUIDE.md"
rawUrl: "/raw/08-agents/microsoft-ai-agents-for-beginners/STUDY_GUIDE.md"
sourceSha256: "04e1b967117003ed9a898d073572f23d2efe89cd9f9339ddbd9910e93f43ac1f"
pageSha256: "04e1b967117003ed9a898d073572f23d2efe89cd9f9339ddbd9910e93f43ac1f"
...
1. Read the [Course Setup](/lib/08-agents/microsoft-ai-agents-for-beginners/00-course-setup).
...
- **Foundry Local** — run models fully on-device through an OpenAI-compatible API (no cloud, no API keys). Ideal for offline or cost-free experimentation. See [Course Setup](/lib/08-agents/microsoft-ai-agents-for-beginners/00-course-setup).
...
|--------|----------------|---------------------------|
| [01 - Intro to AI Agents](/lib/08-agents/microsoft-ai-agents-for-beginners/01-intro-to-ai-agents) | What makes an agent different from a basic chatbot. | Explain your demo idea as an agent, not just a chat app. |
| [02 - Agentic Frameworks](/lib/08-agents/microsoft-ai-agents-for-beginners/02-explore-agentic-frameworks) | How frameworks help with models, tools, state, and workflows. | Identify which parts of your demo a framework would manage. |
| [03 - Agentic Design Patterns](/lib/08-agents/microsoft-ai-agents-for-beginners/03-agentic-design-patterns) | Common patterns for designing agent behavior. | Sketch the user journey before writing code. |
| [04 - Tool Use](/lib/08-agents/microsoft-ai-agents-for-beginners/04-tool-use) | How agents call tools to get data or take action. | Define one tool your demo agent would need. |
| [05 - Agentic RAG](/lib/08-agents/microsoft-ai-agents-for-beginners/05-agentic-rag) | How retrieval grounds agent answers in documents or data. | Decide what knowledge source your demo should search. |
| [06 - Trustworthy Agents](/lib/08-agents/microsoft-ai-agents-for-beginners/06-building-trustworthy-agents) | How to add guardrails, oversight, and safer behavior. | Add one rule for when the agent should ask the user first. |
| [07 - Planning Design](/lib/08-agents/microsoft-ai-agents-for-beginners/07-planning-design) | How agents break larger goals into smaller steps. | Write a three-step plan for your demo request. |
| [08 - Multi-Agent Design](/lib/08-agents/microsoft-ai-agents-for-beginners/08-multi-agent) | When to split work across specialized agents. | Decide whether your demo needs one agent or several. |
| [09 - Metacognition](/lib/08-agents/microsoft-ai-agents-for-beginners/09-metacognition/index) | How agents can review and improve their own output. | Add a final self-check before the agent responds. |
| [10 - AI Agents in Production](/lib/08-agents/microsoft-ai-agents-for-beginners/10-ai-agents-production) | What changes when an agent moves from demo to production. | List what you would monitor: quality, cost, latency, failures. |
| [11 - Agentic Protocols](/lib/08-agents/microsoft-ai-agents-for-beginners/11-agentic-protocols) | How protocols connect agents to tools and other agents. | Identify where a standard protocol could simplify integration. |
| [12 - Context Engineering](/lib/08-agents/microsoft-ai-agents-for-beginners/12-context-engineering) | How to select, trim, isolate, and manage context. | Decide what belongs in the prompt and what should stay out. |
| [13 - Agent Memory](/lib/08-agents/microsoft-ai-agents-for-beginners/13-agent-memory) | How agents can save useful information across interactions. | Choose one safe preference your demo could remember. |
| [14 - Microsoft Agent Framework](/lib/08-agents/microsoft-ai-agents-for-beginners/14-microsoft-agent-framework) | Framework-specific building blocks for agents and workflows, plus hosting LangChain/LangGraph agents on Microsoft Foundry. | Map your demo steps to framework concepts. |
| [15 - Computer Use Agents](/lib/08-agents/microsoft-ai-agents-for-beginners/15-browser-use) | How agents can interact with browser or UI surfaces, including real-world examples like Microsoft Project Opal. | Pick one browser task that should still require user confirmation. |
| [16 - Deploying Scalable Agents](/lib/08-agents/microsoft-ai-agents-for-beginners/16-deploying-scalable-agents) | How to take an agent from prototype to a scalable, observable production deployment on Microsoft Foundry (hosted agents, model routing, caching, evaluation gates, smoke tests). | List the production concerns your demo still needs: hosting, routing, cost, evaluation. |
| [17 - Creating Local AI Agents](/lib/08-agents/microsoft-ai-agents-for-beginners/17-creating-local-ai-agents) | How to build local-first agents that run entirely on your machine with Foundry Local and Qwen (local tools, local RAG, local MCP). | Decide which parts of your demo should stay private and run locally. |
| [18 - Securing AI Agents](/lib/08-agents/microsoft-ai-agents-for-beginners/18-securing-ai-agents) | How to make agent actions more auditable and tamper-evident. | Decide what actions in your demo should be logged or receipted. |
...
catalogs under [tests/](https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/tests/README.md) for the deployable agents in Lessons
