...
- 使用 [Microsoft Agent Framework](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-14-microsoft-agent-framework-README) 构建代理（第14课）。
- [工具使用](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-04-tool-use-README)（第4课）和 [代理式RAG](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-05-agentic-rag-README)（第5课）。
- [代理内存](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-13-agent-memory-README)（第13课）和 [代理协议 / MCP](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-11-agentic-protocols-README)（第11课）。
- [可观测性和评估](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-10-ai-agents-production-README)（第10课） — 本课将直接建立在此基础上。
...
这一核心理念继承自 [第10课](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-10-ai-agents-production-README)：**离线评估是门槛，而非事后考虑。** 新版本代理必须通过评估门槛后才能发布。上线可观测性将真实失败反馈入离线测试集。整个流程如是。
...
**生产环境中的 MCP。** [MCP](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-11-agentic-protocols-README) 允许代理通过标准接口调用外部工具。生产中应将每个 MCP 服务器视为不可信边界：锁定服务器版本，使用限定身份运行，验证输出，绝不暴露秘密。MCP 服务是依赖项，需要补丁、审计和速率限制。
...
[构建计算机使用代理 (CUA)](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-15-browser-use-README)
