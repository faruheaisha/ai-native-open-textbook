---
title: "Creating Local AI Agents Using Microsoft Foundry Local and Qwen"
...
entryUrl: "https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/17-creating-local-ai-agents/README.md"
sourceRel: "17-creating-local-ai-agents/README.md"
rawUrl: "/raw/08-agents/microsoft-ai-agents-for-beginners/17-creating-local-ai-agents/README.md"
sourceSha256: "b46f76d0acb7136cc3b49da0836d50d5d6678cdb9df95f98ba068cc892f4f5d1"
pageSha256: "b46f76d0acb7136cc3b49da0836d50d5d6678cdb9df95f98ba068cc892f4f5d1"
...
![Creating Local AI Agents](https://gh-proxy.com/https://raw.githubusercontent.com/microsoft/ai-agents-for-beginners/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/17-creating-local-ai-agents/images/lesson-17-thumbnail.png)
...
- [Agentic Protocols / MCP](/lib/08-agents/microsoft-ai-agents-for-beginners/11-agentic-protocols) (Lesson 11).
- The [Microsoft Agent Framework](/lib/08-agents/microsoft-ai-agents-for-beginners/14-microsoft-agent-framework) (Lesson 14).
...
- Python 3.12+ and the packages in the repository [`requirements.txt`](https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/requirements.txt), plus `foundry-local-sdk`, `openai`, and `chromadb` for this lesson.
...
[MCP](/lib/08-agents/microsoft-ai-agents-for-beginners/11-agentic-protocols) is a transport, not a cloud service. An MCP server can run as a local process on `stdio`, exposing tools to your agent over the standard protocol. This lets you reuse the growing ecosystem of MCP servers — filesystem access, git operations, database queries — entirely offline.
...
Open [`code_samples/17-local-agent-foundry-local.ipynb`](https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/17-creating-local-ai-agents/code_samples/17-local-agent-foundry-local.ipynb) and work through it. You will build a **local engineering assistant** that runs entirely on your workstation and can:
...
[Deploying Scalable Agents](/lib/08-agents/microsoft-ai-agents-for-beginners/16-deploying-scalable-agents)

## Next Lesson

[Securing AI Agents](/lib/08-agents/microsoft-ai-agents-for-beginners/18-securing-ai-agents)
