...
- [工具使用](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-04-tool-use-README) (第4课) 和 [Agentic RAG](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-05-agentic-rag-README) (第5课)。
- [Agentic 协议 / MCP](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-11-agentic-protocols-README) (第11课)。
- [Microsoft 代理框架](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-14-microsoft-agent-framework-README) (第14课)。
...
[MCP](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-11-agentic-protocols-README) 是一种传输协议，不是云服务。MCP 服务器可以作为本地进程运行于 `stdio`，通过标准协议向代理暴露工具。这让你可以离线复用日益丰富的 MCP 服务器生态——文件系统访问、git 操作、数据库查询等。
