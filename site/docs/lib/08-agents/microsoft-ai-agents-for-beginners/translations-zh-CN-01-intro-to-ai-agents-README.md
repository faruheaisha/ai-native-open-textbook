...
- 🐍 Python: [Agent Framework](https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/translations/zh-CN/01-intro-to-ai-agents/code_samples/01-python-agent-framework.ipynb)
- 🔷 .NET: [Agent Framework](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-01-intro-to-ai-agents-code_samples-01-dotnet-agent-framework)
...
一旦您学会如何在 [第16课](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-16-deploying-scalable-agents-README) 部署代理，就可以为本课的 `TravelAgent` 添加快速的部署后健康检查，使用预制目录 [`tests/lesson-01-smoke-tests.json`](https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/tests/lesson-01-smoke-tests.json)。查看 [`tests/README.md`](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-tests-README) 了解运行方式。
