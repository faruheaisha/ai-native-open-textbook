...
entryUrl: "https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/translations/zh-CN/.agents/skills/testing-course-samples/SKILL.md"
sourceRel: "translations/zh-CN/.agents/skills/testing-course-samples/SKILL.md"
rawUrl: "/raw/08-agents/microsoft-ai-agents-for-beginners/translations/zh-CN/.agents/skills/testing-course-samples/SKILL.md"
sourceSha256: "284c46aa311d62900426447caca87426e7904a22e2864b5a610059d928447981"
pageSha256: "284c46aa311d62900426447caca87426e7904a22e2864b5a610059d928447981"
...
[`scripts/validate-notebooks.ps1`](https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/scripts/validate-notebooks.ps1)，
...
托管代理 — 见 [`tests/README.md`](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-tests)）。本工具
是本地执行笔记本。

## 先决条件（先检查）
1. **Python 3.12+** 及课程依赖：`python -m pip install -r requirements.txt`
   还需要执行器：`python -m pip install nbconvert ipykernel`。
2. 仓库根目录需要 **`.env` 文件**（从 [`.env.example`](https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/.env.example) 复制），至少包含：
