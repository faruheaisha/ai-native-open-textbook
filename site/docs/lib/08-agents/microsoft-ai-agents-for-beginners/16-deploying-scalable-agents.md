---
title: "Deploying Scalable Agents with Microsoft Foundry"
...
entryUrl: "https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/16-deploying-scalable-agents/README.md"
sourceRel: "16-deploying-scalable-agents/README.md"
rawUrl: "/raw/08-agents/microsoft-ai-agents-for-beginners/16-deploying-scalable-agents/README.md"
sourceSha256: "4db02e83e787f0d33f0a608a205e340d1914f6be8ca52361f2331b8340ed8a68"
pageSha256: "4db02e83e787f0d33f0a608a205e340d1914f6be8ca52361f2331b8340ed8a68"
...
![Deploying Scalable Agents](https://gh-proxy.com/https://raw.githubusercontent.com/microsoft/ai-agents-for-beginners/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/16-deploying-scalable-agents/images/lesson-16-thumbnail.png)
...
- Building agents with the [Microsoft Agent Framework](/lib/08-agents/microsoft-ai-agents-for-beginners/14-microsoft-agent-framework) (Lesson 14).
- [Tool Use](/lib/08-agents/microsoft-ai-agents-for-beginners/04-tool-use) (Lesson 4) and [Agentic RAG](/lib/08-agents/microsoft-ai-agents-for-beginners/05-agentic-rag) (Lesson 5).
- [Agent Memory](/lib/08-agents/microsoft-ai-agents-for-beginners/13-agent-memory) (Lesson 13) and [Agentic Protocols / MCP](/lib/08-agents/microsoft-ai-agents-for-beginners/11-agentic-protocols) (Lesson 11).
- [Observability and Evaluation](/lib/08-agents/microsoft-ai-agents-for-beginners/10-ai-agents-production) (Lesson 10) — this lesson builds directly on it.
...
- Python 3.12+ and the packages in the repository [`requirements.txt`](https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/requirements.txt).
...
The key idea, carried over from [Lesson 10](/lib/08-agents/microsoft-ai-agents-for-beginners/10-ai-agents-production): **offline evaluation is a gate, not an afterthought.** A new agent version does not ship unless it clears your evaluation thresholds. Online observability then feeds real-world failures back into your offline test set. That is the whole loop.
...
Open [`code_samples/16-python-agent-framework.ipynb`](https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/16-deploying-scalable-agents/code_samples/16-python-agent-framework.ipynb) and work through it end to end. You will assemble a **Contoso customer support agent** with every production concern wired in:
...
- **Catalog** — [`tests/lesson-16-smoke-tests.json`](https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/tests/lesson-16-smoke-tests.json) contains prompts and assertions for the Contoso support agent (grounded policy answers, an order lookup, staying on-topic, and multi-turn thread continuity). Catalogs for other lessons' agents live alongside it — see [`tests/README.md`](https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/tests/README.md).
- **Workflow** — [`.github/workflows/smoke-test.yml`](https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/.github/workflows/smoke-test.yml) logs in with Azure OIDC and POSTs each prompt to the agent's Responses endpoint, failing the job on any assertion miss.
...
[Building Computer Use Agents (CUA)](/lib/08-agents/microsoft-ai-agents-for-beginners/15-browser-use)

## Next Lesson

[Creating Local AI Agents](/lib/08-agents/microsoft-ai-agents-for-beginners/17-creating-local-ai-agents)
