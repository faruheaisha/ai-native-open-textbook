---
title: "将 Python 应用从 Azure OpenAI 聊天补全迁移到 Responses API"
...
entryUrl: "https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/translations/zh-CN/.agents/skills/azure-openai-to-responses/SKILL.md"
sourceRel: "translations/zh-CN/.agents/skills/azure-openai-to-responses/SKILL.md"
rawUrl: "/raw/08-agents/microsoft-ai-agents-for-beginners/translations/zh-CN/.agents/skills/azure-openai-to-responses/SKILL.md"
sourceSha256: "f462e05bb038fa23f6ff7b45848349bcc9a2245a43859f7159849717b51cdd47"
pageSha256: "f462e05bb038fa23f6ff7b45848349bcc9a2245a43859f7159849717b51cdd47"
...
详细的前后代码示例，参见 [cheat-sheet.md](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-_agents-skills-azure-openai-to-responses-references-cheat-sheet)。
...
客户端设置代码示例（同步、异步、EntraID、API 密钥、多租户）见 [cheat-sheet.md](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-_agents-skills-azure-openai-to-responses-references-cheat-sheet)。

---

## 步骤 1：检测旧版调用点

运行 [detect_legacy.py](https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/.agents/skills/azure-openai-to-responses/scripts/detect_legacy.py) 脚本查找所有需迁移的调用点：
...
- <strong>工具</strong>：将函数调用工具定义从嵌套格式（<code v-pre>\{"type": "function", "function": \{"name": ...}}</code>）转换为扁平的 Responses 格式（`\{"type": "function", "name": ...\}`）；使用 `tool_choice`；返回工具结果作为 `\{"type": "function_call_output", "call_id": ..., "output": ...\}` 项（而非 `\{"role": "tool", ...\}`）。
...
- <strong>格式化</strong>：将 Chat 的顶层 `response_format` 替换为 Responses 的 `text.format`。规范形态：<code v-pre>text=\{"format": \{"type": "json_schema", "name": "Output", "strict": True, "schema": \{...}}\}</code>。
...
- <strong>图片内容项</strong>：将 Chat 的 `content[].type: "image_url"` 替换为 Responses 的 `content[].type: "input_image"`。`image_url` 字段由 <code v-pre>\{"image_url": \{"url": "..."}}</code> 扁平为 `\{"image_url": "..."\}`（纯字符串，https URL 或 `data:image/...;base64,...` 数据 URI）。
...
完整的前后代码示例见 [cheat-sheet.md](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-_agents-skills-azure-openai-to-responses-references-cheat-sheet)。

测试基础设施迁移（模拟、快照、断言）见 [test-migration.md](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-_agents-skills-azure-openai-to-responses-references-test-migration)。

错误排查及注意事项见 [troubleshooting.md](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-_agents-skills-azure-openai-to-responses-references-troubleshooting)。
...
- [ ] 顶层没有 `response_format`，所有结构化输出使用 <code v-pre>text=\{"format": \{...}}</code>。
...
- [备忘清单 — 所有代码片段](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-_agents-skills-azure-openai-to-responses-references-cheat-sheet)
- [测试迁移 — 模拟、快照、断言](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-_agents-skills-azure-openai-to-responses-references-test-migration)
- [故障排查 — 错误、风险表、注意事项](/lib/08-agents/microsoft-ai-agents-for-beginners/translations-zh-CN-_agents-skills-azure-openai-to-responses-references-troubleshooting)
- [detect_legacy.py — 自动扫描器](https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/.agents/skills/azure-openai-to-responses/scripts/detect_legacy.py)
