...
entryUrl: "https://github.com/ranxi2001/zero2Agent/blob/46e9f7c28f84f54b2f6e45681d14989f01e18291/learn-claude-code/06-context-compact/index.md"
sourceRel: "learn-claude-code/06-context-compact/index.md"
rawUrl: "/raw/08-agents/zero2agent/learn-claude-code/06-context-compact/index.md"
sourceSha256: "a4bf7b35bf0183c5445f95c7a62fe350a5162ad83f3fba624d0598c56d606a52"
pageSha256: "a4bf7b35bf0183c5445f95c7a62fe350a5162ad83f3fba624d0598c56d606a52"
...
### 为什么 Full Compact 输出 `<analysis>` + `` 两个块？

`<analysis>` 是思维草稿（scratchpad），让模型先梳理完整上下文再写摘要。压缩后 `<analysis>` 被丢弃，只保留 `` 进入新上下文——既保证摘要质量，又不浪费 token。
...
下一篇：[Task System：持久化任务图](https://github.com/ranxi2001/zero2Agent/blob/46e9f7c28f84f54b2f6e45681d14989f01e18291/learn-claude-code/07-task-system/index.html)
