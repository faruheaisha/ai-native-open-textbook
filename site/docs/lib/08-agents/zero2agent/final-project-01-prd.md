...
entryUrl: "https://github.com/ranxi2001/zero2Agent/blob/46e9f7c28f84f54b2f6e45681d14989f01e18291/final-project/01-prd/index.md"
sourceRel: "final-project/01-prd/index.md"
rawUrl: "/raw/08-agents/zero2agent/final-project/01-prd/index.md"
sourceSha256: "2dc7929570b88e65f12443bfda27e3d770bf61ae7b2bc162500957c4ab5d764b"
pageSha256: "2dc7929570b88e65f12443bfda27e3d770bf61ae7b2bc162500957c4ab5d764b"
...
![用户场景](/mirror/27/27de1099bcf701748e96fbbdb881130cb298915d.webp)
...
![10 层 Harness 系统架构](/mirror/07/075785423ecfdb0bdd929a1c45cd8adca34bef36.webp)
...
![Skills 管线流程](/mirror/a0/a0fc9b638071d87d3264f0e9ee3ccb27a10599fd.webp)

## 第 3 层：Query Engine —— 模型调用的工程化

不是简单 `await model.invoke()`，而是完整的调用管线：

![Query Engine 调用管线](/mirror/0b/0b7c34b2d4a12d1b1540d47d2b4a8ede9e79aa23.webp)
...
![Context 管理策略](/mirror/f2/f20d5b319bf393b2d95a7e7a1155a13add0de1a6.webp)

## 第 5 层：Memory —— 用户画像与诊断历史

![Memory 三层模型](/mirror/fb/fbbd1480dd66df667dda1e898201b16ea03e0a0e.webp)
...
![权限矩阵](/mirror/9c/9c118ed352cbe8b45a0edcffc206434c661519c3.webp)
...
![Session 状态机](/mirror/66/666712321bdab55409346ce8d487a40f818e8c68.webp)

## 第 8 层：Command —— 确定性操作入口

![用户命令](/mirror/74/7460c7c6dc2f5511fabf03cc5115d93cdeb67786.webp)

## 第 9 层：Hook —— 治理逻辑的扩展点

![Hook 管线](/mirror/c2/c28f28c3032d41c537625503c22c07c9a97498ee.webp)

## 第 10 层：Sub-agent —— 诊断任务的并行分发

单题诊断可以串行，但多题诊断适合并行分发：

![Sub-agent 并行诊断架构](/mirror/32/32340097933d0b411e75e141604cfbcac85edb43.webp)
...
![知识库设计](/mirror/c3/c3908358693797e717b5481c6b64fd349ad2d18d.webp)

## 诊断维度与评分体系

![诊断维度与评分体系](/mirror/d8/d81047dbb9b3c75e22c1dc82272c1c2b68be25b1.webp)
...
![开发路线图](/mirror/5c/5cc5ad687fb49a74e348318354f58880b389af16.webp)
...
- [02-architecture：系统架构设计](https://github.com/ranxi2001/zero2Agent/blob/46e9f7c28f84f54b2f6e45681d14989f01e18291/final-project/02-architecture/index.html)
