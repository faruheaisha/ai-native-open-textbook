...
![一次明确交接由普通 task 完成；面对批量或多阶段任务，主 LLM 可以生成 JavaScript，并由 QuickJS 多次调用 task() 后汇总结果](https://gh-proxy.com/https://raw.githubusercontent.com/datawhalechina/deepagents-in-action/4097ff944f9ffa1bdfe2dd04f751f4416b058860/public/imgs/52-comparison-direct-vs-dynamic-subagents.png)
...
![用户用 workflow 描述请求，主 LLM 编写 JavaScript，经 eval 进入 QuickJS；task() 使用三个可用字段启动已配置的子 Agent，结果经筛选和合并后返回](https://gh-proxy.com/https://raw.githubusercontent.com/datawhalechina/deepagents-in-action/4097ff944f9ffa1bdfe2dd04f751f4416b058860/public/imgs/53-framework-quickjs-task-orchestration.png)
...
![开发者先通过 subagents 和 CodeInterpreterMiddleware 准备可调度角色，用户再用 workflow 描述输入范围、角色顺序、结果要求和停止条件，两部分共同交给主 LLM 生成 JavaScript](https://gh-proxy.com/https://raw.githubusercontent.com/datawhalechina/deepagents-in-action/4097ff944f9ffa1bdfe2dd04f751f4416b058860/public/imgs/54-framework-three-orchestration-patterns.png)
...
![检查主 LLM 可能生成的 JavaScript：subagentType 应来自已配置的 name，task() 字段应正确，输入覆盖和阶段顺序应符合流程，数量上限和停止条件应实际生效](https://gh-proxy.com/https://raw.githubusercontent.com/datawhalechina/deepagents-in-action/4097ff944f9ffa1bdfe2dd04f751f4416b058860/public/imgs/55-flow-dynamic-subagents-guardrails.png)
