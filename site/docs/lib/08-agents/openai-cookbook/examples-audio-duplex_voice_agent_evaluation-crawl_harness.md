...
entryUrl: "https://github.com/openai/openai-cookbook/blob/a0709e05a54d8dd1c4d9be3fc0a41526c3496c39/examples/audio/duplex_voice_agent_evaluation/crawl_harness/README.md"
sourceRel: "examples/audio/duplex_voice_agent_evaluation/crawl_harness/README.md"
rawUrl: "/raw/08-agents/openai-cookbook/examples/audio/duplex_voice_agent_evaluation/crawl_harness/README.md"
sourceSha256: "d5acfb48e8da045940d330db005be5975d26653ff830608508ed1138a45d36d0"
pageSha256: "d5acfb48e8da045940d330db005be5975d26653ff830608508ed1138a45d36d0"
...
![CRAWL architecture: scenario text becomes synthetic caller audio, while agent context reaches the GPT Live agent and evaluator-only expectations go directly to grading.](/mirror/4b/4b5f5dc34417436f57889a17bcfdb3718c673f5f.svg)
...
[data/scenarios.json](https://github.com/openai/openai-cookbook/blob/a0709e05a54d8dd1c4d9be3fc0a41526c3496c39/examples/audio/duplex_voice_agent_evaluation/crawl_harness/data/scenarios.json). Each scenario can provide:
...
`./results/crawl/` by default. See [installation and path rules](/lib/08-agents/openai-cookbook/examples-audio-duplex_voice_agent_evaluation#installed-package-and-paths)
...
[config.toml](https://github.com/openai/openai-cookbook/blob/a0709e05a54d8dd1c4d9be3fc0a41526c3496c39/examples/audio/duplex_voice_agent_evaluation/crawl_harness/config.toml) controls the module:
...
[environment-file rules](/lib/08-agents/openai-cookbook/examples-audio-duplex_voice_agent_evaluation#environment-file-selection).

### Data

[data/scenarios.json](https://github.com/openai/openai-cookbook/blob/a0709e05a54d8dd1c4d9be3fc0a41526c3496c39/examples/audio/duplex_voice_agent_evaluation/crawl_harness/data/scenarios.json) uses the same JSON contract as
WALK and RUN:
