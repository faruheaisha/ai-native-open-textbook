...
4. **Format**
   - Embed files appropriately:
     ...
     - Use standard Markdown syntax for charts and images (only if the file exists), e.g., `![vol-chart](https://gh-proxy.com/https://raw.githubusercontent.com/openai/openai-cookbook/a0709e05a54d8dd1c4d9be3fc0a41526c3496c39/examples/agents_sdk/multi-agent-portfolio-collaboration/prompts/AVGO_NVDA_price_vol_chart.png)`.
