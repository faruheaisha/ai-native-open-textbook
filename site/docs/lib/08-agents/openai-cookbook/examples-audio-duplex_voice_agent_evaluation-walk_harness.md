...
entryUrl: "https://github.com/openai/openai-cookbook/blob/a0709e05a54d8dd1c4d9be3fc0a41526c3496c39/examples/audio/duplex_voice_agent_evaluation/walk_harness/README.md"
sourceRel: "examples/audio/duplex_voice_agent_evaluation/walk_harness/README.md"
rawUrl: "/raw/08-agents/openai-cookbook/examples/audio/duplex_voice_agent_evaluation/walk_harness/README.md"
sourceSha256: "536aa9bd9b0e0b5a5a4f6c00d9b41495726163a62fd76046153040170a21cbb0"
pageSha256: "536aa9bd9b0e0b5a5a4f6c00d9b41495726163a62fd76046153040170a21cbb0"
...
![WALK architecture: a recorded caller request reaches the GPT Live agent, with optional synthetic recording and noise generation and evaluator-only expected outcomes.](/mirror/d6/d6abe69488a150b0e90f7038d92a4a5ac352e98f.svg)
...
WALK uses the same [response-completion policy](/lib/08-agents/openai-cookbook/examples-audio-duplex_voice_agent_evaluation-crawl_harness#response-completion)
...
[data/scenarios.json](https://github.com/openai/openai-cookbook/blob/a0709e05a54d8dd1c4d9be3fc0a41526c3496c39/examples/audio/duplex_voice_agent_evaluation/walk_harness/data/scenarios.json). Each scenario can provide:
...
`./results/walk/` by default. See [installation and path rules](/lib/08-agents/openai-cookbook/examples-audio-duplex_voice_agent_evaluation#installed-package-and-paths)
...
- `--assistant-endpoint wss://agent.example.com/ws/assistant` selects a
  ...
  it requires a dedicated service token. See [service setup](/lib/08-agents/openai-cookbook/examples-audio-duplex_voice_agent_evaluation-assistants#existing-application-endpoint).
...
[config.toml](https://github.com/openai/openai-cookbook/blob/a0709e05a54d8dd1c4d9be3fc0a41526c3496c39/examples/audio/duplex_voice_agent_evaluation/walk_harness/config.toml) controls the module:
...
the selected `.env` file or shell; [`.env.example`](https://github.com/openai/openai-cookbook/blob/a0709e05a54d8dd1c4d9be3fc0a41526c3496c39/examples/audio/duplex_voice_agent_evaluation/.env.example) is only a
setup template. See [environment-file selection](/lib/08-agents/openai-cookbook/examples-audio-duplex_voice_agent_evaluation#environment-file-selection).
...
[data/scenarios.json](https://github.com/openai/openai-cookbook/blob/a0709e05a54d8dd1c4d9be3fc0a41526c3496c39/examples/audio/duplex_voice_agent_evaluation/walk_harness/data/scenarios.json) uses the same portable JSON
