...
Read `README.md` for the runnable fixture and classroom modification exercise. Shared [persistence contract](/lib/08-agents/agent-systems-handbook/skills-personal-workflow-automation-references-persistence-contract) and [source notes](/lib/08-agents/agent-systems-handbook/skills-personal-workflow-automation-references-source-notes) define remote dependencies and attribution. Resolve scripts relative to this package; execute from the handbook root.
