---
title: "Local MCP Server Lifecycle"
...
entryUrl: "https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/.agents/references/local-mcp-server-lifecycle.md"
sourceRel: ".agents/references/local-mcp-server-lifecycle.md"
rawUrl: "/raw/08-agents/openai-agents-python/.agents/references/local-mcp-server-lifecycle.md"
sourceSha256: "d56991d429e30796a8339dd6b18371ab1c65feefc06b0f387b77468698238e07"
pageSha256: "d56991d429e30796a8339dd6b18371ab1c65feefc06b0f387b77468698238e07"
...
Use this reference for changes to Python-managed MCP servers, `MCPServerManager`, client-session request ordering, tool caching or filtering, local MCP retries, cancellation, or cleanup. Hosted MCP is a provider tool and follows the OpenAI API contract; use `$openai-knowledge` for that protocol surface. Read [Tool identity and routing](/lib/08-agents/openai-agents-python/_agents-references-tool-identity) for server-prefixed names and [Tool execution lifecycle](/lib/08-agents/openai-agents-python/_agents-references-tool-execution-lifecycle) for approval and invocation behavior after an MCP tool is converted to a `FunctionTool`.
