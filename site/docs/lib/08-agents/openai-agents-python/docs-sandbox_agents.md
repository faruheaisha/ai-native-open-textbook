...
entryUrl: "https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/docs/sandbox_agents.md"
sourceRel: "docs/sandbox_agents.md"
rawUrl: "/raw/08-agents/openai-agents-python/docs/sandbox_agents.md"
sourceSha256: "533b55ae40da81fc3ada6689d4ab59b293caa19f7369925cf176c0444896d27b"
pageSha256: "533b55ae40da81fc3ada6689d4ab59b293caa19f7369925cf176c0444896d27b"
...
- [Concepts](/lib/08-agents/openai-agents-python/docs-sandbox-guide): understand manifests, capabilities, permissions, snapshots, run config, and composition patterns.
- [Sandbox clients](/lib/08-agents/openai-agents-python/docs-sandbox-clients): choose Unix-local, Docker, hosted providers, and mount strategies.
- [Agent memory](/lib/08-agents/openai-agents-python/docs-sandbox-memory): preserve and reuse lessons from previous sandbox runs.
