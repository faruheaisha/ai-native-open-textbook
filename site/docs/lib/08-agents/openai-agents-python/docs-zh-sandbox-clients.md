...
entryUrl: "https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/docs/zh/sandbox/clients.md"
sourceRel: "docs/zh/sandbox/clients.md"
rawUrl: "/raw/08-agents/openai-agents-python/docs/zh/sandbox/clients.md"
sourceSha256: "237759b768087bfa54a58aa8639bd4d9fee25aeff1eb3c3604541171ab1973e7"
pageSha256: "237759b768087bfa54a58aa8639bd4d9fee25aeff1eb3c3604541171ab1973e7"
...
`SandboxPathGrant.host_path` 仅适用于 Docker，可将主机路径映射到容器内的另一个 POSIX 路径。Unix-local 仅支持相同路径授权。有关详细信息，请参阅[清单路径授权](/lib/08-agents/openai-agents-python/docs-zh-sandbox-guide#manifest)。
