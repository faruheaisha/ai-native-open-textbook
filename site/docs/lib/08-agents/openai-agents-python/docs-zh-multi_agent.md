...
entryUrl: "https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/docs/zh/multi_agent.md"
sourceRel: "docs/zh/multi_agent.md"
rawUrl: "/raw/08-agents/openai-agents-python/docs/zh/multi_agent.md"
sourceSha256: "4e1149cbd18f0780fcafa04fac59e5d09f7143b39a31f52c48af3bcfb35d28bf"
pageSha256: "4e1149cbd18f0780fcafa04fac59e5d09f7143b39a31f52c48af3bcfb35d28bf"
...
如果你想了解这种编排方式背后的 SDK 核心基础组件，请先参阅[工具](/lib/08-agents/openai-agents-python/docs-zh-tools)、[任务转移](/lib/08-agents/openai-agents-python/docs-zh-handoffs)和[运行智能体](/lib/08-agents/openai-agents-python/docs-zh-running_agents)。
...
-   [智能体](/lib/08-agents/openai-agents-python/docs-zh-agents)：组合模式和智能体配置。
-   [工具](/lib/08-agents/openai-agents-python/docs-zh-tools#agents-as-tools)：`Agent.as_tool()` 和管理器式编排。
-   [任务转移](/lib/08-agents/openai-agents-python/docs-zh-handoffs)：专业智能体之间的任务委派。
-   [运行智能体](/lib/08-agents/openai-agents-python/docs-zh-running_agents)：每次运行的编排控制和对话状态。
-   [快速入门](/lib/08-agents/openai-agents-python/docs-zh-quickstart)：最简端到端任务转移示例。
