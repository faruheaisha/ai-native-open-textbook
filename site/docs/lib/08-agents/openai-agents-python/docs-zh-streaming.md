...
entryUrl: "https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/docs/zh/streaming.md"
sourceRel: "docs/zh/streaming.md"
rawUrl: "/raw/08-agents/openai-agents-python/docs/zh/streaming.md"
sourceSha256: "e6bc0730b9c2cf3ca90d22e1a6b3d915665a87038f759e3508507bd6d72b14e8"
pageSha256: "e6bc0730b9c2cf3ca90d22e1a6b3d915665a87038f759e3508507bd6d72b14e8"
...
有关完整的暂停和恢复操作流程，请参阅[人在回路指南](/lib/08-agents/openai-agents-python/docs-zh-human_in_the_loop)。
...
-   如果在该未完成的运行恢复前收到了新的用户输入，请使用 `result.to_state()` 转换已消费完毕的结果，调用 [`state.add_input(...)`][agents.run_state.RunState.add_input]，然后从该状态恢复运行。运行器会在下一次模型调用前立即接纳暂存的输入；请参阅[恢复前添加输入](/lib/08-agents/openai-agents-python/docs-zh-results#add-input-before-resuming)。
