...
entryUrl: "https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/.agents/skills/runtime-behavior-probe/SKILL.md"
sourceRel: ".agents/skills/runtime-behavior-probe/SKILL.md"
rawUrl: "/raw/08-agents/openai-agents-python/.agents/skills/runtime-behavior-probe/SKILL.md"
sourceSha256: "df880793aa448189d210b0aa6258410263649045206ba8bee942ad518bb2de35"
pageSha256: "df880793aa448189d210b0aa6258410263649045206ba8bee942ad518bb2de35"
...
- For OpenAI API or OpenAI platform probes in this repository, use [$openai-knowledge](/lib/08-agents/openai-agents-python/_agents-skills-openai-knowledge-SKILL) early to confirm contract-sensitive details such as supported parameters, field names, and limits. Use runtime probing to validate or challenge the documented behavior, not to skip the documentation pass entirely. If the docs MCP is unavailable, fall back to the official OpenAI docs and say that you used the fallback in the report.
...
Open [validation-matrix.md](/lib/08-agents/openai-agents-python/_agents-skills-runtime-behavior-probe-references-validation-matrix) when you need a stronger prioritization model or a reusable case template.
...
Open [python_probe.py](https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/.agents/skills/runtime-behavior-probe/templates/python_probe.py) when you want a lightweight disposable Python probe scaffold.
...
Open [reporting-format.md](/lib/08-agents/openai-agents-python/_agents-skills-runtime-behavior-probe-references-reporting-format) for the recommended response template.

## Resources

- Open [validation-matrix.md](/lib/08-agents/openai-agents-python/_agents-skills-runtime-behavior-probe-references-validation-matrix) to design and prioritize the case matrix.
- Open [error-cases.md](/lib/08-agents/openai-agents-python/_agents-skills-runtime-behavior-probe-references-error-cases) to expand common failure scenarios.
- Open [openai-runtime-patterns.md](/lib/08-agents/openai-agents-python/_agents-skills-runtime-behavior-probe-references-openai-runtime-patterns) for recurring OpenAI and Responses API probe patterns.
- Open [reporting-format.md](/lib/08-agents/openai-agents-python/_agents-skills-runtime-behavior-probe-references-reporting-format) for the final report structure.
- Open [python_probe.py](https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/.agents/skills/runtime-behavior-probe/templates/python_probe.py) for a minimal disposable Python probe scaffold.
