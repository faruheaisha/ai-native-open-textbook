...
For a full pause/resume flow, see [Human-in-the-loop](/lib/08-agents/openai-agents-python/docs-human_in_the_loop) and `examples/mcp/get_all_mcp_tools_example/main.py`.
...
When you have multiple MCP servers, use `MCPServerManager` to connect them up front and expose the successfully connected subset of those servers to your agents. See the [MCPServerManager API reference](https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/docs/ref/mcp/manager.md) for constructor options and reconnect behavior.
...
![MCP Tracing Screenshot](/mirror/e5/e5b537dc814ed448f9df8d9b64d8ceba8aca6204.webp)
