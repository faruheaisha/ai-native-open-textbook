...
entryUrl: "https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/docs/zh/sandbox_agents.md"
sourceRel: "docs/zh/sandbox_agents.md"
rawUrl: "/raw/08-agents/openai-agents-python/docs/zh/sandbox_agents.md"
sourceSha256: "699adf09dde7c278a5a9c7d37f832ea81683ff7c888a8b96a76b44f9447a844a"
pageSha256: "699adf09dde7c278a5a9c7d37f832ea81683ff7c888a8b96a76b44f9447a844a"
...
- [概念](/lib/08-agents/openai-agents-python/docs-zh-sandbox-guide)：了解清单、能力、权限、快照、运行配置和组合模式。
- [沙箱客户端](/lib/08-agents/openai-agents-python/docs-zh-sandbox-clients)：选择 Unix 本地、Docker、托管提供商和挂载策略。
- [智能体记忆](/lib/08-agents/openai-agents-python/docs-zh-sandbox-memory)：保留并复用之前沙箱运行中获得的经验。

如果 Shell 访问只是你偶尔使用的一项工具，请先从[工具指南](/lib/08-agents/openai-agents-python/docs-zh-tools)中的托管 Shell 开始。当工作区隔离、沙箱客户端选择或沙箱会话恢复行为属于设计的一部分时，请使用沙箱智能体。
