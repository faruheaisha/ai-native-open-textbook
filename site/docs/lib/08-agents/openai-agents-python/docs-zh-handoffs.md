...
entryUrl: "https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/docs/zh/handoffs.md"
sourceRel: "docs/zh/handoffs.md"
rawUrl: "/raw/08-agents/openai-agents-python/docs/zh/handoffs.md"
sourceSha256: "0664227af732003cca4d38e8b5c490df239a0e746b8e101ff28861dbc76c44eb"
pageSha256: "0664227af732003cca4d38e8b5c490df239a0e746b8e101ff28861dbc76c44eb"
...
-   将现有的应用程序状态和依赖项放入 [`RunContextWrapper.context`][agents.run_context.RunContextWrapper.context]。请参阅[上下文指南](/lib/08-agents/openai-agents-python/docs-zh-context)。
...
-   如果要在不转移对话的情况下为嵌套的专家智能体提供结构化输入，请优先使用 [`Agent.as_tool(parameters=...)`][agents.agent.Agent.as_tool]。请参阅[工具](/lib/08-agents/openai-agents-python/docs-zh-tools#structured-input-for-tool-agents)。
