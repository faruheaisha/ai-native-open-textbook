...
entryUrl: "https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/tests/README.md"
sourceRel: "tests/README.md"
rawUrl: "/raw/08-agents/openai-agents-python/tests/README.md"
sourceSha256: "68927ae88aa3c7fa6bc9c5f6689d42ded87b67b6e5d68da615b61c4bac37db59"
pageSha256: "68927ae88aa3c7fa6bc9c5f6689d42ded87b67b6e5d68da615b61c4bac37db59"
...
During iterative implementation review, run focused tests for the changed behavior and relevant subsystem boundaries, including applicable `review_optional` cases without filtering them away. Resolve uncertain coverage by tracing affected callers and dependencies and selecting the needed focused checks. Follow [implementation-final-review](/lib/08-agents/openai-agents-python/_agents-skills-implementation-final-review-SKILL) for review sequencing; defer broad `make tests-review`, `make tests`, and repository-wide type checking until clean review. Then follow [code-change-verification](/lib/08-agents/openai-agents-python/_agents-skills-code-change-verification-SKILL) for the complete final SDK stack. Explicit requests to run a suite outside an implementation review remain supported.
