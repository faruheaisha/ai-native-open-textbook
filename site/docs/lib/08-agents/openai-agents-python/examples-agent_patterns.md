...
entryUrl: "https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/examples/agent_patterns/README.md"
sourceRel: "examples/agent_patterns/README.md"
rawUrl: "/raw/08-agents/openai-agents-python/examples/agent_patterns/README.md"
sourceSha256: "91cd17e4d50313204f1c40537e2e686e3259aa548e9873f36a7663513a05ca66"
pageSha256: "91cd17e4d50313204f1c40537e2e686e3259aa548e9873f36a7663513a05ca66"
...
The Responses API can coordinate server-hosted GPT-5.6 subagents while the normal SDK Runner executes developer-defined function tools locally. See [`hosted_multi_agent_beta.py`](https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/examples/agent_patterns/hosted_multi_agent_beta.py) for non-streaming and streaming examples using the experimental model module.
...
See the [`deterministic.py`](https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/examples/agent_patterns/deterministic.py) file for an example of this.
...
For example, you might have a frontline agent that receives a request, and then hands off to a specialized agent based on the language of the request. See the [`routing.py`](https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/examples/agent_patterns/routing.py) file for an example of this.
...
See the [`agents_as_tools.py`](https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/examples/agent_patterns/agents_as_tools.py) file for an example of this. See the [`agents_as_tools_streaming.py`](https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/examples/agent_patterns/agents_as_tools_streaming.py) file for a streaming variant that taps into nested agent events via `on_stream`. See the [`agents_as_tools_structured.py`](https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/examples/agent_patterns/agents_as_tools_structured.py) file for a structured-input variant using `Agent.as_tool()` parameters.
...
See the [`llm_as_a_judge.py`](https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/examples/agent_patterns/llm_as_a_judge.py) file for an example of this.
...
See the [`parallelization.py`](https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/examples/agent_patterns/parallelization.py) file for an example of this. It runs a translation agent multiple times in parallel, and then picks the best translation.
...
See the [`input_guardrails.py`](https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/examples/agent_patterns/input_guardrails.py) and [`output_guardrails.py`](https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/examples/agent_patterns/output_guardrails.py) files for examples.
...
See [`human_in_the_loop.py`](https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/examples/agent_patterns/human_in_the_loop.py) for the base approval flow and [`human_in_the_loop_custom_rejection.py`](https://github.com/openai/openai-agents-python/blob/83c737fd0b8d9a53bd39fa2a0856070417bb0bd3/examples/agent_patterns/human_in_the_loop_custom_rejection.py) for run-level tool error formatting when approvals are rejected.
