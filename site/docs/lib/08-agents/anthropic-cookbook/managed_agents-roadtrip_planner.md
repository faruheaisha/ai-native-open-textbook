...
entryUrl: "https://github.com/anthropics/anthropic-cookbook/blob/a97b9a2dc300635f0c26b5e05d0b54bbe0279ee5/managed_agents/roadtrip_planner/README.md"
sourceRel: "managed_agents/roadtrip_planner/README.md"
rawUrl: "/raw/08-agents/anthropic-cookbook/managed_agents/roadtrip_planner/README.md"
sourceSha256: "7d284c7a0b0c73d55ff962988b819b3b0cf1a3ad88a464be5e95db4c48d2dacd"
pageSha256: "7d284c7a0b0c73d55ff962988b819b3b0cf1a3ad88a464be5e95db4c48d2dacd"
...
- `event_deltas` on the session event stream: [`src/app/api/stream/route.ts`](https://github.com/anthropics/anthropic-cookbook/blob/a97b9a2dc300635f0c26b5e05d0b54bbe0279ee5/managed_agents/roadtrip_planner/src/app/api/stream/route.ts), the SSE proxy
- the SDK's `accumulateManagedAgentsEvent` folding previews in the browser: [`src/lib/use-managed-agent-session.ts`](https://github.com/anthropics/anthropic-cookbook/blob/a97b9a2dc300635f0c26b5e05d0b54bbe0279ee5/managed_agents/roadtrip_planner/src/lib/use-managed-agent-session.ts)
- the event log folded into renderable turns: [`src/lib/transcript.ts`](https://github.com/anthropics/anthropic-cookbook/blob/a97b9a2dc300635f0c26b5e05d0b54bbe0279ee5/managed_agents/roadtrip_planner/src/lib/transcript.ts)
- `injection_location` provisioned on each credential: [`setup/create.ts`](https://github.com/anthropics/anthropic-cookbook/blob/a97b9a2dc300635f0c26b5e05d0b54bbe0279ee5/managed_agents/roadtrip_planner/setup/create.ts), step 5
- `injection_location` flipped on a live credential: one `ant` CLI call, beat 2 below
- `agent_with_overrides` on session create: [`src/app/api/session/route.ts`](https://github.com/anthropics/anthropic-cookbook/blob/a97b9a2dc300635f0c26b5e05d0b54bbe0279ee5/managed_agents/roadtrip_planner/src/app/api/session/route.ts)
- the `multiagent` coordinator roster on the planner agent: [`setup/create.ts`](https://github.com/anthropics/anthropic-cookbook/blob/a97b9a2dc300635f0c26b5e05d0b54bbe0279ee5/managed_agents/roadtrip_planner/setup/create.ts), step 3
- thread events folded into the rail and the chat: [`src/lib/transcript.ts`](https://github.com/anthropics/anthropic-cookbook/blob/a97b9a2dc300635f0c26b5e05d0b54bbe0279ee5/managed_agents/roadtrip_planner/src/lib/transcript.ts)
...
Setup provisions each credential with the injection location its vendor documents, hardcoded in [`setup/create.ts`](https://github.com/anthropics/anthropic-cookbook/blob/a97b9a2dc300635f0c26b5e05d0b54bbe0279ee5/managed_agents/roadtrip_planner/setup/create.ts):
...
A Managed Agents session already is a resumable chat backend, so the client is three pieces, all in [`src/lib/use-managed-agent-session.ts`](https://github.com/anthropics/anthropic-cookbook/blob/a97b9a2dc300635f0c26b5e05d0b54bbe0279ee5/managed_agents/roadtrip_planner/src/lib/use-managed-agent-session.ts) and [`src/lib/transcript.ts`](https://github.com/anthropics/anthropic-cookbook/blob/a97b9a2dc300635f0c26b5e05d0b54bbe0279ee5/managed_agents/roadtrip_planner/src/lib/transcript.ts):
