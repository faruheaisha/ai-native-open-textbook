...
entryUrl: "https://github.com/anthropics/anthropic-cookbook/blob/a97b9a2dc300635f0c26b5e05d0b54bbe0279ee5/managed_agents/roadtrip_planner/skill.md"
sourceRel: "managed_agents/roadtrip_planner/skill.md"
rawUrl: "/raw/08-agents/anthropic-cookbook/managed_agents/roadtrip_planner/skill.md"
sourceSha256: "b9e94fbc64f497a04ba2190e9be95f1aa5693725f7c0cc0136820aeb7f972607"
pageSha256: "b9e94fbc64f497a04ba2190e9be95f1aa5693725f7c0cc0136820aeb7f972607"
...
Open <http://localhost:3000>. The page creates one session per browser on load (cookie `roadtrip_planner_session_id`), so the sandbox is warm before the first question. Then do the four beats in [README.md](/lib/08-agents/anthropic-cookbook/managed_agents-roadtrip_planner#four-things-to-do-with-it), in order. Beat 2 is the vault story and it only lands after a real conversation exists. Beat 3 is the `agent_with_overrides` model picker. Beat 4 is the multi-agent review: it needs a full itinerary ask, not a one-fact question.
