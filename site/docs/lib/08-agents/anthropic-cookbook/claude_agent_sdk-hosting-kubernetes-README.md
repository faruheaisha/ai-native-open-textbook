...
> Part of the [Agent SDK hosting cookbook](https://github.com/anthropics/anthropic-cookbook/blob/a97b9a2dc300635f0c26b5e05d0b54bbe0279ee5/claude_agent_sdk/07_Hosting_the_agent.ipynb).
...
[`hosting/Dockerfile`](https://github.com/anthropics/anthropic-cookbook/blob/a97b9a2dc300635f0c26b5e05d0b54bbe0279ee5/claude_agent_sdk/hosting/Dockerfile/README.md). Same image, different machinery: instead
...
> [Hosting overview](/lib/08-agents/anthropic-cookbook/claude_agent_sdk-hosting-README). This guide is for teams that need the
...
- DNS-level egress control — port 53 stays open to any resolver so node-local
  ...
  [`manifests/network-policy.yaml`](https://github.com/anthropics/anthropic-cookbook/blob/a97b9a2dc300635f0c26b5e05d0b54bbe0279ee5/claude_agent_sdk/hosting/kubernetes/manifests/network-policy.yaml) shows how
