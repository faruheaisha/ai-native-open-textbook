...
- There are many essential guides in the [guides](https://github.com/ed-donner/production/blob/daeb3dae34be3287842ea7faa3e6f4cba467028b/guides/01_intro.ipynb) section
- Please `git pull` frequently to get the latest updates - see [Guide 3 in the Guides folder](https://github.com/ed-donner/production/blob/daeb3dae34be3287842ea7faa3e6f4cba467028b/guides/03_git_and_github.ipynb) on how to pull.
