...
- <code v-pre>{{tool_name}}[{{tool_input}}]</code>:调用一个可用工具。
...
最终的答案就是最后一个步骤的执行结果 $s_n$。
  ...
  <img src="/mirror/cc/cc8a0123e5a347e62fcb966719d62a3221aaec86.webp" alt="Plan-and-Solve范式的两阶段工作流" width="90%"/>
...
<img src="/mirror/07/074f784c9056f2fe41d3f5e21bacb68dac2dbd3d.webp" alt="Reflection机制中的“执行-反思-优化”迭代循环" width="70%"/>
