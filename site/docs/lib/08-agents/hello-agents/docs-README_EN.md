...
| [Chapter 1: Introduction to Agents](/lib/08-agents/hello-agents/docs-chapter1-Chapter1-Introduction-to-Agents)                                      | Agent definition, types, paradigms, and applications                        | ✅      |
| [Chapter 2: History of Agents](/lib/08-agents/hello-agents/docs-chapter2-Chapter2-History-of-Agents)                                                | Evolution from symbolism to LLM-driven agents                               | ✅      |
| [Chapter 3: Large Language Model Fundamentals](/lib/08-agents/hello-agents/docs-chapter3-Chapter3-Fundamentals-of-Large-Language-Models)            | Transformer, prompts, mainstream LLMs and their limitations                 | ✅      |
| **Part Two: Building Your Large Language Model Agent**                                                                  |                                                                             |        |
| [Chapter 4: Building Classic Agent Paradigms](/lib/08-agents/hello-agents/docs-chapter4-Chapter4-Building-Classic-Agent-Paradigms)                  | Hands-on implementation of ReAct, Plan-and-Solve, Reflection                | ✅      |
| [Chapter 5: Agent Building Based on Low-Code Platforms](/lib/08-agents/hello-agents/docs-chapter5-Chapter5-Building-Agents-with-Low-Code-Platforms) | Understanding the use of low-code agent platforms like Coze, Dify, n8n      | ✅      |
| [Chapter 6: Framework Development Practice](/lib/08-agents/hello-agents/docs-chapter6-Chapter6-Framework-Development-Practice)                      | Application of mainstream frameworks such as AutoGen, AgentScope, LangGraph | ✅      |
| [Chapter 7: Building Your Agent Framework](/lib/08-agents/hello-agents/docs-chapter7-Chapter7-Building-Your-Agent-Framework)                        | Building an agent framework from scratch                                    | ✅      |
| **Part Three: Advanced Knowledge Extension**                                                                            |                                                                             |        |
| [Chapter 8: Memory and Retrieval](/lib/08-agents/hello-agents/docs-chapter8-Chapter8-Memory-and-Retrieval)                                          | Memory systems, RAG, storage                                                | ✅      |
| [Chapter 9: Context Engineering](/lib/08-agents/hello-agents/docs-chapter9-Chapter9-Context-Engineering)                                            | "Contextual understanding" for continuous interaction                       | ✅      |
| [Chapter 10: Agent Communication Protocols](/lib/08-agents/hello-agents/docs-chapter10-Chapter10-Agent-Communication-Protocols)                     | Analysis of protocols such as MCP, A2A, ANP                                 | ✅      |
| [Chapter 11: Agentic-RL](/lib/08-agents/hello-agents/docs-chapter11-Chapter11-Agentic-RL)                                                           | Practical LLM training from SFT to GRPO                                     | ✅      |
| [Chapter 12: Agent Performance Evaluation](/lib/08-agents/hello-agents/docs-chapter12-Chapter12-Agent-Performance-Evaluation)                       | Core metrics, benchmarks, and evaluation frameworks                         | ✅      |
| **Part Four: Comprehensive Case Studies**                                                                               |                                                                             |        |
| [Chapter 13: Intelligent Travel Assistant](https://github.com/datawhalechina/hello-agents/blob/4f7682ceafe573d07cd8a7d0b89908500e83227d/docs/chapter13/Chapter13-Intelligent-Travel-Assistant.md)                       | Real-world application of MCP and multi-agent collaboration                 | ✅      |
| [Chapter 14: Automated Deep Research Agent](https://github.com/datawhalechina/hello-agents/blob/4f7682ceafe573d07cd8a7d0b89908500e83227d/docs/chapter14/Chapter14-Automated-Deep-Research-Agent.md)                     | DeepResearch Agent reproduction and analysis                                | ✅      |
| [Chapter 15: Building a Cyber Town](/lib/08-agents/hello-agents/docs-chapter15-Chapter15-Building-Cyber-Town)                                       | Combination of Agents and games, simulating social dynamics                 | ✅      |
