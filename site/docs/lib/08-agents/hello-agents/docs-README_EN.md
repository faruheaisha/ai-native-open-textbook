...
entryUrl: "https://github.com/datawhalechina/hello-agents/blob/4f7682ceafe573d07cd8a7d0b89908500e83227d/docs/README_EN.md"
sourceRel: "docs/README_EN.md"
rawUrl: "/raw/08-agents/hello-agents/docs/README_EN.md"
sourceSha256: "1ae080e77c8f05bdc36ab7b0cf0017f1a480b9b19cba3cb712cc7c47c748dedf"
pageSha256: "1ae080e77c8f05bdc36ab7b0cf0017f1a480b9b19cba3cb712cc7c47c748dedf"
...
<div align='center'>
  <img src="/mirror/c8/c8a2232e1290445a2fbfd9addf38c5cee5b74e1e.png" alt="alt text" width="100%">
  <h1>Hello-Agents</h1>
...
| ----------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | ------ |
| [Preface](/lib/08-agents/hello-agents/docs-Preface)                                                                                                 | Project origin, background, and reader suggestions                          | ✅      |
| **Part One: Agent and Language Model Fundamentals**                                                                     |                                                                             |        |
| [Chapter 1: Introduction to Agents](/lib/08-agents/hello-agents/docs-chapter1-Chapter1-Introduction-to-Agents/index)                                      | Agent definition, types, paradigms, and applications                        | ✅      |
| [Chapter 2: History of Agents](/lib/08-agents/hello-agents/docs-chapter2-Chapter2-History-of-Agents/index)                                                | Evolution from symbolism to LLM-driven agents                               | ✅      |
| [Chapter 3: Large Language Model Fundamentals](/lib/08-agents/hello-agents/docs-chapter3-Chapter3-Fundamentals-of-Large-Language-Models/index)            | Transformer, prompts, mainstream LLMs and their limitations                 | ✅      |
| **Part Two: Building Your Large Language Model Agent**                                                                  |                                                                             |        |
| [Chapter 4: Building Classic Agent Paradigms](/lib/08-agents/hello-agents/docs-chapter4-Chapter4-Building-Classic-Agent-Paradigms/index)                  | Hands-on implementation of ReAct, Plan-and-Solve, Reflection                | ✅      |
| [Chapter 5: Agent Building Based on Low-Code Platforms](/lib/08-agents/hello-agents/docs-chapter5-Chapter5-Building-Agents-with-Low-Code-Platforms/index) | Understanding the use of low-code agent platforms like Coze, Dify, n8n      | ✅      |
| [Chapter 6: Framework Development Practice](/lib/08-agents/hello-agents/docs-chapter6-Chapter6-Framework-Development-Practice/index)                      | Application of mainstream frameworks such as AutoGen, AgentScope, LangGraph | ✅      |
| [Chapter 7: Building Your Agent Framework](/lib/08-agents/hello-agents/docs-chapter7-Chapter7-Building-Your-Agent-Framework/index)                        | Building an agent framework from scratch                                    | ✅      |
| **Part Three: Advanced Knowledge Extension**                                                                            |                                                                             |        |
| [Chapter 8: Memory and Retrieval](/lib/08-agents/hello-agents/docs-chapter8-Chapter8-Memory-and-Retrieval/index)                                          | Memory systems, RAG, storage                                                | ✅      |
| [Chapter 9: Context Engineering](/lib/08-agents/hello-agents/docs-chapter9-Chapter9-Context-Engineering/index)                                            | "Contextual understanding" for continuous interaction                       | ✅      |
| [Chapter 10: Agent Communication Protocols](/lib/08-agents/hello-agents/docs-chapter10-Chapter10-Agent-Communication-Protocols/index)                     | Analysis of protocols such as MCP, A2A, ANP                                 | ✅      |
| [Chapter 11: Agentic-RL](/lib/08-agents/hello-agents/docs-chapter11-Chapter11-Agentic-RL/index)                                                           | Practical LLM training from SFT to GRPO                                     | ✅      |
| [Chapter 12: Agent Performance Evaluation](/lib/08-agents/hello-agents/docs-chapter12-Chapter12-Agent-Performance-Evaluation/index)                       | Core metrics, benchmarks, and evaluation frameworks                         | ✅      |
| **Part Four: Comprehensive Case Studies**                                                                               |                                                                             |        |
| [Chapter 13: Intelligent Travel Assistant](/lib/08-agents/hello-agents/docs-chapter13-Chapter13-Intelligent-Travel-Assistant/index)                       | Real-world application of MCP and multi-agent collaboration                 | ✅      |
| [Chapter 14: Automated Deep Research Agent](/lib/08-agents/hello-agents/docs-chapter14-Chapter14-Automated-Deep-Research-Agent/index)                     | DeepResearch Agent reproduction and analysis                                | ✅      |
| [Chapter 15: Building a Cyber Town](/lib/08-agents/hello-agents/docs-chapter15-Chapter15-Building-Cyber-Town/index)                                       | Combination of Agents and games, simulating social dynamics                 | ✅      |
| **Part Five: Graduation Project and Future Outlook**                                                                    |                                                                             |        |
| [Chapter 16: Graduation Project](/lib/08-agents/hello-agents/docs-chapter16-Chapter16-Graduation-Project)                                           | Build your own complete multi-agent application                             | ✅      |
...
<div align='center'>
	<img src="/mirror/24/24641bf905e731ac5ea525de46b88abd076632bd.png" alt="阅读群额码" width="30%">
...
<div align='center'>
    <img src="/mirror/61/616e8ff958f4e8fcb707cd556dfa3c759eb0895a.png" alt="Datawhale" width="30%">
