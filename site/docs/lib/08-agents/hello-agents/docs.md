...
entryUrl: "https://github.com/datawhalechina/hello-agents/blob/4f7682ceafe573d07cd8a7d0b89908500e83227d/docs/README.md"
sourceRel: "docs/README.md"
rawUrl: "/raw/08-agents/hello-agents/docs/README.md"
sourceSha256: "c06e5e8cce5638db501b29fb9af851908f7a1d81fe669297997408ce7b3a49e3"
pageSha256: "c06e5e8cce5638db501b29fb9af851908f7a1d81fe669297997408ce7b3a49e3"
...
| 章节                                                                                   | 关键内容                                      | 状态 |
| -------------------------------------------------------------------------------------- | --------------------------------------------- | ---- |
| [前言](/lib/08-agents/hello-agents/overview)                                                                      | 项目的缘起、背景及读者建议                    | ✅    |
| <strong>第一部分：智能体与语言模型基础</strong>                                        |                                               |      |
| [第一章 初识智能体](/lib/08-agents/hello-agents/docs-chapter1-第一章_初识智能体)                                 | 智能体定义、类型、范式与应用                  | ✅    |
| [第二章 智能体发展史](/lib/08-agents/hello-agents/docs-chapter2-第二章_智能体发展史)                             | 从符号主义到 LLM 驱动的智能体演进             | ✅    |
| [第三章 大语言模型基础](/lib/08-agents/hello-agents/docs-chapter3-第三章_大语言模型基础/index)                         | Transformer、提示、主流 LLM 及其局限          | ✅    |
| <strong>第二部分：构建你的大语言模型智能体</strong>                                    |                                               |      |
| [第四章 智能体经典范式构建](/lib/08-agents/hello-agents/docs-chapter4-第四章_智能体经典范式构建/index)                 | 手把手实现 ReAct、Plan-and-Solve、Reflection  | ✅    |
| [第五章 基于低代码平台的智能体搭建](/lib/08-agents/hello-agents/docs-chapter5-第五章_基于低代码平台的智能体搭建/index) | 了解 Coze、Dify、n8n 等低代码智能体平台使用   | ✅    |
| [第六章 框架开发实践](/lib/08-agents/hello-agents/docs-chapter6-第六章_框架开发实践/index)                             | AutoGen、AgentScope、LangGraph 等主流框架应用 | ✅    |
| [第七章 构建你的Agent框架](/lib/08-agents/hello-agents/docs-chapter7-第七章_构建你的Agent框架/index)                   | 从 0 开始构建智能体框架                       | ✅    |
| <strong>第三部分：高级知识扩展</strong>                                                |                                               |      |
| [第八章 记忆与检索](/lib/08-agents/hello-agents/docs-chapter8-第八章_记忆与检索/index)                                 | 记忆系统，RAG，存储                           | ✅    |
| [第九章 上下文工程](/lib/08-agents/hello-agents/docs-chapter9-第九章_上下文工程/index)                                 | 持续交互的"情境理解"                          | ✅    |
| [第十章 智能体通信协议](/lib/08-agents/hello-agents/docs-chapter10-第十章_智能体通信协议/index)                        | MCP、A2A、ANP 等协议解析                      | ✅    |
| [第十一章 Agentic-RL](/lib/08-agents/hello-agents/docs-chapter11-第十一章_Agentic-RL/index)                            | 从 SFT 到 GRPO 的 LLM 训练实战                | ✅    |
| [第十二章 智能体性能评估](/lib/08-agents/hello-agents/docs-chapter12-第十二章_智能体性能评估/index)                    | 核心指标、基准测试与评估框架                  | ✅    |
| <strong>第四部分：综合案例进阶</strong>                                                |                                               |      |
| [第十三章 智能旅行助手](/lib/08-agents/hello-agents/docs-chapter13-第十三章_智能旅行助手/index)                        | MCP 与多智能体协作的真实世界应用              | ✅    |
| [第十四章 自动化深度研究智能体](/lib/08-agents/hello-agents/docs-chapter14-第十四章_自动化深度研究智能体/index)        | DeepResearch Agent 复现与解析                 | ✅    |
| [第十五章 构建赛博小镇](/lib/08-agents/hello-agents/docs-chapter15-第十五章_构建赛博小镇/index)                        | Agent 与游戏的结合，模拟社会动态              | ✅    |
| <strong>第五部分：毕业设计及未来展望</strong>                                          |                                               |      |
| [第十六章 毕业设计](/lib/08-agents/hello-agents/docs-chapter16-第十六章_毕业设计)                                | 构建属于你的完整多智能体应用                  | ✅    |
...
<div align='center'>
    <img src="/mirror/44/44af02ff48ee53548f27441ae301534ef5471a8c.png" alt="读者群二维码" width="30%">
