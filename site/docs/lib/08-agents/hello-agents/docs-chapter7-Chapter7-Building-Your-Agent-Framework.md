...
- <code v-pre>{{tool_name}}[{{tool_input}}]</code> - Call specified tool
...
def _eval_node(node, operators, functions):
    ...
    if isinstance(node, ast.Constant):
        ...
        if func_name in functions:
            ...
            return functions[func_name](https://github.com/datawhalechina/hello-agents/blob/4f7682ceafe573d07cd8a7d0b89908500e83227d/docs/chapter7/*args/README.md)
...
1. This chapter built the `HelloAgents` framework and explained "why we need to build our own Agent framework." Please analyze:
   ...
   - Section 7.1.1 mentioned four main limitations of current mainstream frameworks. Combined with your actual experience using a framework in [Chapter 6 exercises](/lib/08-agents/hello-agents/docs-chapter6-第六章_框架开发实践#习题) or actual projects, explain how these problems affect development efficiency.
