...
if calc_agent:
    ...
    for query in test_queries:
        if "信息" in query:
            result = calc_agent.skills["info"](https://github.com/datawhalechina/hello-agents/blob/4f7682ceafe573d07cd8a7d0b89908500e83227d/docs/chapter10/query/README.md)
        elif "+" in query:
            result = calc_agent.skills["add"](https://github.com/datawhalechina/hello-agents/blob/4f7682ceafe573d07cd8a7d0b89908500e83227d/docs/chapter10/query/README.md)
        elif "*" in query or "×" in query:
            result = calc_agent.skills["multiply"](https://github.com/datawhalechina/hello-agents/blob/4f7682ceafe573d07cd8a7d0b89908500e83227d/docs/chapter10/query/README.md)
        else:
            result = "未知查询类型"
...
if custom_agent:
    # 测试技能
    print("测试问候技能:")
    result1 = custom_agent.skills["greet"](https://github.com/datawhalechina/hello-agents/blob/4f7682ceafe573d07cd8a7d0b89908500e83227d/docs/chapter10/%22张三%22/README.md)
    print(result1)
