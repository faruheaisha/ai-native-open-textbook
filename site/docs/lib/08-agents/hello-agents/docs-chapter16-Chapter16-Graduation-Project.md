...
entryUrl: "https://github.com/datawhalechina/hello-agents/blob/4f7682ceafe573d07cd8a7d0b89908500e83227d/docs/chapter16/Chapter16-Graduation-Project.md"
sourceRel: "docs/chapter16/Chapter16-Graduation-Project.md"
rawUrl: "/raw/08-agents/hello-agents/docs/chapter16/Chapter16-Graduation-Project.md"
sourceSha256: "7a52940e81192ef906552072f1400261b4d8fbd63ac18377d8fe99fcd19cd567"
pageSha256: "7a52940e81192ef906552072f1400261b4d8fbd63ac18377d8fe99fcd19cd567"
...
3. Select your GitHub account and create the Fork
  ...
  <img src="/mirror/6f/6ff3c8956f9f5e3d29d312456b95de0cf0c1bbf7.png" alt="" width="85%"/>
...
```
  ...
  <img src="/mirror/7e/7e1955c91608b56007a3e16841f281c459676361.png" alt="" width="85%"/>
...
- Dataset 1: [Baidu Netdisk](https://github.com/datawhalechina/hello-agents/blob/4f7682ceafe573d07cd8a7d0b89908500e83227d/docs/chapter16/link/README.md) Extraction code: xxxx
- Dataset 2: [Google Drive](https://github.com/datawhalechina/hello-agents/blob/4f7682ceafe573d07cd8a7d0b89908500e83227d/docs/chapter16/link/README.md)
- Demo video: [Bilibili](https://github.com/datawhalechina/hello-agents/blob/4f7682ceafe573d07cd8a7d0b89908500e83227d/docs/chapter16/link/README.md) / [YouTube](https://github.com/datawhalechina/hello-agents/blob/4f7682ceafe573d07cd8a7d0b89908500e83227d/docs/chapter16/link/README.md)
```
...
- Complete dataset (100,000 records) download from [here](https://github.com/datawhalechina/hello-agents/blob/4f7682ceafe573d07cd8a7d0b89908500e83227d/docs/chapter16/link/README.md)
```
...
### Demo Video
- Bilibili: [Project Demo Video](https://github.com/datawhalechina/hello-agents/blob/4f7682ceafe573d07cd8a7d0b89908500e83227d/docs/chapter16/link/README.md)
- YouTube: [Demo Video](https://github.com/datawhalechina/hello-agents/blob/4f7682ceafe573d07cd8a7d0b89908500e83227d/docs/chapter16/link/README.md)
```
...
3. Click the "New pull request" button
  ...
  <img src="/mirror/7c/7c0f0ac9f1e1507e1bc683a5b1dc884a6dcc0474.png" alt="" width="85%"/>
...
As shown in Figure 16.4, click the "Create pull request" button to submit.
  ...
  <img src="/mirror/81/810ccad62db06162e00b6c4db14c9c21b9d90560.png" alt="" width="85%"/>
