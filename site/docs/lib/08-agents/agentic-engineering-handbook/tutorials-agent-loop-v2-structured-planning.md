...
Open [`v2_todo_agent.py`](https://github.com/keyuchen21/agentic-engineering-handbook/blob/002d5456ac717fb6c4444005c9bb2ceff416d8c7/tutorials/agent-loop/v2_todo_agent.py) and read these pieces first:
...
[← v1](/lib/08-agents/agentic-engineering-handbook/tutorials-agent-loop-v1-model-as-agent) | [Back to README](https://github.com/keyuchen21/agentic-engineering-handbook/blob/002d5456ac717fb6c4444005c9bb2ceff416d8c7/tutorials/README.md) | [v3 →](/lib/08-agents/agentic-engineering-handbook/tutorials-agent-loop-v3-subagent-mechanism)
