...
2. Use [vector search](https://github.com/Osly-AI/PocketManus/blob/8ab0ec5f2d5dc17ff58b060af7afcda08a9f57fd/PocketFlow/docs/design_pattern/tool.md) to retrieve relevant exchanges beyond the last 4.
