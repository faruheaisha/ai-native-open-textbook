...
entryUrl: "https://github.com/Osly-AI/PocketManus/blob/8ab0ec5f2d5dc17ff58b060af7afcda08a9f57fd/PocketFlow/docs/design_pattern/agent.md"
sourceRel: "PocketFlow/docs/design_pattern/agent.md"
rawUrl: "/raw/08-agents/pocket-manus/PocketFlow/docs/design_pattern/agent.md"
sourceSha256: "3bb7b6e9e6aff717f5a6e95c198934536a631255c4e9044097bef30be38a424e"
pageSha256: "3bb7b6e9e6aff717f5a6e95c198934536a631255c4e9044097bef30be38a424e"
...
Then, connect this agent node with [branching](/lib/08-agents/pocket-manus/PocketFlow-docs-core_abstraction-flow) to other action nodes.

> The core of building **performant** and **reliable** agents boils down to:
>
> 1. **Context Management:** Provide *clear, relevant context* so agents can understand the problem. For example, rather than dumping an entire chat history or entire files, use a [Workflow](/lib/08-agents/pocket-manus/PocketFlow-docs-design_pattern-workflow) that filters out and includes only the most relevant information.
>
