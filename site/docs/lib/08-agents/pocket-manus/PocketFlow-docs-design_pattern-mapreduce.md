...
and there is a logical way to break the task into smaller, ideally independent parts. 
  ...
  <img src="https://github.com/The-Pocket-World/Pocketflow-Framework-Py/raw/main/assets/mapreduce.png?raw=true" width="400"/>

You first break down the task using [BatchNode](/lib/08-agents/pocket-manus/PocketFlow-docs-core_abstraction-batch) in the map phase, followed by aggregation in the reduce phase.
