...
entryUrl: "https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/25-LangGraph高级特性.md"
sourceRel: "25-LangGraph高级特性.md"
rawUrl: "/raw/08-agents/ai-agents-from-zero/25-LangGraph高级特性.md"
sourceSha256: "45f4d58d9de143566391d671e02c6185879c3d1c82bc968ac996a6fcbb4a9884"
pageSha256: "45f4d58d9de143566391d671e02c6185879c3d1c82bc968ac996a6fcbb4a9884"
...
LangGraph 图本身实现了 **Runnable** 接口，所以自然拥有这些流式能力。这也让它和 [LangChain `Runnable` / LCEL](/lib/08-agents/ai-agents-from-zero/15-LCEL与链式调用) 体系能够衔接起来。
...
[StreamGraphState.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/07-senior/streaming/StreamGraphState.py ":include :type=code")
...
[StreamMultipleModes.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/07-senior/streaming/StreamMultipleModes.py ":include :type=code")
...
[StreamLLMTokens.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/07-senior/streaming/StreamLLMTokens.py ":include :type=code")
...
[StreamCustomDataSimple.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/07-senior/streaming/StreamCustomDataSimple.py ":include :type=code")

【案例源码】`案例与源码-3-LangGraph框架/07-senior/streaming/StreamCustomData.py`

[StreamCustomData.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/07-senior/streaming/StreamCustomData.py ":include :type=code")
...
LangGraph 的持久化核心围绕 **checkpoint（检查点）** 展开。给图配置 checkpointer 后，图在执行过程中会把状态保存成一个个检查点。被保存的字段与合并规则，仍由你在 [第 23 章](/lib/08-agents/ai-agents-from-zero/23-LangGraphAPI_图与状态) 定义的 **State / Reducer** 决定。
...
![Checkpoint 持久化概念：自动存档、失败恢复、暂停与恢复、时间旅行与审计追踪](/mirror/62/625dc5aeeeaddca764dcdbd605db42e602ea27a3.svg)
...
![同一 Agent 会话内通过 Checkpointer 保持上下文：第二次调用可以沿用第一次天气工具返回的结果](/mirror/fd/fdf07b5d48c48e8e43256c6b20925cc4b96eb22b.png)
...
![节点报错后的断点恢复场景：Node1 正常写入状态，Node2 报错，修复后希望从 checkpoint 继续执行](/mirror/51/514b6efcdea52eb0873d05170c3ef0ab875be774.png)
...
3. 调用图时传入 <code v-pre>config=\{"configurable": \{"thread_id": "..."}}</code>。
...
![LangGraph 持久化后端选型：从内存、SQLite 到 Postgres / Redis 的学习与生产部署演进路线](/mirror/25/25022a2b26cd1cf7d70fbf63be0e2bc63cb281c4.png)
...
[MemoryPersistence.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/07-senior/state_persistence/MemoryPersistence.py ":include :type=code")
...
[SqlitePersistence.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/07-senior/state_persistence/SqlitePersistence.py ":include :type=code")
...
[AgentPersistence.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/07-senior/state_persistence/AgentPersistence.py ":include :type=code")
...
![interrupt 恢复时节点会重新执行：副作用不要放在 interrupt 前，推荐在审核通过后的 execute_node 中真正执行](/mirror/f4/f4e3e2af6af1cc8a8c1f4d059397c0d27d02d6d5.png)
...
[TimeTravel.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/07-senior/time_travel/TimeTravel.py ":include :type=code")
...
[SubGraphHello.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/07-senior/subgraph/SubGraphHello.py ":include :type=code")
...
[SubGraphSimple.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/07-senior/subgraph/SubGraphSimple.py ":include :type=code")
...
[SubGraphPro.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/07-senior/subgraph/SubGraphPro.py ":include :type=code")
