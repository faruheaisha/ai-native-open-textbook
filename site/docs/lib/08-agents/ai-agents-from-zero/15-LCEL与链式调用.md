...
- 能读懂并运行本章全部案例：**顺序链、分支链、多步串行链、并行链、函数链**，建立后续学习 [记忆与对话历史](/lib/08-agents/ai-agents-from-zero/16-记忆与对话历史_含Redis基础_)、[Tools 工具调用](/lib/08-agents/ai-agents-from-zero/17-Tools工具调用)、[RAG](/lib/08-agents/ai-agents-from-zero/19-RAG检索增强生成)、[Agent](/lib/08-agents/ai-agents-from-zero/21-Agent智能体) 的基础。
...
- [Prompt 模板](/lib/08-agents/ai-agents-from-zero/13-提示词与消息模板)、[聊天模型](/lib/08-agents/ai-agents-from-zero/11-Model-I-O与模型接入)、[输出解析器](/lib/08-agents/ai-agents-from-zero/14-输出解析器)
- 后面会学到的检索器、工具、甚至整条链
...
如果把 [第 13 章](/lib/08-agents/ai-agents-from-zero/13-提示词与消息模板)、[第 11 章](/lib/08-agents/ai-agents-from-zero/11-Model-I-O与模型接入)、[第 14 章](/lib/08-agents/ai-agents-from-zero/14-输出解析器) 放在一起看，你会发现最典型的一条链就是：
...
[LCEL_RunnableSequenceDemo.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/06-lcel/LCEL_RunnableSequenceDemo.py ":include :type=code")
...
[LCEL_RunnableBranchDemo.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/06-lcel/LCEL_RunnableBranchDemo.py ":include :type=code")
...
[LCEL_MultiStepChainDemo.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/06-lcel/LCEL_MultiStepChainDemo.py ":include :type=code")
...
[LCEL_RunnableParallelDemo.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/06-lcel/LCEL_RunnableParallelDemo.py ":include :type=code")
...
[LCEL_RunnableLambdaDemo.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/06-lcel/LCEL_RunnableLambdaDemo.py ":include :type=code")
...
- **链的核心主线** 是前面几章内容的自然延伸：把 [提示词模板](/lib/08-agents/ai-agents-from-zero/13-提示词与消息模板)、[模型调用](/lib/08-agents/ai-agents-from-zero/11-Model-I-O与模型接入)、[输出解析器](/lib/08-agents/ai-agents-from-zero/14-输出解析器) 组织成一条可执行流程。
...
**建议下一步：** 先把本章 5 个案例都跑一遍，重点观察“每一步输入输出是什么、为什么能接上下一步”；然后继续学习 [第 16 章 记忆与对话历史](/lib/08-agents/ai-agents-from-zero/16-记忆与对话历史_含Redis基础_) 和 [第 17 章 Tools 工具调用](/lib/08-agents/ai-agents-from-zero/17-Tools工具调用)，你会更清楚链式调用如何进一步扩展成带状态、带工具、带决策能力的 LLM 应用。
