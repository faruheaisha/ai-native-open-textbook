---
title: "12 - 深度研搜：RAGFlow 子智能体与知识库准备"
...
entryUrl: "https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/实战项目-深度研搜/12-RAGFlow子智能体与知识库准备.md"
sourceRel: "实战项目-深度研搜/12-RAGFlow子智能体与知识库准备.md"
rawUrl: "/raw/08-agents/ai-agents-from-zero/实战项目-深度研搜/12-RAGFlow子智能体与知识库准备.md"
sourceSha256: "eeca27cfda758ec1a92ca9c23b804c0895111ade2e4b978b059761950c0b1e27"
pageSha256: "eeca27cfda758ec1a92ca9c23b804c0895111ade2e4b978b059761950c0b1e27"
...
![腾讯云 CVM 购买页面：选择竞价实例、地域、可用区和基础规格](/mirror/93/935128b199a21e22bd1d6dd963a708f8f826c429.png)
...
![腾讯云安全组配置页面：课堂测试可临时放开入站规则，真实项目只开放必要端口](/mirror/69/69e43adc0711d6f14bc67ff693df4a2fa5293b5d.png)

截图里的安全组配置只适合课堂临时测试。真实项目里，RAGFlow 页面、数据库、对象存储和向量检索服务都不要直接暴露给公网。

![腾讯云实例创建结果页面：记录公网 IP、登录密码和安全组信息](/mirror/7e/7efb8ece8625e34cc0f1b22ffe7061d35b59a152.png)
...
![Docker 镜像加速配置验证与 RAGFlow 镜像拉取过程：确认 Registry Mirrors 生效并开始拉取依赖镜像](/mirror/48/48c21674bea5d6157b2347d831d12f4427206c9e.png)
...
![RAGFlow 服务日志：看到服务监听地址后再进入浏览器访问](/mirror/c1/c1bffb8113da87a69547047014e4679d95e216c9.png)
...
![RAGFlow 登录或注册页面：确认公网访问、端口映射和主服务启动正常](/mirror/46/46b6a6798118f2ba4c02f50245be31aaa8685e43.png)
...
![RAGFlow 模型供应商配置页面：选择 Tongyi-Qianwen 并填写百炼 API Key](/mirror/83/83a6035ff86a430b8a348371b66abe065cd0b413.png)
...
![RAGFlow 知识库列表页面：确认电商行业和金融行业两个知识库已经创建](/mirror/bd/bdfb10018270b108e0b3ad9483b3a2ec2731402e.png)
...
![RAGFlow 文件上传页面：上传资料后需要等待解析状态完成](/mirror/02/0268c3fa98afffac7caacba9746b3f1658b70e6e.png)
...
![RAGFlow 聊天助手列表页面：确认不同业务方向的助手已经创建并准备绑定知识库](/mirror/60/601fb2a83a10f63d5107d1ecaac1cce4680d1dc1.png)
...
![RAGFlow 页面测试结果：确认助手能基于知识库返回答案和引用来源](/mirror/e0/e01efd4aa38bdf8ad893f75c6dce9e0658f57d82.png)
...
![RAGFlow 个人中心 API Key 页面：生成后端代码调用服务所需的访问密钥](/mirror/e9/e9842560db9068fb4742144ceac1557649ae9379.png)
