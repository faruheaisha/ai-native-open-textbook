...
entryUrl: "https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/实战项目-电商问数/9-字段与指标检索能力构建.md"
sourceRel: "实战项目-电商问数/9-字段与指标检索能力构建.md"
rawUrl: "/raw/08-agents/ai-agents-from-zero/实战项目-电商问数/9-字段与指标检索能力构建.md"
sourceSha256: "b43fdfab3bf582d4c93ccf31b979f8959ead6047186ec48827e3e9c4c80106b1"
pageSha256: "b43fdfab3bf582d4c93ccf31b979f8959ead6047186ec48827e3e9c4c80106b1"
...
![一个字段会按字段名、描述和别名拆成多条向量记录](/mirror/68/6874a79bedaf5ea7ef4bbe5b6c6e9c592cf1774b.png)
...
![在 Qdrant Dashboard 中查看字段向量 collection 和字段 payload](/mirror/d6/d6cafa9d5b761a6bc1b3355b70558f00a382ff67.png)
...
![在 Kibana Dev Tools 中搜索字段真实值并返回 column_id](/mirror/26/26183f87aa89968db31cfe988918dedc111c1b75.png)
...
![在 Meta MySQL 中查看 metric_info、column_metric 等元数据表](/mirror/64/64d60af107aff30e231628f3e927d3ee0fd31099.png)

2. `Qdrant` 里已经有两个 collection

当前项目里对应的是 `column_info_collection` 和 `metric_info_collection`。

![在 Qdrant Dashboard 中查看字段和指标两个向量 collection](/mirror/54/54c3ff46c6400035f68f176e4ff3a7c4f6264eb3.png)

3. `Elasticsearch` 里的字段值索引已经建好

当前项目里对应的是 `value_index`。

![在 Kibana Index Management 中查看 value_index 索引](/mirror/01/0180728f30f87809433e77a223994792a99c94d1.png)
