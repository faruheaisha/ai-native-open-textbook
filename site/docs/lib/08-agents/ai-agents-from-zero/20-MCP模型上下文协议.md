...
- 理解 **MCP（Model Context Protocol，模型上下文协议）** 是什么、解决什么痛点，以及它与 [Tool](/lib/08-agents/ai-agents-from-zero/17-Tools工具调用)、[RAG](/lib/08-agents/ai-agents-from-zero/19-RAG检索增强生成)、[Agent](/lib/08-agents/ai-agents-from-zero/21-Agent智能体) 的定位区别。
- 掌握 MCP 的**主机 / 客户端 / 服务器**架构、核心能力、常见传输方式，以及 `mcp.json`、FastMCP、LangChain MCP 适配器在项目中的作用。
- 跑通并理解本章全部案例：**极简教学版服务端、FastMCP 服务端、天气 MCP 服务、同进程客户端、基于 `mcp.json` + LangChain Agent 的 MCP 客户端**，为后续学习 [第 21 章 Agent 智能体](/lib/08-agents/ai-agents-from-zero/21-Agent智能体) 打基础。
...
![无 MCP 时：各 AI 应用需分别对接 GitHub、Slack、数据库等，重复开发与适配成本高](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/20/20-1-1-1.jpeg)
...
![若缺乏统一协议，每接一类系统都要单独实现连接与鉴权，维护成本陡增](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/20/20-1-3-1.jpeg)
...
> **术语约定：** 本章里表格写作 **Tool / Function Calling**，是为了兼容不同文档语境；和 [第 17 章](/lib/08-agents/ai-agents-from-zero/17-Tools工具调用) 一样，你可以把它们先看成同一层“模型如何表达工具调用意图”的机制。
...
![分散接入：各工具、服务、客户端各自约定协议与 schema，重复适配多](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/20/20-3-1-1.jpeg)

> **说明**：「分」——各应用、各数据源各自对接，重复开发、难以复用。

![MCP 统一层：标准化暴露后，由 Host 侧按同一套方式发现与调用能力](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/20/20-3-1-2.jpeg)
...
![通过 Registry 或目录浏览、发现已发布的 MCP 服务与能力（示意）](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/20/20-4-1-1.jpeg)
...
4. 让 Agent 在对话中实际调用它们（Agent 的创建与执行细节见 [第 21 章 Agent 智能体](/lib/08-agents/ai-agents-from-zero/21-Agent智能体)）
...
![MCP 架构：Host（用户应用）内的 Client 与远端或子进程中的 Server 通信，Server 再访问本地/远程资源](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/20/20-5-1-1.jpeg)
...
![多 Server 拓扑：同一 Host 可挂多个 Client，各 Client 分别维护到一台 Server 的会话](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/20/20-5-1-2.jpeg)
...
![传输方式对照：stdio（子进程管道）与 Streamable HTTP（独立 HTTP 服务，可含 SSE 流式）及历史 SSE 兼容语境](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/20/20-5-3-1.jpeg)
...
[McpServer.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/11-mcp/McpServer.py ":include :type=code")
...
[McpServerByFastMCP.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/11-mcp/McpServerByFastMCP.py ":include :type=code")
...
[McpServerWeatherByFastMCP.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/11-mcp/McpServerWeatherByFastMCP.py ":include :type=code")
...
[mcp.json](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/11-mcp/mcp.json ":include :type=code")
...
[McpClient.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/11-mcp/McpClient.py ":include :type=code")
...
[McpClientAgent.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/11-mcp/McpClientAgent.py ":include :type=code")
...
**建议下一步：** 建议先把本章的本地服务端和客户端都亲手跑通，再回看 [第 17 章 Tools 工具调用](/lib/08-agents/ai-agents-from-zero/17-Tools工具调用) 和 [第 21 章 Agent 智能体](/lib/08-agents/ai-agents-from-zero/21-Agent智能体)，你会更容易看清“本地 Tool、MCP Tool、Agent 决策层”三者在工程上的分工。
