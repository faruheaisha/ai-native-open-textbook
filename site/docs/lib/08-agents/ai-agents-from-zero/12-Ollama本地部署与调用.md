...
- 学会使用 **LangChain** 里的 `ChatOllama` 调用本机 Ollama 服务，理解它与 [第 11 章 Model I/O 与模型接入](/lib/08-agents/ai-agents-from-zero/11-Model-I-O与模型接入) 中云端模型调用的异同。
...
![Ollama 官方标志：羊驼线稿风格图标（品牌识别，常见于安装包与文档）](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/12/12-1-1-1.png)
...
![Windows 安装向导中自定义 Ollama 程序安装路径的操作步骤（动图）](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/12/12-2-4-1.gif)
...
![Windows「环境变量」对话框中新建用户变量 OLLAMA_MODELS 并指向自定义 models 目录](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/12/12-2-5-1.jpeg)
...
![将已有 blobs、manifests 等模型目录内容复制到 OLLAMA_MODELS 指定路径以复用下载](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/12/12-2-6-1.jpeg)
...
![Ollama 桌面客户端菜单中打开 Settings（设置）的入口位置](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/12/12-2-7-1.png)

![在 Settings 中将 Model location 改为课程资料或自定义的 models 文件夹](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/12/12-2-7-2.png)
...
![本地 LangChain 应用连接 Ollama 服务：代码发送请求，本地服务加载模型文件并返回 AI 回复](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/12/12-5-1-1.png)
...
如果你希望和 [第 13 章 提示词与消息模板](/lib/08-agents/ai-agents-from-zero/13-提示词与消息模板) 保持一致，也可以传消息列表：
...
[LangChain_Ollama.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/03-ollama/LangChain_Ollama.py ":include :type=code")
...
**建议下一步：** 先亲手完成这条最小链路：安装 Ollama → `ollama run qwen:4b` 跑通一次本地模型 → 用 `案例与源码-2-LangChain框架/03-ollama/LangChain_Ollama.py` 在 Python 里调通本机模型。跑通之后，再进入 [第 13 章 提示词与消息模板](/lib/08-agents/ai-agents-from-zero/13-提示词与消息模板)、[第 14 章 输出解析器](/lib/08-agents/ai-agents-from-zero/14-输出解析器)、[第 15 章 LCEL 与链式调用](/lib/08-agents/ai-agents-from-zero/15-LCEL与链式调用)，把本地模型也串进完整的 LangChain 工作流里。
