...
entryUrl: "https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/26-LangGraph多智能体与A2A.md"
sourceRel: "26-LangGraph多智能体与A2A.md"
rawUrl: "/raw/08-agents/ai-agents-from-zero/26-LangGraph多智能体与A2A.md"
sourceSha256: "6c988bd4361d3e491f4d42f9dce1981ad1c743a37c3350fb2e470da31260de43"
pageSha256: "6c988bd4361d3e491f4d42f9dce1981ad1c743a37c3350fb2e470da31260de43"
...
**官方文档与资源**：详见 [工具导航与参考资料索引 - LangGraph](/lib/08-agents/ai-agents-from-zero/工具导航与参考资料索引#LangGraph)、[工具导航与参考资料索引 - 工具调用、mcp与智能体](/lib/08-agents/ai-agents-from-zero/工具导航与参考资料索引#工具调用、mcp与智能体)。
...
![MCP 与 A2A 的区别：MCP 负责 Agent 接入工具和资源，A2A 负责 Agent 与 Agent 之间的跨系统任务协作](/mirror/63/63c86ebb836604a9762791b9666701e28ba85f7e.png)
...
[LangGraphAgent.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/08-multi_agent/LangGraphAgent.py ":include :type=code")
...
![Supervisor 执行流程示意：主管 Agent 接收用户请求后，按任务类型调度航班、酒店等子 Agent，并汇总结果返回给用户](/mirror/2b/2b6df18414cbc1f6d9db4cf336602737b6f22b3f.svg)
...
[SupervisorV0.3.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/08-multi_agent/SupervisorV0.3.py ":include :type=code")
...
[SupervisorV1.0.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/08-multi_agent/SupervisorV1.0.py ":include :type=code")
...
[SupervisorHandoff.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/08-multi_agent/SupervisorHandoff.py ":include :type=code")
...
请继续看 [第 27 章 Agent Skills 智能体技能与 AI 编程工具实践](/lib/08-agents/ai-agents-from-zero/27-Skills技能与AI编程工具实践)。
...
**建议下一步：** 建议先完整运行 `案例与源码-3-LangGraph框架/08-multi_agent` 下的 4 个案例，再回头对照 [第 20 章 MCP 模型上下文协议](/lib/08-agents/ai-agents-from-zero/20-MCP模型上下文协议)、[第 21 章 Agent 智能体](/lib/08-agents/ai-agents-from-zero/21-Agent智能体)、[第 25 章 LangGraph 高级特性](/lib/08-agents/ai-agents-from-zero/25-LangGraph高级特性) 一起理解。这样你会更容易把“工具接入、单智能体、多智能体、协议互通”四层关系真正串起来。
