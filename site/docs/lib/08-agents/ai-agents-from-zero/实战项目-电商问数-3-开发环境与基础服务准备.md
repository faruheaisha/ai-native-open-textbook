...
entryUrl: "https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/实战项目-电商问数/3-开发环境与基础服务准备.md"
sourceRel: "实战项目-电商问数/3-开发环境与基础服务准备.md"
rawUrl: "/raw/08-agents/ai-agents-from-zero/实战项目-电商问数/3-开发环境与基础服务准备.md"
sourceSha256: "55b81b7cfce1b631c6149a2c88685da3540bfe54487f05652f875f5efef46b0f"
pageSha256: "55b81b7cfce1b631c6149a2c88685da3540bfe54487f05652f875f5efef46b0f"
...
![PyCharm 中新建 uv 项目的界面示意](/mirror/05/05bfc42bc8526a0aa575b6ec66a4f91b84f3c505.png)
...
![uv 项目创建完成后生成 .venv、pyproject.toml 和 uv.lock 的目录示意](/mirror/b0/b00d6155dae9b2afcd460eb2cfdc35a68bc7f683.png)
...
> [第 8 章 Docker 快速入门与 Dify 部署排障](/lib/08-agents/ai-agents-from-zero/8-Docker快速入门与Dify部署排障/index)
...
![Docker Desktop 图形界面中的容器与资源管理入口](/mirror/b2/b22fe427b32c70640384fa912b0e3fe2c243159f.png)
...
这部分属于 Docker 通用问题，完整解释统一放在 [第 8 章 - 网络慢或镜像拉取失败](/lib/08-agents/ai-agents-from-zero/8-Docker快速入门与Dify部署排障/index#_44-网络慢或镜像拉取失败)。本节只保留本项目启动前需要知道的操作入口。
...
![执行 docker compose up -d 启动整套基础服务的终端界面](/mirror/70/705991edc5bf25a718d0648396ca9ab1dff28bbd.png)

启动成功后，可以在 Docker Desktop 中查看容器运行状态：

![执行 docker compose up -d 启动整套基础服务的终端界面](/mirror/97/97c4d87906fb156bae3852e6a3fe3a49a7357300.png)
...
`up`、`stop`、`down`、`down -v` 的区别见 [第 8 章 - Compose 命令速查](/lib/08-agents/ai-agents-from-zero/8-Docker快速入门与Dify部署排障/index#_36-compose-命令速查)。这里尤其要记住：如果只是停止本项目基础服务，不要随手执行 `docker compose down -v`，它会删除命名卷中的 MySQL、Elasticsearch、Qdrant 数据。
