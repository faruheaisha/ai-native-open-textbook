...
entryUrl: "https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/7-企业级大模型部署.md"
sourceRel: "7-企业级大模型部署.md"
rawUrl: "/raw/08-agents/ai-agents-from-zero/7-企业级大模型部署.md"
sourceSha256: "ea05f5eb94889739881a8ea422c1a3e64a694b693678dcfa225f0edffbb0df2d"
pageSha256: "ea05f5eb94889739881a8ea422c1a3e64a694b693678dcfa225f0edffbb0df2d"
...
**学习建议：** 企业部署最容易被环境细节淹没，先把层次分清：Dify 属于应用层，Xinference 属于推理层，GPU 服务器只是承载它们的基础设施。第 1 节先看选型逻辑，第 2 节只负责把 Dify 跑起来，第 3 节再接模型服务。遇到 Docker、网络、数据库或升级问题，直接回看 [第 8 章](/lib/08-agents/ai-agents-from-zero/8-Docker快速入门与Dify部署排障/index)，不要在这一章里硬猜。
...
![企业级大模型部署中应用层与模型推理层的调用路径示意图](/mirror/b6/b62b20bc9e2077afd21e9aa24eb56c903f1b4b27.webp)
...
![Dify 对接 Xinference 与推理引擎的整体调用关系图](/mirror/c2/c2625947a90cca1305e838ee8ee1cc37c17152c7.webp)
...
![腾讯云服务器购买页中选择计费与实例类型的界面](/mirror/4d/4d8478f1db37129893293152c774c22e21ff7b08.webp)

地域选择：没有要求，自己根据需要选即可。

实例配置：根据自己需求选择，无具体要求。这里我选择 4 核 8GB。

![腾讯云服务器实例配置选择界面](/mirror/f1/f12ddda360d95f783743584e30e1230e244bc389.webp)

镜像：选择 CentOS、Ubuntu 都可以，这里使用了 Ubuntu。选择后点击下一步。

![腾讯云服务器镜像选择界面](/mirror/55/5507804a93293bb89b9a55fe3a5b9993521cb8ee.webp)

![腾讯云服务器镜像确认界面](/mirror/af/af836e368998f797003fda521ff5bcd4bbcf3cdf.webp)

#### 2.2.2 设置网络和主机

拉满带宽上限，新建安全组，把常用的端口都开启：

![腾讯云服务器安全组和带宽配置界面](/mirror/2a/2a6e2af8b43ef62b9f81e8880c0c530692482663.webp)

命名实例，设置密码，进行下一步：

![腾讯云服务器设置主机名与登录密码的界面](/mirror/5b/5bfbbe04d9078afe7b1842cc2122c44c5da78483.webp)

开通：

![腾讯云服务器确认开通的界面](/mirror/13/138b08e581dcce69458da1a2b09b6041f64b9b22.webp)

#### 2.2.3 登录(使用 Xshell 或 finalshell 或 windTerm)

![腾讯云服务器获取公网 IP 与登录信息的界面](/mirror/ab/aba3c46a77b3e95ad48ca4c880d67720d271218a.webp)

创建好了，通过这个公网 IP，端口使用 22，账号 ubuntu，密码使用你设置的密码。使用你的远程连接工具 XShell 或 FinalShell 连接即可。

XShell 界面如下：

![使用 XShell 连接腾讯云服务器的界面](/mirror/27/27f3fb801781091e01239873d51ede51d5cbf624.png)
...
![Docker 容器化技术的概念示意图](/mirror/e5/e5d6fe26c067494c2b3dc609de6668c47ffb248e.webp)
...
![Docker 容器与传统部署方式对比示意图](/mirror/98/98ee107d4b3afbeddf46a9b84b6f64c12cdab53a.webp)
...
![执行 sudo apt upgrade 时出现交互提示的界面](/mirror/86/865c92714c7cd41e9623a3e4e0f1328e3e6a02e7.webp)
...
![Docker 服务启动成功并显示 running 状态的界面](/mirror/a0/a07c4d1e1c7fdbb7a6d15d76d2f8b3bc10181bdd.png)

> 看到 running 状态说明 docker 已经正常启动

**注意：安装过程中如果报错如下：**

![Docker 安装过程中报错的界面](/mirror/13/130c0aa15feac24a8910ca02ad9f53d5733ec1c7.png)
...
![GitHub 上下载 Dify 0.15.5 离线安装包的界面](/mirror/bf/bf81781b5306910edaaeca074491af19c701b9cf.webp)

> 注意：网络不好的同学，可在网盘资料中查看使用。

利用远程连接工具（比如：XFTP）将 dify 源码包传递到服务器 /opt/dify 文件夹中，并解压即可：

![通过 XFTP 将 Dify 源码包上传到服务器的界面](/mirror/e6/e6ed96a6324d35f1ff52f0287e86927d3cfa01d1.webp)
...
![在服务器上解压 Dify 源码包并进入目录的界面](/mirror/bb/bb21fed27f8f0b7859c8583d9e3745ad49766fdd.webp)
...
![通过 Gitee 克隆 Dify 项目的界面](/mirror/f9/f9e3f8b4d606b8c864b8cbf6727dd41ca97df95d.png)
...
4. 运行命令后，你应该会看到类似以下的输出，显示所有容器的状态和端口映射：
   ...
   ![首次执行 docker compose up -d 启动 Dify 时的容器创建界面](/mirror/f8/f8a2742f1c2adee87a0868b9f2012700a5763bc8.webp)
...
![执行 docker compose ps 查看 Dify 容器状态的界面](/mirror/71/7161dfd61815d17de843d9604277bef5d8d1e14f.png)
...
![Dify 启动时因镜像或网络问题报错的界面](/mirror/6b/6b5779a99e725f241a1908c862b796162321bf8b.png)

![通过 XFTP 将 Dify 源码包上传到服务器的界面](/mirror/e6/e6ed96a6324d35f1ff52f0287e86927d3cfa01d1.webp)

进行镜像源或代理配置。

> **说明：** 镜像源和代理属于 Docker 通用网络问题，第三方镜像源的可用性、安全性和同步完整性都可能变化。生产环境优先使用 Docker 官方源、企业内网镜像仓库，或云厂商明确提供并可信的镜像加速服务。通用处理思路见 [第 8 章 - 网络慢或镜像拉取失败](/lib/08-agents/ai-agents-from-zero/8-Docker快速入门与Dify部署排障/index#_44-网络慢或镜像拉取失败)。
...
![配置镜像源后重新下载 Docker 镜像的界面](/mirror/fa/fa20bf37e120f01511ad29443396b5ecefffa783.png)

![通过 Gitee 克隆 Dify 项目的界面](/mirror/f9/f9e3f8b4d606b8c864b8cbf6727dd41ca97df95d.png)

**问题 2：可能出现报错，报错如下**

![Dify 部署过程中出现系统配置报错的界面](/mirror/84/84e396674270730caed387c73a077379b5f36f16.png)
...
![修复系统配置文件中多余字符的界面](/mirror/3f/3fcb8e3721862ee36f8d86c6f43a42852ed38066.png)

重新运行，成功

![修复后重新运行 Dify 成功的界面](/mirror/53/53878e66be1f14ad290a54ad3b5bddda773d7ce2.png)
...
![访问 Dify 管理员初始化页面的界面](/mirror/fa/faf1696e11caa929f16c74991f6a4c369c67a05c.webp)

如图所示为成功访问，进行注册登录即可

![Dify 私有化部署成功后的登录或首页界面](/mirror/e5/e536343f8849eac431fe743ebb806511a28bcd4f.webp)
...
![腾讯云创建快照策略的界面](/mirror/67/67cfa0e015a61f4874f609257478b9db9276ae0f.webp)

![腾讯云配置快照策略细节的界面](/mirror/6a/6a54c624e0806d035d54f5497a7872a8b3b2dd9c.webp)

![腾讯云快照策略设置成功的界面](/mirror/c0/c0533e3bd6c70e640272ec0095ff2ea223993a06.webp)
...
![Dify 中添加在线模型供应商的界面](/mirror/5a/5a45adaf1689f0c8f0515d7524118f3c28274db4.webp)

DeepSeek 官网地址：https://www.deepseek.com/ ，在官网获取自己的 API Key 即可配置后使用

![DeepSeek 官网获取 API Key 的界面](/mirror/2f/2f64ba458edd684543f98231d4bf1ceaac7b067d.webp)

在这里可以使用平台提供的在线大模型服务（运营商），但是考虑到可能存在的数据安全问题，所以我们自己部署 Xinference，进而部署私有的大模型。

![Dify 中选择在线模型运营商的界面](/mirror/42/42b533ae8afcb20d064754c3a638e8a9827d8545.webp)

![Dify 中配置在线大模型连接信息的界面](/mirror/7f/7fa819456959aa400de4c0724c521a134e86171a.webp)
...
![Xinference WebUI 访问成功后的界面](/mirror/c2/c2a8da480ed7fe9cc66f00e7a4e02795d330565b.webp)
...
![AutoDL 平台中选择镜像和基础环境的界面](/mirror/11/115234ac3bec384c1cccecec4d685ad9d570688e.webp)
...
![AutoDL 平台中确认镜像配置的界面](/mirror/94/94b41f82511b2871edb29de47760031913e5f475.webp)

#### 3.1.2 XShell 连接登录

复制该服务器的登录指令，通过远程连接工具进行登录

![AutoDL 平台中查看服务器登录命令的界面](/mirror/eb/ebc19612bf926f0af58cee707c930b2dc1d7fcab.webp)

![通过远程工具连接 AutoDL 服务器的界面](/mirror/1d/1d529f4be7cb03d49b3e1a738b9a2396e84cda2a.webp)

测试连接：

> 默认的用户名：root

![测试 AutoDL 服务器连接成功的界面](/mirror/68/6802484015fee4de0c15c82c77dca036ff8eaf90.png)
...
![AutoDL 学术资源加速说明页面界面](/mirror/bd/bd815337f792bad4285b2fd6ad0752140f794667.webp)
...
![在终端中开启 AutoDL 学术资源加速的界面](/mirror/b3/b36606f7b7e188ebf0dcccda076f84950bf83b6f.png)
...
![Xinference 官方文档中 Qwen3 模型配置示意图](/mirror/8f/8f8a63b49772d469d55626186d1144429124aa2e.webp)
...
![Xinference 服务端下载 LLM 模型时的界面](/mirror/c9/c9e442ea4e35dd679efb6955b5500b5f10dd0037.webp)

模型部署完成

![LLM 在 Xinference 中部署完成后的界面](/mirror/34/34153f567a7b0531cb03520c320bc3c0ef54a360.webp)
...
![使用 xinference list 查看 LLM 部署情况的界面](/mirror/78/7865181c2f441134460c1801db3cca1db8735d02.png)

##### ② WebUI

![Xinference WebUI 中查看已部署 LLM 的界面](/mirror/1f/1f2c109c2ee53924ff649b982f6be9f79b33548d.webp)
...
![向 Xinference 发送 LLM 请求后的响应界面](/mirror/9c/9c8564ac588340659a8600325c4b71e4ad0e3762.png)
...
![Xinference 下载 Embedding 模型时的界面](/mirror/f7/f7b964a02f325431f3a8f08d4e0610f3d1106d8f.png)

部署完成

![Embedding 模型在 Xinference 中部署完成后的界面](/mirror/40/40c5ed630350be7f8dffd5d9ed7c0a3ac3e695da.png)
...
![使用 xinference list 查看 Embedding 模型的界面](/mirror/df/dfb5e227890bb0098e2d90ead51d4fc08a6ebaba.png)

##### ② WebUI

![Xinference WebUI 中查看 Embedding 模型的界面](/mirror/10/10112ea2a3dbcfcc60f5620ad2a4494aa3606188.webp)
...
![向 Xinference 发送 Embedding 请求后的响应界面](/mirror/2e/2eee9ec6bd3830e90038764b8f75dbcce2055d9b.png)
...
![Xinference 下载 Rerank 模型时的界面](/mirror/e6/e63a80747a1dedfb8219b42e7e3fa0bea3e862ef.png)

部署完成

![Rerank 模型在 Xinference 中部署完成后的界面](/mirror/24/248422ae436216aa01e04e55b06adef8a768a45a.png)
...
![使用 xinference list 查看 Rerank 模型的界面](/mirror/01/01091ea2707223717742eae06008b30a2e9f91ce.png)

##### ② WebUI

![Xinference WebUI 中查看 Rerank 模型的界面](/mirror/3c/3c8c31179f1b4e0390d4db2499f3736d9eb6a660.webp)
...
![向 Xinference 发送 Rerank 请求后的响应界面](/mirror/0f/0f1b416c5ba4dc755c21de72e6907ecaab420ed7.png)

### 3.6 Dify 对接 Xinference

#### 3.6.1 安装 Xinference 插件

![Dify 插件市场入口界面](/mirror/da/da3fc412f0fc1d09e9140a371e9431bb1b073716.webp)

搜索 Xinference

![在 Dify 插件市场中搜索 Xinference 的界面](/mirror/1a/1afb640b06ade610152f3904ae6957da7773ecde.webp)

安装插件

![在 Dify 中安装 Xinference 插件的界面](/mirror/13/13b97a6d9d3f6ebe0ed69746e978d8954230152e.webp)

![Dify 中确认安装 Xinference 插件的界面](/mirror/dd/dd5cef9de67a4489abdce3fab953d9944147fcdc.webp)

安装完成后即可看到 Xinference

![Dify 中已成功安装 Xinference 插件的界面](/mirror/ba/baab37792c38356b9d36a738a58c9d7f9a9128f6.webp)

#### 3.6.2 添加 LLM

![在 Dify 中添加 Xinference 提供的 LLM 的界面](/mirror/37/37efbe02615b489c35959806deb3b70cba37946f.webp)

![在 Dify 中填写 Xinference LLM 连接信息的界面](/mirror/9c/9c8912e112f9d10da60875a2e92d4728e48adee6.webp)

在 Xinference 插件下可以看到模型，则配置成功

![Dify 中看到 Xinference LLM 模型列表的界面](/mirror/6b/6bd14a71732ab8d6d84f68ddd7460dec0385513e.webp)

#### 3.6.3 添加 Embedding 模型

![在 Dify 中添加 Xinference Embedding 模型的界面](/mirror/ef/ef6534336f9f467791eb9f113b54ce35a1d4f8a1.webp)

![Dify 中配置 Xinference Embedding 模型的界面](/mirror/3b/3bcfab72dc5d95203fe59d3cea741f072db03c42.webp)

#### 3.6.4 添加 Rerank 模型

![在 Dify 中添加 Xinference Rerank 模型的界面](/mirror/15/15fb10428b1d53f32427005d2b1c6d339a6d9d51.webp)

![Dify 中配置 Xinference Rerank 模型的界面](/mirror/c0/c01847e9dc1ce2ebc7436fa94d9da12a2f8af68a.webp)
...
**建议下一步：** 先按第 2 节在腾讯云上把 Dify 跑通并能在浏览器使用；再按第 3 节在 AutoDL 上把 Xinference 及 LLM/Embedding/Rerank 部署并测试通过；最后在 Dify 中安装 Xinference 插件并添加自建模型，用一个小型 RAG 或 Agent 应用验证端到端调用。遇到 Docker 基础问题或 Dify 具体报错可查 [第 8 章 Docker 快速入门与 Dify 部署排障](/lib/08-agents/ai-agents-from-zero/8-Docker快速入门与Dify部署排障/index)。
