...
![企业级大模型部署中应用层与模型推理层的调用路径示意图](/mirror/b6/b62b20bc9e2077afd21e9aa24eb56c903f1b4b27.png)
...
![Dify 对接 Xinference 与推理引擎的整体调用关系图](/mirror/c2/c2625947a90cca1305e838ee8ee1cc37c17152c7.png)
...
![腾讯云服务器购买页中选择计费与实例类型的界面](/mirror/4d/4d8478f1db37129893293152c774c22e21ff7b08.png)

地域选择：没有要求，自己根据需要选即可。

实例配置：根据自己需求选择，无具体要求。这里我选择 4 核 8GB。

![腾讯云服务器实例配置选择界面](/mirror/f1/f12ddda360d95f783743584e30e1230e244bc389.png)

镜像：选择 CentOS、Ubuntu 都可以，这里使用了 Ubuntu。选择后点击下一步。

![腾讯云服务器镜像选择界面](/mirror/55/5507804a93293bb89b9a55fe3a5b9993521cb8ee.png)

![腾讯云服务器镜像确认界面](/mirror/af/af836e368998f797003fda521ff5bcd4bbcf3cdf.png)

#### 2.2.2 设置网络和主机

拉满带宽上限，新建安全组，把常用的端口都开启：

![腾讯云服务器安全组和带宽配置界面](/mirror/2a/2a6e2af8b43ef62b9f81e8880c0c530692482663.png)

命名实例，设置密码，进行下一步：

![腾讯云服务器设置主机名与登录密码的界面](/mirror/5b/5bfbbe04d9078afe7b1842cc2122c44c5da78483.png)

开通：

![腾讯云服务器确认开通的界面](/mirror/13/138b08e581dcce69458da1a2b09b6041f64b9b22.png)

#### 2.2.3 登录(使用 Xshell 或 finalshell 或 windTerm)

![腾讯云服务器获取公网 IP 与登录信息的界面](/mirror/ab/aba3c46a77b3e95ad48ca4c880d67720d271218a.png)
...
![Docker 容器化技术的概念示意图](/mirror/e5/e5d6fe26c067494c2b3dc609de6668c47ffb248e.png)
...
![Docker 容器与传统部署方式对比示意图](/mirror/98/98ee107d4b3afbeddf46a9b84b6f64c12cdab53a.png)
...
![执行 sudo apt upgrade 时出现交互提示的界面](/mirror/86/865c92714c7cd41e9623a3e4e0f1328e3e6a02e7.png)
...
![GitHub 上下载 Dify 0.15.5 离线安装包的界面](/mirror/bf/bf81781b5306910edaaeca074491af19c701b9cf.png)

> 注意：网络不好的同学，可在网盘资料中查看使用。

利用远程连接工具（比如：XFTP）将 dify 源码包传递到服务器 /opt/dify 文件夹中，并解压即可：

![通过 XFTP 将 Dify 源码包上传到服务器的界面](/mirror/e6/e6ed96a6324d35f1ff52f0287e86927d3cfa01d1.png)
...
![在服务器上解压 Dify 源码包并进入目录的界面](/mirror/bb/bb21fed27f8f0b7859c8583d9e3745ad49766fdd.png)
...
4. 运行命令后，你应该会看到类似以下的输出，显示所有容器的状态和端口映射：
   ...
   ![首次执行 docker compose up -d 启动 Dify 时的容器创建界面](/mirror/f8/f8a2742f1c2adee87a0868b9f2012700a5763bc8.png)
...
![访问 Dify 管理员初始化页面的界面](/mirror/fa/faf1696e11caa929f16c74991f6a4c369c67a05c.png)

如图所示为成功访问，进行注册登录即可

![Dify 私有化部署成功后的登录或首页界面](/mirror/e5/e536343f8849eac431fe743ebb806511a28bcd4f.png)
...
![腾讯云创建快照策略的界面](/mirror/67/67cfa0e015a61f4874f609257478b9db9276ae0f.png)

![腾讯云配置快照策略细节的界面](/mirror/6a/6a54c624e0806d035d54f5497a7872a8b3b2dd9c.png)

![腾讯云快照策略设置成功的界面](/mirror/c0/c0533e3bd6c70e640272ec0095ff2ea223993a06.png)
...
![Dify 中添加在线模型供应商的界面](/mirror/5a/5a45adaf1689f0c8f0515d7524118f3c28274db4.png)

DeepSeek 官网地址：https://www.deepseek.com/ ，在官网获取自己的 API Key 即可配置后使用

![DeepSeek 官网获取 API Key 的界面](/mirror/2f/2f64ba458edd684543f98231d4bf1ceaac7b067d.png)

在这里可以使用平台提供的在线大模型服务（运营商），但是考虑到可能存在的数据安全问题，所以我们自己部署 Xinference，进而部署私有的大模型。

![Dify 中选择在线模型运营商的界面](/mirror/42/42b533ae8afcb20d064754c3a638e8a9827d8545.png)

![Dify 中配置在线大模型连接信息的界面](/mirror/7f/7fa819456959aa400de4c0724c521a134e86171a.png)
...
![Xinference WebUI 访问成功后的界面](/mirror/c2/c2a8da480ed7fe9cc66f00e7a4e02795d330565b.png)
...
![AutoDL 平台中选择镜像和基础环境的界面](/mirror/11/115234ac3bec384c1cccecec4d685ad9d570688e.png)
...
![AutoDL 平台中确认镜像配置的界面](/mirror/94/94b41f82511b2871edb29de47760031913e5f475.png)

#### 3.1.2 XShell 连接登录

复制该服务器的登录指令，通过远程连接工具进行登录

![AutoDL 平台中查看服务器登录命令的界面](/mirror/eb/ebc19612bf926f0af58cee707c930b2dc1d7fcab.png)

![通过远程工具连接 AutoDL 服务器的界面](/mirror/1d/1d529f4be7cb03d49b3e1a738b9a2396e84cda2a.png)
...
![AutoDL 学术资源加速说明页面界面](/mirror/bd/bd815337f792bad4285b2fd6ad0752140f794667.png)
...
![Xinference 官方文档中 Qwen3 模型配置示意图](/mirror/8f/8f8a63b49772d469d55626186d1144429124aa2e.png)
...
![Xinference 服务端下载 LLM 模型时的界面](/mirror/c9/c9e442ea4e35dd679efb6955b5500b5f10dd0037.png)

模型部署完成

![LLM 在 Xinference 中部署完成后的界面](/mirror/34/34153f567a7b0531cb03520c320bc3c0ef54a360.png)
...
![Xinference WebUI 中查看已部署 LLM 的界面](/mirror/1f/1f2c109c2ee53924ff649b982f6be9f79b33548d.png)
...
![Xinference WebUI 中查看 Embedding 模型的界面](/mirror/10/10112ea2a3dbcfcc60f5620ad2a4494aa3606188.png)
...
![Xinference WebUI 中查看 Rerank 模型的界面](/mirror/3c/3c8c31179f1b4e0390d4db2499f3736d9eb6a660.png)
...
![Dify 插件市场入口界面](/mirror/da/da3fc412f0fc1d09e9140a371e9431bb1b073716.png)

搜索 Xinference

![在 Dify 插件市场中搜索 Xinference 的界面](/mirror/1a/1afb640b06ade610152f3904ae6957da7773ecde.png)

安装插件

![在 Dify 中安装 Xinference 插件的界面](/mirror/13/13b97a6d9d3f6ebe0ed69746e978d8954230152e.png)

![Dify 中确认安装 Xinference 插件的界面](/mirror/dd/dd5cef9de67a4489abdce3fab953d9944147fcdc.png)

安装完成后即可看到 Xinference

![Dify 中已成功安装 Xinference 插件的界面](/mirror/ba/baab37792c38356b9d36a738a58c9d7f9a9128f6.png)

#### 3.6.2 添加 LLM

![在 Dify 中添加 Xinference 提供的 LLM 的界面](/mirror/37/37efbe02615b489c35959806deb3b70cba37946f.png)

![在 Dify 中填写 Xinference LLM 连接信息的界面](/mirror/9c/9c8912e112f9d10da60875a2e92d4728e48adee6.png)

在 Xinference 插件下可以看到模型，则配置成功

![Dify 中看到 Xinference LLM 模型列表的界面](/mirror/6b/6bd14a71732ab8d6d84f68ddd7460dec0385513e.png)

#### 3.6.3 添加 Embedding 模型

![在 Dify 中添加 Xinference Embedding 模型的界面](/mirror/ef/ef6534336f9f467791eb9f113b54ce35a1d4f8a1.png)

![Dify 中配置 Xinference Embedding 模型的界面](/mirror/3b/3bcfab72dc5d95203fe59d3cea741f072db03c42.png)

#### 3.6.4 添加 Rerank 模型

![在 Dify 中添加 Xinference Rerank 模型的界面](/mirror/15/15fb10428b1d53f32427005d2b1c6d339a6d9d51.png)

![Dify 中配置 Xinference Rerank 模型的界面](/mirror/c0/c01847e9dc1ce2ebc7436fa94d9da12a2f8af68a.png)
