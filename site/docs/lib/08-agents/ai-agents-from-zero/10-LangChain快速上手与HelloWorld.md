...
- 会运行并理解本章全部案例：**环境检查、HelloWorld、多模型共存、企业级封装、流式输出**，为后续 [Model I/O](/lib/08-agents/ai-agents-from-zero/11-Model-I-O与模型接入)、[Ollama 本地调用](/lib/08-agents/ai-agents-from-zero/12-Ollama本地部署与调用)、[提示词与消息模板](/lib/08-agents/ai-agents-from-zero/13-提示词与消息模板)、[输出解析器](/lib/08-agents/ai-agents-from-zero/14-输出解析器) 打基础。
...
![LangChain支持的大模型](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/10/10-1-1-1.png)
...
[GetEnvInfo.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/01-helloworld/GetEnvInfo.py ":include :type=code")
...
![PyCharm「Python 软件包」面板：查看已安装的 langchain、langchain-core、langchain-openai 等包及版本，用于核对是否装对虚拟环境](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/10/10-3-3-1.png)
...
![阿里云百炼控制台：API-KEY 管理页创建与复制密钥（形如 sk-xxx）](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/10/10-4-1-1.jpeg)

#### 4.1.2 获得模型名

在模型广场或模型详情页里确认你真正要调用的模型标识，例如 `qwen-plus`、`qwen3-max` 等。

![百炼模型广场：浏览可选模型及在列表中展示的模型标识](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/10/10-4-1-2.jpeg)

![模型详情页：查看实际调用时使用的模型名（与界面展示名称可能略有差异，以详情/API 文档为准）](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/10/10-4-1-3.jpeg)

![模型名示例：如 qwen-plus、qwen3-max 等在代码 `model=` 中填写的字符串](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/10/10-4-1-4.jpeg)

#### 4.1.3 获得 Base URL

如果你走的是 OpenAI 兼容接法，就需要对应的兼容接口地址，例如：

![百炼文档或控制台：OpenAI 兼容模式的 Base URL（如 compatible-mode/v1 根地址）](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/10/10-4-1-5.jpeg)
...
[LangChainV0.3.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/01-helloworld/LangChainV0.3.py ":include :type=code")
...
[LangChainV1.0.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/01-helloworld/LangChainV1.0.py ":include :type=code")
...
![DeepSeek 开放平台：API Key 创建、查看与管理入口](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/10/10-5-2-1.jpeg)
...
![DeepSeek 文档或控制台：模型列表与调用名示意（如 deepseek-v4-flash、deepseek-v4-pro）](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/10/10-5-2-2.jpeg)
...
![DeepSeek：普通对话模式与推理（reasoner）模式的适用场景说明示意](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/10/10-5-2-3.jpeg)

### 5.3 多模型共存示例代码

【案例源码】`案例与源码-2-LangChain框架/01-helloworld/LangChain_MoreV1.0.py`

[LangChain_MoreV1.0.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/01-helloworld/LangChain_MoreV1.0.py ":include :type=code")
...
[StandardDesc.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/01-helloworld/StandardDesc.py ":include :type=code")
...
**建议下一步：** 先亲手跑通本章至少两个脚本，推荐顺序是：`GetEnvInfo.py` → `LangChainV1.0.py` → `LangChain_MoreV1.0.py` → `StandardDesc.py`。跑通之后，马上进入 [第 11 章 Model I/O 与模型接入](/lib/08-agents/ai-agents-from-zero/11-Model-I-O与模型接入)，把这章中“会用”的部分升级成“真正理解为什么这样接、不同模型如何统一接入”。等你再接着学 [第 13 章 提示词与消息模板](/lib/08-agents/ai-agents-from-zero/13-提示词与消息模板) 和 [第 14 章 输出解析器](/lib/08-agents/ai-agents-from-zero/14-输出解析器)，就能形成完整的 **输入 → 模型 → 输出** 学习闭环。
