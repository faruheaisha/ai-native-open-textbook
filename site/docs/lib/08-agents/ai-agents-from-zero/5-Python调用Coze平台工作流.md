...
![Coze 工作流发布 API 入口的界面示意图](/mirror/8b/8b6187f019cc8cdacf9866a1318f0b5e8cd8ec85.webp)
...
![Coze 工作流画布中的 API 调试入口界面](/mirror/fa/fa5a7cac220eff08276d92b371c0e8abf889f93f.webp)
...
![Coze API Playground 中查看 workflow_id 和 app_id 的界面](/mirror/27/27ea9949c488a6387d49c69f7a9c48f5197cfad9.webp)
...
![Coze API Playground 中生成并授权 API Key 的界面](/mirror/35/359691c650eca8f3328d4d2b9dce7e61290ca153.webp)

点击后会自动生成并填充 API Key。

![Coze API Playground 中自动填充 API Key 后的界面](/mirror/5f/5ffaed489d23e9767462cac0abad54ce4af6fbc2.webp)
...
![Coze API Playground 中配置 parameters 入参的界面](/mirror/6b/6bf6c4e316fbec2f67cce0b12858f2b68ed8f259.webp)
...
![Coze API Playground 中运行工作流请求的界面](/mirror/1c/1cee1512dd77a6b2096b200a32c85c649195eda0.webp)
...
![Coze 工作流流式运行结果界面的整体示意图](/mirror/9e/9e217d0746da0d1d2466183f8eb68241fecef2ea.webp)

### 4.2 Message

![Coze 流式返回中 Message 事件内容的界面示意图](/mirror/86/86fcb74fffca874abaee5d3f18b023ea511fe98f.webp)

`Message` 才是携带真正业务内容的事件类型，此处的 `content` 就是工作流某一步的输出。

### 4.3 Done

![Coze 流式返回中 Done 结束事件的界面示意图](/mirror/8c/8c4becd7af28dcff70be179e14288bcd479736cc.webp)
...
![Coze 官方 Python SDK cozepy 的文档或仓库界面示意图](/mirror/0a/0ae34f4910188fca130e237c206c93047943df54.webp)
...
![Python 调用 Coze 工作流后的运行结果界面示意图](/mirror/ad/adf8eff160dcaef9d839b309be5a4a1bff8683d3.webp)

## 6、除了 SDK，还可以在平台侧运行

如果你只是想先确认工作流本身能正常输出，也可以直接在平台里测试。

![在 Coze 平台侧直接测试工作流输出的界面示意图](/mirror/bc/bca8baa2ca704e2c8334c80f2ad36aa05bb5ded7.webp)
...
**建议下一步：** 如果你想继续走 Coze 本地化和私有化路线，可以看 [第 6 章 Coze 与 Dify 的 Windows 平台部署](/lib/08-agents/ai-agents-from-zero/6-Coze与Dify的Windows平台部署)；如果你想从平台调用进一步过渡到代码框架主线，也可以回到 [第 9 章 LangChain 概述与架构](/lib/08-agents/ai-agents-from-zero/9-LangChain概述与架构) 开始进入 LangChain 学习。
