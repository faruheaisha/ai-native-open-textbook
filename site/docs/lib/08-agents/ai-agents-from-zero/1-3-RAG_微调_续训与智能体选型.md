...
![从提示词、RAG、微调、续训到智能体的方案诊断关系图](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/1-3/1-3-1-1-1.png)
...
这和 [1-2 提示词工程基础](/lib/08-agents/ai-agents-from-zero/1-2-提示词工程基础) 的区别也很重要：

- **提示词工程**主要依赖你提前写好的 Prompt。
- **RAG**主要依赖系统在提问时实时检索到的外部资料。

![RAG 的基本流程：先检索外部资料，再把结果与问题一起交给大模型生成答案](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/1-3/1-3-2-1-1.png)
...
- [2-RAG-搭建企业私有&个人知识库](/lib/08-agents/ai-agents-from-zero/2-RAG-搭建企业私有_个人知识库) 会从平台角度带你搭建知识库。
- [19-RAG检索增强生成](/lib/08-agents/ai-agents-from-zero/19-RAG检索增强生成) 会从 LangChain 代码角度带你拆开 RAG 的技术链路。
...
![RAG、微调等方案在“补知识”和“改行为”上的分工对比示意图](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/1-3/1-3-3-6-1.png)
...
![典型 LLM Agent 架构：模型、记忆、工具、规划和行动执行协同工作](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/1-3/1-3-5-1-1.jpg)
...
![Function Calling 的基本流程：模型决定工具和参数，程序负责真正执行](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/1-3/1-3-5-3-1.jpg)

![Function Calling 在实际接口调用中的工具声明与参数返回示意图](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/1-3/1-3-5-3-2.jpg)
...
![MCP 像 AI 世界的 USB-C 接口，用统一协议暴露工具、资源和提示模板](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/1-3/1-3-5-3-3.jpg)
...
![MCP 的调用流程：主机、客户端和服务器之间如何完成能力发现与调用](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/1-3/1-3-5-3-4.jpg)
...
![工作流更强调固定步骤、可控执行和明确顺序的流程编排方式](https://gh-proxy.com/https://raw.githubusercontent.com/didilili/ai-agents-from-zero/ea7f28ffe0b2c2650e3936f3bb591560225702b3/images/1-3/1-3-5-5-1.jpg)
...
**建议下一步：** 建议按你最关心的能力线继续往下走：想把 RAG 落到代码里，就看 [第 19 章 RAG 检索增强生成](/lib/08-agents/ai-agents-from-zero/19-RAG检索增强生成)；想理解工具接入和协议层，就看 [第 20 章 MCP 模型上下文协议](/lib/08-agents/ai-agents-from-zero/20-MCP模型上下文协议)；想理解多步决策与执行，就看 [第 21 章 Agent 智能体](/lib/08-agents/ai-agents-from-zero/21-Agent智能体)。
