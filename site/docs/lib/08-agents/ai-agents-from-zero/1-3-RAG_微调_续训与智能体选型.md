...
![从提示词、RAG、微调、续训到智能体的方案诊断关系图](/mirror/38/384a7ab766774851e2f77f54a829c796e653eff8.webp)
...
![RAG 的基本流程：先检索外部资料，再把结果与问题一起交给大模型生成答案](/mirror/d7/d776e23ee11476267cf84920ee82f0a9eb4c9d85.webp)
...
![RAG、微调等方案在“补知识”和“改行为”上的分工对比示意图](/mirror/43/43cb51a4ad0f83078e588b599fc6ab50c27923e8.webp)
...
![典型 LLM Agent 架构：模型、记忆、工具、规划和行动执行协同工作](/mirror/45/450ac9502f3691c71ef985deaa7e683350a51c89.webp)
...
![Function Calling 的基本流程：模型决定工具和参数，程序负责真正执行](/mirror/95/95f2b8fa626132508ac3fe52126d6ee4201ea4ac.webp)

![Function Calling 在实际接口调用中的工具声明与参数返回示意图](/mirror/77/77284aaa2baf00f9ea84321fc366e965f0ee88ba.webp)
...
![MCP 像 AI 世界的 USB-C 接口，用统一协议暴露工具、资源和提示模板](/mirror/c3/c3f2628370f806a199e9ea86e4488e8c125ecce4.webp)
...
![MCP 的调用流程：主机、客户端和服务器之间如何完成能力发现与调用](/mirror/d0/d04688d838f9769d54f4bb12afc0d6faa720aed1.webp)
...
![工作流更强调固定步骤、可控执行和明确顺序的流程编排方式](/mirror/0a/0a28f56c168b55a2cf48d0224a6e66d68751ee67.webp)
