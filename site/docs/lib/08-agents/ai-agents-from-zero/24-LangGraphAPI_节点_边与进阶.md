...
entryUrl: "https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/24-LangGraphAPI：节点、边与进阶.md"
sourceRel: "24-LangGraphAPI：节点、边与进阶.md"
rawUrl: "/raw/08-agents/ai-agents-from-zero/24-LangGraphAPI：节点、边与进阶.md"
sourceSha256: "63b50fd9ed7dce696f9ec4b4b2f5cfb4c35e6b139e1a7a685d2c10a969af3bcb"
pageSha256: "63b50fd9ed7dce696f9ec4b4b2f5cfb4c35e6b139e1a7a685d2c10a969af3bcb"
...
如果说 [第 23 章](/lib/08-agents/ai-agents-from-zero/23-LangGraphAPI_图与状态) 重点在讲“图里有哪些共享状态”，那本章开始讲的 Node，重点就在讲：**状态到了某一站之后，要做什么处理。**
...
![官方文档摘录：LangGraph 节点可接收 state、config、runtime 三类参数](/mirror/70/70957b94c0a4b375866dcddd3f80b35b575d78fd.jpeg)
...
[DefNode.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/04-node/DefNode.py ":include :type=code")
...
![官方说明摘录：节点缓存需在编译时提供 cache、在节点上配置 CachePolicy（含 key 与 ttl）](/mirror/5a/5aa00b3882a43b77d54e78ed7729d9699362bd56.jpeg)
...
[Node_Cache.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/04-node/Node_Cache.py ":include :type=code")
...
[Node_ExpErrRetry.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/04-node/Node_ExpErrRetry.py ":include :type=code")
...
![固定边示例：`add_edge` 串联 START → input → process → output → END 与对应有向图](/mirror/26/26f774818c44fb6e9df4da8d0de4dedefe5d4d41.jpeg)
...
[Edge_Normal.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/05-edge/Edge_Normal.py ":include :type=code")
...
[Edge_Conditional.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/05-edge/Edge_Conditional.py ":include :type=code")

[Edge_ConditionalV2.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/05-edge/Edge_ConditionalV2.py ":include :type=code")
...
[Edge_EntryPoint.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/05-edge/Edge_EntryPoint.py ":include :type=code")

[Edge_ConditionalEntryPoint.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/05-edge/Edge_ConditionalEntryPoint.py ":include :type=code")
...
![ReAct 循环示意：input 进入 model，model 可调用 tools，tools 结果再回到 model，最终输出 output](/mirror/48/48ba19a8b1d3f92e16a302edac1c4da687cac5cd.png)
...
`Send` 允许图在运行时动态决定开出多少条分支，而且每条分支可以拿到不同版本的状态。并行分支写回同一状态字段时，通常要在 State 上配置合适的 [Reducer](/lib/08-agents/ai-agents-from-zero/23-LangGraphAPI_图与状态)（例如列表追加），否则结果难以汇总。
...
[SendDemo.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/06-specialApi/SendDemo.py ":include :type=code")
...
[CommandDemo.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/06-specialApi/CommandDemo.py ":include :type=code")
...
[RuntimeContextDemo.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-3-LangGraph框架/06-specialApi/RuntimeContextDemo.py ":include :type=code")
...
![Send、Command 与 Runtime 对比：Send 负责动态多路分发，Command 负责更新状态并指定下一跳，Runtime 负责注入运行配置](/mirror/13/134ceeab7b5716e1ebb1e5712e17232ee71af22d.png)
