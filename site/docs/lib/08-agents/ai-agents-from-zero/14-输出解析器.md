...
entryUrl: "https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/14-输出解析器.md"
sourceRel: "14-输出解析器.md"
rawUrl: "/raw/08-agents/ai-agents-from-zero/14-输出解析器.md"
sourceSha256: "b039ea8a6ff63c92aedb3d166da11ff3cf66691b8b326b721fa7e13cb684e436"
pageSha256: "b039ea8a6ff63c92aedb3d166da11ff3cf66691b8b326b721fa7e13cb684e436"
...
本章对应 [Model I/O](/lib/08-agents/ai-agents-from-zero/11-Model-I-O与模型接入) 中的**输出解析（Parse）**部分：把模型的**文本输出**转成程序易用的**结构化数据**（如字符串、JSON、强类型对象）。与 [第 13 章 提示词](/lib/08-agents/ai-agents-from-zero/13-提示词与消息模板)（**Format（输入格式化）**）、第 11 章模型（**Predict（模型调用）**）组合，即形成「输入 → 模型 → 输出解析」完整链路，[第 15 章 LCEL](/lib/08-agents/ai-agents-from-zero/15-LCEL与链式调用) 会用管道符将三者串成一条链。
...
- 第 [15 章 LCEL 与链式调用](/lib/08-agents/ai-agents-from-zero/15-LCEL与链式调用) 会把这条链真正串起来。

![输出解析器在 Model I/O 中的位置：承接模型文本输出，解析为程序可用的结构化数据](/mirror/08/08f823670d297e011b9450f5049eafbe19fbdc92.webp)
...
[StrOutputParserDemo.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/05_parser/StrOutputParserDemo.py ":include :type=code")
...
[JsonOutputParserDemo.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/05_parser/JsonOutputParserDemo.py ":include :type=code")
...
[JsonOutputParser_GetFormatInstructions.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/05_parser/JsonOutputParser_GetFormatInstructions.py ":include :type=code")
...
![从普通文本、Parser、JSON 到结构化输出和 Pydantic 校验的逐步增强路线](/mirror/ee/ee26a7a617ad25dc6a1d438497dfaa1978431f08.svg)
...
[StructuredOutput_TypedDict.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/05_parser/StructuredOutput_TypedDict.py ":include :type=code")
...
[AnnotatedTypedDict.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/05_parser/AnnotatedTypedDict.py ":include :type=code")
...
[AnnotatedPydantic.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/05_parser/AnnotatedPydantic.py ":include :type=code")
...
[StructuredOutput_Pydantic.py](https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/案例与源码-2-LangChain框架/05_parser/StructuredOutput_Pydantic.py ":include :type=code")
...
**建议下一步：** 学习 [第 15 章 LCEL 与链式调用](/lib/08-agents/ai-agents-from-zero/15-LCEL与链式调用)，把本章的解析器与 [第 13 章](/lib/08-agents/ai-agents-from-zero/13-提示词与消息模板) 的 Prompt、[第 11 章](/lib/08-agents/ai-agents-from-zero/11-Model-I-O与模型接入) 的 Model 串成真正的 `prompt | model | parser` 链。
