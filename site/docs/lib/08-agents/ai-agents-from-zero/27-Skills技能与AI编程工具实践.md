...
entryUrl: "https://github.com/didilili/ai-agents-from-zero/blob/ea7f28ffe0b2c2650e3936f3bb591560225702b3/27-Skills技能与AI编程工具实践.md"
sourceRel: "27-Skills技能与AI编程工具实践.md"
rawUrl: "/raw/08-agents/ai-agents-from-zero/27-Skills技能与AI编程工具实践.md"
sourceSha256: "9a5d7b1284724bcc426bd6dd970c242f8a9ad55c838ee149d692c8ef44b35fd1"
pageSha256: "9a5d7b1284724bcc426bd6dd970c242f8a9ad55c838ee149d692c8ef44b35fd1"
...
**官方文档与资源**：详见 [工具导航与参考资料索引 - 工具调用、MCP、Skills与智能体](/lib/08-agents/ai-agents-from-zero/工具导航与参考资料索引#工具调用、MCP、Skills与智能体)。
...
![从长 Prompt 到 Skill 化：把反复出现的规则、流程、模板和脚本从主提示词中拆出来，整理成可复用的技能包](/mirror/a0/a00d5e362b4c02717decc244bbac05fdbdea9970.svg)
...
![Skill 扩展目录结构：code-reviewer 技能包由 SKILL.md、requirements.txt、references、scripts 与 assets 组成，并由 Agent 按需加载](/mirror/e9/e9512c110e9122242c532eae7c4d39fb2d8a768b.png)
...
![Skill 渐进式加载三层：先加载 name 和 description，任务匹配后读取 SKILL.md，真正需要时再读取 references、scripts 和 assets](/mirror/a3/a3b6ebc61da6468a0b231d83a661672704aeef97.svg)
...
![Skill 与 Prompt、Rules、Memory、Tool、MCP、Agent 的边界：Prompt 是一次性指令，Rules 是常驻规则，Memory 是历史状态，Tool 执行动作，MCP 统一接入外部能力，Agent 负责决策，Skill 沉淀可复用任务方法](/mirror/5e/5eb42d569608cc1fdc6c9a4f2d86f17d2aa91d3b.svg)
