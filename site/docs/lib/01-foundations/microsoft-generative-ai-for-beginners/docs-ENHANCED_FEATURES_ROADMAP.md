...
entryUrl: "https://github.com/microsoft/generative-ai-for-beginners/blob/c9657f3fdb6e4f50a168b1d026eadf4cda2f0d07/docs/ENHANCED_FEATURES_ROADMAP.md"
sourceRel: "docs/ENHANCED_FEATURES_ROADMAP.md"
rawUrl: "/raw/01-foundations/microsoft-generative-ai-for-beginners/docs/ENHANCED_FEATURES_ROADMAP.md"
sourceSha256: "349c8e58b648cfa7c29a9f3594cc4ff7135c57dd76ef52b77cb78d0533fbaffa"
pageSha256: "349c8e58b648cfa7c29a9f3594cc4ff7135c57dd76ef52b77cb78d0533fbaffa"
...
3. **Testing Framework**
   - Add pytest configuration and example tests _(done: pytest config in `pyproject.toml`; example tests for the shared utilities in [`tests/`](https://github.com/microsoft/generative-ai-for-beginners/blob/c9657f3fdb6e4f50a168b1d026eadf4cda2f0d07/tests/README.md) run in CI)_
...
Implemented in [`.github/workflows/code-quality.yml`](https://github.com/microsoft/generative-ai-for-beginners/blob/c9657f3fdb6e4f50a168b1d026eadf4cda2f0d07/.github/workflows/code-quality.yml): Python linting/formatting (Ruff + Black) is **enforced** on the maintained `shared/` utilities module and runs **advisory** across the rest of the curriculum, plus an advisory ESLint pass for JavaScript/TypeScript. The illustrative baseline was:
...
Implemented in [`.github/workflows/security.yml`](https://github.com/microsoft/generative-ai-for-beginners/blob/c9657f3fdb6e4f50a168b1d026eadf4cda2f0d07/.github/workflows/security.yml): CodeQL analysis for Python and JavaScript/TypeScript (on push, pull request, and a weekly schedule) plus a dependency review on pull requests. The illustrative baseline was:
...
Implemented in [`.devcontainer/devcontainer.json`](https://github.com/microsoft/generative-ai-for-beginners/blob/c9657f3fdb6e4f50a168b1d026eadf4cda2f0d07/.devcontainer/devcontainer.json) and [`.devcontainer/post-create.sh`](https://github.com/microsoft/generative-ai-for-beginners/blob/c9657f3fdb6e4f50a168b1d026eadf4cda2f0d07/.devcontainer/post-create.sh): the container now ships Pylance, the Black formatter, Ruff, ESLint, Prettier, and Copilot extensions, enables format-on-save wired to the repo's Black/Prettier config, and installs the developer tooling (`ruff`, `black`, `mypy`, `pytest`) so the [code-quality workflow](https://github.com/microsoft/generative-ai-for-beginners/blob/c9657f3fdb6e4f50a168b1d026eadf4cda2f0d07/.github/workflows/code-quality.yml) can be reproduced locally. The `mcr.microsoft.com/devcontainers/universal` base image already bundles Python and Node, so no extra features are required. The illustrative baseline was:
