...
Above, you see how the prompt is constructed using a template. In the template there's a number of variables, denoted by <code v-pre>{{variable}}</code>, that will be replaced with actual values from a company API.
...
[Solution](https://github.com/microsoft/generative-ai-for-beginners/blob/c9657f3fdb6e4f50a168b1d026eadf4cda2f0d07/05-advanced-prompts/python/aoai-solution.py)
...
Head over to Lesson 6 where we will apply our knowledge of Prompt Engineering by [building text generation apps](/lib/01-foundations/microsoft-generative-ai-for-beginners/06-text-generation-apps-README)
