...
The world of open-source LLMs is exciting and constantly evolving. This lesson aims to provide an in-depth look at open source models. If you are looking for information on how proprietary models compare to open source models, go to the ["Exploring and Comparing Different LLMs" lesson](/lib/01-foundations/microsoft-generative-ai-for-beginners/02-exploring-and-comparing-different-llms-README). This lesson will also cover the topic of fine-tuning but a more detailed explanation can be found in the ["Fine-Tuning LLMs" lesson](/lib/01-foundations/microsoft-generative-ai-for-beginners/18-fine-tuning-README).
