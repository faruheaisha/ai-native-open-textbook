...
sourceRel: "api/docs/guides/evals.md"
rawUrl: "/raw/01-foundations/openai-api-docs-en/api/docs/guides/evals.md"
sourceSha256: "436858d92a90a74c03d38ff8911f226700345d4dbd39929a7a461bb40172d9ba"
pageSha256: "436858d92a90a74c03d38ff8911f226700345d4dbd39929a7a461bb40172d9ba"
...
In the test configuration, we will introduce template syntax, represented by the <code v-pre>{{</code> and <code v-pre>}}</code> brackets below. This is how we will insert dynamic content into the test for this eval.

- <code v-pre>{{ item.correct_label }}</code> refers to the ground truth value in our test data.
- <code v-pre>{{ sample.output_text }}</code> refers to the content we will generate from a model to evaluate our prompt - we'll show how to do that when we actually kick off the eval run.
