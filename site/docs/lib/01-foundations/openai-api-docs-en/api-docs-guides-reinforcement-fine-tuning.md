...
sourceRel: "api/docs/guides/reinforcement-fine-tuning.md"
rawUrl: "/raw/01-foundations/openai-api-docs-en/api/docs/guides/reinforcement-fine-tuning.md"
sourceSha256: "b1a4f4cce0f7e0f4305cef68d42587ddc90d7888eca08225d498968fd5bccb38"
pageSha256: "b1a4f4cce0f7e0f4305cef68d42587ddc90d7888eca08225d498968fd5bccb38"
...
Below is the JSON payload data we'll use for this grader in API requests. In both graders, we use <code v-pre>{{ }}</code> template syntax to refer to the relevant properties of both the `item` (the row of test data being used for evaluation) and `sample` (the model output generated during the training run).
