...
sourceRel: "api/reference/resources/evals/methods/create.md"
rawUrl: "/raw/01-foundations/openai-api-reference-en/api/reference/resources/evals/methods/create.md"
sourceSha256: "01fc66a1fe509db8dd75d6830e4ff9101c7c48ea935509bc1be8da86a5080a48"
pageSha256: "01fc66a1fe509db8dd75d6830e4ff9101c7c48ea935509bc1be8da86a5080a48"
...
- `testing_criteria: array of object \{ input, labels, model, 3 more \}  or StringCheckGrader or TextSimilarityGrader or 2 more`
  ...
  A list of graders for all eval runs in this group. Graders can reference variables in the data source using double curly braces notation, like <code v-pre>{{item.variable_name}}</code>. To reference the model's output, use the `sample` namespace (ie, <code v-pre>{{sample.output_text}}</code>).
