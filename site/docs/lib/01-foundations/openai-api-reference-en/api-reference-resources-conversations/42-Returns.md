...
pageSha256: "d8cd11f701401008ac839fa927f9f9472339fc9e2d2570d8608469532f3696ab"
...
- `ConversationItem = Message or object \{ id, arguments, call_id, 7 more \}  or object \{ id, output, status, 6 more \}  or 26 more`
  ...
  A single item within a conversation. The set of possible types are the same as the `output` type of a [Response object](https://developers.openai.com/api/reference/resources/responses#(resource) responses > (model) response > (schema) > (property) output).
