...
entryUrl: "https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/09_dsa/README.md"
sourceRel: "ch04/09_dsa/README.md"
rawUrl: "/raw/01-foundations/llms-from-scratch/ch04/09_dsa/README.md"
sourceSha256: "19fb3886f277be349c6a856a6c75a4d0b0ee0c0f464ea84158a4689f8b75c948"
pageSha256: "19fb3886f277be349c6a856a6c75a4d0b0ee0c0f464ea84158a4689f8b75c948"
...
[Sliding Window Attention (SWA)](/lib/01-foundations/llms-from-scratch/ch04-06_swa) already showed that restricting attention to a fixed local window substantially reduces this cost. In SWA, each query token attends only to a local span of nearby previous tokens.
...
The full-scale DeepSeek-V3.2 model uses Multi-Head Latent Attention (MLA, see [../05_mla](/lib/01-foundations/llms-from-scratch/ch04-05_mla)) alongside DSA, and the indexer queries are derived from the shared compressed latent representation rather than the raw input. DeepSeek-V3.2 uses the same architecture as DeepSeek-V3.2-Exp, where DSA was first introduced and tested.
