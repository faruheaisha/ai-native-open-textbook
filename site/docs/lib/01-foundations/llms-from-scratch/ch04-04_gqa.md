...
entryUrl: "https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/04_gqa/README.md"
sourceRel: "ch04/04_gqa/README.md"
rawUrl: "/raw/01-foundations/llms-from-scratch/ch04/04_gqa/README.md"
sourceSha256: "87425195f5b6d8dc8f76214168a153a12e07526e739183b544ad1c7b81377f02"
pageSha256: "87425195f5b6d8dc8f76214168a153a12e07526e739183b544ad1c7b81377f02"
...
You can use the [memory_estimator_gqa.py](https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/04_gqa/memory_estimator_gqa.py) script in this folder to apply this for different model configs to see how much memory you can save by using GQA over MHA:
...
The [gpt_with_kv_mha.py](https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/04_gqa/gpt_with_kv_mha.py) and [gpt_with_kv_gqa.py](https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/04_gqa/gpt_with_kv_gqa.py) scripts in this folder provide hands-on examples for comparing the MHA and GQA memory usage in the context of a GPT model implementation.

Note that GQA is also used in the [Llama 3](/lib/01-foundations/llms-from-scratch/ch05-07_gpt_to_llama), [Gemma 3](/lib/01-foundations/llms-from-scratch/ch05-12_gemma3), and [Qwen3](/lib/01-foundations/llms-from-scratch/ch05-11_qwen3) bonus materials. However, for simplicity, the code scripts in this folder modify the GPT architecture, which traditionally didn't use GQA.
