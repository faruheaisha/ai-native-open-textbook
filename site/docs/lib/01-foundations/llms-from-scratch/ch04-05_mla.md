...
entryUrl: "https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/05_mla/README.md"
sourceRel: "ch04/05_mla/README.md"
rawUrl: "/raw/01-foundations/llms-from-scratch/ch04/05_mla/README.md"
sourceSha256: "ac43479cfe7b59bfdb76d212ce81c958bf7ab9b4c846b78e83eaf04a2128836e"
pageSha256: "ac43479cfe7b59bfdb76d212ce81c958bf7ab9b4c846b78e83eaf04a2128836e"
...
You can use the [memory_estimator_mla.py](https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/05_mla/memory_estimator_mla.py) script in this folder to apply this for different model configs to see how much memory you can save by using MLA over MHA:
...
The [gpt_with_kv_mha.py](https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/05_mla/gpt_with_kv_mha.py) and [gpt_with_kv_mla.py](https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/05_mla/gpt_with_kv_mla.py) scripts in this folder provide hands-on examples for comparing the MHA and MLA memory usage in the context of a GPT model implementation. 
...
Note that MLA can also be used in combination with [GQA](/lib/01-foundations/llms-from-scratch/ch04-04_gqa), but for simplicity, I this is not done here. (Currently, I am also not aware of a prominent LLM doing this.)
...
Lastly, this implementation uses the KV cache explained in [another bonus section](/lib/01-foundations/llms-from-scratch/ch04-03_kv-cache) so the memory savings are more pronounced.
