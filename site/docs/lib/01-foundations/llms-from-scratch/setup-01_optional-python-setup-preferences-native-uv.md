---
title: "Native uv Python and package management"
...
entryUrl: "https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/setup/01_optional-python-setup-preferences/native-uv.md"
sourceRel: "setup/01_optional-python-setup-preferences/native-uv.md"
rawUrl: "/raw/01-foundations/llms-from-scratch/setup/01_optional-python-setup-preferences/native-uv.md"
sourceSha256: "ca3027d43ea3c9c7dd557f0337c4e38fccfb12551eac97b8be5d45a7365e7948"
pageSha256: "ca3027d43ea3c9c7dd557f0337c4e38fccfb12551eac97b8be5d45a7365e7948"
...
This tutorial is an alternative to *Option 1: Using uv* in the [README.md](/lib/01-foundations/llms-from-scratch/setup-01_optional-python-setup-preferences) document for those who prefer `uv`'s native commands over the `uv pip` interface. While `uv pip` is faster than pure `pip`, `uv`'s native interface is even faster than `uv pip` as it has less overhead and doesn't have to handle legacy support for PyPy package dependency management.
...
Otherwise, similar to *Option 1: Using uv* in the [README.md](/lib/01-foundations/llms-from-scratch/setup-01_optional-python-setup-preferences) , this tutorial guides you through the Python setup and package installation procedure using `uv`.
