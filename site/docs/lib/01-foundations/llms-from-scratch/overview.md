...
- **Chapter 2: Working With Text Data**
  ...
  - [Comparing Various Byte Pair Encoding (BPE) Implementations](/lib/01-foundations/llms-from-scratch/ch02-02_bonus_bytepair-encoder)
  - [Understanding the Difference Between Embedding Layers and Linear Layers](/lib/01-foundations/llms-from-scratch/ch02-03_bonus_embedding-vs-matmul)
  - [Dataloader Intuition With Simple Numbers](/lib/01-foundations/llms-from-scratch/ch02-04_bonus_dataloader-intuition)
  - [BPE From Scratch](/lib/01-foundations/llms-from-scratch/ch02-05_bpe-from-scratch)
  - [SimpleTokenizerV3 variant](/lib/01-foundations/llms-from-scratch/ch02-06_bonus_simple-tokenizer-v3)
