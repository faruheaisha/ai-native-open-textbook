...
entryUrl: "https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/07_moe/README.md"
sourceRel: "ch04/07_moe/README.md"
rawUrl: "/raw/01-foundations/llms-from-scratch/ch04/07_moe/README.md"
sourceSha256: "7f90f091838d0d3526f221124994c1703d821b039f2cc9fdaea97bbd3e33f798"
pageSha256: "7f90f091838d0d3526f221124994c1703d821b039f2cc9fdaea97bbd3e33f798"
...
You can use the [memory_estimator_moe.py](https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/07_moe/memory_estimator_moe.py) script in this folder to apply this for different model configs to see how much memory you can save by using MoE over FFN (note that this is for a single transformer block, to get the total savings, multiply by the number of transformer blocks in your model):
...
The [gpt_with_kv_ffn.py](https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/07_moe/gpt_with_kv_ffn.py) and [gpt_with_kv_moe.py](https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/07_moe/gpt_with_kv_moe.py) scripts in this folder provide hands-on examples for comparing the regular FFN and MoE memory usage in the context of a GPT model implementation. Note that both scripts use [SwiGLU](https://arxiv.org/abs/2002.05202) feed-forward modules as shown in the first figure of this page (GPT-2 traditionally uses GELU).
