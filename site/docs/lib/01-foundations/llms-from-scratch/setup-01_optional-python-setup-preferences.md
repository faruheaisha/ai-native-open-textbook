...
entryUrl: "https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/setup/01_optional-python-setup-preferences/README.md"
sourceRel: "setup/01_optional-python-setup-preferences/README.md"
rawUrl: "/raw/01-foundations/llms-from-scratch/setup/01_optional-python-setup-preferences/README.md"
sourceSha256: "9f43da63a108880a6f6496f2801fbfb5607882c227f9cd3d8b2e832c2b3d8bdd"
pageSha256: "9f43da63a108880a6f6496f2801fbfb5607882c227f9cd3d8b2e832c2b3d8bdd"
...
>
> If you are a macOS or Linux user and prefer the native `uv` commands, refer to the [./native-uv.md tutorial](/lib/01-foundations/llms-from-scratch/setup-01_optional-python-setup-preferences-native-uv). I also recommend checking the official [`uv` documentation](https://docs.astral.sh/uv/).
>
> The `uv add` syntax also applies to Windows users. However, I found that some dependencies in the `pyproject.toml` cause problems on Windows. So, for Windows users, I recommend `pixi` instead, which has a similar `pixi add` workflow like `uv add`. For more information, see the [./native-pixi.md tutorial](/lib/01-foundations/llms-from-scratch/setup-01_optional-python-setup-preferences-native-pixi).
>
...
Please refer to the [Installing Python packages and libraries used in this book](/lib/01-foundations/llms-from-scratch/setup-02_installing-python-libraries) document for instructions on how to install the required libraries.
