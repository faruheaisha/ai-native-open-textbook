...
1. [`gpt_ch04.py`](https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/03_kv-cache/gpt_ch04.py): Self-contained code taken from Chapter 3 and 4 to implement the LLM and run the simple text generation function
2. [`gpt_with_kv_cache.py`](https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/03_kv-cache/gpt_with_kv_cache.py): The same as above, but with the necessary changes made to implement the KV cache. 

You can either 

a. Open the [`gpt_with_kv_cache.py`](https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/03_kv-cache/gpt_with_kv_cache.py) file and look out for the `# NEW` sections that mark the new changes:
...
You can find these optimizations in the [`gpt_with_kv_cache_optimized.py`](https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/03_kv-cache/gpt_with_kv_cache_optimized.py) file. 
