...
entryUrl: "https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/10_kv-sharing/README.md"
sourceRel: "ch04/10_kv-sharing/README.md"
rawUrl: "/raw/01-foundations/llms-from-scratch/ch04/10_kv-sharing/README.md"
sourceSha256: "e6750a4810d5b5112dcee8ebb6fc1dad36b76e12233fd2fa0dd20dbdfb22fe05"
pageSha256: "e6750a4810d5b5112dcee8ebb6fc1dad36b76e12233fd2fa0dd20dbdfb22fe05"
...
In [../04_gqa](/lib/01-foundations/llms-from-scratch/ch04-04_gqa), we discussed Grouped-Query Attention (GQA), where several query heads share the same key and value heads. Cross-layer KV sharing applies a related idea across transformer layers.
...
<img src="/mirror/e8/e80c8e62997074acb2bace83647fe73234f8966b.webp" alt="Cross-layer KV sharing" width="800px" />

&nbsp;

In [Gemma 4](/lib/01-foundations/llms-from-scratch/ch05-17_gemma4), KV sharing is combined with GQA or MQA and sliding window attention. For the simplified GPT example in this folder, we only implement the cross-layer KV-sharing part, so the code stays focused on the main mechanism.
...
You can use the [memory_estimator_kv_sharing.py](https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/10_kv-sharing/memory_estimator_kv_sharing.py) script in this folder to apply this to different model configs:
...
<img src="/mirror/d0/d0ded29f7635f8bb985fb9178a3bab1d1baad775.webp" alt="KV-sharing memory savings for Gemma 4 E2B-like setup" width="800px" />

&nbsp;

<img src="/mirror/f4/f4ae3d0c38a2b05a57ddc8c0e7beb05901fd9654.webp" alt="KV-sharing memory savings for Gemma 4 E4B-like setup" width="800px" />
...
The [gpt_with_kv_mha.py](https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/10_kv-sharing/gpt_with_kv_mha.py) and [gpt_with_kv_sharing.py](https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/10_kv-sharing/gpt_with_kv_sharing.py) scripts in this folder provide hands-on examples for comparing regular MHA with a cross-layer KV-sharing variant.

The easiest way to see the implementation details is to inspect a file diff between [gpt_with_kv_mha.py](https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/10_kv-sharing/gpt_with_kv_mha.py) and [gpt_with_kv_sharing.py](https://github.com/rasbt/LLMs-from-scratch/blob/ef9fbc2f52bf9bbb6769f43e6d726bbba4aed03e/ch04/10_kv-sharing/gpt_with_kv_sharing.py). The comments are intentionally kept similar so that the diff highlights the KV-sharing changes.
...
Also, this implementation uses the KV cache explained in [another bonus section](/lib/01-foundations/llms-from-scratch/ch04-03_kv-cache), so the memory savings are more pronounced.
