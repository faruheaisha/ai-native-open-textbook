---
title: "AI Engineering Lab: Skills Library"
...
entryUrl: "https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/reference/skills/README.md"
sourceRel: "reference/skills/README.md"
rawUrl: "/raw/01-foundations/ai-engineering-lab/reference/skills/README.md"
sourceSha256: "e926da428e882eb60334784d525564172bd1a755fb8ceedf29474909e2336631"
pageSha256: "e926da428e882eb60334784d525564172bd1a755fb8ceedf29474909e2336631"
...
| Skill | One-liner |
|---|---|
| [claude-code](/lib/01-foundations/ai-engineering-lab/reference-skills-claude-code) | Anthropic's terminal coding agent, `CLAUDE.md`, subagents, hooks, MCP, headless CI. |
| [cursor](/lib/01-foundations/ai-engineering-lab/reference-skills-cursor) | Anysphere's AI-native editor, Tab + Agent, Rules, MCP, Cursor Router, team tiers. |
| [deepseek-harness](/lib/01-foundations/ai-engineering-lab/reference-skills-deepseek-harness) | DeepSeek's open-source plugin harness, skills, goals, subagents, workflows, web GUI. |
| [opencode](/lib/01-foundations/ai-engineering-lab/reference-skills-opencode) | SST's terminal-native, model-agnostic agent, `opencode.json`, `AGENTS.md`, TUI. |
| [openrouter](/lib/01-foundations/ai-engineering-lab/reference-skills-openrouter) | One API key routing to hundreds of models, `:free` variants, credits, fallbacks. |
| [ollama-llamacpp](/lib/01-foundations/ai-engineering-lab/reference-skills-ollama-llamacpp) | Local inference with Ollama and llama.cpp, pulls, Modelfiles, GGUF quants, VRAM picks. |

## Agent skills (the other kind of skill)

The guides above teach *you* to use a tool. **[`agent-skills/`](/lib/01-foundations/ai-engineering-lab/reference-skills-agent-skills)**
...
→ **[Zorost Agent Skills Catalog](/lib/01-foundations/ai-engineering-lab/reference-skills-agent-skills)**, 14 skills across the
