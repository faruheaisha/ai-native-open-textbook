...
entryUrl: "https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/reference/knowledge-base/11-mcp-ecosystem.md"
sourceRel: "reference/knowledge-base/11-mcp-ecosystem.md"
rawUrl: "/raw/01-foundations/ai-engineering-lab/reference/knowledge-base/11-mcp-ecosystem.md"
sourceSha256: "424e5c93f84844d3e6a67aee28401afdb9fdc4842c5d11cdd22746fe588af618"
pageSha256: "424e5c93f84844d3e6a67aee28401afdb9fdc4842c5d11cdd22746fe588af618"
...
[`10-agents-multiagent.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-10-agents-multiagent) and the reference for Week 16's MCP
server lab.
...
- **Trust**: only connect servers whose provenance you trust; a malicious server can
  ...
  [`10-agents-multiagent.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-10-agents-multiagent) §10).
...
- **Test with the MCP Inspector** before wiring it into any agent; then A/B the multi-agent
  team against the single agent (see [`10-agents-multiagent.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-10-agents-multiagent) §12).
...
> [`10-agents-multiagent.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-10-agents-multiagent) §14 applies unchanged to the *server* here,
