---
title: "Week 21, Databricks Day Zero: Unity Catalog & the Lakehouse"
...
entryUrl: "https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/curriculum/week-21/README.md"
sourceRel: "curriculum/week-21/README.md"
rawUrl: "/raw/01-foundations/ai-engineering-lab/curriculum/week-21/README.md"
sourceSha256: "8b31e645f69b2abadf8f63795d1ba261376187095ba8ebaf678594456a1fa967"
pageSha256: "8b31e645f69b2abadf8f63795d1ba261376187095ba8ebaf678594456a1fa967"
...
|---|---|---|---|---|
| **Mon** | Account, workspace anatomy, control vs. compute plane, personas ([`00-day-zero-setup.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-00-day-zero-setup)) | Create the free-trial workspace; tour the sidebar; install + auth the CLI | A first notebook `%sql` cell that prints `current_user()` | ~2 h |
| **Tue** | Unity Catalog object model, managed vs. external, the privilege model ([`01-unity-catalog.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-01-unity-catalog)) | `01-unity-catalog-and-delta-lab.ipynb` cells 1 to 4: create `zrl_`/`zorologistics`/volumes, upload CSVs, load `shipments_bronze` | A governed catalog/schema/volume with a `SHOW GRANTS` you can read | ~2.5 h |
| **Wed** | Delta Lake: ACID, time travel, VACUUM/OPTIMIZE, liquid clustering ([`03-delta-lake.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-03-delta-lake)) | Notebook 1 cells 5 to 11: `DESCRIBE HISTORY`, `VERSION AS OF`, `VACUUM DRY RUN`, `OPTIMIZE ZORDER`, `CLUSTER BY` | A time-travel demo table with two versions and a clustering change | ~2.5 h |
| **Thu** | Medallion architecture + DBSQL ([`03-delta-lake.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-03-delta-lake) §9, [`04-dbsql.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-04-dbsql)) | `02-medallion-sql.ipynb`: bronze → silver (dedupe/cast/impute) → gold | `silver_shipments` + `gold_on_time_kpis` with quality checks passing | ~3 h |
...
Your fact base this week is [`reference/knowledge-base/research/06-databricks-deep-dive.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-research-06-databricks-deep-dive) (§0, §4) and [`reference/knowledge-base/13-databricks-overview.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-13-databricks-overview); the deep-dives are [`00-day-zero-setup.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-00-day-zero-setup), [`01-unity-catalog.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-01-unity-catalog), [`02-compute.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-02-compute), [`03-delta-lake.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-03-delta-lake), and [`04-dbsql.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-04-dbsql). This README is the map; those files are the terrain.
...
broad. (Full model and an OpenSharing/Delta Sharing example: [`01-unity-catalog.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-01-unity-catalog).)
...
DBR 15.4 LTS+). Full mechanics in [`03-delta-lake.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-03-delta-lake).
...
dashboard"). Details in [`04-dbsql.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-04-dbsql).
...
Take [`quiz.md`](/lib/01-foundations/ai-engineering-lab/curriculum-week-21-quiz), 10 questions, **8/10 to pass**. It mixes multiple-choice
...
[`exercises.md`](/lib/01-foundations/ai-engineering-lab/curriculum-week-21-exercises) with hints, the portfolio item advances the
