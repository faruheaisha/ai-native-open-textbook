...
entryUrl: "https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/reference/platforms/databricks/12-ai-functions-genie.md"
sourceRel: "reference/platforms/databricks/12-ai-functions-genie.md"
rawUrl: "/raw/01-foundations/ai-engineering-lab/reference/platforms/databricks/12-ai-functions-genie.md"
sourceSha256: "a8df2d3bc6bb1cf58c012ca7ebeadcdaf55a2e6f491f95858769b682c6d4af5c"
pageSha256: "a8df2d3bc6bb1cf58c012ca7ebeadcdaf55a2e6f491f95858769b682c6d4af5c"
...
> unauthorized readers, see [`16-governance-security.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-16-governance-security). Use
...
(the retrieval target of [`11-vector-search-rag.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-11-vector-search-rag)):
...
- Genie respects the **row filters / column masks** on the underlying tables (see
  [`16-governance-security.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-16-governance-security)), a masked email stays masked in a
  Genie answer.
...
4. **Point recurring KPIs at dashboards**: Genie One answers ad-hoc questions; the recurring
   ...
   [`14-apps-dashboards.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-14-apps-dashboards)).
...
- **Genie for a fixed, recurring KPI**: that is a dashboard's job (see
  [`14-apps-dashboards.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-14-apps-dashboards)); Genie is for *ad-hoc* questions. Reserve
...
`parsed_chunks` in AI Search (see [`11-vector-search-rag.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-11-vector-search-rag)).
...
4. **Confusing `ai_mask` with a column mask.** One is a one-time text transform, the other a
   ...
   governed columns (see [`16-governance-security.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-16-governance-security)).
