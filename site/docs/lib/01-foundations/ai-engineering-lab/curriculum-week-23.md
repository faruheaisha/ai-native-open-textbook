---
title: "Week 23, Databricks ML & GenAI: Training, Serving, Genie"
...
entryUrl: "https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/curriculum/week-23/README.md"
sourceRel: "curriculum/week-23/README.md"
rawUrl: "/raw/01-foundations/ai-engineering-lab/curriculum/week-23/README.md"
sourceSha256: "db629a8df46ab224b5bafc0e97fc1a5406d885ec0ccea12b94b457228fcccd47"
pageSha256: "db629a8df46ab224b5bafc0e97fc1a5406d885ec0ccea12b94b457228fcccd47"
...
|---|---|---|---|---|
| **Mon** | MLflow tracking + Models in UC + aliases ([`07-mlflow-experiments.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-07-mlflow-experiments)); feature tables + PIT joins ([`08-feature-engineering.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-08-feature-engineering)) | `01-mlflow-feature-engineering-training.ipynb`: feature tables + `FeatureLookup` + `create_training_set` | A point-in-time training set (proof: `timestamp_lookup_key`) | ~3 h |
| **Tue** | Training + registration ([`09-model-training.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-09-model-training)) | Train champion XGBoost, challenger (static-only), register both, set `@prod`/`@challenger` | Two registered model versions with a MAE comparison | ~2.5 h |
| **Wed** | Serving + Unity AI Gateway ([`10-model-serving.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-10-model-serving)) | Create a scale-to-zero endpoint; attach a gateway rate limit; call from Python | An endpoint that 429s when the limit trips | ~2.5 h |
| **Thu** | AI Search + RAG ([`11-vector-search-rag.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-11-vector-search-rag)); AI functions ([`12-ai-functions-genie.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-12-ai-functions-genie)) | `02-vector-search-rag.ipynb` + `03-ai-functions-and-genie.ipynb` | A cited RAG answer + groundedness score; AI-function SQL cells | ~3 h |
| **Fri** | Use case day | Stand up the Genie space; verify its SQL | The Week 23 gate (below) | ~2 h |

## Concepts (study first: Mon/Tue)

Fact base: [`reference/knowledge-base/research/06-databricks-deep-dive.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-research-06-databricks-deep-dive) (§6, §7). Deep-dives: [`07-mlflow-experiments.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-07-mlflow-experiments), [`08-feature-engineering.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-08-feature-engineering), [`09-model-training.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-09-model-training), [`10-model-serving.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-10-model-serving), [`11-vector-search-rag.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-11-vector-search-rag), [`12-ai-functions-genie.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-12-ai-functions-genie).
...
Take [`quiz.md`](/lib/01-foundations/ai-engineering-lab/curriculum-week-23-quiz), 10 questions, **8/10 to pass**, mixing multiple-choice
and short-answer tied to the Concepts sections and notebook cells.

## Exercises

Four graded exercises are in [`exercises.md`](/lib/01-foundations/ai-engineering-lab/curriculum-week-23-exercises) with hints, the
