---
title: "Zorost Agent Skills: Catalog"
...
entryUrl: "https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/reference/skills/agent-skills/README.md"
sourceRel: "reference/skills/agent-skills/README.md"
rawUrl: "/raw/01-foundations/ai-engineering-lab/reference/skills/agent-skills/README.md"
sourceSha256: "2271ec63c7f642b67f7cafd12fb0eb655146f95d764cfcc6c6154c03274d4412"
pageSha256: "2271ec63c7f642b67f7cafd12fb0eb655146f95d764cfcc6c6154c03274d4412"
...
|---|---|---|
| [spec-first-ai-feature](/lib/01-foundations/ai-engineering-lab/reference-skills-agent-skills-spec-first-ai-feature-SKILL) | Write the one-page spec, user, golden set, metric, gate, before any AI code. | W13 |
| [eval-first-development](/lib/01-foundations/ai-engineering-lab/reference-skills-agent-skills-eval-first-development-SKILL) | Build the golden set and the scorer before touching the prompt or model. | W6, W11 |

### Build: construct the AI component

| Skill | One-line description | Program week |
|---|---|---|
| [prompt-suite-versioning](/lib/01-foundations/ai-engineering-lab/reference-skills-agent-skills-prompt-suite-versioning-SKILL) | Treat a prompt as a versioned artifact with a score; change one variable at a time. | W6 |
| [context-budget-audit](/lib/01-foundations/ai-engineering-lab/reference-skills-agent-skills-context-budget-audit-SKILL) | Audit the seven claimants on the context window and set a working ceiling. | W6 |
| [rag-pipeline-checkup](/lib/01-foundations/ai-engineering-lab/reference-skills-agent-skills-rag-pipeline-checkup-SKILL) | Verify a RAG pipeline end-to-end: chunks, embeddings, retrieval, rerank, citations. | W7 |
| [local-model-fit](/lib/01-foundations/ai-engineering-lab/reference-skills-agent-skills-local-model-fit-SKILL) | Compute the VRAM budget and pick a model + quantization before downloading anything. | W8 to 9 |
| [fine-tune-readiness](/lib/01-foundations/ai-engineering-lab/reference-skills-agent-skills-fine-tune-readiness-SKILL) | Decide whether fine-tuning is justified, and gate the dataset before training. | W10 |
| [agent-loop-safety](/lib/01-foundations/ai-engineering-lab/reference-skills-agent-skills-agent-loop-safety-SKILL) | Wrap an agent loop with step limits, cost caps, human gates, and a trace. | W14 |
| [mcp-server-craft](/lib/01-foundations/ai-engineering-lab/reference-skills-agent-skills-mcp-server-craft-SKILL) | Design MCP tools that are narrow, typed, idempotent, and documented. | W16 |

### Verify: prove it works

| Skill | One-line description | Program week |
|---|---|---|
| [error-analysis-50](/lib/01-foundations/ai-engineering-lab/reference-skills-agent-skills-error-analysis-50-SKILL) | Read 50 real failures, cluster them, fix the largest class, extend the golden set. | W11 |
| [ai-output-review](/lib/01-foundations/ai-engineering-lab/reference-skills-agent-skills-ai-output-review-SKILL) | Review AI-generated code or text: spec diff, verifier run, secret scan, smell list. | W12 to 13 |

### Ship & operate: run it in production

| Skill | One-line description | Program week |
|---|---|---|
| [agent-ops-handoff](/lib/01-foundations/ai-engineering-lab/reference-skills-agent-skills-agent-ops-handoff-SKILL) | Move an agent from laptop to operated: tracing, cost dashboard, alerts, rollback. | W17 |
| [cloud-deploy-gate](/lib/01-foundations/ai-engineering-lab/reference-skills-agent-skills-cloud-deploy-gate-SKILL) | The pre-deploy gate for Foundry / Vertex / Bedrock: evals, budget, guardrails, owner. | W18 to 20 |

### Meta

| Skill | One-line description | Program week |
|---|---|---|
| [using-zorost-skills](/lib/01-foundations/ai-engineering-lab/reference-skills-agent-skills-using-zorost-skills-SKILL) | How to pick, run, and amend skills from this catalog. Start here. | all |
