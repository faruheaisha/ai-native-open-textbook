---
title: "Week 08, Open Models & Local Inference: GPUs, Ollama, llama.cpp"
...
entryUrl: "https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/curriculum/week-08/README.md"
sourceRel: "curriculum/week-08/README.md"
rawUrl: "/raw/01-foundations/ai-engineering-lab/curriculum/week-08/README.md"
sourceSha256: "7de9f6c638b5f176877b8e4bd3cef6c9971d85d26baca772a770ef16c116b222"
pageSha256: "7de9f6c638b5f176877b8e4bd3cef6c9971d85d26baca772a770ef16c116b222"
...
|---|---|---|---|---|
| **Mon** | Open vs. closed, licenses, families in [`reference/knowledge-base/08-local-inference-gpu.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-08-local-inference-gpu) §1 to 2 | Skim `02-vram-sizing-and-model-selection.ipynb` | Notes: "open weights ≠ open license" | ~2 h |
...
Read [`reference/knowledge-base/08-local-inference-gpu.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-08-local-inference-gpu) first; [`reference/knowledge-base/research/03-harnesses-local-stacks.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-research-03-harnesses-local-stacks) has the full command reference. "Open weights" is a *distribution* fact, "open license" is a *legal* fact, do not conflate them.
...
Ten questions covering the concepts and notebook code are in [`quiz.md`](/lib/01-foundations/ai-engineering-lab/curriculum-week-08-quiz), the passing bar is **8/10**.

## Exercises

Four graded exercises (easy / standard / stretch / portfolio), a task-parameter sweep, two new catalog models, a `num_ctx` sweep, and a `model_picker.py` CLI. Hints for each are in [`exercises.md`](/lib/01-foundations/ai-engineering-lab/curriculum-week-08-exercises).
