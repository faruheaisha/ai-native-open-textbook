---
title: "Week 12, Coding-Agent Harnesses: Claude Code, Cursor, OpenCode, DSH"
...
entryUrl: "https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/curriculum/week-12/README.md"
sourceRel: "curriculum/week-12/README.md"
rawUrl: "/raw/01-foundations/ai-engineering-lab/curriculum/week-12/README.md"
sourceSha256: "917e0729d555f282b52dafafddedf0ffc40a3f7832df7c264dbf68846adce0bb"
pageSha256: "917e0729d555f282b52dafafddedf0ffc40a3f7832df7c264dbf68846adce0bb"
...
|---|---|---|---|---|
| **Mon** | Read the four skill guides; skim [`KB 09`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-09-harnesses-tools) | Tool-check cell in the notebook | 2 harnesses installed + authenticated, version-checked | ~2 h |
...
things ([`KB 09 §1`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-09-harnesses-tools)):
...
The decision rule of thumb from [`KB 09 §3`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-09-harnesses-tools):
...
[`reference/skills/claude-code.md`](/lib/01-foundations/ai-engineering-lab/reference-skills-claude-code), [`reference/skills/cursor.md`](/lib/01-foundations/ai-engineering-lab/reference-skills-cursor),
[`reference/skills/opencode.md`](/lib/01-foundations/ai-engineering-lab/reference-skills-opencode), and
[`reference/skills/deepseek-harness.md`](/lib/01-foundations/ai-engineering-lab/reference-skills-deepseek-harness) before installing.
...
repo is*, *commands*, *conventions*, and a *never-touch* list ([`KB 09 §4`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-09-harnesses-tools)).
...
([`KB 09 §3`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-09-harnesses-tools)). Feed it the spec, the rules file,
...
against** ([`KB 01 §3`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-01-ai-engineering-discipline)). That is the
bridge to Week 13.
...
([`KB 09 §5`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-09-harnesses-tools)): **context isolation** (a specialist
...
([`reference/skills/openrouter.md`](/lib/01-foundations/ai-engineering-lab/reference-skills-openrouter)). It is the routing layer *behind* a
harness, and it is how you make the cost comparison honest. The levers, in order of impact
([`KB 09 §6`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-09-harnesses-tools)): **narrow the task**, **trim
...
"still broken, try again" ([`KB 01 §3`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-01-ai-engineering-discipline)).
...
[`KB 01`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-01-ai-engineering-discipline) and Zorost's artifact-gate
philosophy in [`07-zorost-skills-map-guide.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-research-07-zorost-skills-map-guide):
...
([`reference/skills/openrouter.md`](/lib/01-foundations/ai-engineering-lab/reference-skills-openrouter))
...
Take [`quiz.md`](/lib/01-foundations/ai-engineering-lab/curriculum-week-12-quiz), 10 questions on concepts and notebook code, **8/10 to pass**.

## Exercises

Four graded exercises (easy / standard / stretch / portfolio) live in
[`exercises.md`](/lib/01-foundations/ai-engineering-lab/curriculum-week-12-exercises): run the notebook to a score, fill the SPEC.md and drive one
