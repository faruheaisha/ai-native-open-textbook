...
entryUrl: "https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/reference/platforms/databricks/16-governance-security.md"
sourceRel: "reference/platforms/databricks/16-governance-security.md"
rawUrl: "/raw/01-foundations/ai-engineering-lab/reference/platforms/databricks/16-governance-security.md"
sourceSha256: "43c59b49a07b9e199ca30aa30ea865cdd1c8aa62c4a71eae3bf1c03aa71ee3c3"
pageSha256: "43c59b49a07b9e199ca30aa30ea865cdd1c8aa62c4a71eae3bf1c03aa71ee3c3"
...
> **Week 24 · Production & Capstone.** Pairs with [`15-dabs-ci-cd.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-15-dabs-ci-cd)
> (who *deploys*) and [`17-finopps-cost.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-17-finopps-cost) (who *pays*).
...
> **`ai_mask` ≠ column mask.** `ai_mask` (see [`12-ai-functions-genie.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-12-ai-functions-genie))
...
- **Secrets**: store API keys/credentials in a Databricks **secret scope**; reference them by
  path (<code v-pre>{{secrets/&lt;scope>/&lt;key>}}</code>) in SQL/Python. Never in code or notebooks.
...
- **OAuth U2M / M2M vs PATs**: the decision, in one table:
  ...
  legacy**, migrate to OAuth. Full detail in [`15-dabs-ci-cd.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-15-dabs-ci-cd).
