---
title: "13: Agentic AI on Databricks"
...
entryUrl: "https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/reference/platforms/databricks/13-agents.md"
sourceRel: "reference/platforms/databricks/13-agents.md"
rawUrl: "/raw/01-foundations/ai-engineering-lab/reference/platforms/databricks/13-agents.md"
sourceSha256: "2331aaece225def3a17084e4bcb34c217b6b7c6ab590bc5b0d6820e3bda43d53"
pageSha256: "2331aaece225def3a17084e4bcb34c217b6b7c6ab590bc5b0d6820e3bda43d53"
...
> **Weeks 23 to 24 · ML & GenAI.** Builds on [`10-model-serving.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-10-model-serving) (agents
> are custom models), [`11-vector-search-rag.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-11-vector-search-rag) (AI Search tools),
> and the agent concepts in [`reference/knowledge-base/10-agents-multiagent.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-10-agents-multiagent).
...
- `ResponsesAgent` is the wrapper that makes the agent **serveable**: the same serving
  machinery from [`10-model-serving.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-10-model-serving) then hosts it.
...
[`11-vector-search-rag.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-11-vector-search-rag), give it instructions, and it returns
...
[`11-vector-search-rag.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-11-vector-search-rag)):
...
[`reference/knowledge-base/11-mcp-ecosystem.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-11-mcp-ecosystem) carries over
...
> auth, streaming), see [`14-apps-dashboards.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-14-apps-dashboards).
...
[`reference/knowledge-base/07-evals-error-analysis.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-07-evals-error-analysis).
...
Agents route through the **Unity AI Gateway** (see [`10-model-serving.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-10-model-serving))
...
discipline from [`reference/knowledge-base/07-evals-error-analysis.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-07-evals-error-analysis):
