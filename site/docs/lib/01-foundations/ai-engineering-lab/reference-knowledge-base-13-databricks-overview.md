---
title: "13 · The Databricks Data Intelligence Platform at a Glance"
...
entryUrl: "https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/reference/knowledge-base/13-databricks-overview.md"
sourceRel: "reference/knowledge-base/13-databricks-overview.md"
rawUrl: "/raw/01-foundations/ai-engineering-lab/reference/knowledge-base/13-databricks-overview.md"
sourceSha256: "7730fb27601c84e32d66ea0956c0b03fdf7828836182955e211b9e92c40b4bf6"
pageSha256: "7730fb27601c84e32d66ea0956c0b03fdf7828836182955e211b9e92c40b4bf6"
...
file is built from, see [`research/06-databricks-deep-dive.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-research-06-databricks-deep-dive).

The running case study is **ZoroLogistics**, a fictional freight company whose synthetic
data toolkit lives in [`zoro/`](https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/zoro/README.md). Every example in the platform files maps a
...
**Which week teaches it:** Week 21, [`reference/platforms/databricks/00-day-zero-setup.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-00-day-zero-setup).
...
**Which week teaches it:** Week 21, [`01-unity-catalog.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-01-unity-catalog).
...
**Which week teaches it:** Week 21, [`03-delta-lake.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-03-delta-lake).
...
**Which week teaches it:** Week 21, [`02-compute.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-02-compute).
...
**Which week teaches it:** Week 21, [`04-dbsql.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-04-dbsql).
...
**Which week teaches it:** Week 22, [`06-pipelines-jobs.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-06-pipelines-jobs).
...
**Which week teaches it:** Week 23, [`07-mlflow-experiments.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-07-mlflow-experiments).
...
**Which week teaches it:** Week 23, [`08-feature-engineering.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-08-feature-engineering).
...
**Which week teaches it:** Week 23, [`11-vector-search-rag.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-11-vector-search-rag).
...
**Which week teaches it:** Week 23, [`12-ai-functions-genie.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-12-ai-functions-genie).
...
**Which week teaches it:** Week 24, [`15-dabs-ci-cd.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-15-dabs-ci-cd).
...
**Which week teaches it:** Week 24, [`18-certification-path.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-18-certification-path).
...
|---|---|---|---|
| Platform planes, accounts/workspaces | n/a | 21 | [`00-day-zero-setup.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-00-day-zero-setup) |
| Unity Catalog (namespace, GRANT/REVOKE, row filters/masks) | n/a | 21 | [`01-unity-catalog.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-01-unity-catalog) |
| Compute (clusters, policies, Photon, DBU) | n/a | 21 | [`02-compute.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-02-compute) |
| Delta Lake (ACID, time travel, liquid clustering) | n/a | 21 | [`03-delta-lake.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-03-delta-lake) |
| Databricks SQL + AI/BI | DBSQL / Lakeview dashboards | 21 | [`04-dbsql.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-04-dbsql) |
| PySpark DataFrames + Structured Streaming | n/a | 22 | [`05-pyspark.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-05-pyspark) |
| Lakeflow Pipelines + Jobs + Connect | DLT / Workflows / Ingest | 22 | [`06-pipelines-jobs.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-06-pipelines-jobs) |
| MLflow experiments + Models in UC | MLflow Model Registry | 23 | [`07-mlflow-experiments.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-07-mlflow-experiments) |
| Feature Engineering (point-in-time joins) | Feature Store | 23 | [`08-feature-engineering.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-08-feature-engineering) |
| Model Training (Optuna, AI Runtime) | Mosaic AI Model Training | 23 | [`09-model-training.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-09-model-training) |
| Model Serving + Unity AI Gateway | Mosaic AI Serving / AI Gateway | 23 to 24 | [`10-model-serving.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-10-model-serving) |
| AI Search + RAG | Vector Search | 23 | [`11-vector-search-rag.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-11-vector-search-rag) |
| AI Functions + Genie | n/a | 23 | [`12-ai-functions-genie.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-12-ai-functions-genie) |
| Agent Framework + Agent Bricks | n/a | 23 to 24 | [`13-agents.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-13-agents) |
| Databricks Apps + AI/BI dashboards | n/a | 24 | [`14-apps-dashboards.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-14-apps-dashboards) |
| DABs + CI/CD | Databricks Asset Bundles | 24 | [`15-dabs-ci-cd.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-15-dabs-ci-cd) |
| Governance + security (system tables) | n/a | 24 | [`16-governance-security.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-16-governance-security) |
| FinOps + cost | n/a | 24 | [`17-finopps-cost.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-17-finopps-cost) |
| Certification path | n/a | 24 | [`18-certification-path.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-18-certification-path) |
