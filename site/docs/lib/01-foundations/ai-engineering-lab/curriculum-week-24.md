---
title: "Week 24, Databricks Production: DABs, Governance & the Capstone"
...
entryUrl: "https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/curriculum/week-24/README.md"
sourceRel: "curriculum/week-24/README.md"
rawUrl: "/raw/01-foundations/ai-engineering-lab/curriculum/week-24/README.md"
sourceSha256: "757d24a74742628acf3025f11bcad099ac87614d8b8d0adc2da381f702a0b0d4"
pageSha256: "757d24a74742628acf3025f11bcad099ac87614d8b8d0adc2da381f702a0b0d4"
...
- [ ] By Friday you can describe how to bundle the Weeks 21 to 23 assets into a **Declarative Automation Bundles (DABs)** project with CI/CD, and outline the **capstone** (see [`reference/platforms/databricks/capstone/`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-capstone)).

## Day-by-day plan

| Day | Study | Run | Ship | Time |
|---|---|---|---|---|
| **Mon** | DABs anatomy + CLI lifecycle ([`15-dabs-ci-cd.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-15-dabs-ci-cd)) | Scaffold a bundle; `bundle validate --strict`; `deploy -t dev` | A valid, deployable `databricks.yml` | ~3 h |
| **Tue** | CI/CD + auth (M2M/OIDC) ([`15-dabs-ci-cd.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-15-dabs-ci-cd) §5 to 6) | Wire a GitHub Actions workflow that validates + deploys | A CI job with no stored secrets | ~2.5 h |
| **Wed** | Fine-grained governance ([`16-governance-security.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-16-governance-security)) | `01-governance-and-finopps.ipynb`: row filter + column mask + dynamic view + audit + lineage | Before/after evidence of each control | ~3 h |
| **Thu** | FinOps ([`17-finopps-cost.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-17-finopps-cost)) | Billing query → cost-by-day; find one cost win | A cost metric + a documented DBU/dollar delta | ~2.5 h |
| **Fri** | Capstone + graduation ([`18-certification-path.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-18-certification-path), capstone) | Map every Weeks 21 to 23 asset to a bundle resource; demo end-to-end | The capstone gate (below) + portfolio | ~3 h |

## Concepts (study first: Mon/Tue)

Fact base: [`reference/knowledge-base/research/06-databricks-deep-dive.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-research-06-databricks-deep-dive) (§8, §10). Deep-dives: [`13-agents.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-13-agents), [`14-apps-dashboards.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-14-apps-dashboards), [`15-dabs-ci-cd.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-15-dabs-ci-cd), [`16-governance-security.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-16-governance-security), [`17-finopps-cost.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-17-finopps-cost), [`18-certification-path.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-18-certification-path), and the [capstone](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-capstone).
...
**Worked example: the capstone bundle.** The starter [`capstone/databricks.yml`](https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/reference/platforms/databricks/capstone/databricks.yml)
...
[`13-agents.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-13-agents) and [`14-apps-dashboards.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-14-apps-dashboards)
...
the warm-up ([`18-certification-path.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-18-certification-path)).
...
[`reference/platforms/databricks/capstone/`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-capstone) and map every
...
Take [`quiz.md`](/lib/01-foundations/ai-engineering-lab/curriculum-week-24-quiz), 10 questions, **8/10 to pass**, mixing multiple-choice
and short-answer tied to the Concepts sections and notebook cells.

## Exercises

Four graded exercises are in [`exercises.md`](/lib/01-foundations/ai-engineering-lab/curriculum-week-24-exercises) with hints, the
