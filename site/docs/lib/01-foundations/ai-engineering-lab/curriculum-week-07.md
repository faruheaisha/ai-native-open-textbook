---
title: "Week 07: RAG, Vector Search & Knowledge Graphs"
...
entryUrl: "https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/curriculum/week-07/README.md"
sourceRel: "curriculum/week-07/README.md"
rawUrl: "/raw/01-foundations/ai-engineering-lab/curriculum/week-07/README.md"
sourceSha256: "a854b55a532ec71870c63da5a0e31853f8f3e2e71eaaffd3868865cf9784212a"
pageSha256: "a854b55a532ec71870c63da5a0e31853f8f3e2e71eaaffd3868865cf9784212a"
...
|---|---|---|---|---|
| **Mon** | Why RAG + the pipeline in [`reference/knowledge-base/05-rag-graph-engineering.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-05-rag-graph-engineering) §1 to 2 | Skim `01-rag-policy-bot.ipynb` cells 0 to 4 (chunking) | Notes: RAG = grounding, freshness, permissions | ~2 h |
...
Ten questions covering the concepts and notebook code are in [`quiz.md`](/lib/01-foundations/ai-engineering-lab/curriculum-week-07-quiz), the passing bar is **8/10**.

## Exercises

Four graded exercises (easy / standard / stretch / portfolio), a `k` sweep, two new golden questions, a `via`-constrained route, and a `policy_bot.py` CLI. Hints for each are in [`exercises.md`](/lib/01-foundations/ai-engineering-lab/curriculum-week-07-exercises).
