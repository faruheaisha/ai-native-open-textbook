...
entryUrl: "https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/reference/agents/README.md"
sourceRel: "reference/agents/README.md"
rawUrl: "/raw/01-foundations/ai-engineering-lab/reference/agents/README.md"
sourceSha256: "915ec2eb2e3e6460966b05061cc91371912af538b2bd144cd1f23bfa5369ee9c"
pageSha256: "915ec2eb2e3e6460966b05061cc91371912af538b2bd144cd1f23bfa5369ee9c"
...
|---|---|---|
| 14 | Agent fundamentals: a hand-written ReAct loop, tools, memory, guardrails, traces | [`reference/knowledge-base/10-agents-multiagent.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-10-agents-multiagent) |
| 15 | LangGraph state graphs, checkpoints, human-in-the-loop | [`reference/knowledge-base/10-agents-multiagent.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-10-agents-multiagent) + LangGraph docs |
| 16 | Multi-agent triage team + an MCP server | [`reference/knowledge-base/10-agents-multiagent.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-10-agents-multiagent) · [`reference/knowledge-base/11-mcp-ecosystem.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-11-mcp-ecosystem) |
...
| File | What it covers |
|---|---|
| [`openclaw.md`](/lib/01-foundations/ai-engineering-lab/reference-agents-openclaw) | OpenClaw, the open-source personal AI assistant: architecture, channels, skills, the context loop, permission modes, install, Ollama, MCP, and a ZoroLab scenario |
| [`hermes.md`](/lib/01-foundations/ai-engineering-lab/reference-agents-hermes) | "Hermes" disambiguated, Nous Research's Hermes open-weight models **and** the Hermes Agent framework; running Hermes locally; using one as a triage-agent brain |

**Theory files (knowledge base):**

- [`../knowledge-base/10-agents-multiagent.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-10-agents-multiagent),
...
- [`../knowledge-base/11-mcp-ecosystem.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-11-mcp-ecosystem),
...
5. **OpenClaw ZoroLab assistant** (Week 17), your personal assistant wired to the Week-16
   MCP server (see [`openclaw.md`](/lib/01-foundations/ai-engineering-lab/reference-agents-openclaw)).
6. **Hermes-class agent brain** (Week 17), swap a local Hermes model into the triage agent
   and compare it against a frontier API model (see [`hermes.md`](/lib/01-foundations/ai-engineering-lab/reference-agents-hermes)).
...
weeks, see [`reference/resources/free-ai-learning.md`](/lib/01-foundations/ai-engineering-lab/reference-resources-free-ai-learning).
