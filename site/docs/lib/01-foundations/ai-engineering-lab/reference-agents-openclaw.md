---
title: "OpenClaw: Practical Guide"
...
entryUrl: "https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/reference/agents/openclaw.md"
sourceRel: "reference/agents/openclaw.md"
rawUrl: "/raw/01-foundations/ai-engineering-lab/reference/agents/openclaw.md"
sourceSha256: "600607d7afb2e7b3304d47e869903941cd9d8a4e38a1a9261d9f8784f910a491"
pageSha256: "600607d7afb2e7b3304d47e869903941cd9d8a4e38a1a9261d9f8784f910a491"
...
[`reference/knowledge-base/10-agents-multiagent.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-10-agents-multiagent) §5,
...
1. **Install Ollama** and pull a tool-capable model, e.g. `ollama pull hermes4` (see
   [`hermes.md`](/lib/01-foundations/ai-engineering-lab/reference-agents-hermes) for model choice).
...
- **Compaction & context budget**: watch `/usage tokens`; a long-running assistant degrades
  ...
  [`10-agents-multiagent.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-10-agents-multiagent)).
...
1. Install OpenClaw and onboard with a **local Hermes model** via Ollama (§6,
   [`hermes.md`](/lib/01-foundations/ai-engineering-lab/reference-agents-hermes)).
