---
title: "Week 13: Agentic Coding Loops & Spec-Driven Development"
...
entryUrl: "https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/curriculum/week-13/README.md"
sourceRel: "curriculum/week-13/README.md"
rawUrl: "/raw/01-foundations/ai-engineering-lab/curriculum/week-13/README.md"
sourceSha256: "ade828f12b85439e7b198a13935adccde61f127ded55b3a5fbd3a09746cdfc70"
pageSha256: "ade828f12b85439e7b198a13935adccde61f127ded55b3a5fbd3a09746cdfc70"
...
|---|---|---|---|---|
| **Mon** | Re-read [`KB 01`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-01-ai-engineering-discipline) three loops; verifier patterns in [`KB 09`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-09-harnesses-tools) | Notebook §0, §2 (classifier + eval set) | MVP `classify_ticket` + 60-ticket eval set loaded | ~2 h |
...
([`KB 01`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-01-ai-engineering-discipline),
[`07-zorost-skills-map-guide.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-research-07-zorost-skills-map-guide)):
...
([`KB 07`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-07-evals-error-analysis)).
...
([`KB 01 §3`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-01-ai-engineering-discipline)). The Week-13 addition: the
...
([`KB 09 §5`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-09-harnesses-tools),
[`reference/skills/claude-code.md`](/lib/01-foundations/ai-engineering-lab/reference-skills-claude-code),
[`reference/skills/deepseek-harness.md`](/lib/01-foundations/ai-engineering-lab/reference-skills-deepseek-harness)).

### Blast-radius rules

A blast-radius rule calibrates autonomy **per action**, not per session
([`KB 01 §3`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-01-ai-engineering-discipline)). Reading a scratch file is
...
([`KB 01`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-01-ai-engineering-discipline)). A loop log turns "the agent
...
Take [`quiz.md`](/lib/01-foundations/ai-engineering-lab/curriculum-week-13-quiz), 10 questions on concepts and notebook code, **8/10 to pass**.

## Exercises

Four graded exercises (easy / standard / stretch / portfolio) live in
[`exercises.md`](/lib/01-foundations/ai-engineering-lab/curriculum-week-13-exercises): run the notebook to a pass rate, add a billing check + an
