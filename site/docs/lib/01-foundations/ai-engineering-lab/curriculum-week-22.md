---
title: "Week 22, Databricks Data Engineering: PySpark, Streaming & Lakeflow"
...
entryUrl: "https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/curriculum/week-22/README.md"
sourceRel: "curriculum/week-22/README.md"
rawUrl: "/raw/01-foundations/ai-engineering-lab/curriculum/week-22/README.md"
sourceSha256: "a70bb40ace3bdafa294e825174e8fe31784b7976458f0394f08c68192387ef64"
pageSha256: "a70bb40ace3bdafa294e825174e8fe31784b7976458f0394f08c68192387ef64"
...
|---|---|---|---|---|
| **Mon** | PySpark DataFrame mental model, laziness, schema, partitioning ([`05-pyspark.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-05-pyspark)) | `01-pyspark-data-engineering.ipynb`: read → transform → join → aggregate → window | A DataFrame KPI table whose numbers match the SQL version | ~2.5 h |
| **Tue** | Structured Streaming: Auto Loader, watermarks, checkpoints, exactly-once ([`06-pipelines-jobs.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-06-pipelines-jobs) Part A) | `02-streaming-and-dlt-pipeline.ipynb`: `@dp.table` bronze + `@dp.materialized_view` silver | A pipeline with a streaming table and two expectations | ~3 h |
| **Wed** | Expectations in depth (warn/drop/fail) + AUTO CDC ([`06-pipelines-jobs.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-06-pipelines-jobs) §A4 to A5) | Re-run the pipeline after dropping a bad-weight CSV into `events/`; read the event log | Before/after row counts proving a gate removed bad rows | ~2.5 h |
| **Thu** | Lakeflow Jobs: task DAG, Run-if, triggers, parameters ([`06-pipelines-jobs.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-06-pipelines-jobs) Part B) | Wrap the pipeline in a scheduled Job; check runs and lineage | A scheduled job with a monitoring query | ~2.5 h |
| **Fri** | Use case day | Publish the monitoring query; screenshot the DAG | The Week 22 gate (below) | ~2 h |

## Concepts (study first: Mon/Tue)

Fact base: [`reference/knowledge-base/research/06-databricks-deep-dive.md`](/lib/01-foundations/ai-engineering-lab/reference-knowledge-base-research-06-databricks-deep-dive) (§5). Deep-dives: [`05-pyspark.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-05-pyspark) and [`06-pipelines-jobs.md`](/lib/01-foundations/ai-engineering-lab/reference-platforms-databricks-06-pipelines-jobs).
...
`ALL_FAILED`. Parameters flow as <code v-pre>{{job.parameters.run_date}}</code> (read in a notebook
...
Take [`quiz.md`](/lib/01-foundations/ai-engineering-lab/curriculum-week-22-quiz), 10 questions, **8/10 to pass**, mixing multiple-choice
and short-answer tied to the Concepts sections and notebook cells.

## Exercises

Four graded exercises are in [`exercises.md`](/lib/01-foundations/ai-engineering-lab/curriculum-week-22-exercises) with hints, the
