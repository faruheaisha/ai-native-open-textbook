---
title: "START HERE: A Complete Beginner's Guide to AI Engineering Lab"
...
entryUrl: "https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/START-HERE.md"
sourceRel: "START-HERE.md"
rawUrl: "/raw/01-foundations/ai-engineering-lab/START-HERE.md"
sourceSha256: "b21a65a4187b10feb889c281ed8f80d70fe410c724feb4de8bc64c7edaefc38a"
pageSha256: "b21a65a4187b10feb889c281ed8f80d70fe410c724feb4de8bc64c7edaefc38a"
...
2. **Skim the map.** Open [`curriculum/learning-path.md`](/lib/01-foundations/ai-engineering-lab/curriculum-learning-path)
   and look at the diagrams. You are not memorizing anything, just getting the shape
   of the journey.
3. **Open Week 1.** Go to [`curriculum/week-01/README.md`](/lib/01-foundations/ai-engineering-lab/curriculum-week-01).
...
4. **Get your progress tracker.** Open
   [`curriculum/tracking/ai-engineering-lab-24-week-tracker.xlsx`](/lib/01-foundations/ai-engineering-lab/curriculum-tracking)
...
6. **When a term confuses you**, look it up in the [`reference/GLOSSARY.md`](/lib/01-foundations/ai-engineering-lab/reference-GLOSSARY),
...
![The repository at top level, and the two places to start](/mirror/d4/d47f468a4b92a88b50967f650c1dd743350a3f05.webp)
...
3. **Search the [`reference/GLOSSARY.md`](/lib/01-foundations/ai-engineering-lab/reference-GLOSSARY)** if the blocker is a term you don't
   understand.
...
Engineering Skills Map framework (see [`README.md`](/lib/01-foundations/ai-engineering-lab/overview#the-framework-behind-the-program)),
...
[`.github/CONTRIBUTING.md`](https://github.com/zorost/AI-Engineering-Lab/blob/cdd8dbdf559f72211a7c068e8877918441531e52/.github/CONTRIBUTING.md) explains how to file an issue or open a pull
