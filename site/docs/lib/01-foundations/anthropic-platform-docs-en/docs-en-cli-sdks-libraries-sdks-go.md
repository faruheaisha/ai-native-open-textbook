...
sourceRel: "docs/en/cli-sdks-libraries/sdks/go.md"
rawUrl: "/raw/01-foundations/anthropic-platform-docs-en/docs/en/cli-sdks-libraries/sdks/go.md"
sourceSha256: "fd0d37283a23419548705e95bd8fe9a20458b8f4366a60624b57f4a612cf270d"
pageSha256: "fd0d37283a23419548705e95bd8fe9a20458b8f4366a60624b57f4a612cf270d"
...
To send a custom value instead of a struct, use the generic function `param.Override` (for example, `param.Override[anthropic.FooParams](https://platform.claude.com/docs)`).
...
For this use case, `param.SetJSON` (available since v1.20.0) is preferred over the more general `param.Override[T](https://platform.claude.com/docs)` because it doesn't require spelling out the type parameter and makes the round-trip intent explicit.
