...
> 相关：用 DeepSeek-V4 驱动 Claude Code / Codex / OpenCode 的配置见 [DeepSeek 生态指南](/lib/01-foundations/awesome-chatgpt-zh/docs-DeepSeek#在编程智能体中使用-deepseek)，通用智能体见 [AGI](/lib/01-foundations/awesome-chatgpt-zh/docs-AGI)，Agent 开发框架见 [应用开发指南](/lib/01-foundations/awesome-chatgpt-zh/docs-ChatGPT_dev)，工具连接协议见 [MCP 指南](/lib/01-foundations/awesome-chatgpt-zh/docs-MCP)。
...
> 这类是"通用型"自主智能体（个人助理），并非纯编程工具，但都能编排/委派编程 Agent（如 Codex、OpenCode）完成开发任务，2026 年热度极高。更多通用 Agent 见 [AGI](/lib/01-foundations/awesome-chatgpt-zh/docs-AGI)。
