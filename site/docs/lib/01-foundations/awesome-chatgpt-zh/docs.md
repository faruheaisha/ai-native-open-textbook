...
| MCP（模型上下文协议） | [Anthropic 公告](https://www.anthropic.com/news/model-context-protocol) | Anthropic（2024-11） | agent 连接数据/工具/工作流的开放标准，"AI 应用的 USB-C"，已成事实标准（详见本仓库 [MCP 指南](https://github.com/EmbraceAGI/awesome-chatgpt-zh/blob/f7c206f6b3e27dae3f4fa7fb1eee1852c72b1f68/docs/MCP.md)） |
