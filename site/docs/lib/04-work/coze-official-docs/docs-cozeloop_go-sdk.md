...
sourceUrl: ""
entryUrl: null
sourceRel: "docs/cozeloop_go-sdk.md"
rawUrl: "/raw/04-work/coze-official-docs/docs/cozeloop_go-sdk.md"
sourceSha256: "e21e32eca36765e0c933fa2d077c3913c1843b0a737c855ad0b8e0f93f066e85"
pageSha256: "e21e32eca36765e0c933fa2d077c3913c1843b0a737c855ad0b8e0f93f066e85"
...
1. 首先，通过环境变量的方式完成授权。
   该示例中使用了 PAT 授权方式，你可以使用 OAuth 方式进行授权。具体说明，请参考SDK 鉴权。
2. 创建扣子罗盘客户端。
...
1. 通过环境变量的方式完成授权。具体说明，请参考SDK 鉴权。
2. 初始化扣子罗盘客户端。
3. 创建 PromptHub 组件。
