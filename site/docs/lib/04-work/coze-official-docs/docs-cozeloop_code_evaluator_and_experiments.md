...
sourceUrl: ""
entryUrl: null
sourceRel: "docs/cozeloop_code_evaluator_and_experiments.md"
rawUrl: "/raw/04-work/coze-official-docs/docs/cozeloop_code_evaluator_and_experiments.md"
sourceSha256: "6e2ac976c1b9a4c97d5db41fa46d8065f211de7bf6f7a40594365354a6c20593"
pageSha256: "6e2ac976c1b9a4c97d5db41fa46d8065f211de7bf6f7a40594365354a6c20593"
...
* 已创建专利分类助手的扣子智能体，详细步骤参考搭建一个低代码智能体，智能体的提示词如下：
   ```Plain Text
...
5. 设置评估器。
   单击**添加评估器**，选择步骤一 创建 Code 评估器中已创建的评估器和版本，单击**确认实验配置**。
...
* 已创建邮编查询助手的扣子智能体，详细步骤参考搭建一个低代码智能体，智能体的提示词如下：
   ```Plain Text
