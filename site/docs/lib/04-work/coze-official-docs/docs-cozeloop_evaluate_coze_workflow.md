...
sourceUrl: ""
entryUrl: null
sourceRel: "docs/cozeloop_evaluate_coze_workflow.md"
rawUrl: "/raw/04-work/coze-official-docs/docs/cozeloop_evaluate_coze_workflow.md"
sourceSha256: "2171f91c2c67646b51667d8d0b79ddbc51e7e7239e41240fe274b929b3efc9d9"
pageSha256: "2171f91c2c67646b51667d8d0b79ddbc51e7e7239e41240fe274b929b3efc9d9"
...
5. 填写配置列，声明`执行工作流` OpenAPI 请求的数据结构，并单击**创建**。
   ...
   | |你可以在数据结构区域中单击 + 字段来新增输入参数，也可以导入一段 JSON 样例，扣子罗盘会自动解析 JSON 中的字段。如何为 parameter 构造 JSON 样例，并导入样例数据，可参考配置列如何导入样例数据？。 |
   | | | \
