...
entryUrl: "https://github.com/Tencent/workbuddy-bench/blob/625b2233093ae4f23e76be28c1f341d41cc70373/.agents/skills/wbbench-run-setup/SKILL.md"
sourceRel: ".agents/skills/wbbench-run-setup/SKILL.md"
rawUrl: "/raw/04-work/workbuddy-bench-official/.agents/skills/wbbench-run-setup/SKILL.md"
sourceSha256: "9e86e40d6e167d5358a3513125ed5834c698d346263dfbd232f57322c04ef059"
pageSha256: "9e86e40d6e167d5358a3513125ed5834c698d346263dfbd232f57322c04ef059"
...
| Phase | Goal | Read |
|-------|------|------|
| 0. Datasets | subset(s) downloaded under `datasets/` | [`references/00-datasets.md`](/lib/04-work/workbuddy-bench-official/_agents-skills-wbbench-run-setup-references-00-datasets) |
| 1. Environment | a checkout that can run | [`references/01-environment.md`](/lib/04-work/workbuddy-bench-official/_agents-skills-wbbench-run-setup-references-01-environment) |
| 2. Model | `configs/models/<provider>/<slug>.yaml` | [`references/02-model.md`](/lib/04-work/workbuddy-bench-official/_agents-skills-wbbench-run-setup-references-02-model) |
| 3. Credentials | `.env` URL + key for the chosen names | [`references/03-credentials.md`](/lib/04-work/workbuddy-bench-official/_agents-skills-wbbench-run-setup-references-03-credentials) |
| 4. Job | `configs/jobs/<slug>.yaml` | [`references/04-job.md`](/lib/04-work/workbuddy-bench-official/_agents-skills-wbbench-run-setup-references-04-job) |
| 5. Launch | dry-run, confirm, run | [`references/05-run.md`](/lib/04-work/workbuddy-bench-official/_agents-skills-wbbench-run-setup-references-05-run) |
| 6. Analysis | hand off to `wbbench-report-skills` | [`references/06-analysis.md`](/lib/04-work/workbuddy-bench-official/_agents-skills-wbbench-run-setup-references-06-analysis) |
...
- The model wire-protocol key is **`protocols`** (plural). The manifest resolver
  ...
  (Details in [`references/02-model.md`](/lib/04-work/workbuddy-bench-official/_agents-skills-wbbench-run-setup-references-02-model).)
- `model_connection: local_proxy` is the **recommended default** — a job-private
  ...
  (Details in [`references/04-job.md`](/lib/04-work/workbuddy-bench-official/_agents-skills-wbbench-run-setup-references-04-job).)
