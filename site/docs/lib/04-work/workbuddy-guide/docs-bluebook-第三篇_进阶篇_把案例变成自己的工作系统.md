...
- [第 22 章 打造skill：将书和视频蒸馏为可执行 Skill](/lib/04-work/workbuddy-guide/docs-bluebook-第三篇_进阶篇_把案例变成自己的工作系统-第_22_章_打造skill_将书和视频蒸馏为可执行_Skill)
- [第 23 章 其他用法补充：WorkBuddy 实操案例集](/lib/04-work/workbuddy-guide/docs-bluebook-第三篇_进阶篇_把案例变成自己的工作系统-第_23_章_其他用法补充_WorkBuddy_实操案例集)
- [第 24 章 如何进行多 Agent 系统设计](/lib/04-work/workbuddy-guide/docs-bluebook-第三篇_进阶篇_把案例变成自己的工作系统-第_24_章_如何进行多_Agent_系统设计)
- [第 25 章 自动化工作流的可靠性](/lib/04-work/workbuddy-guide/docs-bluebook-第三篇_进阶篇_把案例变成自己的工作系统-第_25_章_自动化工作流的可靠性)
