...
entryUrl: "https://github.com/AlephAITech/WorkBuddyGuide/blob/814ec835e9dae4a89da368fe208425ff50e121fe/docs/bluebook/第一篇%20使用手册：先把%20WorkBuddy%20用起来/第%204%20章%20快速完成第一个%20WorkBuddy%20任务/index.md"
sourceRel: "docs/bluebook/第一篇 使用手册：先把 WorkBuddy 用起来/第 4 章 快速完成第一个 WorkBuddy 任务/index.md"
rawUrl: "/raw/04-work/workbuddy-guide/docs/bluebook/第一篇 使用手册：先把 WorkBuddy 用起来/第 4 章 快速完成第一个 WorkBuddy 任务/index.md"
sourceSha256: "e7349ee1727cfabc79f72afead9162adcd376f69da88ccf982961684f6f58718"
pageSha256: "e7349ee1727cfabc79f72afead9162adcd376f69da88ccf982961684f6f58718"
...
![](/mirror/42/4252d9f7a989a1cc4a0aa2b075367ff47af4f223.png)

2. 选择或创建独立工作目录；

*PS：WorkBuddy 采用文件夹级授权与高危拦截，首次操作请先在演练目录进行、留意授权范围，处理真实业务数据前谨慎确认*

![](/mirror/8f/8f3d5c4d4b4d62abb6a39ab4fa9f91755b4fdbaf.png)

3. 判断应该使用模式，默认为Craft，还可以设置成Ask或Plan；

![](/mirror/26/262e95a0126d90b178839e2b8870f712d22f76dc.png)

4. 选择模型，可以指定你想使用的模型，不同模型积分消耗不同。

![](/mirror/aa/aaf7ed8d597ea77e691f60a2fc561f82346ba513.png)

5. 输入任务说明，“帮我分析一下《电商销售数据.xlsx》数据，生成一份汇报 PPT。”

![](/mirror/94/94744778b040cd977d20f9a7875eba31b9298276.png)

6. 如有必要，指定 Skill、专家、连接器或资料库，这里暂时忽略

![](/mirror/1d/1df773840abe5f3db1af92f8fac55393f28e4854.png)

7. 发送后观察计划、工具调用和文件变更；

![](/mirror/d3/d37791a40334c925203abec82cc4f268122c3c04.png)

8. 在结果区预览产物并验收。

文件可以本地打开、上传云端、或分享，注意分享前先确认产物不含敏感或涉密信息，按公司规范选择共享范围。

![](/mirror/17/17b2b1daaca855c56a03da3e9a36fe9b03991c2f.png)
