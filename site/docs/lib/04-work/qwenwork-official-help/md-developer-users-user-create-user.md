...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-users-user-create-user.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-users-user-create-user.md"
sourceSha256: "59f478127fff1b247d883a952f46e2ef2b2f911a664ac4eb99c54808cfc1b76b"
pageSha256: "59f478127fff1b247d883a952f46e2ef2b2f911a664ac4eb99c54808cfc1b76b"
...
在当前组织创建用户，设置姓名、联系方式、初始密码和部门归属，并可选择是否分配席位。未提供部门时，服务端将用户归入根部门；响应中的 qid 用于后续更新或删除。
...
## 请求参数
<table> <thead> <tr> <td>名称</td> <td>位置</td> <td>类型</td> <td>必填</td> <td>说明</td> <td>示例</td> </tr> </thead> <tbody> <tr> <td>Idempotency-Key</td> <td>header</td> <td>string</td> <td>必填</td> <td>本次写操作的幂等键。同一操作重试时复用相同键和请求内容，避免重复处理。</td> <td>"\&lt;string\&gt;"</td> </tr> <tr> <td>account</td> <td>body</td> <td>string</td> <td>否</td> <td>用户的登录账号。 最多字符数：255。</td> <td>"\&lt;string\&gt;"</td> </tr> <tr> <td>department_ids</td> <td>body</td> <td>array \| null</td> <td>否</td> <td>用户所属部门的标识列表。 最多项数：50。</td> <td>\["\&lt;string\&gt;"\]</td> </tr> <tr> <td>email</td> <td>body</td> <td>string · email</td> <td>否</td> <td>用户的邮箱地址。 最多字符数：255。</td> <td>"developer@example.com"</td> </tr> <tr> <td>initial_password</td> <td>body</td> <td>string · password</td> <td>否</td> <td>为新用户设置的初始密码；仅作为输入，响应不会返回。 最少字符数：12。 最多字符数：1024。</td> <td>"\&lt;string\&gt;"</td> </tr> <tr> <td>job_number</td> <td>body</td> <td>string</td> <td>否</td> <td>企业为用户分配的工号。 最多字符数：255。</td> <td>"\&lt;string\&gt;"</td> </tr> <tr> <td>name</td> <td>body</td> <td>string</td> <td>必填</td> <td>用户的姓名。 最多字符数：128。</td> <td>"\&lt;string\&gt;"</td> </tr> <tr> <td>phone</td> <td>body</td> <td>string</td> <td>否</td> <td>用户的电话号码。 最多字符数：20。</td> <td>"\&lt;string\&gt;"</td> </tr> <tr> <td>seat_status</td> <td>body</td> <td>string</td> <td>否</td> <td>用户的席位状态：assigned 为已分配，unassigned 为未分配。</td> <td>"unassigned"</td> </tr> </tbody> </table>
...
HELPCODEESCAPE-text
curl --request POST \
  --url '<BASE_URL>/api/openapi/v1/users' \
