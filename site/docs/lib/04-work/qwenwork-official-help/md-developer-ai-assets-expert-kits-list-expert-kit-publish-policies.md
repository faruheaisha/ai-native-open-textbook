...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-expert-kits-list-expert-kit-publish-policies.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-expert-kits-list-expert-kit-publish-policies.md"
sourceSha256: "9a7713c6d5c08b75a031a7fde40862c9c41c79dca69194c981662eca67810670"
pageSha256: "9a7713c6d5c08b75a031a7fde40862c9c41c79dca69194c981662eca67810670"
...
查询专家套件策略组，查看允许或限制模式、人员范围、资源范围及启用状态。返回组标识和范围数量，用于核对已有授权配置。
...
```
HELPCODEESCAPE-http
GET /api/openapi/v1/expert-suite-policies
```
...
HELPCODEESCAPE-text
curl --request GET \
  --url '<BASE_URL>/api/openapi/v1/expert-suite-policies?keyword=<keyword>&page=1&page_size=20' \
