...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-security-trusted-devices-delete-trusted-device-policies.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-security-trusted-devices-delete-trusted-device-policies.md"
sourceSha256: "b393d90754e4e80c64b6290e7041efb913fd113ac6eea94bdaa5f119bf35410b"
pageSha256: "b393d90754e4e80c64b6290e7041efb913fd113ac6eea94bdaa5f119bf35410b"
...
删除指定的可信设备策略，使用 version 确认删除的是最新读取的版本。系统默认策略受到保护，不能删除。
...
```
HELPCODEESCAPE-http
DELETE /api/openapi/v1/trusted-device-policies/{policyId}
```
...
## 请求参数
<table> <thead> <tr> <td>名称</td> <td>位置</td> <td>类型</td> <td>必填</td> <td>说明</td> <td>示例</td> </tr> </thead> <tbody> <tr> <td>policyId</td> <td>path</td> <td>string · uuid</td> <td>必填</td> <td>需要操作的策略标识。</td> <td>"\&lt;uuid\&gt;"</td> </tr> <tr> <td>version</td> <td>query</td> <td>integer · int64</td> <td>必填</td> <td>最新读取的策略 version，用于校验删除操作的版本。 最小值：0。</td> <td>0</td> </tr> </tbody> </table>
...
HELPCODEESCAPE-text
curl --request DELETE \
  --url '<BASE_URL>/api/openapi/v1/trusted-device-policies/<policyId>?version=<version>' \
