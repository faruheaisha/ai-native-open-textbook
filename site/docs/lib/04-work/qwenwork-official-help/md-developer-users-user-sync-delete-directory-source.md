...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-users-user-sync-delete-directory-source.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-users-user-sync-delete-directory-source.md"
sourceSha256: "fff5483a7f45ea558b2d77329229cb22fab56749021844d6745efbe18b874bb3"
pageSha256: "fff5483a7f45ea558b2d77329229cb22fab56749021844d6745efbe18b874bb3"
...
删除指定的通讯录数据源配置，需要提交最新 config_revision。当前处于启用状态的数据源必须先停用，否则服务端拒绝删除。
...
```
HELPCODEESCAPE-http
DELETE /api/openapi/v1/directory-sync/sources/{sourceId}
```
...
## 请求参数
<table> <thead> <tr> <td>名称</td> <td>位置</td> <td>类型</td> <td>必填</td> <td>说明</td> <td>示例</td> </tr> </thead> <tbody> <tr> <td>sourceId</td> <td>path</td> <td>string · uuid</td> <td>必填</td> <td>需要操作的数据源标识。</td> <td>"\&lt;uuid\&gt;"</td> </tr> <tr> <td>Idempotency-Key</td> <td>header</td> <td>string</td> <td>必填</td> <td>本次写操作的幂等键。同一操作重试时复用相同键和请求内容，避免重复处理。</td> <td>"\&lt;string\&gt;"</td> </tr> <tr> <td>config_revision</td> <td>query</td> <td>integer · int64</td> <td>必填</td> <td>最新读取的数据源 config_revision，用于校验删除操作的版本。 最小值：1。</td> <td>1</td> </tr> </tbody> </table>
...
HELPCODEESCAPE-text
curl --request DELETE \
  --url '<BASE_URL>/api/openapi/v1/directory-sync/sources/<sourceId>?config_revision=<config_revision>' \
