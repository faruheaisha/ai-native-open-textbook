...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-organization-admin-roles-update-admin-roles.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-organization-admin-roles-update-admin-roles.md"
sourceSha256: "3d731b596fa124c89ee4c66cf224be040295f15ddd24f1c2e5b5903cb0ac6f8b"
pageSha256: "3d731b596fa124c89ee4c66cf224be040295f15ddd24f1c2e5b5903cb0ac6f8b"
...
替换指定角色的名称、说明、权限、成员和管理范围，数组字段应提交需要保留的完整集合。系统预置角色可以调整配置明细，但不能改名。
...
```
HELPCODEESCAPE-http
PATCH /api/openapi/v1/admin-roles/{roleId}
```
...
HELPCODEESCAPE-text
curl --request PATCH \
  --url '<BASE_URL>/api/openapi/v1/admin-roles/<roleId>' \
