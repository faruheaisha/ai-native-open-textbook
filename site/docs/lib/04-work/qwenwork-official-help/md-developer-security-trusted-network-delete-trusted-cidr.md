...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-security-trusted-network-delete-trusted-cidr.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-security-trusted-network-delete-trusted-cidr.md"
sourceSha256: "3266c9fb6b5ac8fdeaff2aa300396f4ef6a65e550962b2587399fc6dc75d2c4f"
pageSha256: "3266c9fb6b5ac8fdeaff2aa300396f4ef6a65e550962b2587399fc6dc75d2c4f"
...
移除指定的可信网络记录，使该 IP 或网段不再作为这条配置中的可信范围。成功时返回 204，无响应正文。
...
```
HELPCODEESCAPE-http
DELETE /api/openapi/v1/network-ranges/{rangeId}
```
...
## 请求参数
<table> <thead> <tr> <td>名称</td> <td>位置</td> <td>类型</td> <td>必填</td> <td>说明</td> <td>示例</td> </tr> </thead> <tbody> <tr> <td>rangeId</td> <td>path</td> <td>string · uuid</td> <td>必填</td> <td>需要操作的可信网络记录标识。</td> <td>"\&lt;uuid\&gt;"</td> </tr> </tbody> </table>
