...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-expert-kits-list-expert-kit-listing-requests.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-expert-kits-list-expert-kit-listing-requests.md"
sourceSha256: "7c96019839fa3afd908c3e3ded06a2168525bb100011aebe3fbec3d8b74acc94"
pageSha256: "7c96019839fa3afd908c3e3ded06a2168525bb100011aebe3fbec3d8b74acc94"
...
查询成员提交的专家套件上架申请，查看提交时的资源快照、审批状态及提交人信息。取得 reviewId 后可调用对应的审批接口。

## 所需权限
<table> <thead> <tr> <td>所需权限</td> <td>资源</td> <td>Scope</td> <td>资源服务</td> </tr> </thead> <tbody> <tr> <td>专家套件上传审批读取（读取）</td> <td>expert-suites-upload-reviews</td> <td>admin.v1.expert-suites-upload-reviews.read</td> <td>qwenwork-biz-service</td> </tr> </tbody> </table>

```
HELPCODEESCAPE-http
GET /api/openapi/v1/expert-suite-upload-reviews
```
...
HELPCODEESCAPE-text
curl --request GET \
  --url '<BASE_URL>/api/openapi/v1/expert-suite-upload-reviews?page=1&page_size=20' \
