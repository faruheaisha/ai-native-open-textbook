...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-users-user-handle-join-requests.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-users-user-handle-join-requests.md"
sourceSha256: "6708f2dc0e47a914ab19a6a9d150ec2b31afbc71fb1bcdff07cce236d2d8a7bf"
pageSha256: "6708f2dc0e47a914ab19a6a9d150ec2b31afbc71fb1bcdff07cce236d2d8a7bf"
...
审批一条加入企业的申请，可通过、通过并分配席位或拒绝。当前实现要求应用的人员范围为全部用户；返回处理后的申请状态。
...
```
HELPCODEESCAPE-http
POST /api/openapi/v1/join-requests/{requestId}/decision
```
...
HELPCODEESCAPE-text
curl --request POST \
  --url '<BASE_URL>/api/openapi/v1/join-requests/<requestId>/decision' \
