...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-security-hooks-rules-create-hooks-rules.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-security-hooks-rules-create-hooks-rules.md"
sourceSha256: "d418055f8cfe947d7d93d0cef5c3a8f1ac8e196fdfa31044354eb8d959d33001"
pageSha256: "d418055f8cfe947d7d93d0cef5c3a8f1ac8e196fdfa31044354eb8d959d33001"
...
为一个 Agent 事件创建 Hook 配置，提交名称、事件、JSON 配置数组和启用状态。同一组织内名称不能重复，每个事件只能有一组配置；保存成功不代表数组中的命令已执行验证。
...
```
HELPCODEESCAPE-http
POST /api/openapi/v1/hook-policies
```
...
HELPCODEESCAPE-text
curl --request POST \
  --url '<BASE_URL>/api/openapi/v1/hook-policies' \
