...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-skills-update-skill-categories.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-skills-update-skill-categories.md"
sourceSha256: "59614aae132e45ecf0d424246ffccaf04391e3a7892a66f8c3fa747cbf42ecee"
pageSha256: "59614aae132e45ecf0d424246ffccaf04391e3a7892a66f8c3fa747cbf42ecee"
...
修改技能分类的名称或排序值。expected_revision 必须填写分类列表中最新读取的 revision，防止覆盖其他调用方的修改。
...
```
HELPCODEESCAPE-http
PATCH /api/openapi/v1/skill-categories/{categoryId}
```
