...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-expert-kits-handle-expert-kit-listing-requests.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-expert-kits-handle-expert-kit-listing-requests.md"
sourceSha256: "6d3ca51fbf5889dcb466d93488f6792dfd1ced25b6ae56be2b8d66becef2792c"
pageSha256: "6d3ca51fbf5889dcb466d93488f6792dfd1ced25b6ae56be2b8d66becef2792c"
...
通过或拒绝一条专家套件上架申请。通过时可指定或清除市场分类，拒绝时必须填写 reason；只处理属于专家套件队列的申请。

## 所需权限
<table> <thead> <tr> <td>所需权限</td> <td>资源</td> <td>Scope</td> <td>资源服务</td> </tr> </thead> <tbody> <tr> <td>专家套件上传审批执行（执行）</td> <td>expert-suites-upload-reviews</td> <td>admin.v1.expert-suites-upload-reviews.execute</td> <td>qwenwork-biz-service</td> </tr> </tbody> </table>

```
HELPCODEESCAPE-http
POST /api/openapi/v1/expert-suite-upload-reviews/{reviewId}/decision
```
...
HELPCODEESCAPE-text
curl --request POST \
  --url '<BASE_URL>/api/openapi/v1/expert-suite-upload-reviews/<reviewId>/decision' \
