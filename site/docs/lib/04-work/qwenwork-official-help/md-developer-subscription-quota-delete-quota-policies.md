...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-subscription-quota-delete-quota-policies.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-subscription-quota-delete-quota-policies.md"
sourceSha256: "d151c0c9e18d6c76f99549a3b3797a90ab4b08580e13a5677337465a679aa456"
pageSha256: "d151c0c9e18d6c76f99549a3b3797a90ab4b08580e13a5677337465a679aa456"
...
删除指定的自定义限额策略，并重新计算受该策略影响的用户限额。组织默认限额策略不能删除，服务端会返回业务错误。
...
```
HELPCODEESCAPE-http
DELETE /api/openapi/v1/quota-policies/{policyId}
```
...
## 请求参数
<table> <thead> <tr> <td>名称</td> <td>位置</td> <td>类型</td> <td>必填</td> <td>说明</td> <td>示例</td> </tr> </thead> <tbody> <tr> <td>policyId</td> <td>path</td> <td>integer · int64</td> <td>必填</td> <td>限额策略列表返回的整数 id。 最小值：1。</td> <td>1</td> </tr> </tbody> </table>
