...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-skills-delete-skill-categories.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-skills-delete-skill-categories.md"
sourceSha256: "cd9af88bd1173eba461487f4451688c01a54dd228838ef69ed0d9654df1dd5e1"
pageSha256: "cd9af88bd1173eba461487f4451688c01a54dd228838ef69ed0d9654df1dd5e1"
...
删除指定的技能分类。服务端先确认分类属于此资源类型，再读取当前修订号执行删除。
...
```
HELPCODEESCAPE-http
DELETE /api/openapi/v1/skill-categories/{categoryId}
```
...
## 请求参数
<table> <thead> <tr> <td>名称</td> <td>位置</td> <td>类型</td> <td>必填</td> <td>说明</td> <td>示例</td> </tr> </thead> <tbody> <tr> <td>categoryId</td> <td>path</td> <td>string · uuid</td> <td>必填</td> <td>需要操作的分类标识。</td> <td>"\&lt;uuid\&gt;"</td> </tr> </tbody> </table>
...
HELPCODEESCAPE-text
curl --request DELETE \
  --url '<BASE_URL>/api/openapi/v1/skill-categories/<categoryId>' \
