...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-models-model-policy-groups-create-model-policies.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-models-model-policy-groups-create-model-policies.md"
sourceSha256: "18db6f21905072b12f54b54df66814afc018f2810f62669893cb97282d9fabde"
pageSha256: "18db6f21905072b12f54b54df66814afc018f2810f62669893cb97282d9fabde"
...
创建模型策略组，将用户、部门或用户组与模型资源的允许或限制规则关联。可设置生效时间和启用状态；当前使用入口仅支持 qwenwork_pc。
...
```
HELPCODEESCAPE-http
POST /api/openapi/v1/model-policies
```
...
HELPCODEESCAPE-text
curl --request POST \
  --url '<BASE_URL>/api/openapi/v1/model-policies' \
