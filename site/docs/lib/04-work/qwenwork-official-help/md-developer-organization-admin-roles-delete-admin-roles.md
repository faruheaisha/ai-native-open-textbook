...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-organization-admin-roles-delete-admin-roles.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-organization-admin-roles-delete-admin-roles.md"
sourceSha256: "3bb0bb19791d873b7b4b313c6936df0902856283a6ce500aadc9a3dfc1b005c9"
pageSha256: "3bb0bb19791d873b7b4b313c6936df0902856283a6ce500aadc9a3dfc1b005c9"
...
删除不再使用的自定义管理员角色。删除前必须移除该角色的全部成员；系统预置角色不能删除。
...
```
HELPCODEESCAPE-http
DELETE /api/openapi/v1/admin-roles/{roleId}
```
...
## 请求参数
<table> <thead> <tr> <td>名称</td> <td>位置</td> <td>类型</td> <td>必填</td> <td>说明</td> <td>示例</td> </tr> </thead> <tbody> <tr> <td>roleId</td> <td>path</td> <td>string · uuid</td> <td>必填</td> <td>需要操作的管理员角色标识。</td> <td>"\&lt;uuid\&gt;"</td> </tr> </tbody> </table>
