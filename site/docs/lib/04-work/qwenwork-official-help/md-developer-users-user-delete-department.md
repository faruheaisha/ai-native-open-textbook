...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-users-user-delete-department.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-users-user-delete-department.md"
sourceSha256: "4250c52c5cc8de92e58a9c7abcc4573a98bb853aff35cf0bd9d427461e858a9c"
pageSha256: "4250c52c5cc8de92e58a9c7abcc4573a98bb853aff35cf0bd9d427461e858a9c"
...
删除指定的组织部门。服务端将操作交给目录服务检查和执行；成功时返回 204，不返回部门对象。
...
```
HELPCODEESCAPE-http
DELETE /api/openapi/v1/departments/{departmentId}
```
...
## 请求参数
<table> <thead> <tr> <td>名称</td> <td>位置</td> <td>类型</td> <td>必填</td> <td>说明</td> <td>示例</td> </tr> </thead> <tbody> <tr> <td>departmentId</td> <td>path</td> <td>string · uuid</td> <td>必填</td> <td>需要操作的部门标识。</td> <td>"\&lt;uuid\&gt;"</td> </tr> <tr> <td>Idempotency-Key</td> <td>header</td> <td>string</td> <td>必填</td> <td>本次写操作的幂等键。同一操作重试时复用相同键和请求内容，避免重复处理。</td> <td>"\&lt;string\&gt;"</td> </tr> </tbody> </table>
