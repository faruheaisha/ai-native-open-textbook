...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-connectors-delete-connectors.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-connectors-delete-connectors.md"
sourceSha256: "0954de0b2d7ae443ac66bc47b8902e87b9be91233999bbc1349a5df576bb450b"
pageSha256: "0954de0b2d7ae443ac66bc47b8902e87b9be91233999bbc1349a5df576bb450b"
...
删除指定连接器资源，需在 revision 中传入最新读取的修订号。服务端校验资源状态和版本后执行删除，成功时不返回资源正文。
...
```
HELPCODEESCAPE-http
DELETE /api/openapi/v1/connectors/{resourceId}
```
...
HELPCODEESCAPE-text
curl --request DELETE \
  --url '<BASE_URL>/api/openapi/v1/connectors/<resourceId>?revision=<revision>' \
