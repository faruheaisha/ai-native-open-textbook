...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-connectors-create-connector-categories.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-connectors-create-connector-categories.md"
sourceSha256: "c0d3659a41250d0d5b95a09540dd3567e4716647cd4a8e1100139e0ae7c5b45d"
pageSha256: "c0d3659a41250d0d5b95a09540dd3567e4716647cd4a8e1100139e0ae7c5b45d"
...
在企业市场中新建供连接器使用的分类，设置名称和排序值。此操作创建分类，不会向其中新增资源。
...
```
HELPCODEESCAPE-http
POST /api/openapi/v1/connector-categories
```
...
HELPCODEESCAPE-text
curl --request POST \
  --url '<BASE_URL>/api/openapi/v1/connector-categories' \
