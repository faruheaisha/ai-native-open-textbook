...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-expert-kits-update-expert-kit-categories.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-expert-kits-update-expert-kit-categories.md"
sourceSha256: "938302b85f14071e75a53fb410783491d8f691e76d44c343af6c2ee937e917da"
pageSha256: "938302b85f14071e75a53fb410783491d8f691e76d44c343af6c2ee937e917da"
...
修改专家套件分类的名称或排序值。expected_revision 必须填写分类列表中最新读取的 revision，防止覆盖其他调用方的修改。
...
```
HELPCODEESCAPE-http
PATCH /api/openapi/v1/expert-suite-categories/{categoryId}
```
...
HELPCODEESCAPE-text
curl --request PATCH \
  --url '<BASE_URL>/api/openapi/v1/expert-suite-categories/<categoryId>' \
