...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-users-user-groups-update-user-groups.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-users-user-groups-update-user-groups.md"
sourceSha256: "de7c8d732f8af52abee69f6e14134cdcea875e48c11d2296f35759f0d94d7082"
pageSha256: "de7c8d732f8af52abee69f6e14134cdcea875e48c11d2296f35759f0d94d7082"
...
替换指定用户组的名称、说明和成员集合。members 应包含更新后需要保留的全部用户和部门，空数组会清空成员。
...
```
HELPCODEESCAPE-http
PATCH /api/openapi/v1/user-groups/{groupId}
```
...
HELPCODEESCAPE-text
curl --request PATCH \
  --url '<BASE_URL>/api/openapi/v1/user-groups/<groupId>' \
