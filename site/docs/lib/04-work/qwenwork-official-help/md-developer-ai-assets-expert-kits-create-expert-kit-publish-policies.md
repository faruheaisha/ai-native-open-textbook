...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-expert-kits-create-expert-kit-publish-policies.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-expert-kits-create-expert-kit-publish-policies.md"
sourceSha256: "6e4c19e5b7f2c84d7d9c638cd3baed9bde77912e1628c159bc5bb3825373335a"
pageSha256: "6e4c19e5b7f2c84d7d9c638cd3baed9bde77912e1628c159bc5bb3825373335a"
...
创建专家套件策略组，将用户、部门或用户组与专家套件资源的允许或限制规则关联。可设置生效时间和启用状态；当前使用入口仅支持 qwenwork_pc。
...
```
HELPCODEESCAPE-http
POST /api/openapi/v1/expert-suite-policies
```
...
HELPCODEESCAPE-text
curl --request POST \
  --url '<BASE_URL>/api/openapi/v1/expert-suite-policies' \
