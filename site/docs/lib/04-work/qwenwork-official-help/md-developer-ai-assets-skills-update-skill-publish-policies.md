...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-skills-update-skill-publish-policies.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-skills-update-skill-publish-policies.md"
sourceSha256: "f58d87f03915c9e0f91e4f9e73c873a76d59d4423140dbb1fd2b8e7e459912f5"
pageSha256: "f58d87f03915c9e0f91e4f9e73c873a76d59d4423140dbb1fd2b8e7e459912f5"
...
替换技能策略组的配置，包含模式、人员范围、资源范围、有效时间和状态，集合字段提交完整保留值。默认组的名称、模式、人员范围类型和状态固定，不能通过更新改变。
...
```
HELPCODEESCAPE-http
PATCH /api/openapi/v1/skill-policies/{policyId}
```
