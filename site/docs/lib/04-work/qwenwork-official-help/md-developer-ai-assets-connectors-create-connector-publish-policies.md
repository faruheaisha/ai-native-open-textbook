...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-connectors-create-connector-publish-policies.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-connectors-create-connector-publish-policies.md"
sourceSha256: "86c87a13d13c0848705785612f8cfb9fbf51ad801d556d15eb9dd4381de9663e"
pageSha256: "86c87a13d13c0848705785612f8cfb9fbf51ad801d556d15eb9dd4381de9663e"
...
创建连接器策略组，将用户、部门或用户组与连接器资源的允许或限制规则关联。可设置生效时间和启用状态；当前使用入口仅支持 qwenwork_pc。
...
```
HELPCODEESCAPE-http
POST /api/openapi/v1/connector-policies
```
...
HELPCODEESCAPE-text
curl --request POST \
  --url '<BASE_URL>/api/openapi/v1/connector-policies' \
