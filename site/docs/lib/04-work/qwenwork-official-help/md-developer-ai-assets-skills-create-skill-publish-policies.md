...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-skills-create-skill-publish-policies.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-skills-create-skill-publish-policies.md"
sourceSha256: "1475f8020c94b2b5aa7ea822454db456cd4db383f42ee371e262455012115aa7"
pageSha256: "1475f8020c94b2b5aa7ea822454db456cd4db383f42ee371e262455012115aa7"
...
创建技能策略组，将用户、部门或用户组与技能资源的允许或限制规则关联。可设置生效时间和启用状态；当前使用入口仅支持 qwenwork_pc。
...
```
HELPCODEESCAPE-http
POST /api/openapi/v1/skill-policies
```
...
HELPCODEESCAPE-text
curl --request POST \
  --url '<BASE_URL>/api/openapi/v1/skill-policies' \
