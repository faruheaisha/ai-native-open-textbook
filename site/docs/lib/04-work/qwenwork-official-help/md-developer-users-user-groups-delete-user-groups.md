...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-users-user-groups-delete-user-groups.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-users-user-groups-delete-user-groups.md"
sourceSha256: "c31a8ad4383e136d148ede121f17d00e3c5ffc1a90a49acfdd39892449284504"
pageSha256: "c31a8ad4383e136d148ede121f17d00e3c5ffc1a90a49acfdd39892449284504"
...
删除指定用户组。若该组仍被其他配置引用，删除会被拒绝；此接口不提供强制解除引用的选项。
...
```
HELPCODEESCAPE-http
DELETE /api/openapi/v1/user-groups/{groupId}
```
...
## 请求参数
<table> <thead> <tr> <td>名称</td> <td>位置</td> <td>类型</td> <td>必填</td> <td>说明</td> <td>示例</td> </tr> </thead> <tbody> <tr> <td>groupId</td> <td>path</td> <td>string · uuid</td> <td>必填</td> <td>需要操作的用户组标识。</td> <td>"\&lt;uuid\&gt;"</td> </tr> </tbody> </table>
