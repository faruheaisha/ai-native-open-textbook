...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-organization-org-profile-get-admin-login-address.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-organization-org-profile-get-admin-login-address.md"
sourceSha256: "905695d4666ffb19939cc6e1cfa7546478bd74a35a90d693c6ee23c68e23f253"
pageSha256: "905695d4666ffb19939cc6e1cfa7546478bd74a35a90d693c6ee23c68e23f253"
...
读取当前组织的专属登录地址 login_url，供企业系统展示或跳转到千问办公登录入口。此接口只读取地址。
...
```
HELPCODEESCAPE-http
GET /api/openapi/v1/organization/access-domain
```
...
HELPCODEESCAPE-text
curl --request GET \
  --url '<BASE_URL>/api/openapi/v1/organization/access-domain' \
...
<table> <thead> <tr> <td>名称</td> <td>类型</td> <td>必填</td> <td>说明</td> <td>示例</td> </tr> </thead> <tbody> <tr> <td>login_url</td> <td>string</td> <td>是</td> <td>当前组织的专属登录地址。</td> <td>"\&lt;string\&gt;"</td> </tr> </tbody> </table>
