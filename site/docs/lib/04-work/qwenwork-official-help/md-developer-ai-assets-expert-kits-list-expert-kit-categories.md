...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-expert-kits-list-expert-kit-categories.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-expert-kits-list-expert-kit-categories.md"
sourceSha256: "9e1aebd786ec61ee49f2c81d8cb9b44e532db80bda051ce4f905a715efdc5263"
pageSha256: "9e1aebd786ec61ee49f2c81d8cb9b44e532db80bda051ce4f905a715efdc5263"
...
查询专家套件分类的名称、排序值和修订号。分类标识可用于筛选专家套件列表或为资源指定分类。
...
```
HELPCODEESCAPE-http
GET /api/openapi/v1/expert-suite-categories
```
...
HELPCODEESCAPE-text
curl --request GET \
  --url '<BASE_URL>/api/openapi/v1/expert-suite-categories?keyword=<keyword>&page=1&page_size=20' \
