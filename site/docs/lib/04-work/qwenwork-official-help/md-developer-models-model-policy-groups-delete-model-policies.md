...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-models-model-policy-groups-delete-model-policies.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-models-model-policy-groups-delete-model-policies.md"
sourceSha256: "a27d557eb93d3ff123dbddcb2d66aca3ad5edc07fec67478d10d32f0bf2e4aed"
pageSha256: "a27d557eb93d3ff123dbddcb2d66aca3ad5edc07fec67478d10d32f0bf2e4aed"
...
删除自定义模型策略组，移除该组保存的范围和资源规则。默认模型策略组不能删除。

## 所需权限
<table> <thead> <tr> <td>所需权限</td> <td>资源</td> <td>Scope</td> <td>资源服务</td> </tr> </thead> <tbody> <tr> <td>模型策略管理（管理）</td> <td>model-policies</td> <td>admin.v1.model-policies.manage</td> <td>qwenwork-biz-service</td> </tr> </tbody> </table>

```
HELPCODEESCAPE-http
DELETE /api/openapi/v1/model-policies/{policyId}
```
...
HELPCODEESCAPE-text
curl --request DELETE \
  --url '<BASE_URL>/api/openapi/v1/model-policies/<policyId>' \
