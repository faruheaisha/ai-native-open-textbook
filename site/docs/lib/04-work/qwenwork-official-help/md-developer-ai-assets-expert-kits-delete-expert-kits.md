...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-expert-kits-delete-expert-kits.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-expert-kits-delete-expert-kits.md"
sourceSha256: "2aedfe7ffad60fe7615bea6422d9c13c121f5eee15a0cc81d15cc4b84bdf58bd"
pageSha256: "2aedfe7ffad60fe7615bea6422d9c13c121f5eee15a0cc81d15cc4b84bdf58bd"
...
删除指定专家套件资源，需在 revision 中传入最新读取的修订号。服务端校验资源状态和版本后执行删除，成功时不返回资源正文。
...
```
HELPCODEESCAPE-http
DELETE /api/openapi/v1/expert-suites/{resourceId}
```
...
HELPCODEESCAPE-text
curl --request DELETE \
  --url '<BASE_URL>/api/openapi/v1/expert-suites/<resourceId>?revision=<revision>' \
