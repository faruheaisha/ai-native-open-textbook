...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-expert-kits-delete-expert-kit-publish-policies.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-expert-kits-delete-expert-kit-publish-policies.md"
sourceSha256: "445fbcc188d21281ed7fd80c991c2bc4057bed4eb9f628815fdff5bb9b72da52"
pageSha256: "445fbcc188d21281ed7fd80c991c2bc4057bed4eb9f628815fdff5bb9b72da52"
...
删除自定义专家套件策略组，移除该组保存的范围和资源规则。默认专家套件策略组不能删除。
...
```
HELPCODEESCAPE-http
DELETE /api/openapi/v1/expert-suite-policies/{policyId}
```
...
## 请求参数
<table> <thead> <tr> <td>名称</td> <td>位置</td> <td>类型</td> <td>必填</td> <td>说明</td> <td>示例</td> </tr> </thead> <tbody> <tr> <td>policyId</td> <td>path</td> <td>string · uuid</td> <td>必填</td> <td>需要操作的策略标识。</td> <td>"\&lt;uuid\&gt;"</td> </tr> </tbody> </table>
...
HELPCODEESCAPE-text
curl --request DELETE \
  --url '<BASE_URL>/api/openapi/v1/expert-suite-policies/<policyId>' \
