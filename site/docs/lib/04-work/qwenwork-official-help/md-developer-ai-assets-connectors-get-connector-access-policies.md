...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-connectors-get-connector-access-policies.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-connectors-get-connector-access-policies.md"
sourceSha256: "5c4a23a21abd06d5d13f282cd157006aca3d9da46676e667ee183ca67c1ce81a"
pageSha256: "5c4a23a21abd06d5d13f282cd157006aca3d9da46676e667ee183ca67c1ce81a"
...
读取组织的连接器执行控制配置，包括全部允许、按规则匹配或全部禁止模式，以及服务地址和命令匹配规则。此配置控制连接器执行，与分配资源给用户的连接器策略组分别管理。
...
```
HELPCODEESCAPE-http
GET /api/openapi/v1/connector-access-policy
```
