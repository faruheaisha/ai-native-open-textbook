...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-expert-kits-create-expert-kit-categories.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-expert-kits-create-expert-kit-categories.md"
sourceSha256: "591203f44309d7ec8c8a006b664f5ceecdb2f1bdab9d437f485a768e3afea57a"
pageSha256: "591203f44309d7ec8c8a006b664f5ceecdb2f1bdab9d437f485a768e3afea57a"
...
在企业市场中新建供专家套件使用的分类，设置名称和排序值。此操作创建分类，不会向其中新增资源。
...
```
HELPCODEESCAPE-http
POST /api/openapi/v1/expert-suite-categories
```
...
HELPCODEESCAPE-text
curl --request POST \
  --url '<BASE_URL>/api/openapi/v1/expert-suite-categories' \
