...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-subscription-quota-update-quota-policies.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-subscription-quota-update-quota-policies.md"
sourceSha256: "d7b9fda9f39ace9c36466a656b0831f29ae4871a6e50f52aedd3bfed7349ecb4"
pageSha256: "d7b9fda9f39ace9c36466a656b0831f29ae4871a6e50f52aedd3bfed7349ecb4"
...
修改限额策略的名称、说明、优先级、每人限额或适用范围，只更新传入的字段。scopes 传空数组会清空此策略的适用对象；保存后服务端会重新计算受影响用户的限额。
...
```
HELPCODEESCAPE-http
PATCH /api/openapi/v1/quota-policies/{policyId}
```
...
## 请求参数
<table> <thead> <tr> <td>名称</td> <td>位置</td> <td>类型</td> <td>必填</td> <td>说明</td> <td>示例</td> </tr> </thead> <tbody> <tr> <td>policyId</td> <td>path</td> <td>integer · int64</td> <td>必填</td> <td>限额策略列表返回的整数 id。 最小值：1。</td> <td>1</td> </tr> <tr> <td>description</td> <td>body</td> <td>string</td> <td>否</td> <td>限额策略的用途说明。 最多字符数：512。</td> <td>"\&lt;string\&gt;"</td> </tr> <tr> <td>name</td> <td>body</td> <td>string</td> <td>否</td> <td>限额策略的名称。 最多字符数：255。</td> <td>"\&lt;string\&gt;"</td> </tr> <tr> <td>per_user_limit</td> <td>body</td> <td>integer · int64</td> <td>否</td> <td>每位用户在一个周期内的积分上限；当前服务要求至少 500 积分。 最小值：500。</td> <td>500</td> </tr> <tr> <td>priority</td> <td>body</td> <td>integer · int64</td> <td>否</td> <td>策略匹配的优先级，数值越小越先匹配。 最小值：0。 最大值：99。</td> <td>0</td> </tr> <tr> <td>scopes</td> <td>body</td> <td>array\&lt;OpenapifacadeQuotaPolicyScope\&gt;</td> <td>否</td> <td>此限额策略适用的用户、部门和用户组。</td> <td>\[\{"id":"\&lt;string\&gt;","type":"user"\}\]</td> </tr> <tr> <td>scopes\[\].id</td> <td>body</td> <td>string</td> <td>必填</td> <td>与 type 对应的用户、部门或用户组标识。</td> <td>"\&lt;string\&gt;"</td> </tr> <tr> <td>scopes\[\].type</td> <td>body</td> <td>string</td> <td>必填</td> <td>范围类型：user 为用户，dept 为部门，user_group 为用户组。</td> <td>"user"</td> </tr> </tbody> </table>
...
HELPCODEESCAPE-text
curl --request PATCH \
  --url '<BASE_URL>/api/openapi/v1/quota-policies/<policyId>' \
