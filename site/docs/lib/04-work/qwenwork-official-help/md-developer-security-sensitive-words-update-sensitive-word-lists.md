...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-security-sensitive-words-update-sensitive-word-lists.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-security-sensitive-words-update-sensitive-word-lists.md"
sourceSha256: "7e53a7903f5e44ebc585f84b5c7f512e1410fa2895c6e296e635bc19024ee750"
pageSha256: "7e53a7903f5e44ebc585f84b5c7f512e1410fa2895c6e296e635bc19024ee750"
...
替换指定敏感词库的名称、说明、全部词条和启用状态。keywords 应包含更新后保留的完整词条列表，不是本次新增的词条。
...
```
HELPCODEESCAPE-http
PATCH /api/openapi/v1/sensitive-word-libraries/{libraryId}
```
...
## 请求参数
<table> <thead> <tr> <td>名称</td> <td>位置</td> <td>类型</td> <td>必填</td> <td>说明</td> <td>示例</td> </tr> </thead> <tbody> <tr> <td>libraryId</td> <td>path</td> <td>string · uuid</td> <td>必填</td> <td>需要操作的敏感词库标识。</td> <td>"\&lt;uuid\&gt;"</td> </tr> <tr> <td>description</td> <td>body</td> <td>string</td> <td>必填</td> <td>敏感词库的用途说明。 最多字符数：512。</td> <td>"\&lt;string\&gt;"</td> </tr> <tr> <td>enabled</td> <td>body</td> <td>boolean \| null</td> <td>必填</td> <td>是否启用这项配置。</td> <td>false</td> </tr> <tr> <td>keywords</td> <td>body</td> <td>array \| null</td> <td>必填</td> <td>敏感词库中的词条列表。 最少项数：1。 最多项数：1000。</td> <td>\["\&lt;string\&gt;"\]</td> </tr> <tr> <td>name</td> <td>body</td> <td>string</td> <td>必填</td> <td>敏感词库的名称。 最多字符数：128。</td> <td>"\&lt;string\&gt;"</td> </tr> </tbody> </table>
...
HELPCODEESCAPE-text
curl --request PATCH \
  --url '<BASE_URL>/api/openapi/v1/sensitive-word-libraries/<libraryId>' \
