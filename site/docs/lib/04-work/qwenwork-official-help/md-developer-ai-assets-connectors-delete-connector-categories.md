...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-connectors-delete-connector-categories.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-connectors-delete-connector-categories.md"
sourceSha256: "d2dba013f49964398d8cbaa41a2c85a31032b98725abf34f238a4bf2297b9114"
pageSha256: "d2dba013f49964398d8cbaa41a2c85a31032b98725abf34f238a4bf2297b9114"
...
删除指定的连接器分类。服务端先确认分类属于此资源类型，再读取当前修订号执行删除。
...
```
HELPCODEESCAPE-http
DELETE /api/openapi/v1/connector-categories/{categoryId}
```
