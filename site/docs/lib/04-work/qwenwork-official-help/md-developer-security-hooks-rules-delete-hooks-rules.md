...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-security-hooks-rules-delete-hooks-rules.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-security-hooks-rules-delete-hooks-rules.md"
sourceSha256: "76078309c50af9cabc91040ce32a8c3d944a233b13e073cc0afac6e7f0896a69"
pageSha256: "76078309c50af9cabc91040ce32a8c3d944a233b13e073cc0afac6e7f0896a69"
...
删除指定事件的已保存 Hook 配置。服务端移除配置记录并通知配置变化，成功时返回 204。
...
```
HELPCODEESCAPE-http
DELETE /api/openapi/v1/hook-policies/{policyId}
```
