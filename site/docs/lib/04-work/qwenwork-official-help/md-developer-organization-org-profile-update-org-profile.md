...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-organization-org-profile-update-org-profile.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-organization-org-profile-update-org-profile.md"
sourceSha256: "03aa9f0384b0a886fee07e773e78d33c2b354ac174624a7277abc8ded95d0cb9"
pageSha256: "03aa9f0384b0a886fee07e773e78d33c2b354ac174624a7277abc8ded95d0cb9"
...
修改当前组织的名称并返回更新后的组织信息。当前请求模型只接受 name，Logo 和已验证邮箱域名不在此接口的修改范围内。

## 所需权限
<table> <thead> <tr> <td>所需权限</td> <td>资源</td> <td>Scope</td> <td>资源服务</td> </tr> </thead> <tbody> <tr> <td>组织信息管理（管理）</td> <td>organization</td> <td>admin.v1.organization.manage</td> <td>qwenwork-biz-service</td> </tr> </tbody> </table>

```
HELPCODEESCAPE-http
PATCH /api/openapi/v1/organization
```
...
## 请求参数
<table> <thead> <tr> <td>名称</td> <td>位置</td> <td>类型</td> <td>必填</td> <td>说明</td> <td>示例</td> </tr> </thead> <tbody> <tr> <td>Idempotency-Key</td> <td>header</td> <td>string</td> <td>必填</td> <td>本次写操作的幂等键。同一操作重试时复用相同键和请求内容，避免重复处理。</td> <td>"\&lt;string\&gt;"</td> </tr> <tr> <td>name</td> <td>body</td> <td>string</td> <td>必填</td> <td>组织的名称。</td> <td>"\&lt;string\&gt;"</td> </tr> </tbody> </table>
