...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-security-trusted-network-update-trusted-cidr.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-security-trusted-network-update-trusted-cidr.md"
sourceSha256: "f84c97bbc51e2899e5256868d384afa460985f0c21915869c17d2ad7ebc14437"
pageSha256: "f84c97bbc51e2899e5256868d384afa460985f0c21915869c17d2ad7ebc14437"
...
替换指定可信网络记录的 IP 或 CIDR、名称和备注。请求需包含更新后要保存的完整网络信息。
...
```
HELPCODEESCAPE-http
PATCH /api/openapi/v1/network-ranges/{rangeId}
```
...
## 请求参数
<table> <thead> <tr> <td>名称</td> <td>位置</td> <td>类型</td> <td>必填</td> <td>说明</td> <td>示例</td> </tr> </thead> <tbody> <tr> <td>rangeId</td> <td>path</td> <td>string · uuid</td> <td>必填</td> <td>需要操作的可信网络记录标识。</td> <td>"\&lt;uuid\&gt;"</td> </tr> <tr> <td>cidr</td> <td>body</td> <td>string</td> <td>必填</td> <td>可信 IP 地址或 CIDR 网段。 最多字符数：64。</td> <td>"\&lt;string\&gt;"</td> </tr> <tr> <td>name</td> <td>body</td> <td>string</td> <td>必填</td> <td>用于识别此对象的名称。 最多字符数：128。</td> <td>"\&lt;string\&gt;"</td> </tr> <tr> <td>note</td> <td>body</td> <td>string \| null</td> <td>否</td> <td>用于说明此可信网络记录用途的备注。 最多字符数：512。</td> <td>"\&lt;string\&gt;"</td> </tr> </tbody> </table>
...
HELPCODEESCAPE-text
curl --request PATCH \
  --url '<BASE_URL>/api/openapi/v1/network-ranges/<rangeId>' \
