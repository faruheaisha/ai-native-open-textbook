...
sourceUrl: ""
entryUrl: null
sourceRel: "md/developer-ai-assets-connectors-list-connector-categories.md"
rawUrl: "/raw/04-work/qwenwork-official-help/md/developer-ai-assets-connectors-list-connector-categories.md"
sourceSha256: "7cb9b577aa4973fd6cc06ef0260ede5e82310af902d914e8df336ae8f17a7053"
pageSha256: "7cb9b577aa4973fd6cc06ef0260ede5e82310af902d914e8df336ae8f17a7053"
...
查询连接器分类的名称、排序值和修订号。分类标识可用于筛选连接器列表或为资源指定分类。
...
```
HELPCODEESCAPE-http
GET /api/openapi/v1/connector-categories
```
...
HELPCODEESCAPE-text
curl --request GET \
  --url '<BASE_URL>/api/openapi/v1/connector-categories?keyword=<keyword>&page=1&page_size=20' \
