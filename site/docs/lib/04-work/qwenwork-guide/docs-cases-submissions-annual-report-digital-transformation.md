...
entryUrl: "https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/docs/cases/submissions/annual-report-digital-transformation/index.md"
sourceRel: "docs/cases/submissions/annual-report-digital-transformation/index.md"
rawUrl: "/raw/04-work/qwenwork-guide/docs/cases/submissions/annual-report-digital-transformation/index.md"
sourceSha256: "999806534963507089e04793922bf5085eb5de68b3f545f11957053b634216f1"
pageSha256: "999806534963507089e04793922bf5085eb5de68b3f545f11957053b634216f1"
...
![案例封面：数字化转型叙事分析报告首页](/mirror/90/909b1e211aaa63ea1515b9a99219101ad4b699a2.webp)
...
![在千问办公首页输入任务指令并选中「智数分析专家团」](/mirror/81/81cd92b245ff206aa8b170483471c3cdb9d68404.webp)
...
![专家团创建协作团队并生成任务清单](/mirror/32/32a800206fdad9e33121097889dda8bab821ae7a.webp)
...
![专家团成员分工执行，实时汇报各阶段关键发现](/mirror/e1/e11d4fd92aaf297fd232043855fc2ca3f297c7f4.webp)

4. **过程产物落盘**：执行过程中，年报原文、解析后的文本与结构化数据、可复现脚本、中间分析结果分别写入 `annual_reports/`、`extracted_text/`、`extracted_data/`、`scripts/` 等目录，全程可追溯。

![执行产出的目录结构：年报原文、可复现脚本、中间数据与最终报告](/mirror/5d/5de62ebce4d8756d36b042b5a75f34a08a90ce5c.webp)
...
![最终 HTML 报告首页：执行摘要与核心指标卡](/mirror/90/909b1e211aaa63ea1515b9a99219101ad4b699a2.webp)
...
![报告核心问题分析：理论依据 + 实证数据 + 词频热力图](/mirror/42/424d03355a99e1d6be48516c73d0aa77baaef19a.webp)
...
![数字化成熟度评估：双维评分卡与五维雷达图](/mirror/d9/d96cab2b6e8cda40d9dbf82d05dbbbd59a2e90f2.webp)

**附录的专业度**：报告末尾附缩略语表（DCS、MD&A、LDA、RBV、VRIO、TAM、CAGR、ROE 等逐一给出全称与释义），连同数据来源、脚本说明、口径说明共四个附录，符合咨询交付物规范。

![报告附录：缩略语表](/mirror/10/1034a92ce44e2b0076407bcea2f45ee8479812d4.webp)
...
![千问办公中的交付总结：交付物清单、报告结构与亮点发现](/mirror/7c/7c85995939a8db1145c7870178806034a300c9d1.webp)
