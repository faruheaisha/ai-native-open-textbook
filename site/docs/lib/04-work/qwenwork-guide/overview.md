...
<p align="center"><strong>千问办公中文使用手册与实战指南（QwenWork Greenbook）</strong></p>
  ...
  简体中文 · <a href="https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/README_en.md">English</a> ·
[参与共创](https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/main/CONTRIBUTING.md)
...
更完整的路线见[如何阅读这本绿皮书](https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/docs/reading-guide.md)。
...
详细配置见 [DEPLOYMENT.md](https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/DEPLOYMENT.md)。
...
投稿时，在 `docs/cases/submissions/` 下为案例新建独立目录，使用 [Case 正文模板](https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/.github/CASE_TEMPLATE.md)编写内容，并通过 [Case PR 模板](https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/.github/PULL_REQUEST_TEMPLATE/case.md)提交。审核合并后，案例会自动出现在网站左侧目录；具有代表性的经典案例经过进一步复现和编辑后，可能进入绿皮书正式章节。
...
本项目采用 [MIT License](https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/LICENSE/README.md) 开源。你可以自由使用、复制、修改和分发本项目，但需要保留原始版权声明和许可证文本。
