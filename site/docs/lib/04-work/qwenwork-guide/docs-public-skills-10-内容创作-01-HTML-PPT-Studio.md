...
entryUrl: "https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/docs/public/skills/10-内容创作/01-HTML-PPT-Studio.md"
sourceRel: "docs/public/skills/10-内容创作/01-HTML-PPT-Studio.md"
rawUrl: "/raw/04-work/qwenwork-guide/docs/public/skills/10-内容创作/01-HTML-PPT-Studio.md"
sourceSha256: "289e1cf2c0fa95b44795ccd557199ea7bc09ab30266a7327108e462e05c9aca8"
pageSha256: "289e1cf2c0fa95b44795ccd557199ea7bc09ab30266a7327108e462e05c9aca8"
...
See [references/presenter-mode.md](https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/docs/public/skills/10-内容创作/references/presenter-mode.md) for the full authoring guide including the 3 rules of speaker script writing:
...
2. **Pick a theme.** Open the deck and press `T` to cycle. Or hard-code it:
   ...
   ```
   Catalog in [references/themes.md](https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/docs/public/skills/10-内容创作/references/themes.md).
3. **Pick layouts.** Copy `<section class="slide">...</section>` blocks out of
   ...
   Catalog in [references/layouts.md](https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/docs/public/skills/10-内容创作/references/layouts.md).
4. **Add animations.** Put `data-anim="fade-up"` (or `class="anim-fade-up"`) on
   any element. On ``/grids, use `anim-stagger-list` for sequenced reveals.
   For canvas FX, use `<div data-fx="knowledge-graph">...</div>` and include
   ``.
   Catalog in [references/animations.md](https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/docs/public/skills/10-内容创作/references/animations.md).
5. **Use a full-deck template.** Copy `templates/full-decks/<name>/` into
   ...
   scoped CSS. Catalog in [references/full-decks.md](https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/docs/public/skills/10-内容创作/references/full-decks.md)
...
- **NEVER put presenter-only text on the slide itself.** Descriptive text like
  ...
  `` / `<span>` elements on the slide. The `.notes` class is `display:none`
...
See [references/authoring-guide.md](https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/docs/public/skills/10-内容创作/references/authoring-guide.md) for a
...
- [references/themes.md](https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/docs/public/skills/10-内容创作/references/themes.md) — all 36 themes with when-to-use.
- [references/layouts.md](https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/docs/public/skills/10-内容创作/references/layouts.md) — all 31 layout types.
- [references/animations.md](https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/docs/public/skills/10-内容创作/references/animations.md) — 27 CSS + 20 canvas FX animations.
- [references/full-decks.md](https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/docs/public/skills/10-内容创作/references/full-decks.md) — all 15 full-deck templates.
- [references/presenter-mode.md](https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/docs/public/skills/10-内容创作/references/presenter-mode.md) — **演讲者模式 + 逐字稿编写指南（技术分享/演讲必看）**.
- [references/authoring-guide.md](https://github.com/wangxiaoshuai1998/QwenWorkGuide/blob/002f698a68b69d3635acf6be0d6e27db69069071/docs/public/skills/10-内容创作/references/authoring-guide.md) — full workflow.
