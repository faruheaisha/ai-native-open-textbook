---
title: "Why Harness is Important"
...
entryUrl: "https://github.com/shanraisshan/claude-code-best-practice/blob/2d6ea151c0d7189c3eaf364809c5574bd210e545/reports/why-harness-is-important.md"
sourceRel: "reports/why-harness-is-important.md"
rawUrl: "/raw/09-harness/claude-code-best-practice/reports/why-harness-is-important.md"
sourceSha256: "441bc05ecf39eabd8a99ed173e155807b79f674209196098afbc9fed0e352ed2"
pageSha256: "441bc05ecf39eabd8a99ed173e155807b79f674209196098afbc9fed0e352ed2"
...
- [Agents vs Commands vs Skills](/lib/09-harness/claude-code-best-practice/reports-claude-agent-command-skill) — shows context isolation, model override, and tool restrictions per feature
- [Claude Agent SDK vs CLI System Prompts](/lib/09-harness/claude-code-best-practice/reports-claude-agent-sdk-vs-cli-system-prompts) — documents the 110+ modular system prompt fragments
- [Claude Agent Memory](/lib/09-harness/claude-code-best-practice/reports-claude-agent-memory) — cross-session persistence via `memory:` scopes
- [Claude Memory Best Practice](/lib/09-harness/claude-code-best-practice/best-practice-claude-memory) — lazy-loaded descendant `CLAUDE.md` files
- [Claude Subagents Best Practice](/lib/09-harness/claude-code-best-practice/best-practice-claude-subagents) — frontmatter reference for harness-enforced capabilities
- [Claude Settings Best Practice](/lib/09-harness/claude-code-best-practice/best-practice-claude-settings/index) — permission rule evaluation and `auto` mode classifier
- [Orchestration Workflow](/lib/09-harness/claude-code-best-practice/orchestration-workflow-orchestration-workflow) — concrete demonstration that the reduction fails
