...
sourceRel: "en/prompt-library.md"
rawUrl: "/raw/09-harness/claude-code-docs-official/en/prompt-library.md"
sourceSha256: "985ba3bd07863a741e2e5f137e14bc8fb173fa547242ad52de426929d3e9ecba"
pageSha256: "985ba3bd07863a741e2e5f137e14bc8fb173fa547242ad52de426929d3e9ecba"
...
export const PromptLibrary = (\{text = \{\}, labels = \{\}, tagLabels = \{\}, phaseLabels = \{\}, sourceLabels = \{\}, catLabels = \{&#125;&#125;) => \{
  ...
  const setFill = (id, key, val) => setFills(f => (\{
    ...f,
    [id + '.' + key]: https://code.claude.com/docs
  \}));
  const fillOf = (p, key) => \{
