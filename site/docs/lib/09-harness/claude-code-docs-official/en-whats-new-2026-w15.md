...
sourceRel: "en/whats-new/2026-w15.md"
rawUrl: "/raw/09-harness/claude-code-docs-official/en/whats-new/2026-w15.md"
sourceSha256: "282687bbdbe4b964dc44ecfe2dc4a5e1e05603fc16309b9c51e520a25e6d2b39"
pageSha256: "282687bbdbe4b964dc44ecfe2dc4a5e1e05603fc16309b9c51e520a25e6d2b39"
...
<div className="digest-meta">
  <span>Releases <a href="https://code.claude.com/docs/en/changelog#2-1-92">v2.1.92 → v2.1.101</a></span>
...
<div className="digest-wins">
  ...
  <div className="digest-wins-grid">
    ...
    <div>Guided <a href="https://code.claude.com/docs/en/amazon-bedrock">Amazon Bedrock</a> and <a href="https://code.claude.com/docs/en/google-vertex-ai">Google Cloud's Agent Platform</a> setup wizards on the login screen: pick "3rd-party platform" for step-by-step auth, region, credential check, and model pinning</div>
