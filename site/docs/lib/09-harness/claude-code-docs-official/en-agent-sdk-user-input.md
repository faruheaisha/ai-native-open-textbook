...
sourceRel: "en/agent-sdk/user-input.md"
rawUrl: "/raw/09-harness/claude-code-docs-official/en/agent-sdk/user-input.md"
sourceSha256: "59d839a8526a2cbbad4e4537a86af6564f1d382511f32ce560d491da4c9fa439"
pageSha256: "59d839a8526a2cbbad4e4537a86af6564f1d382511f32ce560d491da4c9fa439"
...
See the SDK reference for complete input schemas: [Python](https://code.claude.com/docs/en/agent-sdk/python#tool-input/output-types) | [TypeScript](https://code.claude.com/docs/en/agent-sdk/typescript#tool-input-types).
...
| `"html"`        | A styled `` fragment (the SDK rejects `<script>`, `<style>`, and `<!DOCTYPE>` before your callback runs) |
