...
sourceRel: "en/goal.md"
rawUrl: "/raw/09-harness/claude-code-docs-official/en/goal.md"
sourceSha256: "c4541af0af790dbe36801db79afd07937053e693f4a468fd861b0cfc44a4df34"
pageSha256: "c4541af0af790dbe36801db79afd07937053e693f4a468fd861b0cfc44a4df34"
...
| [`/loop`](https://code.claude.com/docs/en/scheduled-tasks#run-a-prompt-repeatedly-with-/loop) | A time interval elapses                                                                                                                                                                       | You stop it, or Claude decides the work is done                                                                                                                                                 |
...
* [Run a prompt repeatedly with `/loop`](https://code.claude.com/docs/en/scheduled-tasks#run-a-prompt-repeatedly-with-/loop): re-run on a time interval instead of toward a condition
