...
sourceRel: "en/whats-new/2026-w24.md"
rawUrl: "/raw/09-harness/claude-code-docs-official/en/whats-new/2026-w24.md"
sourceSha256: "7a2ee84a1e8ef73acccdc418876e8e5182918c40eebce6ff1e5ee7c043682556"
pageSha256: "7a2ee84a1e8ef73acccdc418876e8e5182918c40eebce6ff1e5ee7c043682556"
...
<div className="digest-meta">
  <span>Releases <a href="https://code.claude.com/docs/en/changelog#2-1-166">v2.1.166 → v2.1.176</a></span>
...
<div className="digest-wins">
  ...
  <div className="digest-wins-grid">
    <div><a href="https://code.claude.com/docs/en/model-config#fallback-model-chains"><code>fallbackModel</code></a> configures up to three fallback models tried in order when the primary is overloaded or unavailable, and `--fallback-model` now applies to interactive sessions too</div>
