...
sourceRel: "en/whats-new/2026-w16.md"
rawUrl: "/raw/09-harness/claude-code-docs-official/en/whats-new/2026-w16.md"
sourceSha256: "cef88008fa8788cc06714b7bfe784cb9a237e0f78a7f25fd2a2a98e8ef0c9704"
pageSha256: "cef88008fa8788cc06714b7bfe784cb9a237e0f78a7f25fd2a2a98e8ef0c9704"
...
<div className="digest-meta">
  <span>Releases <a href="https://code.claude.com/docs/en/changelog#2-1-105">v2.1.105 → v2.1.113</a></span>
...
<div className="digest-wins">
  ...
  <div className="digest-wins-grid">
    <div>New <a href="https://code.claude.com/docs/en/ultrareview"><code>/ultrareview</code></a>: comprehensive code review in the cloud using parallel multi-agent analysis and an adversarial critique pass. Run it bare to review your current branch, or <code>/ultrareview \&lt;PR#></code> for a specific PR</div>
    <div><a href="https://code.claude.com/docs/en/permission-modes#eliminate-prompts-with-auto-mode">Auto mode</a> is now available for Max subscribers on Opus 4.7, and the <code>--enable-auto-mode</code> flag is no longer required</div>
    <div><a href="https://code.claude.com/docs/en/interactive-mode#session-recap">Session recap</a> shows a one-line summary of what happened while you were away; run <code>/recap</code> on demand or turn it off from <code>/config</code></div>
