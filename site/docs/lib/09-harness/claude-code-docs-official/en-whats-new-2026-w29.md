...
sourceRel: "en/whats-new/2026-w29.md"
rawUrl: "/raw/09-harness/claude-code-docs-official/en/whats-new/2026-w29.md"
sourceSha256: "118acce134ea5a471a45c714615904a70330fe7e8d3b70d9091fd2060cd1bb0e"
pageSha256: "118acce134ea5a471a45c714615904a70330fe7e8d3b70d9091fd2060cd1bb0e"
...
<div className="digest-meta">
  <span>Releases <a href="https://code.claude.com/docs/en/changelog#2-1-207">v2.1.207 → v2.1.212</a></span>
...
<div className="digest-wins">
  ...
  <div className="digest-wins-grid">
    ...
    <div>`--forward-subagent-text` and <code>CLAUDE\_CODE\_FORWARD\_SUBAGENT\_TEXT</code> include subagent text and thinking blocks in <a href="https://code.claude.com/docs/en/headless">stream-json output</a></div>
