...
entryUrl: "https://github.com/Windy3f3f3f3f/how-claude-code-works/blob/f4d6505ed9162a0ee6be089190f74c419ecacb19/en/docs/10-plan-mode.md"
sourceRel: "en/docs/10-plan-mode.md"
rawUrl: "/raw/09-harness/how-claude-code-works/en/docs/10-plan-mode.md"
sourceSha256: "4d8113d6726544d4320f82a4d44b12cd522e54bfd28c9c39eb28de808afa3c7f"
pageSha256: "4d8113d6726544d4320f82a4d44b12cd522e54bfd28c9c39eb28de808afa3c7f"
...
Plan Mode is deeply integrated with the [Permission System](/lib/09-harness/how-claude-code-works/en-docs-11-permission-security/index). The behavior of `prepareContextForPlanMode()` depends on the mode before entry:
...
Plan Mode provides dedicated instructions for sub-agents in the [Multi-Agent Architecture](/lib/09-harness/how-claude-code-works/en-docs-07-multi-agent/index) (`src/utils/messages.ts:3399-3417`). Sub-agent plan files use a separate namespace (`\{slug\}-agent-\{agentId\}.md`), avoiding conflicts with the main session's plan file.
...
Previous chapter: [Multi-Agent Architecture](/lib/09-harness/how-claude-code-works/en-docs-07-multi-agent/index) | Next chapter: [Code Editing Strategy](/lib/09-harness/how-claude-code-works/en-docs-05-code-editing-strategy)
