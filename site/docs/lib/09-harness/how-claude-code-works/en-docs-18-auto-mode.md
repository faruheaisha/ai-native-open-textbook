---
title: "Chapter 18: Auto Mode — Permissions Enter the Classifier Era"
...
entryUrl: "https://github.com/Windy3f3f3f3f/how-claude-code-works/blob/f4d6505ed9162a0ee6be089190f74c419ecacb19/en/docs/18-auto-mode.md"
sourceRel: "en/docs/18-auto-mode.md"
rawUrl: "/raw/09-harness/how-claude-code-works/en/docs/18-auto-mode.md"
sourceSha256: "bc677bedb78abf6751ef7b5de63c7a674d7da40854100128c4e268ec9226cc77"
pageSha256: "bc677bedb78abf6751ef7b5de63c7a674d7da40854100128c4e268ec9226cc77"
...
Start by connecting to Chapter 12. That chapter laid out a seven-layer defense in depth: workspace trust, permission modes, allow/deny rules, syntax-tree analysis of Bash commands plus 23 checks, tool-level validation, sandboxing, and only last the dialog it pops for you (see [Chapter 12](/lib/09-harness/how-claude-code-works/en-docs-11-permission-security/index), 12.1). Auto Mode doesn't tear this down and rebuild it; it adds a new automatic decision source inside that last layer: where "ask or not" used to be the rules' call, now there's also a classifier that reads the context and decides when the rules gave no verdict.
