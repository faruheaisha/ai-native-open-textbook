...
entryUrl: "https://github.com/Windy3f3f3f3f/how-claude-code-works/blob/f4d6505ed9162a0ee6be089190f74c419ecacb19/en/README.md"
sourceRel: "en/README.md"
rawUrl: "/raw/09-harness/how-claude-code-works/en/README.md"
sourceSha256: "db488ec26524846c837a682bd90586a1083db96d226a68d66df1c0d8be1be955"
pageSha256: "db488ec26524846c837a682bd90586a1083db96d226a68d66df1c0d8be1be955"
...
|---|----------|-------------------|
| 1 | [Overview](/lib/09-harness/how-claude-code-works/en-docs-01-overview) | Thinking behind technology choices (why Bun/React/Zod), 6 core design principles, 9-stage 235ms startup process, complete data flow panorama |
| 2 | [Agent Loop](/lib/09-harness/how-claude-code-works/en-docs-02-agent-loop) | Dual-layer architecture of the Agent loop, 7 Continue Sites for failure recovery, tool pre-execution, StreamingToolExecutor concurrency mechanism |
| 3 | [Context Engineering](/lib/09-harness/how-claude-code-works/en-docs-03-context-engineering/index) | Complete details of the 4-level compression pipeline, post-compression auto-recovery mechanism (5 files + skill reactivation), prompt caching strategy and cache break detection |
| 4 | [Tool System](/lib/09-harness/how-claude-code-works/en-docs-04-tool-system/index) | Registration and concurrency control for 66 tools, detailed MCP 7 transport types, connection state machine, OAuth 2.0 + PKCE authentication flow |
| 5 | [Skills System](/lib/09-harness/how-claude-code-works/en-docs-09-skills-system) | 6-layer skill sources and priority, lazy loading and token budget allocation, Inline/Fork dual execution modes, whitelist permission model, skill retention after compression |
| 6 | [Memory System](/lib/09-harness/how-claude-code-works/en-docs-08-memory-system) | 4 memory types and closed taxonomy, Sonnet semantic recall and async prefetch, background memory extraction Agent, memory drift defense, team memory |
| 7 | [Hooks & Extensibility](/lib/09-harness/how-claude-code-works/en-docs-06-hooks-extensibility) | Complete 23+ Hook events panorama, 5 Hook types, 6-stage execution pipeline, PermissionRequest 4 capabilities, trust model and security |
| 8 | [Multi-Agent Architecture](/lib/09-harness/how-claude-code-works/en-docs-07-multi-agent/index) | Sub-Agent 4 execution modes and Worktree isolation, coordinator pure orchestration design, Swarm 3 execution backends and mailbox communication |
| 9 | [Plan Mode](/lib/09-harness/how-claude-code-works/en-docs-10-plan-mode) | Two entry paths, 5-phase and iterative dual workflows, attachment throttling mechanism, Phase 4 four experimental variants, plan file management and recovery, approval and permission restoration |
| 10 | [Code Editing Strategy](/lib/09-harness/how-claude-code-works/en-docs-05-code-editing-strategy) | Why search-and-replace is better than full file rewrite, uniqueness constraints and anti-hallucination design, code-level implementation of mandatory pre-edit reading |
...
| 12 | [Permissions & Security](/lib/09-harness/how-claude-code-works/en-docs-11-permission-security/index) | 5-layer defense-in-depth system, tree-sitter AST analysis + 23 security checks, race confirmation mechanism and 200ms anti-misclick |
...
| 14 | [User Experience Design](/lib/09-harness/how-claude-code-works/en-docs-12-user-experience) | Custom Ink renderer architecture, Yoga Flexbox layout, virtual scrolling and object pool optimization, Vim mode |
| 15 | [Minimal Essential Components](/lib/09-harness/how-claude-code-works/en-docs-13-minimal-components/index) | 7 minimal essential component framework, item-by-item comparison of minimal vs production implementation, evolution path from 500 lines to 500,000 lines |
...
→ First read [Minimal Essential Components](/lib/09-harness/how-claude-code-works/en-docs-13-minimal-components/index), then follow the 11-chapter tutorial in **[claude-code-from-scratch](https://github.com/Windy3f3f3f3f/claude-code-from-scratch)** to build it hands-on — ~3000 lines of code, each step explained against the source code
...
→ Read [Permissions & Security](/lib/09-harness/how-claude-code-works/en-docs-11-permission-security/index) + [Code Editing Strategy](/lib/09-harness/how-claude-code-works/en-docs-05-code-editing-strategy)
