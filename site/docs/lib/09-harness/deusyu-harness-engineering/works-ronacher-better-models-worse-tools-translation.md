...
entryUrl: "https://github.com/deusyu/harness-engineering/blob/858c0da6570aad32947c09c7e83fb04f46d22ebe/works/ronacher-better-models-worse-tools-translation.md"
sourceRel: "works/ronacher-better-models-worse-tools-translation.md"
rawUrl: "/raw/09-harness/deusyu-harness-engineering/works/ronacher-better-models-worse-tools-translation.md"
sourceSha256: "2436393df8a6acd96f36371aaf1acc5413ced3b5b5d731e485b6bef36c50286f"
pageSha256: "2436393df8a6acd96f36371aaf1acc5413ced3b5b5d731e485b6bef36c50286f"
...
> 译注：本文与本仓库 [references/articles.md](/lib/09-harness/deusyu-harness-engineering/references-articles/index) 中的 #60（Cursor《持续改进我们的 agent harness》）互为正反面——Cursor 的对策正是"给每个模型配它训练时用的工具格式"（OpenAI 走 patch 格式、Anthropic 走字符串替换），因为"给它不熟悉的那个会多花推理 token 并产生更多错误"。文中对 Claude Code 客户端内部行为的描述，可与 #30（Claude Code 源码泄漏事件）对照阅读。
