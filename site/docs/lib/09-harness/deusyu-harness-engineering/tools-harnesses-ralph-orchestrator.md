...
entryUrl: "https://github.com/deusyu/harness-engineering/blob/858c0da6570aad32947c09c7e83fb04f46d22ebe/tools/harnesses/ralph-orchestrator.md"
sourceRel: "tools/harnesses/ralph-orchestrator.md"
rawUrl: "/raw/09-harness/deusyu-harness-engineering/tools/harnesses/ralph-orchestrator.md"
sourceSha256: "1e5fd5a6be5a8095fb89f9be70fe3020478db30ea958890c2ed2ae5aab04c649"
pageSha256: "1e5fd5a6be5a8095fb89f9be70fe3020478db30ea958890c2ed2ae5aab04c649"
...
> 首篇实测工具页。实测来源：[practice/01-ralph-demo/](/lib/09-harness/deusyu-harness-engineering/practice-01-ralph-demo)（v2.8.1，2026-03-31）。
...
对照 [6 维复杂度框架](/lib/09-harness/deusyu-harness-engineering/thinking-software-project-complexity-in-the-ai-era)，按实测判断：
...
- **生效边界**：整个门控体系建立在"测试能表达正确性"之上。如 [thinking/evaluation-elephant-in-the-room.md](/lib/09-harness/deusyu-harness-engineering/thinking-evaluation-elephant-in-the-room) 所指出的——Critic Hat 是折中，**它仍然是 LLM**；需求理解本身错了，测试全绿也救不了。
- **失效场景**：
...
- 与 [practice/01-ralph-demo/](/lib/09-harness/deusyu-harness-engineering/practice-01-ralph-demo) 的归档配置（`ralph.yml` + `PROMPT.md`）配合即可复跑。
...
Ralph 六条信条与 Harness Engineering 概念的完整映射见根 [README.md](/lib/09-harness/deusyu-harness-engineering/overview) "Ralph 系列"一节。
