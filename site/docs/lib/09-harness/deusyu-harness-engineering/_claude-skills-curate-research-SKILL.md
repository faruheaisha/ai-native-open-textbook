---
title: "curate-research —— 仓库自我策展 harness"
...
entryUrl: "https://github.com/deusyu/harness-engineering/blob/858c0da6570aad32947c09c7e83fb04f46d22ebe/.claude/skills/curate-research/SKILL.md"
sourceRel: ".claude/skills/curate-research/SKILL.md"
rawUrl: "/raw/09-harness/deusyu-harness-engineering/.claude/skills/curate-research/SKILL.md"
sourceSha256: "f098d6151ae8c1d4c8a40569b46fa326eb970f9155bf046f52fec5e72a9bfb70"
pageSha256: "f098d6151ae8c1d4c8a40569b46fa326eb970f9155bf046f52fec5e72a9bfb70"
...
- [ ] **数图要抓原文 HTML 数，不能只看渲染出来的正文。** 2026-07-27 的教训：一篇 claude.com 译文声明 `sourceFigureCount: 0`，而原文 HTML 里有 4 个 ``——抓取工具吐出的 markdown 把它们丢了，人只看那份 markdown 就会以为没有图。可用 `curl <url> | grep -c '<figure'` 交叉验证
...
- README.md / README.en.md：`articles-N` badge、`translations-N` badge、目录树、脉络表（脉络一计数）、翻译 `` 摘要数、翻译表格行、Phase 5 提及
