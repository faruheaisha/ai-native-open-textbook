...
问题不大。OpenAI 的[机械化执行](/lib/09-harness/deusyu-harness-engineering/concepts-02-mechanical-enforcement)（概念 3）和 HumanLayer 的背压杠杆都在这一层运作良好。
...
2. **人类抽检的可扩展性：** 如果最终答案是人类审查，那 harness engineering 的["吞吐量优先"理念](/lib/09-harness/deusyu-harness-engineering/concepts-05-throughput-changes-merge)（概念 5）就受到人类注意力的硬约束。Ralph 实验中的 Critic Hat 是一个折中——但它仍然是 LLM。
