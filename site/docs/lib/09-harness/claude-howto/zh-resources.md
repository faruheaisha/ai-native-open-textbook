...
entryUrl: "https://github.com/luongnv89/claude-howto/blob/97bfb0685e03112ad39845889061d02cef6e534c/zh/resources.md"
sourceRel: "zh/resources.md"
rawUrl: "/raw/09-harness/claude-howto/zh/resources.md"
sourceSha256: "2bc0d3f1574c8589097ff06cc8e6ace2356160c607ac77de5893a2242c60cf8a"
pageSha256: "2bc0d3f1574c8589097ff06cc8e6ace2356160c607ac77de5893a2242c60cf8a"
...
| 功能 | 说明 | 了解更多 |
|---------|-------------|------------|
| **Auto Memory** | Claude 会自动学习并记住你跨会话的偏好 | [记忆指南](/lib/09-harness/claude-howto/zh-02-memory) |
| **Remote Control** | 通过外部工具和脚本以编程方式控制 Claude Code 会话 | [高级功能](/lib/09-harness/claude-howto/zh-09-advanced-features) |
| **Web Sessions** | 通过基于浏览器的界面访问 Claude Code，实现远程开发 | [CLI 参考](/lib/09-harness/claude-howto/zh-10-cli) |
| **Desktop App** | Claude Code 的原生桌面应用，界面更强大 | [Claude Code 文档](https://code.claude.com/docs/en/desktop) |
| **Extended Thinking** | 通过 `Alt+T` / `Option+T` 或 `MAX_THINKING_TOKENS` 环境变量切换深度推理 | [高级功能](/lib/09-harness/claude-howto/zh-09-advanced-features) |
| **Permission Modes** | 精细权限控制：default、acceptEdits、plan、auto、dontAsk、bypassPermissions | [高级功能](/lib/09-harness/claude-howto/zh-09-advanced-features) |
| **7-Tier Memory** | Managed Policy、Project、Project Rules、User、User Rules、Local、Auto Memory | [记忆指南](/lib/09-harness/claude-howto/zh-02-memory) |
| **Hook Events** | 33 个事件：PreToolUse、PostToolUse、PostToolUseFailure、Stop、StopFailure、SubagentStart、SubagentStop、Notification、Elicitation 等 | [Hooks 指南](/lib/09-harness/claude-howto/zh-06-hooks) |
| **Agent Teams** | 协调多个 agent 共同处理复杂任务 | [Subagents 指南](/lib/09-harness/claude-howto/zh-04-subagents) |
| **Scheduled Tasks** | 用 `/loop` 和 cron 工具设置周期性任务 | [高级功能](/lib/09-harness/claude-howto/zh-09-advanced-features) |
| **Chrome Integration** | 使用无头 Chromium 做浏览器自动化 | [高级功能](/lib/09-harness/claude-howto/zh-09-advanced-features) |
| **Keyboard Customization** | 自定义按键绑定，包括组合键序列 | [高级功能](/lib/09-harness/claude-howto/zh-09-advanced-features) |
