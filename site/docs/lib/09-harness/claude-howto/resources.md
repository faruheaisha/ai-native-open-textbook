...
entryUrl: "https://github.com/luongnv89/claude-howto/blob/97bfb0685e03112ad39845889061d02cef6e534c/resources.md"
sourceRel: "resources.md"
rawUrl: "/raw/09-harness/claude-howto/resources.md"
sourceSha256: "5afc2039bfcb867c12671e2277b1d657c77059d67e813d88e8289ce051dc37bb"
pageSha256: "5afc2039bfcb867c12671e2277b1d657c77059d67e813d88e8289ce051dc37bb"
...
|---------|-------------|------------|
| **Auto Memory** | Claude automatically learns and remembers your preferences across sessions | [Memory Guide](/lib/09-harness/claude-howto/02-memory) |
| **Remote Control** | Programmatically control Claude Code sessions from external tools and scripts | [Advanced Features](/lib/09-harness/claude-howto/09-advanced-features/index) |
| **Web Sessions** | Access Claude Code through browser-based interfaces for remote development | [CLI Reference](/lib/09-harness/claude-howto/10-cli/index) |
...
| **Extended Thinking** | Deep reasoning toggle via `Alt+T`/`Option+T` or `MAX_THINKING_TOKENS` env var | [Advanced Features](/lib/09-harness/claude-howto/09-advanced-features/index) |
| **Permission Modes** | Fine-grained control: manual (formerly default), acceptEdits, plan, auto, dontAsk, bypassPermissions | [Advanced Features](/lib/09-harness/claude-howto/09-advanced-features/index) |
| **7-Tier Memory** | Managed Policy, Project, Project Rules, User, User Rules, Local, Auto Memory | [Memory Guide](/lib/09-harness/claude-howto/02-memory) |
| **Hook Events** | 33 events: PreToolUse, PostToolUse, PostToolUseFailure, Stop, StopFailure, SubagentStart, SubagentStop, Notification, Elicitation, and more | [Hooks Guide](/lib/09-harness/claude-howto/06-hooks) |
| **Agent Teams** | Coordinate multiple agents working together on complex tasks | [Subagents Guide](/lib/09-harness/claude-howto/04-subagents) |
| **Scheduled Tasks** | Set up recurring tasks with `/loop` and cron tools | [Advanced Features](/lib/09-harness/claude-howto/09-advanced-features/index) |
| **Chrome Integration** | Browser automation with headless Chromium | [Advanced Features](/lib/09-harness/claude-howto/09-advanced-features/index) |
| **Keyboard Customization** | Customize keybindings including chord sequences | [Advanced Features](/lib/09-harness/claude-howto/09-advanced-features/index) |
| **Monitor Tool** | Watch a background command's stdout stream and react to events instead of polling (v2.1.98+) | [Advanced Features](/lib/09-harness/claude-howto/09-advanced-features/index) |
| **/goal mode** | Register a session-level completion condition; Claude keeps working until met (v2.1.139+) | [Slash Commands](/lib/09-harness/claude-howto/01-slash-commands) |
...
| **/run, /verify, /run-skill-generator** | Bundled skills to launch your project, confirm a fix works, and generate per-project run/verify skills (v2.1.145+) | [Skills Guide](/lib/09-harness/claude-howto/03-skills) |
