...
entryUrl: "https://github.com/luongnv89/claude-howto/blob/97bfb0685e03112ad39845889061d02cef6e534c/zh/README.md"
sourceRel: "zh/README.md"
rawUrl: "/raw/09-harness/claude-howto/zh/README.md"
sourceSha256: "87bf5b210007f7e19bc21868fd0b8ca4fb88493dac3a1732eb46dff63e1aedaf"
pageSha256: "87bf5b210007f7e19bc21868fd0b8ca4fb88493dac3a1732eb46dff63e1aedaf"
...
**[15 分钟快速上手](#15-分钟快速上手)** | **[找到适合你的起点](#不知道从哪里开始)** | **[浏览功能目录](/lib/09-harness/claude-howto/zh-CATALOG)**
...
**[开始学习路线  ->](/lib/09-harness/claude-howto/zh-LEARNING-ROADMAP)**
...
完成[自我评估测验](/lib/09-harness/claude-howto/zh-LEARNING-ROADMAP#find-your-level)，或者在 Claude Code 中运行 `/self-assessment`。系统会根据你已经掌握的内容，生成一份个性化学习路线。
...
| Level | 你可以…… | 从这里开始 | 时间 |
|-------|-----------|------------|------|
| **Beginner** | 启动 Claude Code 并进行对话 | [Slash Commands](/lib/09-harness/claude-howto/zh-01-slash-commands) | 约 2.5 小时 |
| **Intermediate** | 使用 `CLAUDE.md` 和自定义命令 | [Skills](/lib/09-harness/claude-howto/zh-03-skills) | 约 3.5 小时 |
| **Advanced** | 配置 MCP servers 和 hooks | [Advanced Features](/lib/09-harness/claude-howto/zh-09-advanced-features) | 约 5 小时 |

**完整学习路径，共 10 个模块：**

| 顺序 | 模块 | 水平 | 时间 |
|-------|--------|-------|------|
| 1 | [Slash Commands](/lib/09-harness/claude-howto/zh-01-slash-commands) | 初学者 | 30 分钟 |
| 2 | [Memory](/lib/09-harness/claude-howto/zh-02-memory) | 初学者+ | 45 分钟 |
| 3 | [Checkpoints](/lib/09-harness/claude-howto/zh-08-checkpoints) | 中级 | 45 分钟 |
| 4 | [CLI Basics](/lib/09-harness/claude-howto/zh-10-cli) | 初学者+ | 30 分钟 |
| 5 | [Skills](/lib/09-harness/claude-howto/zh-03-skills) | 中级 | 1 小时 |
| 6 | [Hooks](/lib/09-harness/claude-howto/zh-06-hooks) | 中级 | 1 小时 |
| 7 | [MCP](/lib/09-harness/claude-howto/zh-05-mcp) | 中级+ | 1 小时 |
| 8 | [Subagents](/lib/09-harness/claude-howto/zh-04-subagents) | 中级+ | 1.5 小时 |
| 9 | [Advanced Features](/lib/09-harness/claude-howto/zh-09-advanced-features) | 高级 | 2 到 3 小时 |
| 10 | [Plugins](/lib/09-harness/claude-howto/zh-07-plugins) | 高级 | 2 小时 |

**[完整学习路线图 ->](/lib/09-harness/claude-howto/zh-LEARNING-ROADMAP)**
...
**我可以参与贡献吗？**
当然可以。请查看 [CONTRIBUTING.md](https://github.com/luongnv89/claude-howto/blob/97bfb0685e03112ad39845889061d02cef6e534c/zh/CONTRIBUTING.md) 了解贡献规范。我们欢迎新的示例、bug 修复、文档改进以及社区模板。
...
**[开始学习路线 ->](/lib/09-harness/claude-howto/zh-LEARNING-ROADMAP)** | **[浏览功能目录](/lib/09-harness/claude-howto/zh-CATALOG)** | **[15 分钟快速上手](#15-分钟快速上手)**
...
| 功能 | 说明 | 文件夹 |
|---------|-------------|--------|
| **功能目录** | 包含安装命令的完整参考 | [CATALOG.md](/lib/09-harness/claude-howto/zh-CATALOG) |
| **Slash Commands** | 用户手动触发的快捷命令 | [01-slash-commands/README.md](/lib/09-harness/claude-howto/zh-01-slash-commands) |
| **Memory** | 持久上下文 | [02-memory/README.md](/lib/09-harness/claude-howto/zh-02-memory) |
| **Skills** | 可复用能力 | [03-skills/README.md](/lib/09-harness/claude-howto/zh-03-skills) |
| **Subagents** | 专门化 AI 助手 | [04-subagents/README.md](/lib/09-harness/claude-howto/zh-04-subagents) |
| **MCP Protocol** | 访问外部工具 | [05-mcp/README.md](/lib/09-harness/claude-howto/zh-05-mcp) |
| **Hooks** | 事件驱动自动化 | [06-hooks/README.md](/lib/09-harness/claude-howto/zh-06-hooks) |
| **Plugins** | 打包后的功能集合 | [07-plugins/README.md](/lib/09-harness/claude-howto/zh-07-plugins) |
| **Checkpoints** | 会话快照与回退 | [08-checkpoints/README.md](/lib/09-harness/claude-howto/zh-08-checkpoints) |
| **Advanced Features** | 规划、思考、后台任务 | [09-advanced-features/README.md](/lib/09-harness/claude-howto/zh-09-advanced-features) |
| **CLI Reference** | 命令、参数与选项 | [10-cli/README.md](/lib/09-harness/claude-howto/zh-10-cli) |
...
**位置**: [01-slash-commands/README.md](/lib/09-harness/claude-howto/zh-01-slash-commands)
...
**位置**: [02-memory/README.md](/lib/09-harness/claude-howto/zh-02-memory)
...
**位置**: [03-skills/README.md](/lib/09-harness/claude-howto/zh-03-skills)
...
**位置**: [04-subagents/README.md](/lib/09-harness/claude-howto/zh-04-subagents)
...
**位置**: [05-mcp/README.md](/lib/09-harness/claude-howto/zh-05-mcp)
...
# 或手动添加到项目 .mcp.json（参见 [05-mcp/README.md](/lib/09-harness/claude-howto/zh-05-mcp) 中的示例）
```
...
**位置**: [06-hooks/README.md](/lib/09-harness/claude-howto/zh-06-hooks)
...
**位置**: [07-plugins/README.md](/lib/09-harness/claude-howto/zh-07-plugins)
...
**位置**: [08-checkpoints/README.md](/lib/09-harness/claude-howto/zh-08-checkpoints)
...
**位置**: [09-advanced-features/README.md](/lib/09-harness/claude-howto/zh-09-advanced-features)
...
完整配置请参见 [config-examples.json](https://github.com/luongnv89/claude-howto/blob/97bfb0685e03112ad39845889061d02cef6e534c/zh/09-advanced-features/config-examples.json)。
...
**位置**: [10-cli/README.md](/lib/09-harness/claude-howto/zh-10-cli)
...
每次 push 到 `main` / `develop`，以及每次向 `main` 提交 PR 时，测试都会自动运行。详情见 [TESTING.md](/lib/09-harness/claude-howto/zh-_github-TESTING)。
...
更多选项见 [scripts/README.md](/lib/09-harness/claude-howto/zh-scripts)。
...
**请先阅读 [CONTRIBUTING.md](https://github.com/luongnv89/claude-howto/blob/97bfb0685e03112ad39845889061d02cef6e534c/zh/CONTRIBUTING.md)，了解以下详细规范：**
...
**我们的社区标准：**
- [CODE_OF_CONDUCT.md](https://github.com/luongnv89/claude-howto/blob/97bfb0685e03112ad39845889061d02cef6e534c/zh/CODE_OF_CONDUCT.md) - 我们如何彼此相处
- [SECURITY.md](https://github.com/luongnv89/claude-howto/blob/97bfb0685e03112ad39845889061d02cef6e534c/zh/SECURITY.md) - 安全政策与漏洞报告方式
...
2. **或者阅读** [.github/SECURITY_REPORTING.md](/lib/09-harness/claude-howto/zh-_github-SECURITY_REPORTING) 获取详细说明
3. **不要**公开提交安全漏洞 issue
...
欢迎贡献内容。如何开始请查看我们的[贡献指南](https://github.com/luongnv89/claude-howto/blob/97bfb0685e03112ad39845889061d02cef6e534c/zh/CONTRIBUTING.md)。
