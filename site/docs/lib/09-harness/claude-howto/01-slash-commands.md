...
| `/workflows` | View running and completed dynamic workflow runs (added v2.1.154). See [Dynamic Workflows](/lib/09-harness/claude-howto/09-advanced-features#dynamic-workflows) |
