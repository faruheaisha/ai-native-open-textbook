...
entryUrl: "https://github.com/luongnv89/claude-howto/blob/97bfb0685e03112ad39845889061d02cef6e534c/claude_concepts_guide.md"
sourceRel: "claude_concepts_guide.md"
rawUrl: "/raw/09-harness/claude-howto/claude_concepts_guide.md"
sourceSha256: "aaf84a5b0277e6bd0c41ab62d4839366788c85a22cd5db83ab651bb6c5c1b17f"
pageSha256: "aaf84a5b0277e6bd0c41ab62d4839366788c85a22cd5db83ab651bb6c5c1b17f"
...
1. [Slash Commands](#slash-commands) — [module](/lib/09-harness/claude-howto/01-slash-commands)
2. [Subagents](#subagents) — [module](/lib/09-harness/claude-howto/04-subagents)
3. [Memory](#memory) — [module](/lib/09-harness/claude-howto/02-memory)
4. [MCP Protocol](#mcp-protocol) — [module](/lib/09-harness/claude-howto/05-mcp)
5. [Agent Skills](#agent-skills) — [module](/lib/09-harness/claude-howto/03-skills)
6. [Plugins](#claude-code-plugins) — [module](/lib/09-harness/claude-howto/07-plugins)
7. [Comparison & Integration](#comparison--integration)
8. [Summary Table](#summary-table)
9. [Quick Start Guide](#quick-start-guide)
10. [Hooks](#hooks) — [module](/lib/09-harness/claude-howto/06-hooks)
11. [Checkpoints and Rewind](#checkpoints-and-rewind) — [module](/lib/09-harness/claude-howto/08-checkpoints)
12. [Advanced Features](#advanced-features) — [module](/lib/09-harness/claude-howto/09-advanced-features/index)
13. [Models and Reasoning Effort](#models-and-reasoning-effort) — [module](/lib/09-harness/claude-howto/10-cli/index)
...
Eight copy-paste command templates live in **[01-slash-commands/](/lib/09-harness/claude-howto/01-slash-commands)** — `/optimize`, `/pr`, `/commit`, `/push-all`, `/generate-api-docs`, `/doc-refactor`, `/setup-ci-cd`, and `/unit-test-expand`.

**[01-slash-commands/README.md](/lib/09-harness/claude-howto/01-slash-commands)** also carries the full built-in command reference (60+ commands) and the frontmatter field table.
...
Nine ready-to-use subagent definitions live in **[04-subagents/](/lib/09-harness/claude-howto/04-subagents)** — `code-reviewer`, `clean-code-reviewer`, `secure-reviewer`, `test-engineer`, `documentation-writer`, `implementation-agent`, `performance-optimizer`, `debugger`, and `data-scientist`.

**[04-subagents/README.md](/lib/09-harness/claude-howto/04-subagents)** documents the complete frontmatter reference, tool-access rules, nesting limits, and Agent Teams.
...
Copy-paste memory templates live in **[02-memory/](/lib/09-harness/claude-howto/02-memory)**:
...
**[02-memory/README.md](/lib/09-harness/claude-howto/02-memory)** covers the full hierarchy, import syntax, `.claude/rules/`, auto memory, and how to keep CLAUDE.md under 200 lines.
...
Auto memory stores what Claude learns about you across sessions in `~/.claude/projects/<project>/memory/`, indexed by `MEMORY.md`. See **[02-memory/README.md](/lib/09-harness/claude-howto/02-memory)** for the file layout, loading limits, and how to enable or disable it.
...
Ready-to-use MCP server configurations live in **[05-mcp/](/lib/09-harness/claude-howto/05-mcp)**: `github-mcp.json`, `database-mcp.json`, `filesystem-mcp.json`, and `multi-mcp.json` (four servers in one file).

**[05-mcp/README.md](/lib/09-harness/claude-howto/05-mcp)** covers the full `claude mcp add` syntax, transports, scopes, OAuth, and enterprise allowlisting.
...
Six complete skills — with their scripts, templates, and reference files — live in **[03-skills/](/lib/09-harness/claude-howto/03-skills)**:
...
See **[03-skills/README.md](/lib/09-harness/claude-howto/03-skills)** for the full frontmatter reference and progressive-disclosure model.
...
Three complete, installable plugins live in **[07-plugins/](/lib/09-harness/claude-howto/07-plugins)**:
...
See the three complete plugins in **[07-plugins/](/lib/09-harness/claude-howto/07-plugins)** — `pr-review/`, `documentation/`, and `devops-automation/` each ship a full `README.md`, manifest, commands, agents, and MCP config you can copy wholesale.
...
**See**: [06-hooks/](/lib/09-harness/claude-howto/06-hooks) for detailed examples
...
**See**: [08-checkpoints/](/lib/09-harness/claude-howto/08-checkpoints) for detailed examples
...
**See**: [09-advanced-features/](/lib/09-harness/claude-howto/09-advanced-features/index) for comprehensive guide
