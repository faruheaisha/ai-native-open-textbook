---
title: "Topic-Specific Recommendations"
...
entryUrl: "https://github.com/luongnv89/claude-howto/blob/97bfb0685e03112ad39845889061d02cef6e534c/.claude/skills/self-assessment/references/topic-recommendations.md"
sourceRel: ".claude/skills/self-assessment/references/topic-recommendations.md"
rawUrl: "/raw/09-harness/claude-howto/.claude/skills/self-assessment/references/topic-recommendations.md"
sourceSha256: "9dc61ba9b5cf2eeadca3d61cfaf6f97d12e8e0d0d4cd26e46f381ffbfc8fdda5"
pageSha256: "9dc61ba9b5cf2eeadca3d61cfaf6f97d12e8e0d0d4cd26e46f381ffbfc8fdda5"
...
- Tutorial: [01-slash-commands/](/lib/09-harness/claude-howto/01-slash-commands)
...
**Memory (score 0)**:
- Tutorial: [02-memory/](/lib/09-harness/claude-howto/02-memory)
...
**Skills (score 0)**:
- Tutorial: [03-skills/](/lib/09-harness/claude-howto/03-skills)
...
**Hooks (score 0)**:
- Tutorial: [06-hooks/](/lib/09-harness/claude-howto/06-hooks)
...
**MCP (score 0)**:
- Tutorial: [05-mcp/](/lib/09-harness/claude-howto/05-mcp)
...
**Subagents (score 0)**:
- Tutorial: [04-subagents/](/lib/09-harness/claude-howto/04-subagents)
...
**Checkpoints (score 0)**:
- Tutorial: [08-checkpoints/](/lib/09-harness/claude-howto/08-checkpoints)
...
- Tutorial: [09-advanced-features/](/lib/09-harness/claude-howto/09-advanced-features/index)
...
**Plugins (score 0)**:
- Tutorial: [07-plugins/](/lib/09-harness/claude-howto/07-plugins)
...
**CLI (score 0)**:
- Tutorial: [10-cli/](/lib/09-harness/claude-howto/10-cli/index)
