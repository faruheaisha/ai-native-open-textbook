...
entryUrl: "https://github.com/luongnv89/claude-howto/blob/97bfb0685e03112ad39845889061d02cef6e534c/LEARNING-ROADMAP.md"
sourceRel: "LEARNING-ROADMAP.md"
rawUrl: "/raw/09-harness/claude-howto/LEARNING-ROADMAP.md"
sourceSha256: "072a6687f44f51abf4e8e56bb2aa223be7140846a6ebd420a665501549088830"
pageSha256: "072a6687f44f51abf4e8e56bb2aa223be7140846a6ebd420a665501549088830"
...
- [01-slash-commands/README.md](/lib/09-harness/claude-howto/01-slash-commands)
- [02-memory/README.md](/lib/09-harness/claude-howto/02-memory)
...
#### Next Steps
- Read: [08-checkpoints/README.md](/lib/09-harness/claude-howto/08-checkpoints)
- Read: [10-cli/README.md](/lib/09-harness/claude-howto/10-cli/index)
...
- [ ] Can create and use slash commands ([01-slash-commands/](/lib/09-harness/claude-howto/01-slash-commands))
- [ ] Have set up project memory via CLAUDE.md ([02-memory/](/lib/09-harness/claude-howto/02-memory))
- [ ] Know how to create and restore checkpoints ([08-checkpoints/](/lib/09-harness/claude-howto/08-checkpoints))
- [ ] Can use `claude` and `claude -p` from the command line ([10-cli/](/lib/09-harness/claude-howto/10-cli/index))
...
- Read: [03-skills/README.md](/lib/09-harness/claude-howto/03-skills)
- Read: [06-hooks/README.md](/lib/09-harness/claude-howto/06-hooks)
...
- Read: [05-mcp/README.md](/lib/09-harness/claude-howto/05-mcp)
- Read: [04-subagents/README.md](/lib/09-harness/claude-howto/04-subagents)
...
- [ ] Can create and use skills with auto-invocation ([03-skills/](/lib/09-harness/claude-howto/03-skills))
- [ ] Have set up hooks for event-driven automation ([06-hooks/](/lib/09-harness/claude-howto/06-hooks))
- [ ] Can configure MCP servers for external data ([05-mcp/](/lib/09-harness/claude-howto/05-mcp))
- [ ] Know how to use subagents for task delegation ([04-subagents/](/lib/09-harness/claude-howto/04-subagents))
...
#### Next Steps
- Read: [09-advanced-features/README.md](/lib/09-harness/claude-howto/09-advanced-features/index)
...
#### Next Steps
- Read: [07-plugins/README.md](/lib/09-harness/claude-howto/07-plugins)
- Read: [10-cli/README.md](/lib/09-harness/claude-howto/10-cli/index)
...
3. Read: [01-slash-commands/README.md](/lib/09-harness/claude-howto/01-slash-commands)
...
### 🟢 Level 1: Beginner
- [ ] Completed [01-slash-commands](/lib/09-harness/claude-howto/01-slash-commands)
- [ ] Completed [02-memory](/lib/09-harness/claude-howto/02-memory)
- [ ] Created first custom slash command
- [ ] Set up project memory
- [ ] **Milestone 1A achieved**
- [ ] Completed [08-checkpoints](/lib/09-harness/claude-howto/08-checkpoints)
- [ ] Completed [10-cli](/lib/09-harness/claude-howto/10-cli/index) basics
- [ ] Created and reverted to a checkpoint
- [ ] Used interactive and print mode
- [ ] **Milestone 1B achieved**

### 🔵 Level 2: Intermediate
- [ ] Completed [03-skills](/lib/09-harness/claude-howto/03-skills)
- [ ] Completed [06-hooks](/lib/09-harness/claude-howto/06-hooks)
- [ ] Installed first skill
- [ ] Set up PreToolUse hook
- [ ] **Milestone 2A achieved**
- [ ] Completed [05-mcp](/lib/09-harness/claude-howto/05-mcp)
- [ ] Completed [04-subagents](/lib/09-harness/claude-howto/04-subagents)
...
### 🔴 Level 3: Advanced
- [ ] Completed [09-advanced-features](/lib/09-harness/claude-howto/09-advanced-features/index)
...
- [ ] Completed [07-plugins](/lib/09-harness/claude-howto/07-plugins)
- [ ] Completed [10-cli](/lib/09-harness/claude-howto/10-cli/index) advanced usage
...
**Solution**: Refer to the [Use Case Matrix](/lib/09-harness/claude-howto/overview#use-case-matrix) in the main README.

### Challenge 3: "Configuration not working"
**Solution**: Check the [Troubleshooting](/lib/09-harness/claude-howto/overview#troubleshooting) section and verify file locations.

### Challenge 4: "Concepts seem to overlap"
**Solution**: Review the [Feature Comparison](/lib/09-harness/claude-howto/overview#feature-comparison) table to understand differences.
...
[← Back to Main README](/lib/09-harness/claude-howto/overview)
