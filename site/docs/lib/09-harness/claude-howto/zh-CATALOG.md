...
entryUrl: "https://github.com/luongnv89/claude-howto/blob/97bfb0685e03112ad39845889061d02cef6e534c/zh/CATALOG.md"
sourceRel: "zh/CATALOG.md"
rawUrl: "/raw/09-harness/claude-howto/zh/CATALOG.md"
sourceSha256: "4634091d718e572316e47aac1db29c08f99d47eb9308ae5d7ee7e435128463f2"
pageSha256: "4634091d718e572316e47aac1db29c08f99d47eb9308ae5d7ee7e435128463f2"
...
| 功能 | 内置 | 示例 | 总数 | 参考 |
|---------|----------|----------|-------|-----------|
| **Slash Commands** | 60+ | 8 | 68+ | [01-slash-commands/README.md](/lib/09-harness/claude-howto/zh-01-slash-commands) |
| **Subagents** | 6 | 8 | 14 | [04-subagents/README.md](/lib/09-harness/claude-howto/zh-04-subagents) |
| **Skills** | 10 个内置 | 6 | 16 | [03-skills/README.md](/lib/09-harness/claude-howto/zh-03-skills) |
| **Plugins** | - | 3 | 3 | [07-plugins/README.md](/lib/09-harness/claude-howto/zh-07-plugins) |
| **MCP Servers** | 1 | 0 | 1 | [05-mcp/README.md](/lib/09-harness/claude-howto/zh-05-mcp) |
| **Hooks** | 33 个事件 | 0 | 33 | [06-hooks/README.md](/lib/09-harness/claude-howto/zh-06-hooks) |
| **Memory** | 7 种类型 | 3 | 10 | [02-memory/README.md](/lib/09-harness/claude-howto/zh-02-memory) |
| **总计** | **117** | **28** | **145** | |
...
**参考**: [01-slash-commands/README.md](/lib/09-harness/claude-howto/zh-01-slash-commands) | [官方文档](https://code.claude.com/docs/en/interactive-mode)
...
> **注意**：`auto` 模式需要满足合格的套餐、模型和提供商条件 — 参见 [09-advanced-features/](/lib/09-harness/claude-howto/zh-09-advanced-features#auto-mode)。只有在可信且已隔离的环境中才使用 `bypassPermissions`。
...
**参考**: [04-subagents/README.md](/lib/09-harness/claude-howto/zh-04-subagents) | [官方文档](https://code.claude.com/docs/en/sub-agents)
...
**参考**: [03-skills/README.md](/lib/09-harness/claude-howto/zh-03-skills) | [官方文档](https://code.claude.com/docs/en/skills)
...
**参考**: [07-plugins/README.md](/lib/09-harness/claude-howto/zh-07-plugins) | [官方文档](https://code.claude.com/docs/en/plugins)
...
**参考**: [05-mcp/README.md](/lib/09-harness/claude-howto/zh-05-mcp) | [MCP 协议文档](https://modelcontextprotocol.io)
...
**参考**: [06-hooks/README.md](/lib/09-harness/claude-howto/zh-06-hooks) | [官方文档](https://code.claude.com/docs/en/hooks)
...
**参考**: [02-memory/README.md](/lib/09-harness/claude-howto/zh-02-memory) | [官方文档](https://code.claude.com/docs/en/memory)
