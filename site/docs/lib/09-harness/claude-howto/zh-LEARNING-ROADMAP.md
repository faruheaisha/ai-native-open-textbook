...
entryUrl: "https://github.com/luongnv89/claude-howto/blob/97bfb0685e03112ad39845889061d02cef6e534c/zh/LEARNING-ROADMAP.md"
sourceRel: "zh/LEARNING-ROADMAP.md"
rawUrl: "/raw/09-harness/claude-howto/zh/LEARNING-ROADMAP.md"
sourceSha256: "190599ea5181c5ba216f076ffbd76a39b2a7f3263e2274ee081ab313503b2aac"
pageSha256: "190599ea5181c5ba216f076ffbd76a39b2a7f3263e2274ee081ab313503b2aac"
...
#### 下一步
熟悉之后，请阅读：
- [01-slash-commands/README.md](/lib/09-harness/claude-howto/zh-01-slash-commands)
- [02-memory/README.md](/lib/09-harness/claude-howto/zh-02-memory)
...
#### 下一步
- 阅读：[08-checkpoints/README.md](/lib/09-harness/claude-howto/zh-08-checkpoints)
- 阅读：[10-cli/README.md](/lib/09-harness/claude-howto/zh-10-cli)
...
- [ ] 会创建和使用 slash commands（[01-slash-commands/README.md](/lib/09-harness/claude-howto/zh-01-slash-commands)）
- [ ] 会通过 `CLAUDE.md` 设置项目 memory（[02-memory/README.md](/lib/09-harness/claude-howto/zh-02-memory)）
- [ ] 知道如何创建和恢复 checkpoints（[08-checkpoints/README.md](/lib/09-harness/claude-howto/zh-08-checkpoints)）
- [ ] 会在命令行使用 `claude` 和 `claude -p`（[10-cli/README.md](/lib/09-harness/claude-howto/zh-10-cli)）
...
- 创建你自己的 custom skill
- 为工作流增加更多 hooks
- 阅读：[03-skills/README.md](/lib/09-harness/claude-howto/zh-03-skills)
- 阅读：[06-hooks/README.md](/lib/09-harness/claude-howto/zh-06-hooks)
...
- 阅读：[05-mcp/README.md](/lib/09-harness/claude-howto/zh-05-mcp)
- 阅读：[04-subagents/README.md](/lib/09-harness/claude-howto/zh-04-subagents)
...
- [ ] 会创建并自动触发 skills（[03-skills/README.md](/lib/09-harness/claude-howto/zh-03-skills)）
- [ ] 会配置 hooks 做事件驱动自动化（[06-hooks/README.md](/lib/09-harness/claude-howto/zh-06-hooks)）
- [ ] 会配置 MCP servers 访问外部数据（[05-mcp/README.md](/lib/09-harness/claude-howto/zh-05-mcp)）
- [ ] 知道如何用 subagents 分派任务（[04-subagents/README.md](/lib/09-harness/claude-howto/zh-04-subagents)）
...
#### 下一步
- 阅读：[09-advanced-features/README.md](/lib/09-harness/claude-howto/zh-09-advanced-features)
...
3. 阅读：[01-slash-commands/README.md](/lib/09-harness/claude-howto/zh-01-slash-commands)
...
### 🟢 Level 1：Beginner
- [ ] 完成 [01-slash-commands](/lib/09-harness/claude-howto/zh-01-slash-commands)
- [ ] 完成 [02-memory](/lib/09-harness/claude-howto/zh-02-memory)
- [ ] 创建第一个自定义 slash command
- [ ] 设置项目 memory
- [ ] **达到里程碑 1A**
- [ ] 完成 [08-checkpoints](/lib/09-harness/claude-howto/zh-08-checkpoints)
- [ ] 完成 [10-cli](/lib/09-harness/claude-howto/zh-10-cli) 基础部分
- [ ] 创建并回退到一个 checkpoint
- [ ] 使用交互模式和 print mode
- [ ] **达到里程碑 1B**

### 🔵 Level 2：Intermediate
- [ ] 完成 [03-skills](/lib/09-harness/claude-howto/zh-03-skills)
- [ ] 完成 [06-hooks](/lib/09-harness/claude-howto/zh-06-hooks)
- [ ] 安装第一个 skill
- [ ] 设置 PreToolUse hook
- [ ] **达到里程碑 2A**
- [ ] 完成 [05-mcp](/lib/09-harness/claude-howto/zh-05-mcp)
- [ ] 完成 [04-subagents](/lib/09-harness/claude-howto/zh-04-subagents)
- [ ] 连接 GitHub MCP
- [ ] 创建自定义 subagent
- [ ] 把多个集成组合进一个工作流
- [ ] **达到里程碑 2B**
...
### 🔴 Level 3：Advanced
- [ ] 完成 [09-advanced-features](/lib/09-harness/claude-howto/zh-09-advanced-features)
- [ ] 成功使用 planning mode
...
- [ ] **达到里程碑 3A**
- [ ] 完成 [07-plugins](/lib/09-harness/claude-howto/zh-07-plugins)
- [ ] 完成 [10-cli](/lib/09-harness/claude-howto/zh-10-cli) 的高级用法
...
### 难题 2：“不知道什么时候该用哪个功能”
**解决**：回到主 README 里的 [Use Case Matrix](/lib/09-harness/claude-howto/zh-2#你能用它做什么)。

### 难题 3：“配置没有生效”
**解决**：检查主 README 里的 [Troubleshooting](/lib/09-harness/claude-howto/zh-2#故障排查) 部分，并确认文件路径。

### 难题 4：“概念之间好像重叠”
**解决**：查看主 README 里的 [Feature Comparison](/lib/09-harness/claude-howto/zh-2#功能对比) 表，理解差异。
