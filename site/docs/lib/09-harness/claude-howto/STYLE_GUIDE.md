...
entryUrl: "https://github.com/luongnv89/claude-howto/blob/97bfb0685e03112ad39845889061d02cef6e534c/STYLE_GUIDE.md"
sourceRel: "STYLE_GUIDE.md"
rawUrl: "/raw/09-harness/claude-howto/STYLE_GUIDE.md"
sourceSha256: "5e62096740dfbfe0729a1f9579d62226faf119f23fa8a4e98b16652682f371b1"
pageSha256: "5e62096740dfbfe0729a1f9579d62226faf119f23fa8a4e98b16652682f371b1"
...
1. Logo (`` element with dark/light variants)
2. H1 title
...
```markdown
[Slash Commands](/lib/09-harness/claude-howto/01-slash-commands)
[Skills Guide](/lib/09-harness/claude-howto/03-skills)
[Memory Architecture](/lib/09-harness/claude-howto/02-memory#memory-architecture)
```
...
All documents that start with a logo use the `` element for dark/light mode support:
