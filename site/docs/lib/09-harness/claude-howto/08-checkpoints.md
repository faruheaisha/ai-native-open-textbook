...
- **[Advanced Features](/lib/09-harness/claude-howto/09-advanced-features)** - Planning mode and other advanced capabilities
...
- [Advanced Features Guide](/lib/09-harness/claude-howto/09-advanced-features) - Extended thinking and other capabilities
