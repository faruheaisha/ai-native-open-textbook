...
entryUrl: "https://github.com/walkinglabs/learn-harness-engineering/blob/77e7a3e21469dcbece2558086c8d91657abeaa40/docs/zh/projects/project-06-runtime-observability-and-debugging/index.md"
sourceRel: "docs/zh/projects/project-06-runtime-observability-and-debugging/index.md"
rawUrl: "/raw/09-harness/learn-harness-engineering/docs/zh/projects/project-06-runtime-observability-and-debugging/index.md"
sourceSha256: "77edc45d0e52733a006c0f51526bba8f23d09b15925e8732c43098909fc49a95"
pageSha256: "77edc45d0e52733a006c0f51526bba8f23d09b15925e8732c43098909fc49a95"
...
> 相关讲义：[L11. 为什么可观测性属于 harness](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-11-why-observability-belongs-inside-the-harness) · [L12. 为什么每次会话都要留干净状态](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-12-why-every-session-must-leave-a-clean-state)
...
- [Lecture 01 — 为什么强 agent 仍然失败](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-01-why-capable-agents-still-fail)
- [Lecture 03 — 为什么仓库必须成为唯一事实来源](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-03-why-the-repository-must-become-the-system-of-record)
- [Lecture 08 — 为什么 feature list 是 harness 的基础原语](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-08-why-feature-lists-are-harness-primitives)
- [Lecture 11 — 为什么可观测性属于 harness 的一部分](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-11-why-observability-belongs-inside-the-harness)
- [Lecture 12 — 为什么每个会话都必须留下干净状态](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-12-why-every-session-must-leave-a-clean-state)
