...
entryUrl: "https://github.com/walkinglabs/learn-harness-engineering/blob/77e7a3e21469dcbece2558086c8d91657abeaa40/docs/zh/projects/project-08-graph-engineering-first-graph/index.md"
sourceRel: "docs/zh/projects/project-08-graph-engineering-first-graph/index.md"
rawUrl: "/raw/09-harness/learn-harness-engineering/docs/zh/projects/project-08-graph-engineering-first-graph/index.md"
sourceSha256: "964c308ed3c1cfe5535fadc45646108ea8fb87d2b5b6ac2770c2be2d4cff97d0"
pageSha256: "964c308ed3c1cfe5535fadc45646108ea8fb87d2b5b6ac2770c2be2d4cff97d0"
...
> 相关讲义：[L14. 从单循环到图工程](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-14-graph-engineering)
...
- [Lecture 14 — 从单循环到图工程](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-14-graph-engineering)
- [Lecture 13 — 从手动驱动到自动循环](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-13-loop-engineering)（你的 loop 就是图里的一个节点；这个项目是把节点的内部结构摊开）
- [Lecture 09 — 为什么 agent 会提前宣告完成](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-09-why-agents-declare-victory-too-early)（验证节点为什么必须独立于实现节点，在图中是结构问题）
- [Lecture 11 — 为什么可观测性属于 harness 的一部分](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-11-why-observability-belongs-inside-the-harness)（图越复杂，越需要看到每个节点在做什么）
