...
> 相关讲义：[L01. 模型能力强，不等于执行可靠](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-01-why-capable-agents-still-fail-index) · [L02. Harness 到底是什么](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-02-what-a-harness-actually-is-index)
...
- [Lecture 02 — harness 到底是什么](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-02-what-a-harness-actually-is-index)
- [Lecture 06 — 为什么初始化需要单独一个阶段](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-06-why-initialization-needs-its-own-phase-index)
