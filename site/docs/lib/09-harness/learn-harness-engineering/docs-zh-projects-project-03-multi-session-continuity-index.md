...
> 相关讲义：[L05. 为什么长时任务会丢失上下文](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-05-why-long-running-tasks-lose-continuity-index) · [L06. 为什么初始化需要单独一个阶段](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-06-why-initialization-needs-its-own-phase-index)
...
- [Lecture 07 — 为什么 agent 总是做过头、做不完](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-07-why-agents-overreach-and-under-finish-index)
...
- [Lecture 09 — 为什么 agent 总是过早宣布胜利](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-09-why-agents-declare-victory-too-early-index)
- [Lecture 10 — 为什么端到端测试能改变结果](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-10-why-end-to-end-testing-changes-results-index)
