...
[`repo-template/`](/lib/09-harness/learn-harness-engineering/docs-zh-resources-openai-advanced-repo-template-index) 里提供了一套可直接复制的起步
结构，核心布局如下：
...
2. 一旦进入多模块、多轮会话、长期演化阶段，就把
   [`repo-template/`](/lib/09-harness/learn-harness-engineering/docs-zh-resources-openai-advanced-repo-template-index) 里的骨架复制到你的仓库。
...
[`sops/`](/lib/09-harness/learn-harness-engineering/docs-zh-resources-openai-advanced-sops-index) 把文章里的几张关键图，整理成可以逐步执行的标准流程：
