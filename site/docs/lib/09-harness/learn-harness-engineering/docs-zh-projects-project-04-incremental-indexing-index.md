...
> 相关讲义：[L07. 为什么 agent 会多做或少做](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-07-why-agents-overreach-and-under-finish-index) · [L08. 为什么功能清单是 harness 原语](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-08-why-feature-lists-are-harness-primitives-index)
