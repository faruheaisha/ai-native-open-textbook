...
- 第十三讲：[从手动驱动到自动循环](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-13-loop-engineering-index) — loop 是图里的一个节点，先理解节点内部再理解图
- 第十一讲：[让 agent 的运行过程可观测](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-11-why-observability-belongs-inside-the-harness-index) — 图越复杂，可观测性越重要；无法观测的图只是把黑盒拼成了更大的黑盒
- 第九讲：[防止 agent 提前宣告完成](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-09-why-agents-declare-victory-too-early-index) — 验证节点为什么必须独立于实现节点，在图中这是结构问题而非提示词问题
