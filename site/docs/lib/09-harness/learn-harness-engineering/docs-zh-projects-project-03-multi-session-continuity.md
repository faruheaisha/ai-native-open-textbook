...
entryUrl: "https://github.com/walkinglabs/learn-harness-engineering/blob/77e7a3e21469dcbece2558086c8d91657abeaa40/docs/zh/projects/project-03-multi-session-continuity/index.md"
sourceRel: "docs/zh/projects/project-03-multi-session-continuity/index.md"
rawUrl: "/raw/09-harness/learn-harness-engineering/docs/zh/projects/project-03-multi-session-continuity/index.md"
sourceSha256: "93c80411738c845495e062bf72a9bcff05717e52331df0a8b6121dfcda4f4dcc"
pageSha256: "93c80411738c845495e062bf72a9bcff05717e52331df0a8b6121dfcda4f4dcc"
...
> 相关讲义：[L05. 为什么长时任务会丢失上下文](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-05-why-long-running-tasks-lose-continuity) · [L06. 为什么初始化需要单独一个阶段](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-06-why-initialization-needs-its-own-phase)
...
- [Lecture 07 — 为什么 agent 总是做过头、做不完](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-07-why-agents-overreach-and-under-finish)
...
- [Lecture 09 — 为什么 agent 总是过早宣布胜利](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-09-why-agents-declare-victory-too-early)
- [Lecture 10 — 为什么端到端测试能改变结果](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-10-why-end-to-end-testing-changes-results)
