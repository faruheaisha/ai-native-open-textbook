...
> 相关讲义：[L11. 为什么可观测性属于 harness](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-11-why-observability-belongs-inside-the-harness-index) · [L12. 为什么每次会话都要留干净状态](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-12-why-every-session-must-leave-a-clean-state-index)
...
- [Lecture 01 — 为什么强 agent 仍然失败](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-01-why-capable-agents-still-fail-index)
- [Lecture 03 — 为什么仓库必须成为唯一事实来源](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-03-why-the-repository-must-become-the-system-of-record-index)
- [Lecture 08 — 为什么 feature list 是 harness 的基础原语](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-08-why-feature-lists-are-harness-primitives-index)
- [Lecture 11 — 为什么可观测性属于 harness 的一部分](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-11-why-observability-belongs-inside-the-harness-index)
- [Lecture 12 — 为什么每个会话都必须留下干净状态](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-12-why-every-session-must-leave-a-clean-state-index)
