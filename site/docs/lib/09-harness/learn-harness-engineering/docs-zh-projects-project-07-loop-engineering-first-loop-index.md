...
> 相关讲义：[L13. 从手动驱动到自动循环](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-13-loop-engineering-index)
...
- [Lecture 13 — 从手动驱动到自动循环](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-13-loop-engineering-index)
- [Lecture 12 — 为什么每次会话都必须留下干净状态](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-12-why-every-session-must-leave-a-clean-state-index)（loop 的每一轮都需要 clean state）
- [Lecture 11 — 为什么可观测性属于 harness 的一部分](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-11-why-observability-belongs-inside-the-harness-index)（你需要看到 loop 内部在发生什么）
- [Lecture 05 — 为什么状态文件是跨会话连续性的核心](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-05-why-long-running-tasks-lose-continuity-index)（loop 状态文件是 state file 的延伸）
