...
> 相关讲义：[L03. 让代码仓库成为唯一的事实来源](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-03-why-the-repository-must-become-the-system-of-record-index) · [L04. 为什么一个巨大的指令文件会失败](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-04-why-one-giant-instruction-file-fails-index)
...
- [Lecture 04 — 为什么一个大而全的指令文件不行](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-04-why-one-giant-instruction-file-fails-index)
- [Lecture 05 — 为什么长任务会丢失连续性](/lib/09-harness/learn-harness-engineering/docs-zh-lectures-lecture-05-why-long-running-tasks-lose-continuity-index)
