...
权限管理和**沙盒**（Sandbox）本质上是同一个概念。想深入可以看 [OpenAI 官方文档](https://developers.openai.com/codex/concepts/sandboxing#how-you-control-it) 或者 [沙盒与审批](https://github.com/freestylefly/CodexGuide/blob/f93c14ba1239178f63210c7e2e6e6965ebf59e79/docs/advanced/07-sandbox-approvals.html) 以了解更多。
...
下一步：[Automation](/lib/09-harness/codex-guide-freestylefly/docs-advanced-05-automation)。
