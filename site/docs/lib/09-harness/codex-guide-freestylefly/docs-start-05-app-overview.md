...
entryUrl: "https://github.com/freestylefly/CodexGuide/blob/f93c14ba1239178f63210c7e2e6e6965ebf59e79/docs/start/05-app-overview.md"
sourceRel: "docs/start/05-app-overview.md"
rawUrl: "/raw/09-harness/codex-guide-freestylefly/docs/start/05-app-overview.md"
sourceSha256: "4599ee231541d65f2da68fe83d37ff456b4be152f5f5f1174772595d5b88bb0e"
pageSha256: "4599ee231541d65f2da68fe83d37ff456b4be152f5f5f1174772595d5b88bb0e"
...
<div class="setting-card-grid">
  ...
  <section class="setting-card">
    <div class="setting-card-body">
      ...
      <ul>
        <li><strong>自定义 config.toml 设置</strong>：Codex 的核心配置文件。详情见：<a href="https://github.com/freestylefly/CodexGuide/blob/f93c14ba1239178f63210c7e2e6e6965ebf59e79/docs/advanced/09-config-toml.html">config.toml 参考</a></li>
...
<div class="setting-card-grid">
  <section class="setting-card">
    ...
    <div class="setting-card-recommend"><strong>推荐配置选项</strong>：根据项目需要配置 MCP。更多请看<a href="https://github.com/freestylefly/CodexGuide/blob/f93c14ba1239178f63210c7e2e6e6965ebf59e79/docs/advanced/03-skills-plugins-mcp.html">技能与插件</a>。</div>
  </section>
...
<div class="setting-card-grid">
  <section class="setting-card">
    <div class="setting-card-body">
      <strong>钩子</strong>
      <p>在 Codex 的生命周期事件中运行自定义脚本。可用于日志、提示检查、记忆整理、验证检查和按目录调整提示。详情见：<a href="https://github.com/freestylefly/CodexGuide/blob/f93c14ba1239178f63210c7e2e6e6965ebf59e79/docs/advanced/06-hooks.html">Hooks</a>。</p>
    </div>
...
下一步：[用 Codex 完成第一个任务](/lib/09-harness/codex-guide-freestylefly/docs-start-06-first-task)。
