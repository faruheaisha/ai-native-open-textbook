...
- `ContextCompactionMiddleware`: manages conversation context when token limits are approached. See [Context Compaction](https://github.com/china-qijizhifeng/agentic-harness-engineering/blob/8b2a55d97590363fe50c3cc6b5e833b020a4bb4c/agents/evolve_agent/skills/nexau-evolution-guide/reference/context_compaction.md) for details.
...
- See [RFC-0003](https://github.com/china-qijizhifeng/agentic-harness-engineering/blob/8b2a55d97590363fe50c3cc6b5e833b020a4bb4c/agents/evolve_agent/skills/rfcs/0003-llm-failover-middleware.md) for the full design rationale
...
Tools like `execute_bash` already perform their own [output truncation](/lib/09-harness/agentic-harness-engineering/agents-evolve_agent-skills-nexau-evolution-guide-reference-sandbox#bash-output-truncation) at the sandbox level. Adding them to `bypass_tool_names` avoids double truncation.
