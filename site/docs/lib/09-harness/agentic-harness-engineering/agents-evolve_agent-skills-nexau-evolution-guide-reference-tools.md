...
The `execute_bash` command automatically redirects stdout/stderr to temporary files and truncates the output when it exceeds a configurable threshold. This is handled at the sandbox level — see [Sandbox — Bash Output Truncation](https://github.com/china-qijizhifeng/agentic-harness-engineering/blob/8b2a55d97590363fe50c3cc6b5e833b020a4bb4c/agents/evolve_agent/skills/nexau-evolution-guide/advanced-guides/sandbox.md#bash-output-truncation) for configuration details.
...
See [Middleware Hooks — LongToolOutputMiddleware](https://github.com/china-qijizhifeng/agentic-harness-engineering/blob/8b2a55d97590363fe50c3cc6b5e833b020a4bb4c/agents/evolve_agent/skills/nexau-evolution-guide/advanced-guides/hooks.md#longtooloutputmiddleware) for full configuration reference.
...
Refer to [Skills](https://github.com/china-qijizhifeng/agentic-harness-engineering/blob/8b2a55d97590363fe50c3cc6b5e833b020a4bb4c/agents/evolve_agent/skills/nexau-evolution-guide/advanced-guides/skills.md) for details about the Skill mechanism.
