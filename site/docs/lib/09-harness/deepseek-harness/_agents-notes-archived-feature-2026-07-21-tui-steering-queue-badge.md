---
title: "Agent Note: TUI status line badges queued steering messages"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-07-21-tui-steering-queue-badge.md"
sourceRel: ".agents/notes/archived/feature/2026-07-21-tui-steering-queue-badge.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/feature/2026-07-21-tui-steering-queue-badge.md"
sourceSha256: "9aabd68c8910fdc7e7b05674492ddb8dc9285dd691fe554adcb84026fb846cc8"
pageSha256: "9aabd68c8910fdc7e7b05674492ddb8dc9285dd691fe554adcb84026fb846cc8"
...
English | [中文](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-07-21-tui-steering-queue-badge.zh)

## Problem

While a turn runs, an editor submission calls `agent.steer()` and joins the steering queue behind the running turn ([front-door Agent Note](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-07-17-dedicated-full-screen-tui-front-door)). The running status line ended only with the `Enter sends steering, Esc cancels` hint, so pressing Enter gave no feedback that the message landed or how many were waiting to reach the model. A user steering several times could not tell the queue from a dropped keystroke.
...
- The running status line composes through `formatTurnStatus`, which inserts a `$\{queued\} queued · ` badge before the `Enter sends steering, Esc cancels` hint when `queued > 0` and shows the plain hint at zero; the phase label and elapsed timing before it are the [verbose status line](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-07-21-tui-verbose-status-line)'s.
