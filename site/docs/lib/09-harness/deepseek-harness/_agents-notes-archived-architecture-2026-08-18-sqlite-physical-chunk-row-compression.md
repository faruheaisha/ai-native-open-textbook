---
title: "Agent Note: SQLite physical chunk-row compression"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-08-18-sqlite-physical-chunk-row-compression.md"
sourceRel: ".agents/notes/archived/architecture/2026-08-18-sqlite-physical-chunk-row-compression.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/architecture/2026-08-18-sqlite-physical-chunk-row-compression.md"
sourceSha256: "4fe241f1b272278d9f3ca1a4431971220e1fa54411df043826ef6f59225bf949"
pageSha256: "4fe241f1b272278d9f3ca1a4431971220e1fa54411df043826ef6f59225bf949"
...
English | [中文](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-18-sqlite-physical-chunk-row-compression.zh)

## Problem

The scalar [`session-persistence-sqlite`](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/packages/session/session-persistence-sqlite/README.md) layout stores one physical row per logical `SessionEvent`. Provider streams produce token-sized `assistant/chunk` events with repeated turn, step, block, type, and envelope fields, so transaction batching reduces commits without reducing row count or repeated JSON payload. The logical stream cannot be coalesced because chunk boundaries, sequence numbers, timestamps, replay, partial output, UI fidelity, and `sourceEventSeqs` remain observable.
...
The [JSONL packed-row decision](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-07-26-packed-chunk-rows-by-default), [bounded persistence batching](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-08-bounded-session-persistence-write-batching), and original [session-persistence decision](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-06-14-session-persistence.md) remain active: they respectively own the JSONL format, write scheduling, and backend-neutral service semantics.
