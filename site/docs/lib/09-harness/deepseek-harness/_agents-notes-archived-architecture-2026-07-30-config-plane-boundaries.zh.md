---
title: "Agent Note: 配置面暴露什么，以及谁有权覆盖什么"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-07-30-config-plane-boundaries.zh.md"
sourceRel: ".agents/notes/archived/architecture/2026-07-30-config-plane-boundaries.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/architecture/2026-07-30-config-plane-boundaries.zh.md"
sourceSha256: "8cc0c48a73aae63201e1225980c675c72b9277ea6056acf104e8073468b8bef9"
pageSha256: "8cc0c48a73aae63201e1225980c675c72b9277ea6056acf104e8073468b8bef9"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-07-30-config-plane-boundaries) | 中文

> 范围：对 [Web 配置面](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-07-30-web-config-plane.zh)的边界加固——哪些 namespace 能抵达协议、哪些调用方能抵达它们，以及一个只持有局部且可能陈旧的视图的编辑器该如何写入，才不会毁掉它看不见的东西。

> 调用方边界、脱敏与 revision 设栅依然有效。把「哪些 namespace 能抵达协议」限制为可配置提供方目录这一条，已被[由插件自己拥有的设置表层](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-12-plugin-owned-settings-surface.zh)取代——后者服务每一个已注册的 namespace。
