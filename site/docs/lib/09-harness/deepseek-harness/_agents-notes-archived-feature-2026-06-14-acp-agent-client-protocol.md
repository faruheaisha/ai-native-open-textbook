---
title: "Agent Note: Agent Client Protocol (ACP) support — drive the coding agent from external editors"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-06-14-acp-agent-client-protocol.md"
sourceRel: ".agents/notes/archived/feature/2026-06-14-acp-agent-client-protocol.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/feature/2026-06-14-acp-agent-client-protocol.md"
sourceSha256: "6828c0af74bb3fb96206ca6b21c0e56a000b50e4744aad4bc2c05092f3a5a31b"
pageSha256: "6828c0af74bb3fb96206ca6b21c0e56a000b50e4744aad4bc2c05092f3a5a31b"
...
English | [中文](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-06-14-acp-agent-client-protocol.zh)

> Superseded by [ACP as an automation-only protocol](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/simplification/2026-07-23-acp-automation-only-protocol.md). This note records the retired editor-facing bridge design.
...
Permission handling is an answerer on the [user-approval seam](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-07-06-approval-seam.md), not an ask-every-tool policy in ACP. An `approval/request` for a bridge-owned agent with a call id becomes `session/request_permission` on that agent's editor session, with one-shot allow/reject choices. Foreign or call-less requests delegate; a missing or failed answerer remains fail-closed. The plugin that asks—such as a pre-execute policy or bash escalation—owns the decision to ask.
...
The current protocol contract lives in the [`dsh-acp` package README](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/packages/acp/acp/README.md).
