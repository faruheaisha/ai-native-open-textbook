---
title: "Agent Note: headless is a direct core entry point"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-08-09-headless-direct-core-entry-point.md"
sourceRel: ".agents/notes/archived/architecture/2026-08-09-headless-direct-core-entry-point.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/architecture/2026-08-09-headless-direct-core-entry-point.md"
sourceSha256: "ce32a3cf4e1bdd3e2f5b6c8a2be2e084763f4745cf6b575ef29a405f4230a87e"
pageSha256: "ce32a3cf4e1bdd3e2f5b6c8a2be2e084763f4745cf6b575ef29a405f4230a87e"
...
English | [中文](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-09-headless-direct-core-entry-point.zh)

## Problem

The `headless` product contract is one local task with final assistant text on stdout, a success-sensitive exit code, no listening port, and the stderr reasoning projection owned by [headless reasoning progress](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-08-21-headless-reasoning-progress.md). A composition containing Workspace Host services, browser RPC, HTTP, the Web runtime, or browser plugins contradicts that contract and makes local completion depend on an unrelated transport tree.
...
This note owns the headless transport and completion contracts; [headless reasoning progress](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-08-21-headless-reasoning-progress.md) owns successful stderr output. [Apps own their command lines](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-06-app-owned-command-line) owns the current `dsh --profile headless` grammar; the former [`dsh run` decision](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-08-08-dsh-run-headless-command.md) records the superseded launcher-owned grammar, [web config-tree boot and transport layering](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-07-24-web-config-tree-boot-and-transport-layering.md) owns the Web tree, and [the default model follows the picker](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-08-07-default-model-follows-the-picker.md) owns persistence of the shared Agent default.
