---
title: "Agent Note: 窄视口下 Plan chip 点击区域回归测试"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-08-06-plan-narrow-viewport-regression.zh.md"
sourceRel: ".agents/notes/archived/bug-fix/2026-08-06-plan-narrow-viewport-regression.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/bug-fix/2026-08-06-plan-narrow-viewport-regression.zh.md"
sourceSha256: "be10805f0cd5a4f0812c883ab7f3e1e9396b579be455696d5cd726434a26b3e1"
pageSha256: "be10805f0cd5a4f0812c883ab7f3e1e9396b579be455696d5cd726434a26b3e1"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-08-06-plan-narrow-viewport-regression) | 中文
...
浏览器回归测试在当前 master 上复现了报告：800×720 下 Plan chip 与模型 trigger 重叠 36.9px，chip 中心命中 trigger 的 label。composer 控制行是 `display: flex; justify-content: space-between` 且 `.trailing \{ flex: none \}`：当控件总宽超过卡片时，可收缩的 `.tools` 组把流内子项留在 `min-width: 0` 的盒内，于是 chip——溢出前最后一个流内子项——被绘制到 trailing 组上方。报告以来 Plan 控件形态已变（select → chip，`c20b988166`/`fe91919346`），控制行也获得过自适应能力（`c8c75ec891`，[web-composer-shared-width-axis](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-08-04-web-composer-shared-width-axis.zh.md)），但该行没有换行，重叠在两次重构后依然存在。
