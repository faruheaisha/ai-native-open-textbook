---
title: "Agent Note: Web Worker VFS 监听与 CLI 兼容 confinement"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-08-23-webworker-vfs-watch-and-landlock.zh.md"
sourceRel: ".agents/notes/archived/architecture/2026-08-23-webworker-vfs-watch-and-landlock.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/architecture/2026-08-23-webworker-vfs-watch-and-landlock.zh.md"
sourceSha256: "b06ac34ba6e8b99c4812e98fea77c9f76f142d6113c54c1993ac30fa3c004554"
pageSha256: "b06ac34ba6e8b99c4812e98fea77c9f76f142d6113c54c1993ac30fa3c004554"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-23-webworker-vfs-watch-and-landlock) | 中文
...
文件系统兼容边界遵循 [Worker Node face 决策](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-20-webworker-node-face.zh)：纯 JavaScript watcher 包在 Node 兼容模块之上保持原样运行。Native 或 binary 包可以保持公开 JavaScript API 与可执行文件协议，同时替换执行后端。无法维持调用方可见 Node 行为的 API 继续明确标记为不可用；`node:vm` 不属于本决策范围。
