---
title: "Agent Note: token-meter surface fold 改为 plan/commit 两段式原地提交"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-08-24-token-meter-surface-fold-plan-commit.zh.md"
sourceRel: ".agents/notes/archived/bug-fix/2026-08-24-token-meter-surface-fold-plan-commit.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/bug-fix/2026-08-24-token-meter-surface-fold-plan-commit.zh.md"
sourceSha256: "df7814c9a8909b1fd3b30606cc559c0bbac3f12e9a167eca6891bc646a6a1c7a"
pageSha256: "df7814c9a8909b1fd3b30606cc559c0bbac3f12e9a167eca6891bc646a6a1c7a"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-08-24-token-meter-surface-fold-plan-commit) | 中文
...
该 fold 不再为长会话 append 成本贡献二次项；meter 剩余的每事件成本是 `_sync` 中的 `Session.events` 快照读取（由索引化日志读取工作独立解决，PR #1724/#2907）与固有的 O(内容) 估价。旧的分离结果类型 `SurfaceTokenFold` 已移除；`surface-fold.ts` 为包内部模块，无外部消费者需要变更。[composer 上下文仪表笔记](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-08-05-composer-context-meter-breakdown.zh.md)记录了该 fold 周边的投影设计。
