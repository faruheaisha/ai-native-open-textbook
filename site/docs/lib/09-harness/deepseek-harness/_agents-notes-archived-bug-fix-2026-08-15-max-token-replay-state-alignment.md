---
title: "Agent Note: Replay state aligns with assembled content by construction"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-08-15-max-token-replay-state-alignment.md"
sourceRel: ".agents/notes/archived/bug-fix/2026-08-15-max-token-replay-state-alignment.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/bug-fix/2026-08-15-max-token-replay-state-alignment.md"
sourceSha256: "a9a519d8fdcd4d9fcc57adc0039d4d7bca8fd3f4d6e65910f2a280aa1494a785"
pageSha256: "a9a519d8fdcd4d9fcc57adc0039d4d7bca8fd3f4d6e65910f2a280aa1494a785"
...
English | [中文](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-08-15-max-token-replay-state-alignment.zh)
...
Continuing after a max-token response that included a tool call works, retains the kept blocks' native signatures, and replays as a native pi-ai message. Sessions recorded before this change replay their affected assistant messages as provider-neutral content (with a diagnostic) instead of failing the turn; on-disk `replayState` values changed shape under the pre-release no-compatibility stance, with the old flat form handled by the same degrade path. This supersedes the read-time hard-error rule in the [provider-routed adapter decision](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-07-14-provider-routed-llm-adapters.md) for unusable state; validation itself is unchanged and still precedes any native reconstruction.
