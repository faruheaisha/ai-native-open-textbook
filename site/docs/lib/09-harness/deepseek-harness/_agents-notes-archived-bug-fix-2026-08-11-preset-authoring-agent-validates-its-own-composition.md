---
title: "Agent Note: The preset-authoring agent mount-validates its own composition"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-08-11-preset-authoring-agent-validates-its-own-composition.md"
sourceRel: ".agents/notes/archived/bug-fix/2026-08-11-preset-authoring-agent-validates-its-own-composition.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/bug-fix/2026-08-11-preset-authoring-agent-validates-its-own-composition.md"
sourceSha256: "1c4902ad59b216e7f8d44b7250d4a1c1512e52ccc045a71a0dd333119dee3d52"
pageSha256: "1c4902ad59b216e7f8d44b7250d4a1c1512e52ccc045a71a0dd333119dee3d52"
...
English | [中文](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-08-11-preset-authoring-agent-validates-its-own-composition.zh)
...
- A successful validation leaves a standing generation that is never reclaimed, which is the [standing-mount](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-08-per-preset-standing-mounts) cost the roster already carries per generation — the agent pays it once at the end of an edit instead of the user paying it at the first session.
...
Supersedes the creator-guidance bullet in [broken presets are roster rows](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-08-09-broken-preset-roster-rows), whose health-check decision remains current — this note reverses only its "the agent cannot start sessions; the settings page's red marking is the user's check" conclusion. Authoring's copy-only shape is owned by [copy-only preset authoring](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/simplification/2026-08-08-copy-only-preset-authoring.md).
