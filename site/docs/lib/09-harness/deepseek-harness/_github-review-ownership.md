---
title: "Pull-request approval policy"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.github/review-ownership/README.md"
sourceRel: ".github/review-ownership/README.md"
rawUrl: "/raw/09-harness/deepseek-harness/.github/review-ownership/README.md"
sourceSha256: "aadbdd50b73fb609725b1ff8c4520648a49d6beadaaa106dab83f2e4760d8e9b"
pageSha256: "aadbdd50b73fb609725b1ff8c4520648a49d6beadaaa106dab83f2e4760d8e9b"
...
The [`weighted-approval` workflow](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.github/workflows/weighted-approval.yml) publishes an approval score for branch rules. Reviewer selection and review requests remain manual.
...
Reviewers whose calculated base repository permission is `write` or `admin` count. The [approval policy](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.github/review-ownership/approval-policy.json) gives `@07akioni`, `@imccyu`, `@tianyicui`, `@tianyicui-bot`, `@turtle1999`, and `@turtle2099` two points each; every other write-capable reviewer gets one point. The pull-request author and reviewers without write permission do not count.
