...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-06-20-package-hierarchy.zh.md"
sourceRel: ".agents/notes/archived/architecture/2026-06-20-package-hierarchy.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/architecture/2026-06-20-package-hierarchy.zh.md"
sourceSha256: "40eec478cc5ff8ae76996e567d1f58309ed71b3bf0068ee06b088deae283512a"
pageSha256: "40eec478cc5ff8ae76996e567d1f58309ed71b3bf0068ee06b088deae283512a"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-06-20-package-hierarchy) | 中文

[冗余 agent 移除](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/simplification/2026-07-20-remove-stdio-and-echo-agents.md)直接删除最初的 `support/ui-stdio` 接口，而不是将其迁移；[仅面向自动化的 ACP 决策](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/simplification/2026-07-23-acp-automation-only-protocol.md)把 ACP 放在 `packages/acp/acp` 下，而不是面向人类的 UI 组。这里拥有的决策仍是统一的二层目录深度。
...
- 聚合配置的 project `references` 仍为显式列表——TypeScript project references 没有通配符形式。从 manifest（元数据清单）生成这些引用留作后续工作（见[通过发现机制获取包清单](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/proposed/process/2026-06-20-discover-package-inventory.md)）。
