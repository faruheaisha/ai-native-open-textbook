...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-08-11-owned-run-finish-reason.zh.md"
sourceRel: ".agents/notes/archived/bug-fix/2026-08-11-owned-run-finish-reason.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/bug-fix/2026-08-11-owned-run-finish-reason.zh.md"
sourceSha256: "168388201eb7d7518966c0a02da43e337376f53fb7f72b7b40ecf07cae16fbd7"
pageSha256: "168388201eb7d7518966c0a02da43e337376f53fb7f72b7b40ecf07cae16fbd7"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-08-11-owned-run-finish-reason) | 中文
...
`RunResult.finish_reason` 是从已提交消息进入持久 inbox 的回执开始、到整个 agent 下一次进入 idle 为止所收集的根会话最后一个 `turn/end` 的字符串 `kind`。如果该区间没有 `turn/end`，字段为 `None`。缺少字符串 `data.reason.kind` 的 `turn/end` 会抛出 `SdkProtocolError`，而不会报告为区间内没有轮次结束。该字段描述自有运行区间；它不会把这个结束原因归属于已提交的提示词。[自有运行边界决策](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-07-30-followup-enqueue-and-owned-runs.zh.md)仍禁止提示词级结果归因。
