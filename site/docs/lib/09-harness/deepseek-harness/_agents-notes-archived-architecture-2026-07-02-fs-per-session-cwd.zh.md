---
title: "Agent Note: 相对文件系统路径按调用方的会话 cwd 解析"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-07-02-fs-per-session-cwd.zh.md"
sourceRel: ".agents/notes/archived/architecture/2026-07-02-fs-per-session-cwd.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/architecture/2026-07-02-fs-per-session-cwd.zh.md"
sourceSha256: "5b94169db27342f96d3d90a5af7841bc548035ce2711d5afce25e9f2d05d1e39"
pageSha256: "5b94169db27342f96d3d90a5af7841bc548035ce2711d5afce25e9f2d05d1e39"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-07-02-fs-per-session-cwd) | 中文

## 问题

ACP（Agent Client Protocol）桥接层为每个会话提供独立的工作区：`session/new` 将自动化客户端的项目目录记录为 `SessionHeader.cwd`，`dsh-tool-bash` 将每次 bash 调用的 `workdir` 默认设为调用方 agent（智能体）的 `session.header.cwd`（见 [ACP 包](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/packages/acp/acp/README.md) 与 `dsh-tool-bash` 中的 `resolveWorkdir`）。因此会话 A 中的 bash 命令在 A 的项目目录执行，会话 B 中的在 B 的项目目录执行——一个服务器进程，N 个工作区。
