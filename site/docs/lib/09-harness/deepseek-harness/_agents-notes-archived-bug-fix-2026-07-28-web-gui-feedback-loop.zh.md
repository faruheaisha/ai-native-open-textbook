---
title: "Agent Note: Web GUI 改动在现有 URL 上闭环"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-07-28-web-gui-feedback-loop.zh.md"
sourceRel: ".agents/notes/archived/bug-fix/2026-07-28-web-gui-feedback-loop.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/bug-fix/2026-07-28-web-gui-feedback-loop.zh.md"
sourceSha256: "4f04d6f08cf32185c37ff31e4fdd785feb6318688f931747f9505cd9b8234d85"
pageSha256: "4f04d6f08cf32185c37ff31e4fdd785feb6318688f931747f9505cd9b8234d85"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-07-28-web-gui-feedback-loop) | 中文

## 问题

Web agent（智能体）既无法识别承载当前会话的 GUI，也不知道用户正在查看哪个 URL。[运行时上下文决策](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-07-28-web-agent-runtime-context.zh)提供前一项事实，但 GUI 编辑仍然没有可执行的验收目标：源码编辑、产物构建、监听中的进程与用户已打开的页面只是互不关联的观察结果。仓库提供的入口让错误的替代方案显得合理，因为 `apps/web/package.json` 将 `vite` 暴露为 `dev` 脚本，而裸 Vite 即使无法注入 `window.__DSH_BOOT__`，仍会返回 HTTP 200。

[事故复盘](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/docs/postmortem/0003-web-agent-gui-feedback-loop.zh.md)集中记录事件日志时间线，并解释原有检查为何会接受错误的页面、进程和端口。
