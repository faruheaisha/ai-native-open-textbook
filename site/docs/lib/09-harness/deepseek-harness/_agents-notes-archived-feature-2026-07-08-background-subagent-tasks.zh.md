---
title: "Agent Note: 后台 subagent 任务"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-07-08-background-subagent-tasks.zh.md"
sourceRel: ".agents/notes/archived/feature/2026-07-08-background-subagent-tasks.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/feature/2026-07-08-background-subagent-tasks.zh.md"
sourceSha256: "7eb45fcaf7c647fd1687ad2ea632301040250b32ffbc0a8aca3538c910272b76"
pageSha256: "7eb45fcaf7c647fd1687ad2ea632301040250b32ffbc0a8aca3538c910272b76"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-07-08-background-subagent-tasks) | 中文

## 问题

[subagent seam](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-06-21-subagent-capability-seam.zh.md) 会返回 `SubagentRun`，但原先面向模型的工具会同步收集每一次运行。因此，各自独立的慢速委派要么一直占用父调用，要么按串行方式运行。
...
后台 subagent 使用[通用后台任务运行时](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-06-20-generic-long-running-tool-runtime.zh.md)。`job_output`、`job_list` 和 `job_kill` 负责收集、列出、取消、完成通知和提示词引导；系统不提供 subagent 专用的配套工具。

前台调用保留其同步约定：等待提供方启动和 `run.result`；仅当状态为 `completed` 时返回最终文本；将其他终止原因映射为出错的工具结果，并在存在时附上由[非交互权限决策](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-08-15-product-subagent-noninteractive-permissions.zh.md)描述的可选安全诊断；而且始终在返回前释放该运行。
