---
title: "Agent Note: dsh-hooks-claude-code + dsh-hooks-codex — the Claude Code / Codex hook bridges"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-06-30-hook-bridges.md"
sourceRel: ".agents/notes/archived/feature/2026-06-30-hook-bridges.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/feature/2026-06-30-hook-bridges.md"
sourceSha256: "753421efb1d91de7adc573fa9717ee9eac0c88c0702067a4149b753aa109e68e"
pageSha256: "753421efb1d91de7adc573fa9717ee9eac0c88c0702067a4149b753aa109e68e"
...
English | [中文](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-06-30-hook-bridges.zh)

## Problem

The harness's extension surface is its typed interception points ([the interception extension-points Agent Note](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-06-30-interception-extension-points.md)): a "native hook" is just an ordinary cordis plugin subscribing to `agent/session-start`, `agent/pre-step`, `tools/pre-execute`, `tools/post-execute`, `agent/turn-stopping`, `subagent/start`, or `subagent/end`. But users arrive with **existing** Claude Code (CC) and Codex hook configs — a `hooks.json` (or a settings file's `hooks` key) full of shell-command hooks — and want those to run unmodified. This Agent Note introduces the two **bridge plugins** that translate that external shell-hook protocol onto the typed extension points, built on the shared wire-protocol library ([the hook-protocol-lib Agent Note](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-06-30-hook-protocol-lib)).
...
Two independent plugins in the `packages/hooks/` group, each a function/namespace plugin (`name`/`inject`/`Config`/`apply`, NO default export — see [postmortem 0001](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/docs/postmortem/0001-acp-default-export-drops-inject.md)) injecting only `bash`:
