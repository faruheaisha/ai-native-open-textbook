...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-08-12-plugin-owned-settings-surface.zh.md"
sourceRel: ".agents/notes/archived/architecture/2026-08-12-plugin-owned-settings-surface.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/architecture/2026-08-12-plugin-owned-settings-surface.zh.md"
sourceSha256: "57a1cde4261d1b7205e86553f58f554dd71e3edc83bcacf3e226549218374b2b"
pageSha256: "57a1cde4261d1b7205e86553f58f554dd71e3edc83bcacf3e226549218374b2b"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-12-plugin-owned-settings-surface) | 中文
...
两者相加，用户自己写的插件就只能靠手改 `settings.yaml` 来配置。[web 插件配置 note](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-08-10-web-plugin-configuration.zh.md) 把白名单记为刻意为之，[配置面边界 note](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-07-30-config-plane-boundaries.zh) 则把「可在 Web 上配置」绑定到可配置提供方目录的成员资格。这两条结论恰恰挡住了那个通用 seam 本来要服务的插件作者。
...
**标签页以被服务的命名空间驱动派发。** 它从 `ctx.settingsScope.describe()` 派生当前被服务的集合并跟随该共享 settings 镜像，自身的监听器只跟随卡片 slot 账本；随后为每个被服务的命名空间派发一个键。渲染出来的是两份账本的交集——存活 Host 插件注册的命名空间，以及注册在这些键上的卡片——由标签页的 controller 从 slot 账本（`ctx.slots.entries`、`ctx.slots.subscribe`）与镜像应答算出。后续的 [settings describe 镜像决策](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-17-settings-describe-mirror.zh)持有浏览器全局的读取与失效生命周期。
