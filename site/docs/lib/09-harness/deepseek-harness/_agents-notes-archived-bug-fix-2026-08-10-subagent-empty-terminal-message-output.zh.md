---
title: "Agent Note: 用同一条选取规则在空终止消息后保留子代理输出"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-08-10-subagent-empty-terminal-message-output.zh.md"
sourceRel: ".agents/notes/archived/bug-fix/2026-08-10-subagent-empty-terminal-message-output.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/bug-fix/2026-08-10-subagent-empty-terminal-message-output.zh.md"
sourceSha256: "f265027ec3318fb59b460ece17513436ba627c92145a75fb2f7098d7df05c4c6"
pageSha256: "f265027ec3318fb59b460ece17513436ba627c92145a75fb2f7098d7df05c4c6"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-08-10-subagent-empty-terminal-message-output) | 中文
...
前台委派工具使用同一选取规则。非 `completed` 的结果仍是 `isError` 工具结果，但其消息会在终止原因标题之后呈现由[非交互权限决策](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-08-15-product-subagent-noninteractive-permissions.zh.md)负责的可选安全提供方诊断，再附上子 agent 的部分文本。父模型会同时收到失败、独立的基础设施说明与已有 assistant 输出，而且不会把它们混为一体。
