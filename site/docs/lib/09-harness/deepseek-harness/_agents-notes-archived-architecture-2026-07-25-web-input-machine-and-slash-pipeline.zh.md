---
title: "Agent Note: Web 输入状态机、composer slot 与 slash 流水线（ui-conversation input / ui-input-trigger）"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-07-25-web-input-machine-and-slash-pipeline.zh.md"
sourceRel: ".agents/notes/archived/architecture/2026-07-25-web-input-machine-and-slash-pipeline.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/architecture/2026-07-25-web-input-machine-and-slash-pipeline.zh.md"
sourceSha256: "ba54a9e9fcc8a13fac3a7fe5f434a0e799cad910241655d820e219c7066d22de"
pageSha256: "ba54a9e9fcc8a13fac3a7fe5f434a0e799cad910241655d820e219c7066d22de"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-07-25-web-input-machine-and-slash-pipeline) | 中文

> 范围：输入状态机（claim 看护 + 提交事务）、hub/facade 与发送编排、跨插件输入改写的三个 scoped bail 事件、`/` 与 `@` 触发检测与菜单流水线（ui-input-trigger）、composer 周边 slot 体系。依赖[会话作用域 note](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-07-25-web-client-session-scope-and-provide-channel.zh.md)的 sctx / provide / session-maybe 与 blank 实体模型；命令知识（三型、目录、popup）零涉——那是[命令业务面 note](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-07-25-web-command-surfaces-and-assembly.zh)的领地。原决策的编辑面一半——textarea + occurrence 表、自管 undo log、粘贴匹配流水线与 backdrop 装饰——已由 [Lexical composer note](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-20-web-composer-lexical-editor.zh) 取代；本 note 仍拥有状态机的提交平面、bail 事件约定、触发流水线与 composer slot。
...
机器的编辑面一半——occurrence 表、自管 undo log、粘贴匹配 attempt 流水线与 `set-invalid`——已并入 Lexical 文档树及其 history（文档身份、位置映射与三投影归 [Lexical composer note](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-20-web-composer-lexical-editor.zh) 所有）。留在这里的是语义不变的提交平面：
...
| contenteditable / 富文本树 | 兼容性差；textarea + U+FFFC + occurrence 表覆盖全部交互约定——后被 [Lexical composer note](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-20-web-composer-lexical-editor.zh) 反转：textarea 栈的样式与身份成本被实测后翻案 |
