---
title: "Agent Note: 在提供方限制覆写上下文 diff 基础"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-07-30-bounded-overwrite-diff-basis.zh.md"
sourceRel: ".agents/notes/archived/bug-fix/2026-07-30-bounded-overwrite-diff-basis.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/bug-fix/2026-07-30-bounded-overwrite-diff-basis.zh.md"
sourceSha256: "8c12df7093870ab9a70639bf7512315faf079f052a1ddf80041097e4bf2acb34"
pageSha256: "8c12df7093870ab9a70639bf7512315faf079f052a1ddf80041097e4bf2acb34"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-07-30-bounded-overwrite-diff-basis) | 中文

## 问题

`dsh-fs-local` 会在 `FsWriteOutcome.before` 中返回完整旧文件，供消费方生成覆写上下文 diff。这个仅用于展示的预读没有上限：大文件覆写可能分配整个旧文件；而仅检查较早的路径 stat 也无法真正实施上限，因为外部进程可以在 stat 与读取之间替换文件或扩大文件。即使旧文件很小，大替换内容也会使上下文 hunk 接近替换内容本身的大小。本改动关闭了 [result-time applied-hunk diff](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-07-02-result-time-applied-hunk-diffs) 中记录的暂缓上限事项。
