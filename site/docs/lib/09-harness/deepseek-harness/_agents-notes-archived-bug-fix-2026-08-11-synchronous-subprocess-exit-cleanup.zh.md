---
title: "Agent Note: 宿主退出时同步清理受管子进程"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-08-11-synchronous-subprocess-exit-cleanup.zh.md"
sourceRel: ".agents/notes/archived/bug-fix/2026-08-11-synchronous-subprocess-exit-cleanup.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/bug-fix/2026-08-11-synchronous-subprocess-exit-cleanup.zh.md"
sourceSha256: "56f5ae9ce8014deb1c66fca64fd5503d9c2ae5368d4739bce4653424e2efd0cd"
pageSha256: "56f5ae9ce8014deb1c66fca64fd5503d9c2ae5368d4739bce4653424e2efd0cd"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-08-11-synchronous-subprocess-exit-cleanup) | 中文

## Problem

本地 subprocess provider拥有普通 detached进程树和 terminal session，但此前只能通过异步 Cordis dispose触及它们。致命 launcher可能在 dispose完成前调用 `process.exit()`：[fail-loud release](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-07-31-fail-loud-releases-the-terminal.zh.md)最多等待两秒，而本地进程可以拥有更长的终止宽限期。Node进入同步退出阶段后，待处理的 Promise与升级 timer不会继续执行，因此忽略 TERM的子进程可能比宿主存活更久，继续占用 CPU、内存或端口。部分 ACP、JSON-RPC和 SDK入口也没有 root release回调。
...
正常 dispose继续使用[subprocess seam](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-07-26-subprocess-seam.zh)的先终止再等待退出路径：普通进程树先接收 TERM，经过配置的宽限期后再接收 KILL，并等待每个普通或 terminal清理达到完全停稳。同步路径只请求最终终止，不发布完成结果，也不声称回调返回时 OS进程树已经消失。远程 provider继续由其 sandbox独立拥有，不继承本地 Node listener。
