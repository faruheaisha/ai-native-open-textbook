---
title: "Agent Note: Filesystem tool schemas — model-facing read/write/edit shapes"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-06-17-filesystem-tool-schemas.md"
sourceRel: ".agents/notes/archived/feature/2026-06-17-filesystem-tool-schemas.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/feature/2026-06-17-filesystem-tool-schemas.md"
sourceSha256: "063068decd8610c0fe6fa0cc56d1bb31e0256e3a9ec08c7454f8d97eae279037"
pageSha256: "063068decd8610c0fe6fa0cc56d1bb31e0256e3a9ec08c7454f8d97eae279037"
...
English | [中文](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-06-17-filesystem-tool-schemas.zh)

## Problem

[The filesystem capability-seam Agent Note](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-06-17-filesystem-capability-seam) defines the filesystem capability seam (`ctx.fs`), the package split (`dsh-fs`, `dsh-fs-local`, `dsh-tool-fs`, plus the `dsh-fs-observation-policy` policy plugin), and the observed-file/stale-version policy for read-before-write/edit checks — which the [split-fs-seam](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/simplification/2026-06-26-fsspec-style-fs-seam.md) and [event-gate](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-06-26-file-context-as-event-gate.md) Agent Notes moved off `ctx.fs` into the `dsh-fs-observation-policy` plugin on the `fs/*` event gate. The remaining decision for the first filesystem tool delivery is the model-facing schema: what arguments the model sees for `read`, `write`, and `edit`.
