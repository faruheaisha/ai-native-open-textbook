---
title: "Agent Note: 横幅整体扫入；副标题行移除"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-07-21-tui-banner-sweep.zh.md"
sourceRel: ".agents/notes/archived/feature/2026-07-21-tui-banner-sweep.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/feature/2026-07-21-tui-banner-sweep.zh.md"
sourceSha256: "91b98a38c1111a561072d749a985c023ecaef0d749d6c1aaa320bfe0034660bd"
pageSha256: "91b98a38c1111a561072d749a985c023ecaef0d749d6c1aaa320bfe0034660bd"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-07-21-tui-banner-sweep) | 中文

> **已被取代**：由[移除启动横幅 Agent Note](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-07-21-tui-no-banner)取代：横幅本身已移除，扫入动画随之移除。

## Problem

[启动 slogan Agent Note](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-07-20-tui-startup-slogans) 用随机 slogan 库加逐字打字机动画取代了说明书式的欢迎行。实际使用中这些引语显得怪异——工具头部出现随机的风味文案——而且动画很慢（每字符 40 ms，扫完一整句），却只动画四行横幅中的一行。本 note 取代该决定中 slogan 的那一半；移除示例配置中欢迎语的决定与动画生命周期的基础设施保持不变。
