---
title: "Agent Note: user-settings seam (ctx.settings) and the file provider"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-07-28-user-settings-seam.md"
sourceRel: ".agents/notes/archived/architecture/2026-07-28-user-settings-seam.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/architecture/2026-07-28-user-settings-seam.md"
sourceSha256: "fef7066e83abc23d57489df2f01bb21d12e3b211d59181c31b953d77eb1a6190"
pageSha256: "fef7066e83abc23d57489df2f01bb21d12e3b211d59181c31b953d77eb1a6190"
...
English | [中文](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-07-28-user-settings-seam.zh)

> Scope: the `packages/settings/` capability family — the Service Definition, the file-backed provider, and the composition boundary between user settings and `cordis.yml`. The [web config-tree note](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-07-24-web-config-tree-boot-and-transport-layering.md) recorded "the profile write path" as a deferral; this seam is that write path's owner. Consumer migrations (theme, locale, default model route) and the web `settings.*` RPC surface are follow-ups, not part of this note's shipped scope.
