...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-07-21-tui-no-banner.zh.md"
sourceRel: ".agents/notes/archived/feature/2026-07-21-tui-no-banner.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/feature/2026-07-21-tui-no-banner.zh.md"
sourceSha256: "05659d5e54a10fbace886f4407ec7a457cbab85139af03e3ae59612fa7611988"
pageSha256: "05659d5e54a10fbace886f4407ec7a457cbab85139af03e3ae59612fa7611988"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-07-21-tui-no-banner) | 中文

> **已被取代**，见[无边框横幅 Agent Note](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-07-21-tui-borderless-banner)：横幅及其扫入动画回归，只是去掉了盒子。本 note 为模型设立的页脚归宿得以保留。

## Problem

TUI 启动时展示一个带框的产品横幅（"DEEPSEEK HARNESS" + 模型/会话详情），最近一版还带扫入动画（[横幅扫入 Agent Note](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-07-21-tui-banner-sweep)）。用户的裁决：删掉它。每次启动都被重读的产品标题是装饰，盒子在任何内容之前先占掉四行，而它承载的识别信息（模型、会话）有更好的去处。
...
本 note 完全取代[横幅扫入 Agent Note](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-07-21-tui-banner-sweep)：扫入动画和它所动画的横幅都已移除。
