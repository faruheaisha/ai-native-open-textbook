...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-08-19-projection-cache-per-session-files.zh.md"
sourceRel: ".agents/notes/archived/architecture/2026-08-19-projection-cache-per-session-files.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/architecture/2026-08-19-projection-cache-per-session-files.zh.md"
sourceSha256: "cc32ae3fb829b0e4afbe2dbcfd55e0fa57cc1d769f60d4c7d0f8c489876b45af"
pageSha256: "cc32ae3fb829b0e4afbe2dbcfd55e0fa57cc1d769f60d4c7d0f8c489876b45af"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-19-projection-cache-per-session-files) | 中文
...
- json 后端仅在枚举时没有发现任何新布局文档路径、旧单元名称匹配，且其版本为当前版本或已声明兼容版本时，才从旧整单元缓存引导 per-record 目录树。接受集合之外的版本保持不变，新域为空；存储绝不把域 owner 未批准的版本改标为当前版本。只要存在任意新文档路径，即使文件不可读或版本陈旧，也会对整个单元禁用引导；缺失的会话行从日志重折叠。[跨版本读兼容决策](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-09-02-projcache-cross-version-read-compat.zh.md)是版本策略的权威说明。
