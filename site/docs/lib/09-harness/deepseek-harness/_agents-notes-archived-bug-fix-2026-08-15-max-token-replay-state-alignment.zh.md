---
title: "Agent Note: 回放状态与组装内容按构造对齐"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-08-15-max-token-replay-state-alignment.zh.md"
sourceRel: ".agents/notes/archived/bug-fix/2026-08-15-max-token-replay-state-alignment.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/bug-fix/2026-08-15-max-token-replay-state-alignment.zh.md"
sourceSha256: "a1d0229cc36a76d4b8b7defceefada0e00be5ba3a0e33295067b7403ef985572"
pageSha256: "a1d0229cc36a76d4b8b7defceefada0e00be5ba3a0e33295067b7403ef985572"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-08-15-max-token-replay-state-alignment) | 中文
...
包含工具调用的 max-token 响应之后的续聊可以工作，保留块保有原生签名，并作为原生 pi-ai 消息回放。本次改动之前记录的会话，其受影响的 assistant 消息作为提供方无关内容回放（带诊断）而不是让轮次失败；`replayState` 落盘形状在预发布无兼容承诺立场下发生变化，旧平铺形式由同一降级路径处理。对不可用状态而言，这取代了[提供方路由适配器决定](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-07-14-provider-routed-llm-adapters.zh.md)中读取时硬错误的规则；校验本身不变，仍先于任何原生重建执行。
