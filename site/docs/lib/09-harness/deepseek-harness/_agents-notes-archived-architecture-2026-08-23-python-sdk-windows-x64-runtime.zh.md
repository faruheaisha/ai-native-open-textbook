---
title: "Agent Note: Python SDK Windows x64 运行时"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-08-23-python-sdk-windows-x64-runtime.zh.md"
sourceRel: ".agents/notes/archived/architecture/2026-08-23-python-sdk-windows-x64-runtime.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/architecture/2026-08-23-python-sdk-windows-x64-runtime.zh.md"
sourceSha256: "f8f924ac91b0b8dd681199ef389801d8f264800c914cd481a3179d9243935dcb"
pageSha256: "f8f924ac91b0b8dd681199ef389801d8f264800c914cd481a3179d9243935dcb"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-23-python-sdk-windows-x64-runtime) | 中文
...
Python 进程仍按 [Python profile 运行时决策](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-23-python-sdk-dsh-profile-runtime.zh)启动普通 `dsh --profile sdk` 应用，并要求显式 Harness home。Windows 不会增加 Python 专用 Node 应用、完整配置入口、隐式 `~/.dsh` 或系统 Node 要求。
...
极简黑盒测试在 Windows 上使用持久 `pwsh` 与 `str_replace_editor`，并由 `minimal/win-x64/model-visible.json` 固定预期；Linux 与 macOS 保留持久 Bash 和共享的 `minimal/model-visible.json`。高级进程／subagent 快照与重启／持久日志快照继续由所有目标共享。随附的 [`sdk-minimal` 组合包](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/packages/bundle/sdk-minimal/README.zh.md)为可运行 Python 教程选择同一组平台 shell。

## Existing decisions and supersession

本决策部分取代[单文件运行时分发](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-07-10-single-file-executable-sdk-runtime-distribution.zh.md)中的 Windows 非目标声明，并扩展[安装后 Python wheel 黑盒决策](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/testing/2026-08-23-installed-python-wheel-black-box-ci.zh.md)中的必需目标集合。上述 Note 继续负责 SEA 打包、两个 Python distribution、来源校验、密钥处理与通用黑盒场景。
