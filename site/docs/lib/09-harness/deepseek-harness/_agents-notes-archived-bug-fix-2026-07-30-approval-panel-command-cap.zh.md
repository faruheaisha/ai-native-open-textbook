---
title: "Agent Note: 审批接管面板与输入框共用同一文本高度上限"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-07-30-approval-panel-command-cap.zh.md"
sourceRel: ".agents/notes/archived/bug-fix/2026-07-30-approval-panel-command-cap.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/bug-fix/2026-07-30-approval-panel-command-cap.zh.md"
sourceSha256: "ff82dcc976d98bb34ed2ebc48107c1369873c58f3464fd0346c8d641aa890304"
pageSha256: "ff82dcc976d98bb34ed2ebc48107c1369873c58f3464fd0346c8d641aa890304"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-07-30-approval-panel-command-cap) | 中文
...
面板卡片把 `--dsh-scrollbar-thumb\{,-hover\}` 重新绑定到 l2 那一对，这是每一个位于高层表面上的滚动区域都必须做的（[滚动条约定](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/packages/client/ui-theme/src/styles/scrollbar.css)）。
...
- InputBar 的 14 行上限现在通过一个自 `.composerSeat` 继承而来的自定义属性解析，且落在真正滚动草稿的那个盒子上（[两层文本共用同一个滚动容器](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-07-31-composer-text-layers-share-one-scrollport)把该声明从自增高镜像层移了出去）。把输入栏渲染到该容器之外会丢掉这条声明（一个没有兜底值的未解析 `var()`），因此未来的 composer 宿主必须带上这个属性——这也正是它声明在共享容器上、而不是应用根节点上的原因。
