...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-07-10-session-query-service.zh.md"
sourceRel: ".agents/notes/archived/feature/2026-07-10-session-query-service.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/feature/2026-07-10-session-query-service.zh.md"
sourceSha256: "48d5a2d5f679bad90124c19a2b7a563f5d6551274c2bef9b3ce3eb9612ba0649"
pageSha256: "48d5a2d5f679bad90124c19a2b7a563f5d6551274c2bef9b3ce3eb9612ba0649"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-07-10-session-query-service) | 中文
...
`@deepseek-ai/dsh-session-query` 拥有面向单一逻辑语料库的唯一抽象 `ctx.sessionQuery` 服务。它具体实现 `listSessions()`、提供方无关的 `filterSessions(filters)`、`listEvents(sessionId)`、`filterEvents(sessionId, filters)`、有界的 `readEvent(request)`、`traceSession(sessionId)` 和 `traceEvent(request)`，而具体后端实现其两个全文搜索方法。[统一服务决策](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-07-23-unified-session-query-service)拥有这一拓扑，[SQLite 搜索决策](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-07-10-sqlite-session-query-provider)拥有搜索行为，[追踪决策](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-07-13-session-query-tracing)拥有血缘与事件关系语义。
