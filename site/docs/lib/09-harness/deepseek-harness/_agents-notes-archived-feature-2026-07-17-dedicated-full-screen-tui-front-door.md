---
title: "Agent Note: Dedicated full-screen TUI front door"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-07-17-dedicated-full-screen-tui-front-door.md"
sourceRel: ".agents/notes/archived/feature/2026-07-17-dedicated-full-screen-tui-front-door.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/feature/2026-07-17-dedicated-full-screen-tui-front-door.md"
sourceSha256: "feb70faaad016965e8cc1bd7339947e48937fb3e8ea1425dada581073396f50c"
pageSha256: "feb70faaad016965e8cc1bd7339947e48937fb3e8ea1425dada581073396f50c"
...
English | [中文](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-07-17-dedicated-full-screen-tui-front-door.zh)

## Problem

The reusable TUI package remains implemented, but [`dsh` no longer ships it as an application entrypoint](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/simplification/2026-08-03-explicit-config-dsh-entrypoint.md). This note continues to own the package boundary and terminal behavior; the later note owns product composition.

At the time this front door was introduced, the line-oriented agent handled pipes and ordinary terminals, but a full-screen coding interface had to own raw input, differential screen drawing, cursor state, overlays, and terminal restoration. Combining those contracts in one UI plugin would have coupled a stream-oriented path to a TTY-only lifecycle. The later [redundant-agent removal](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/simplification/2026-07-20-remove-stdio-and-echo-agents.md) removes that line agent; this Note continues to own the TUI design.
...
DeepSeek Harness ships [`@deepseek-ai/dsh-tui`](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/packages/ui/tui/README.md) as a dedicated Cordis plugin. It owns terminal input and presentation only; agent lifecycle, session persistence, tool execution, and the model-facing question tool remain separate composition entries. The plugin requires both stdin and stdout to be TTYs and fails instead of silently changing to line-oriented behavior.
