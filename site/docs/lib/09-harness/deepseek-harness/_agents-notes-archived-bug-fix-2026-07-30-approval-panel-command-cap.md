---
title: "Agent Note: The approval takeover shares the composer's text cap"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-07-30-approval-panel-command-cap.md"
sourceRel: ".agents/notes/archived/bug-fix/2026-07-30-approval-panel-command-cap.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/bug-fix/2026-07-30-approval-panel-command-cap.md"
sourceSha256: "cd9b396cb775c6c380c4c1a6ec0d6407d182af930b98be3e541195b77cc24b9a"
pageSha256: "cd9b396cb775c6c380c4c1a6ec0d6407d182af930b98be3e541195b77cc24b9a"
...
English | [中文](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-07-30-approval-panel-command-cap.zh)
...
The panel's card rebinds `--dsh-scrollbar-thumb\{,-hover\}` to the l2 pair, as every scrolling surface on an elevated background must ([scrollbar contract](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/packages/client/ui-theme/src/styles/scrollbar.css)).
...
- The InputBar's 14-line cap now resolves through a custom property inherited from `.composerSeat`, on the box that scrolls its draft ([one scrollport for both text layers](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-07-31-composer-text-layers-share-one-scrollport) moved the declaration off the auto-grow mirror). Rendering the bar outside that seat would drop the declaration (an unresolved `var()` with no fallback), so a future composer host has to carry the property — which is why it is declared on the shared seat rather than the app root.
