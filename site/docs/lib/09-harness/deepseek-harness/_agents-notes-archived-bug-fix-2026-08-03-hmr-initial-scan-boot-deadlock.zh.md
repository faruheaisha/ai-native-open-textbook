---
title: "Agent Note: HMR 初始扫描使失败的启动死锁为静默的 exit 13"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-08-03-hmr-initial-scan-boot-deadlock.zh.md"
sourceRel: ".agents/notes/archived/bug-fix/2026-08-03-hmr-initial-scan-boot-deadlock.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/bug-fix/2026-08-03-hmr-initial-scan-boot-deadlock.zh.md"
sourceSha256: "b0f7708f29d078e511d03dbffc6ad5e16de1fad4e9ed36faf6fdeee08ddfc32d"
pageSha256: "b0f7708f29d078e511d03dbffc6ad5e16de1fad4e9ed36faf6fdeee08ddfc32d"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-08-03-hmr-initial-scan-boot-deadlock) | 中文

## 问题

当 `dsh` 启动时配置树校验失败，进程以 13 退出（未结算的顶层 await），不输出任何诊断，并把 TUI 的终端状态残留在 shell 上——这正是 [fail-loud release](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-07-31-fail-loud-releases-the-terminal.zh.md) 修复过的症状，在[事务化配置重载](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-07-20-config-hot-reload-resilience.zh)之后经由另一条机制重新出现。
