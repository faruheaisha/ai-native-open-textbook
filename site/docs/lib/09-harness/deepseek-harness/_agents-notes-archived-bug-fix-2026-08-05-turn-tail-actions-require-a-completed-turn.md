---
title: "Agent Note: Turn-tail IconActions require a completed turn"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-08-05-turn-tail-actions-require-a-completed-turn.md"
sourceRel: ".agents/notes/archived/bug-fix/2026-08-05-turn-tail-actions-require-a-completed-turn.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/bug-fix/2026-08-05-turn-tail-actions-require-a-completed-turn.md"
sourceSha256: "3b0a4fb7511f18a504bd3c45f111ecd0eb3705cee42c54deb6fd571db3116a16"
pageSha256: "3b0a4fb7511f18a504bd3c45f111ecd0eb3705cee42c54deb6fd571db3116a16"
...
English | [中文](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-08-05-turn-tail-actions-require-a-completed-turn.zh)
...
The [archived message-chrome decision](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-07-29-web-message-icon-actions-and-clock.md) always claimed mid-turn narration stays chrome-free; the derivation never carried a completion signal to make that true.
...
This is the same completion fact the branch control and the run-time label already use, so the three parts of one row now agree. Turn completion is read from the durable `turn/end` event rather than inferred from `running`, the streaming partial, or in-flight tool calls, matching the [completed-turn-tail decision](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-08-02-message-fork-actions-require-completed-turn-tail). Every reason kind closes a turn, so an aborted turn's frozen tail keeps its footer, and a crash-orphaned turn receives its `turn/end` from log repair on load.
