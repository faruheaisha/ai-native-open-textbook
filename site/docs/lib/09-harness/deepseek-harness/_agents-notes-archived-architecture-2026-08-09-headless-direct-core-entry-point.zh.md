---
title: "Agent Note: headless 是直接使用核心服务的入口"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-08-09-headless-direct-core-entry-point.zh.md"
sourceRel: ".agents/notes/archived/architecture/2026-08-09-headless-direct-core-entry-point.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/architecture/2026-08-09-headless-direct-core-entry-point.zh.md"
sourceSha256: "cfb72dec612092c0543cf4ba7b628b96c6bacb6af87a575931073c524f666d24"
pageSha256: "cfb72dec612092c0543cf4ba7b628b96c6bacb6af87a575931073c524f666d24"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-09-headless-direct-core-entry-point) | 中文

## 问题

`headless` 的产品约定是一个本地任务：最终 assistant 文本写入 stdout，退出状态反映成功与否，不打开监听端口，并由 [headless 推理进度](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-08-21-headless-reasoning-progress.zh.md)负责 stderr 推理投影。包含 Workspace Host 服务、浏览器 RPC、HTTP、Web 运行时或浏览器插件的组合违背这一约定，也使本地完成状态依赖无关的传输树。
...
本 Agent Note 负责 headless 的传输与完成约定；[headless 推理进度](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-08-21-headless-reasoning-progress.zh.md)负责成功运行时的 stderr 输出。[应用持有自己的命令行](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-06-app-owned-command-line.zh)负责当前的 `dsh --profile headless` 语法；原 [`dsh run` 决策](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-08-08-dsh-run-headless-command.md)记录已被取代的启动器持有语法，[Web 配置树启动与传输分层](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-07-24-web-config-tree-boot-and-transport-layering.zh.md)负责 Web 插件树，[默认模型跟随选择器](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-08-07-default-model-follows-the-picker.zh.md)负责共享 Agent 默认值的持久化。
