---
title: "Agent Note: 文件系统工具 schema——面向模型的读/写/编辑接口形状"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-06-17-filesystem-tool-schemas.zh.md"
sourceRel: ".agents/notes/archived/feature/2026-06-17-filesystem-tool-schemas.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/feature/2026-06-17-filesystem-tool-schemas.zh.md"
sourceSha256: "4542bd2a09d9c4fca9b592e41a9752298aa03f5724e23e91c9e9ecd76ff28544"
pageSha256: "4542bd2a09d9c4fca9b592e41a9752298aa03f5724e23e91c9e9ecd76ff28544"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-feature-2026-06-17-filesystem-tool-schemas) | 中文

## 问题

[文件系统能力 seam Agent Note](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-06-17-filesystem-capability-seam.zh) 定义了文件系统能力 seam（`ctx.fs`）、包拆分（`dsh-fs`、`dsh-fs-local`、`dsh-tool-fs`，加上 `dsh-fs-observation-policy` 策略插件），以及针对 read-before-write/edit 检查的已观测文件／陈旧版本策略——[拆分文件系统 seam](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/simplification/2026-06-26-fsspec-style-fs-seam.zh.md)和[事件门](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-06-26-file-context-as-event-gate.zh.md) Agent Note 后来将其从 `ctx.fs` 移至 `dsh-fs-observation-policy` 插件的 `fs/*` 事件门上。首次文件系统工具交付剩余的决策是面向模型的 schema：模型在 `read`、`write` 和 `edit` 中看到哪些参数。
...
首次实现曾将 `ContentBlock[]` 格式化逻辑放在 `execute` 中。[规范工具输出约定](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-07-20-canonical-tool-output-contract.zh.md)如今将 `ctx.fs` 的结果事实保留为工具经校验的值，并通过 `output.render` 派生相同的模型文本；文件状态的记录/刷新仍归 `ctx.fs` 所有。
