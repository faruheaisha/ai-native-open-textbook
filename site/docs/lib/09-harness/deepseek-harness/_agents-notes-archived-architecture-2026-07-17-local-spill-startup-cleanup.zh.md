---
title: "Agent Note: 本地 spill 文件的一次性启动清理"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-07-17-local-spill-startup-cleanup.zh.md"
sourceRel: ".agents/notes/archived/architecture/2026-07-17-local-spill-startup-cleanup.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/architecture/2026-07-17-local-spill-startup-cleanup.zh.md"
sourceSha256: "17f574516921abd0c84915822d08699fdbaadb00447c15e6b4c1410783b61478"
pageSha256: "17f574516921abd0c84915822d08699fdbaadb00447c15e6b4c1410783b61478"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-07-17-local-spill-startup-cleanup) | 中文

## 问题

本地 spill 后端从不删除它写下的完整工具结果。每个超限结果都会新增一个文件，因此配置的根目录会无限增长，而每进程默认的 `dsh-spill-*` 根目录也会跨多次运行不断累积。立即删除是错误的，因为已持久化、已恢复和已 fork 的会话仍可能引用某个 locator。[工具输出 spill 策略](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-07-08-tool-output-spill-files.zh.md)需要一个有界的本地存储生命周期。
