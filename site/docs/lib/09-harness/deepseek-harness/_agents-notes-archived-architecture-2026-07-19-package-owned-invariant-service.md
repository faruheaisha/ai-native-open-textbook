---
title: "Agent Note: Package-owned invariant service contract"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-07-19-package-owned-invariant-service.md"
sourceRel: ".agents/notes/archived/architecture/2026-07-19-package-owned-invariant-service.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/architecture/2026-07-19-package-owned-invariant-service.md"
sourceSha256: "514f93f2261fecab9eb7efa8613340b1f01b729b411ac4adce903c50935fa95e"
pageSha256: "514f93f2261fecab9eb7efa8613340b1f01b729b411ac4adce903c50935fa95e"
...
English | [中文](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-07-19-package-owned-invariant-service.zh)
...
A workspace package publishes a `./invariant` companion plugin only when it owns an independently observable event or mutable-data relationship. The companion registers its exact full npm name. Packages without such a relationship omit the companion and publication wiring and record the reason in their README; generated placeholders, empty installers, and synthetic API-shape assertions are forbidden by the [runtime-contract Agent Note](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/architecture/2026-07-19-package-invariant-runtime-contracts.md) and [omission decision](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/simplification/2026-08-28-omit-unneeded-invariant-companions.md). Package root entrypoints do not import or register diagnostics implicitly, so loading a root package does not change runtime checking or require the invariant service.
...
The `dsh-sdk-minimal` patch mounts the service and all four stateful companion subpaths as explicit rows. A subpath entry adds its installable root npm package rather than treating the subpath as a package name. The shipped base-backed config trees omit the service and companions under the [shipped-config decision](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/simplification/2026-08-03-omit-invariants-from-shipped-config.md).
