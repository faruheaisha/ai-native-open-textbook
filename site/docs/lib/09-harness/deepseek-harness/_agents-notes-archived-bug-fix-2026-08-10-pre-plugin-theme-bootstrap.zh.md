...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-08-10-pre-plugin-theme-bootstrap.zh.md"
sourceRel: ".agents/notes/archived/bug-fix/2026-08-10-pre-plugin-theme-bootstrap.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/bug-fix/2026-08-10-pre-plugin-theme-bootstrap.zh.md"
sourceSha256: "fccf87f851881ba55466a02ef19cd7e4bb21efa1b15d963d3971011d651788b7"
pageSha256: "fccf87f851881ba55466a02ef19cd7e4bb21efa1b15d963d3971011d651788b7"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-08-10-pre-plugin-theme-bootstrap) | 中文
...
settings provider 存在时，主机侧会注册 [`ui-theme.preference` settings 分节](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-08-06-host-backed-web-preferences.zh.md)。它为每份 index 响应把经过 schema 校验的内建偏好嵌入内联脚本；不存在 settings provider 或有效注册时则嵌入默认值 `system`。浏览器通过 `prefers-color-scheme` 解析 `system`，不支持 `matchMedia` 时回退为浅色。脚本只写 ThemePresenter 后续拥有的两项 DOM 状态：`document.documentElement.style.colorScheme` 与 `body[data-ds-dark-theme]`。
