---
title: "Agent Note: 创作 preset 的 agent 自行挂载校验其组装"
...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-08-11-preset-authoring-agent-validates-its-own-composition.zh.md"
sourceRel: ".agents/notes/archived/bug-fix/2026-08-11-preset-authoring-agent-validates-its-own-composition.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/bug-fix/2026-08-11-preset-authoring-agent-validates-its-own-composition.zh.md"
sourceSha256: "485364d0152b8e9270958a0dd7d2b3449cc71f154984feb562ae81b1c9634edf"
pageSha256: "485364d0152b8e9270958a0dd7d2b3449cc71f154984feb562ae81b1c9634edf"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-08-11-preset-authoring-agent-validates-its-own-composition) | 中文
...
- 校验成功会留下一个永不回收的常驻代际，这是 roster 按代际本就承担的[常驻挂载](/lib/09-harness/deepseek-harness/_agents-notes-archived-architecture-2026-08-08-per-preset-standing-mounts.zh)代价——由 agent 在编辑收尾时付一次，而不是由用户在首次会话时付。
...
取代[破损 preset 是 roster 行](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-08-09-broken-preset-roster-rows.zh)中关于创作模式指导的那一条，其健康检查决策依然有效——本篇只推翻它「agent 起不了会话；设置页的红色标记是用户的检查手段」这一结论。创作的 copy-only 形态由[copy-only preset 创作](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/simplification/2026-08-08-copy-only-preset-authoring.zh.md)负责。
