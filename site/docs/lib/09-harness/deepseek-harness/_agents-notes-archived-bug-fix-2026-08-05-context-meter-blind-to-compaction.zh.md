...
entryUrl: "https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/bug-fix/2026-08-05-context-meter-blind-to-compaction.zh.md"
sourceRel: ".agents/notes/archived/bug-fix/2026-08-05-context-meter-blind-to-compaction.zh.md"
rawUrl: "/raw/09-harness/deepseek-harness/.agents/notes/archived/bug-fix/2026-08-05-context-meter-blind-to-compaction.zh.md"
sourceSha256: "ab912621eafb8ced6e2b9ad7e31c61b80e23a087649f51eb6b1b3782470e3d77"
pageSha256: "ab912621eafb8ced6e2b9ad7e31c61b80e23a087649f51eb6b1b3782470e3d77"
...
[English](/lib/09-harness/deepseek-harness/_agents-notes-archived-bug-fix-2026-08-05-context-meter-blind-to-compaction) | 中文

## 问题

composer 的[上下文仪表](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-08-05-composer-context-meter-breakdown.zh.md)的圆环、百分比与 `~已用 / 容量` 标题都取自 `contextPressure.pressureTokens`，即提供方报告的最新提示词规模。这个数字只在某个请求报告用量时才会移动，而压缩（compaction）不报告用量：`compaction-basic` 通过直连的 `ctx.llm.stream()` 调用生成摘要，只追加 `compaction/start`、`compaction/summary`、用作替换的 `user/message` 和 `compaction/end`——没有 `assistant/message`，也没有用量分片。
...
这推翻了[上下文仪表决策](https://github.com/deepseek-ai/deepseek-harness/blob/c291e7961a515f6d7af9304e7fd1d257929aef26/.agents/notes/archived/feature/2026-08-05-composer-context-meter-breakdown.zh.md)中「圆环、标题与进度条总长保持提供方精确值」的那一半。那条决策真正想守住的东西——不要把启发式明细行按比例缩放到提供方总量、从而伪造精度——依然守住了：明细行仍未被缩放，标题仍不等于它们之和。改变的是这样一个认识：「提供方精确、但描述的是两次压缩之前那个请求」并不是更真实的数字。
