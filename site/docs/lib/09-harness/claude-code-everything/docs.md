...
- Teammates **do** inherit the lead's [effort level](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know/blob/d9e93740193aeae2cd661c7ddf6f0c8f8989860b/docs/reference/effort-levels.md) (v2.1.186+ in split-pane mode).
...
While you're viewing a teammate, plain text and [skills](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know/blob/d9e93740193aeae2cd661c7ddf6f0c8f8989860b/docs/skills.md) go to *that teammate* — but built-in commands still run in the lead's session.
...
- [Dynamic Workflows](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know/blob/d9e93740193aeae2cd661c7ddf6f0c8f8989860b/docs/workflows.md) — when the job outgrows a handful of peers
...
[← Back to README](/lib/09-harness/claude-code-everything/overview#agent-teams-experimental) · [Dynamic Workflows](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know/blob/d9e93740193aeae2cd661c7ddf6f0c8f8989860b/docs/workflows.md) · [Skills](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know/blob/d9e93740193aeae2cd661c7ddf6f0c8f8989860b/docs/skills.md)
