...
entryUrl: "https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know/blob/d9e93740193aeae2cd661c7ddf6f0c8f8989860b/docs/reference/commands.md"
sourceRel: "docs/reference/commands.md"
rawUrl: "/raw/09-harness/claude-code-everything/docs/reference/commands.md"
sourceSha256: "91996d996f6b532bf392a6bfb04de396f553c25e9224aef4b016dd5b74f18d0d"
pageSha256: "91996d996f6b532bf392a6bfb04de396f553c25e9224aef4b016dd5b74f18d0d"
...
*[← Back to README](/lib/09-harness/claude-code-everything/overview#claude-commands)*

The most useful built-in slash commands, plus the file-format spec for custom commands (skills). This is a curated cheatsheet — for the canonical, always-current list see the [official commands reference](https://code.claude.com/docs/en/commands). For workflows and recipes built around slash commands, see [`docs/skills.md`](/lib/09-harness/claude-code-everything/docs-skills).
...
| `/deep-research <question>` | Bundled [workflow](/lib/09-harness/claude-code-everything/docs-workflows) — fans web searches across several angles, cross-checks sources, votes on each claim, returns a cited report. Needs the WebSearch tool |
...
| `/effort` | Set reasoning effort (`low` / `medium` / `high` / `xhigh` / `max` / `ultracode`); no args opens an interactive slider; `/effort auto` resets to the model default. See [Effort levels](/lib/09-harness/claude-code-everything/docs-reference-effort-levels) |
...
| `/workflows` | List and watch [dynamic workflow](/lib/09-harness/claude-code-everything/docs-workflows) runs — drill into phases and agents, pause, stop, or press `s` to save a run's script as a reusable command |
...
> 💡 **Next level:** for workflows, recipes, and best practices, see [`docs/skills.md`](/lib/09-harness/claude-code-everything/docs-skills).

---

[← Back to README](/lib/09-harness/claude-code-everything/overview#claude-commands) · [Skills guide](/lib/09-harness/claude-code-everything/docs-skills) · [FAQ](/lib/09-harness/claude-code-everything/docs-reference-faq)
