...
entryUrl: "https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know/blob/d9e93740193aeae2cd661c7ddf6f0c8f8989860b/docs/reference/faq.md"
sourceRel: "docs/reference/faq.md"
rawUrl: "/raw/09-harness/claude-code-everything/docs/reference/faq.md"
sourceSha256: "5072b7de108a8da78d804e75c1928226cde6aa20349f0ce4dab0fa4f5158d875"
pageSha256: "5072b7de108a8da78d804e75c1928226cde6aa20349f0ce4dab0fa4f5158d875"
...
*[← Back to README](/lib/09-harness/claude-code-everything/overview#faq)*

A consolidated FAQ covering models, pricing, tokens, plans, Fast Mode, worktrees, and Pro-plan optimization. For Skills-specific questions, see [`docs/skills.md` → Skills FAQ](/lib/09-harness/claude-code-everything/docs-skills#skills-faq).
...
As of July 2026: **Sonnet 5** (default), **Opus 4.8**, **Fable 5** (Mythos class), and **Haiku 4.5**, with Opus 4.7/4.6 and Sonnet 4.6 available as legacy models. Full specs, model IDs, and pricing live in one place — [Models](/lib/09-harness/claude-code-everything/docs-reference-models) — so this FAQ doesn't duplicate them.
...
Current defaults (July 2026): Opus 4.8 → `high` on all surfaces; Sonnet 5 → `high` on API and Claude Code. Run `/effort` to see and change yours. Full breakdown: [Effort levels](/lib/09-harness/claude-code-everything/docs-reference-effort-levels).
...
They're officially one system now — `.claude/commands/deploy.md` and `.claude/skills/deploy/SKILL.md` both create `/deploy`. See [`docs/skills.md` → Skills FAQ](/lib/09-harness/claude-code-everything/docs-skills#skills-faq) for security best practices, team sharing, and troubleshooting.
...
See the [Models page](/lib/09-harness/claude-code-everything/docs-reference-models#pricing) for the full table — headline rates: Sonnet 5 $2/$10 (intro through Aug 31, 2026, then $3/$15), Opus 4.8 $5/$25, Fable 5 $10/$50, Haiku 4.5 $1/$5.
...
[← Back to README](/lib/09-harness/claude-code-everything/overview#faq) · [Skills FAQ](/lib/09-harness/claude-code-everything/docs-skills#skills-faq) · [Changelog](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know/blob/d9e93740193aeae2cd661c7ddf6f0c8f8989860b/docs/reference/changelog.md)
