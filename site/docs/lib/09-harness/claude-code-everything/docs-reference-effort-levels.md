...
*~8 min read · [← Back to README](/lib/09-harness/claude-code-everything/overview#prompt-engineering-deep-dive)*
...
- [Models — specs and pricing](/lib/09-harness/claude-code-everything/docs-reference-models) — model IDs, when to pick which
- [Slash commands reference](/lib/09-harness/claude-code-everything/docs-reference-commands) — `/effort`, `/usage`, `/model`
- [README → Prompt Engineering Deep Dive](/lib/09-harness/claude-code-everything/overview#prompt-engineering-deep-dive) — `think` directives, Explore→Plan→Code→Commit, TDD workflow
- [FAQ](/lib/09-harness/claude-code-everything/docs-reference-faq) — pricing, plan limits, Fast Mode

---

[← Back to README](/lib/09-harness/claude-code-everything/overview#prompt-engineering-deep-dive) · [Models](/lib/09-harness/claude-code-everything/docs-reference-models) · [Commands](/lib/09-harness/claude-code-everything/docs-reference-commands)
