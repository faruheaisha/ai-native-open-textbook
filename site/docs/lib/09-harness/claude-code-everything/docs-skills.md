...
*~30 min read · [← Back to README](/lib/09-harness/claude-code-everything/overview#claude-skills)*
...
> - **Combine with hooks** for automatic skill invocation on events (see [Hooks](/lib/09-harness/claude-code-everything/overview#hooks) section).
...
> - **Use Fast Mode** (see [Fast Mode](/lib/09-harness/claude-code-everything/overview#fast-mode)) when latency matters in skill-heavy workflows.
