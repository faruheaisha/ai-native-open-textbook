...
entryUrl: "https://github.com/revfactory/harness/blob/cceac68ea1d0ad198ef4b7b906cd238375836387/docs/quickstart.md"
sourceRel: "docs/quickstart.md"
rawUrl: "/raw/09-harness/meta-skill-harness-revfactory/docs/quickstart.md"
sourceSha256: "9c5a235bbe4200a1861023112b8945e464ce72eb5e24756c4842b13a73462e78"
pageSha256: "9c5a235bbe4200a1861023112b8945e464ce72eb5e24756c4842b13a73462e78"
...
**What this does:** Installs the `harness` plugin from the `harness` marketplace, then enables Agent Teams — the Claude Code API harness uses to orchestrate multi-agent workflows. See [`docs/experimental-dependency.md`](/lib/09-harness/meta-skill-harness-revfactory/docs-experimental-dependency) for why the flag is required.
...
**Next reads:**
- [`docs/experimental-dependency.md`](/lib/09-harness/meta-skill-harness-revfactory/docs-experimental-dependency) — Why the flag, and what we'll do when it changes
