...
[Outcome-bound effectiveness]: /lib/09-harness/harness-engineering-anthology/docs-effectiveness
...
[Accrue Domain Expertise Through the Work]:
  /lib/09-harness/harness-engineering-anthology/docs-feedback#accrue-domain-expertise-through-the-work
...
[coherence loop]: /lib/09-harness/harness-engineering-anthology/docs-durable-systems#make-coherence-cumulative
[proof in the user’s domain]: /lib/09-harness/harness-engineering-anthology/docs-proof
