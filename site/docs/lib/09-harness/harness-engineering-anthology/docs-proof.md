...
[the user’s domain boundary]:
  /lib/09-harness/harness-engineering-anthology/docs-last-mile-deployment#serve-users-who-never-see-code
...
[Release Integrity]: /lib/09-harness/harness-engineering-anthology/docs-proof-release-integrity
...
[homelab canary]: /lib/09-harness/harness-engineering-anthology/docs-domain-modeling-homelab
...
[Prove a Security Claim]: /lib/09-harness/harness-engineering-anthology/docs-proof-rustsec
