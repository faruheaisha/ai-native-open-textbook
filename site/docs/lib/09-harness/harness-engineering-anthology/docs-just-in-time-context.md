...
[Pair Each Goal With a Context Curator]:
  /lib/09-harness/harness-engineering-anthology/docs-last-mile-deployment#pair-each-goal-with-a-context-curator
...
[Feedback infrastructure]: /lib/09-harness/harness-engineering-anthology/docs-feedback
