...
entryUrl: "https://github.com/lopopolo/harness-engineering/blob/226c8d35fb6ea3ed55467753dba6dea2b5fd5778/sources/README.md"
sourceRel: "sources/README.md"
rawUrl: "/raw/09-harness/harness-engineering-anthology/sources/README.md"
sourceSha256: "1208fd8ce3e62e00793890c9373d1596dc5b71fd9e860db555124832ad7e878f"
pageSha256: "1208fd8ce3e62e00793890c9373d1596dc5b71fd9e860db555124832ad7e878f"
...
- [Twitter corpus](/lib/09-harness/harness-engineering-anthology/sources-twitter)
...
| 2025-08-10 | [MCP Solves Tool Discovery for LLMs](https://hyperbo.la/w/tool-discovery/) · [local text](/lib/09-harness/harness-engineering-anthology/sources-raw-hyperbola-tool-discovery)                                                              | Capabilities must be discoverable and legible to the model.                                                   |
...
| 2026-02-17 | [Harness Engineering the Blog Build (Again)](https://hyperbo.la/w/harness-engineering-the-blog-build/) · [local text](/lib/09-harness/harness-engineering-anthology/sources-raw-hyperbola-harness-engineering-the-blog-build)              | A repository-local build, policy, architecture, and verification harness.                                     |
| 2026-03-13 | [The Production Function Changed](https://hyperbo.la/w/production-function-changed/) · [local text](/lib/09-harness/harness-engineering-anthology/sources-raw-hyperbola-production-function-changed)                                       | Cheap implementation moves the bottleneck toward judgment and proof.                                          |
| 2026-03-13 | [Software Work Is No Longer Scheduled](https://hyperbo.la/w/software-work-not-scheduled/) · [local text](/lib/09-harness/harness-engineering-anthology/sources-raw-hyperbola-software-work-not-scheduled)                                  | Bounded work with clear intent, understood interfaces, guardrails, and verifiable results can run asynchronously. |
| 2026-03-13 | [Stop Treating Code as the Artifact](https://hyperbo.la/w/code-is-not-the-artifact/) · [local text](/lib/09-harness/harness-engineering-anthology/sources-raw-hyperbola-code-is-not-the-artifact)                                          | Specifications, boundaries, and guardrails outlast generated source.                                          |
| 2026-03-13 | [Agent Utilization Is the New Performance Ceiling](https://hyperbo.la/w/agents-agents-agents/) · [local text](/lib/09-harness/harness-engineering-anthology/sources-raw-hyperbola-agents-agents-agents)                                    | Agent utilization depends on access across the software lifecycle.                                            |
| 2026-03-30 | [A Lazy Prompt Turned Into a RustSec Advisory](https://hyperbo.la/w/lazy-prompt-rustsec/) · [local text](/lib/09-harness/harness-engineering-anthology/sources-raw-hyperbola-lazy-prompt-rustsec)                                          | Security work closes the loop from reproducer through release and advisory.                                   |
| 2026-04-09 | [Coding Agents for Technical Non-Engineers](https://hyperbo.la/w/coding-agents-for-technical-non-engineers/) · [local text](/lib/09-harness/harness-engineering-anthology/sources-raw-hyperbola-coding-agents-for-technical-non-engineers) | Paved environments let domain experts encode their own work.                                                  |
| 2026-04-10 | [What Does It Mean to Do a Good Job?](https://hyperbo.la/w/what-does-it-mean-to-do-a-good-job/) · [local text](/lib/09-harness/harness-engineering-anthology/sources-raw-hyperbola-what-does-it-mean-to-do-a-good-job)                     | Tacit requirements, proof, and focused reviewer convergence define quality.                                   |
| 2026-04-19 | [Enabling Codex to Upgrade My Robot Vacuum](https://hyperbo.la/w/robot-vacuum-canary-tailscale/) · [local text](/lib/09-harness/harness-engineering-anthology/sources-raw-hyperbola-robot-vacuum-canary-tailscale)                         | Narrow authority, canaries, approval, access verification, and rollback make a dangerous operation tractable. |
| 2026-07-17 | [Please Go Brr, on Token Mandates](https://hyperbo.la/w/token-mandates/) · [local text](/lib/09-harness/harness-engineering-anthology/sources-raw-hyperbola-token-mandates)                                                                | Distributed exploration discovers practitioners, business problems, and deployment patterns worth funding.    |
| 2026-07-17 | [Code Reds Need Maintenance Loops](https://hyperbo.la/w/code-reds-need-maintenance-loops/) · [local text](/lib/09-harness/harness-engineering-anthology/sources-raw-hyperbola-code-reds-need-maintenance-loops)                            | Argues that adaptive episodes should leave durable maintenance loops for newly discovered invariants.         |
...
[Twitter source index]: /lib/09-harness/harness-engineering-anthology/sources-twitter
...
[Influences and Alternate Framings](/lib/09-harness/harness-engineering-anthology/docs-lineage) develops these
...
- [Ryan Lopopolo's Polytoken implementation observation](/lib/09-harness/harness-engineering-anthology/sources-ryan-notes#polytoken-and-codex-apply_patch)
...
- [Agent Client Protocol introduction](https://agentclientprotocol.com/get-started/introduction)
  · [local text](/lib/09-harness/harness-engineering-anthology/sources-raw-acp-introduction)
- [Agent Client Protocol architecture](https://agentclientprotocol.com/get-started/architecture)
  · [local text](/lib/09-harness/harness-engineering-anthology/sources-raw-acp-architecture)
...
- [Future Regret in Artichoke's State Refactor](/lib/09-harness/harness-engineering-anthology/evals-artichoke-state-modeling):
  [failed prototype #442](https://github.com/artichoke/artichoke/pull/442),
  [50-PR preparation ledger](/lib/09-harness/harness-engineering-anthology/sources-artichoke-state-refactor-ledger),
...
- [Infrastructure as a Typed Control Plane](/lib/09-harness/harness-engineering-anthology/docs-domain-modeling-homelab)
- [hyperbo.la](/lib/09-harness/harness-engineering-anthology/docs-domain-modeling-hyperbola)
- [RustSec](/lib/09-harness/harness-engineering-anthology/docs-proof-rustsec)
...
- [Ryan’s hyperbo.la articles](/lib/09-harness/harness-engineering-anthology/sources-raw-hyperbola)
- [Agent Client Protocol documentation](/lib/09-harness/harness-engineering-anthology/sources-raw-acp)

See [`COPYING.md`](/lib/09-harness/harness-engineering-anthology/COPYING) for license scope and attribution.
