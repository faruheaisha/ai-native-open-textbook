...
entryUrl: "https://github.com/adongwanai/learn-workbuddy/blob/d8c2a32614555196e405f20c67e23ed84f2f2239/s23_audit_sandbox/README.md"
sourceRel: "s23_audit_sandbox/README.md"
rawUrl: "/raw/09-harness/learn-workbuddy/s23_audit_sandbox/README.md"
sourceSha256: "9a75c1782e2d10a1c65aa4ed947af3839e686e8cc4d6bb5beec2f51e24f69dde"
pageSha256: "9a75c1782e2d10a1c65aa4ed947af3839e686e8cc4d6bb5beec2f51e24f69dde"
...
![macOS 沙盒安全分层](/mirror/eb/eb62c8325c0b4a3d85a41a6841ee9a69b009d23b.svg)
...
- **哈希链只能防"改", 防不了"删尾"**：任何一个合法链条的前缀本身也是合法链条，所以攻击者删掉末尾几条记录，`verify()` 依然通过。`mini_workbuddy` 的做法是额外写一个链外锚点文件 `audit.head`（记录条数 + 链尾 hash），验证时交叉比对，从而检测截断。真正的生产环境还应把锚点写到本机之外（远端 / WORM 存储），否则拿到机器的攻击者既能作恶又能改账本。详见 [`docs/security-boundaries.md`](/lib/09-harness/learn-workbuddy/docs-security-boundaries)。
## 问题
