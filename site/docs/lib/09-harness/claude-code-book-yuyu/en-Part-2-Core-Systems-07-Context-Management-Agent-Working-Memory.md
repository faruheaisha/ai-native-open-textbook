...
entryUrl: "https://github.com/lintsinghua/claude-code-book/blob/1e2068c05ba80b85d86caae7b4c32e7478e66d09/en/Part-2-Core-Systems/07-Context-Management-Agent-Working-Memory.md"
sourceRel: "en/Part-2-Core-Systems/07-Context-Management-Agent-Working-Memory.md"
rawUrl: "/raw/09-harness/claude-code-book-yuyu/en/Part-2-Core-Systems/07-Context-Management-Agent-Working-Memory.md"
sourceSha256: "b930d75a436cadf918b88ca44531eea01ff1a3448bf0f9b6c0f0b21d73ba2a8f"
pageSha256: "b930d75a436cadf918b88ca44531eea01ff1a3448bf0f9b6c0f0b21d73ba2a8f"
...
- `` block: The formal summary content, containing a structured set of 9 sections.

The `formatCompactSummary` function handles post-processing: it first discards the `<analysis>` block (thinking scratchpad), then extracts the content of the `` block as the formal summary.
...
> **Best Practice:** If you need to customize compression behavior in a PreCompact hook, you can adjust the priority of the 9 sections within ``. For example, if your work focuses on API design, you can inject an instruction in the hook: "In the summary, specifically preserve all API endpoint definitions and their rationale for changes."
...
4. **Dual-Phase Prompt Structure**: `<analysis>` thinking scratchpad + `` formal summary. The former is discarded in the final context to save tokens -- "thinking is the process, the summary is the result."
