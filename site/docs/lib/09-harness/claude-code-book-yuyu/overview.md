...
entryUrl: "https://github.com/lintsinghua/claude-code-book/blob/1e2068c05ba80b85d86caae7b4c32e7478e66d09/00-前言.md"
sourceRel: "00-前言.md"
rawUrl: "/raw/09-harness/claude-code-book-yuyu/00-前言.md"
sourceSha256: "5910e45091514138cc2c104cf4511a96ca158f8c2718870282ae7ceeaa399507"
pageSha256: "5910e45091514138cc2c104cf4511a96ca158f8c2718870282ae7ceeaa399507"
...
flowchart LR
    subgraph wave1["2021-2022"]
        A["代码补全<br/>Inline Complete"]
    end
    subgraph wave2["2023-2024"]
        B["对话助手<br/>Chat Assisted"]
    end
    subgraph wave3["2025 至今"]
        C["自主智能体<br/>Agent Autonomy"]
    end
...
这本书试图填补这个空白。我们结合 Claude Code 的公开文档、产品行为和社区讨论讲解 Agent Harness 的设计原理。
...
```mermaid
flowchart TB
    p1["第一部分 · 基础篇<br/>01 智能体编程的新范式<br/>02 对话循环<br/>03 工具系统<br/>04 权限管线"]
    p2["第二部分 · 核心系统篇<br/>05 设置与配置<br/>06 记忆系统<br/>07 上下文管理<br/>08 钩子系统"]
    p3["第三部分 · 高级模式篇<br/>09 子智能体与 Fork<br/>10 多智能体编排<br/>11 技能与插件<br/>12 MCP 与外部协议"]
    p4["第四部分 · 工程实践篇<br/>13 流式架构与性能优化<br/>14 Plan 模式与工作流<br/>15 构建自己的 Harness"]
    p1 --> p2 --> p3 --> p4
