...
- [Context Engineering](/lib/09-harness/harness-engineering-guide-nexu/guide-context-engineering) — deep dive on context assembly, compression, and budgeting
- [Multi-Agent Orchestration](/lib/09-harness/harness-engineering-guide-nexu/guide-multi-agent-orchestration) — orchestration patterns beyond the three-agent architecture
- [Error Handling](/lib/09-harness/harness-engineering-guide-nexu/guide-error-handling) — handling failures, retries, and graceful degradation in agent loops
