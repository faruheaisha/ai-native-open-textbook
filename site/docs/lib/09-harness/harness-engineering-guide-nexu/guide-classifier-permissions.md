...
**3. Prompt injection.** A malicious README or web page contains ``. The agent reads it and follows the instruction as if it were from the user.
...
- [Guardrails](/lib/09-harness/harness-engineering-guide-nexu/guide-guardrails) — The general permission-layer model this sits on top of
- [Sandbox](/lib/09-harness/harness-engineering-guide-nexu/guide-sandbox) — OS-level isolation that should still run underneath your classifier
