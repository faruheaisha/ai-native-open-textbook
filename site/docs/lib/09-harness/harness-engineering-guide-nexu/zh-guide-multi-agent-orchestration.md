...
entryUrl: "https://github.com/nexu-io/harness-engineering-guide/blob/86fec9bea430cecb29ff10afaae36b96496a8f8e/zh-guide/multi-agent-orchestration.md"
sourceRel: "zh-guide/multi-agent-orchestration.md"
rawUrl: "/raw/09-harness/harness-engineering-guide-nexu/zh-guide/multi-agent-orchestration.md"
sourceSha256: "20648e6d1b64b89dae1b7e4216621337b00c898e85fda8227e3f29aeb05d02c0"
pageSha256: "20648e6d1b64b89dae1b7e4216621337b00c898e85fda8227e3f29aeb05d02c0"
...
[Sub-Agent](/lib/09-harness/harness-engineering-guide-nexu/zh-guide-sub-agent) 一文介绍了最简单的情况：一个主 Agent 生成多个 Worker 执行并行任务。本文更进一步——探讨多个 Agent 协作、专业化和规模化的编排模式。
...
Harness（将 LLM 包装成可工作 Agent 的宿主程序——参见[什么是 Harness](/lib/09-harness/harness-engineering-guide-nexu/zh-guide-what-is-harness)）通过四个机制实现多 Agent 编排：Sub-Agent 生成、Context 隔离、父读子结果通信、超时处理。
...
从最简单的有效模式开始。单个 Agent 加上好的 Tool 使用能处理 80% 的任务。当你遇到[为什么需要多 Agent？](#为什么需要多-agent)中描述的限制时，选择解决特定瓶颈的最轻量编排模式。[Sub-Agent](/lib/09-harness/harness-engineering-guide-nexu/zh-guide-sub-agent) 一文介绍了最简单的委派模式——在构建完整编排层之前先从那里开始。

## 延伸阅读

- [Sub-Agent](/lib/09-harness/harness-engineering-guide-nexu/zh-guide-sub-agent) — 单主多从的基础委派模式
- [Agentic Loop](/lib/09-harness/harness-engineering-guide-nexu/zh-guide-agentic-loop) — 每个 Agent 内部运行的核心执行循环
- [Context 工程](/lib/09-harness/harness-engineering-guide-nexu/zh-guide-context-engineering) — 管理每个 Agent 的 Context Window 中放什么
