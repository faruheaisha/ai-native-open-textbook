...
- [scheduling-and-automation.md](/lib/09-harness/harness-engineering-guide-nexu/guide-scheduling-and-automation) — how to wake the coding agent on a schedule without human babysitting
- [long-running-harness.md](/lib/09-harness/harness-engineering-guide-nexu/guide-long-running-harness) — the broader family of patterns this fits into
- [memory-and-context.md](/lib/09-harness/harness-engineering-guide-nexu/guide-memory-and-context) — deeper dive on out-of-context memory, file layouts, and bootstrap rituals
