---
title: "基于 Classifier 的权限系统（Auto Mode）"
...
entryUrl: "https://github.com/nexu-io/harness-engineering-guide/blob/86fec9bea430cecb29ff10afaae36b96496a8f8e/zh-guide/classifier-permissions.md"
sourceRel: "zh-guide/classifier-permissions.md"
rawUrl: "/raw/09-harness/harness-engineering-guide-nexu/zh-guide/classifier-permissions.md"
sourceSha256: "7b86801c0486b68dc413eeb3728bb7cbeaf970bce423d5e2524f1ba2621a21bc"
pageSha256: "7b86801c0486b68dc413eeb3728bb7cbeaf970bce423d5e2524f1ba2621a21bc"
...
**3. Prompt Injection。** 一个恶意的 README 或网页里包含 ``。Agent 读到了，就像它是用户发出的指令一样去执行。
...
- [Guardrails](/lib/09-harness/harness-engineering-guide-nexu/zh-guide-guardrails) ——这套机制所依托的通用权限层模型
- [Sandbox](/lib/09-harness/harness-engineering-guide-nexu/zh-guide-sandbox) ——应当继续跑在你的 Classifier 下面的 OS 级隔离
