...
- [Sandboxing agent environments](/lib/09-harness/harness-engineering-guide-nexu/guide-sandbox) — capability restriction, MIME allowlists, filesystem isolation.
- [Guardrails for web-enabled agents](/lib/09-harness/harness-engineering-guide-nexu/guide-guardrails) — allowlists, rate limits, credential gating.
- [Eval infrastructure](/lib/09-harness/harness-engineering-guide-nexu/guide-eval-infrastructure) — private holdouts, per-run task generation, rotation.
