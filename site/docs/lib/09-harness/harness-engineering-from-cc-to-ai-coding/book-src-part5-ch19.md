...
entryUrl: "https://github.com/ZhangHanDong/harness-engineering-from-cc-to-ai-coding/blob/e40e0feec02b90e308ccbfc7a8911d64118ccca0/book/src/part5/ch19.md"
sourceRel: "book/src/part5/ch19.md"
rawUrl: "/raw/09-harness/harness-engineering-from-cc-to-ai-coding/book/src/part5/ch19.md"
sourceSha256: "3788bc96a9d9b0f19eaa4935f4b4ae9a344f2388f79e890531c2ca0c2769f7be"
pageSha256: "3788bc96a9d9b0f19eaa4935f4b4ae9a344f2388f79e890531c2ca0c2769f7be"
...
export function stripHtmlComments(content: string): {
  ...
  if (!content.includes('` 的注释
2. **未闭合的注释**（``）被保留——这防止一个拼写错误导致文件剩余内容被静默吞噬
3. 注释后的**残留内容**被保留——例如 ` Use bun` 会保留 ` Use bun`
...
`parseMemoryFileContent` 函数（第 343-399 行）中有一个精巧的优化：只有当文件确实包含 `
