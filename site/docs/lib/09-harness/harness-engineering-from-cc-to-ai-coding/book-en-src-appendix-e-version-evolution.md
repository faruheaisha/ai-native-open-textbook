---
title: "Appendix E: Version Evolution Log"
...
entryUrl: "https://github.com/ZhangHanDong/harness-engineering-from-cc-to-ai-coding/blob/e40e0feec02b90e308ccbfc7a8911d64118ccca0/book-en/src/appendix/e-version-evolution.md"
sourceRel: "book-en/src/appendix/e-version-evolution.md"
rawUrl: "/raw/09-harness/harness-engineering-from-cc-to-ai-coding/book-en/src/appendix/e-version-evolution.md"
sourceSha256: "b98e6c8930852beafe065e55fa6abc522122f5340bbe1bee61c4f1becc3707d4"
pageSha256: "b98e6c8930852beafe065e55fa6abc522122f5340bbe1bee61c4f1becc3707d4"
...
|--------|-------------------|---------|
| Tree-sitter WASM removal | [ch16 Permission System](/lib/09-harness/harness-engineering-from-cc-to-ai-coding/book-en-src-part5-ch16#version-evolutionv2191-changes) | Bash security reverted from AST analysis to regex/shell-quote; due to CC-643 performance issues |
| `"auto"` permission mode formalized | [ch16](/lib/09-harness/harness-engineering-from-cc-to-ai-coding/book-en-src-part5-ch16#version-evolutionv2191-changes)-[ch17](/lib/09-harness/harness-engineering-from-cc-to-ai-coding/book-en-src-part5-ch17#version-evolutionv2191-changes) Permissions/YOLO | SDK public API added auto mode |
| Cold compaction + dialog + quick backfill circuit breaker | [ch11 Micro-compaction](/lib/09-harness/harness-engineering-from-cc-to-ai-coding/book-en-src-part3-ch11#version-evolutionv2191-changes) | Added deferred compaction strategy and user confirmation UI |

### Medium-Impact Changes

| Change | Affected Chapters | Details |
|--------|-------------------|---------|
| `staleReadFileStateHint` | [ch09](/lib/09-harness/harness-engineering-from-cc-to-ai-coding/book-en-src-part3-ch09#version-evolutionv2191-changes)-[ch10](/lib/09-harness/harness-engineering-from-cc-to-ai-coding/book-en-src-part3-ch10#version-evolutionv2191-changes) Context Management | File mtime change detection during tool execution |
| Ultraplan remote multi-agent planning | [ch20 Agent Clusters](/lib/09-harness/harness-engineering-from-cc-to-ai-coding/book-en-src-part6-ch20) | CCR remote sessions + Opus 4.6 + 30min timeout |
| Sub-agent enhancements | [ch20](/lib/09-harness/harness-engineering-from-cc-to-ai-coding/book-en-src-part6-ch20)-[ch21](/lib/09-harness/harness-engineering-from-cc-to-ai-coding/book-en-src-part6-ch21#version-evolutionv2191-changes) Multi-agent/Effort | Turn limits, lean schema, cost steering |
