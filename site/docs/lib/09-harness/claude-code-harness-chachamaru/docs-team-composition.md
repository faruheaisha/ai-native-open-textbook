...
entryUrl: "https://github.com/Chachamaru127/claude-code-harness/blob/2b2b74805321089bd9b660a1064fa97556299703/docs/team-composition.md"
sourceRel: "docs/team-composition.md"
rawUrl: "/raw/09-harness/claude-code-harness-chachamaru/docs/team-composition.md"
sourceSha256: "31fe217235ddd9ef51816652701864e1dc578c19dcf7786c900a6cd817a1d45b"
pageSha256: "31fe217235ddd9ef51816652701864e1dc578c19dcf7786c900a6cd817a1d45b"
...
再 spawn 後も同じ条件が再現したら escalation する。Worker 並列数の決め方には影響せず、stall 検出は Lead 側のみ責務。詳細は [`agents/worker.md`](/lib/09-harness/claude-code-harness-chachamaru/agents-worker) の「Stall 検出 — 2 層防御」を参照。
...
は CC live agent 専用で混同しない。規約の正本は [`spec.md` の Worktree Root Discipline](https://github.com/Chachamaru127/claude-code-harness/blob/2b2b74805321089bd9b660a1064fa97556299703/spec.md)
を参照。

worktree の**中身**（共有ファイルの誰が書くか、`VERSION` bump 禁止、生成物の trunk 再生成）は
[Shared File Discipline](https://github.com/Chachamaru127/claude-code-harness/blob/2b2b74805321089bd9b660a1064fa97556299703/.claude/rules/shared-file-discipline.md) に従う。Lead は sprint contract で
