...
entryUrl: "https://github.com/Chachamaru127/claude-code-harness/blob/2b2b74805321089bd9b660a1064fa97556299703/README_ja.md"
sourceRel: "README_ja.md"
rawUrl: "/raw/09-harness/claude-code-harness-chachamaru/README_ja.md"
sourceSha256: "b6fea079f13fc2d11ca07a1a882a01fe4ae65e4a41291fd32952284a35acc045"
pageSha256: "b6fea079f13fc2d11ca07a1a882a01fe4ae65e4a41291fd32952284a35acc045"
...
# Claude Code Harness
  ...
  <img src="/mirror/b2/b2ce981d22e772e129b4e7b031a98a96969d5198.svg" alt="運用ループ: 計画、実装、レビュー、リリース。すべてのコマンドは実行直前に検査される" width="880">
...
軽い調査にも別の設定があります。[担当別の全設定](/lib/09-harness/claude-code-harness-chachamaru/docs-model-routing-policy)を参照してください。
...
適用範囲は利用するアプリによって異なります。[ホスト間の安全差](/lib/09-harness/claude-code-harness-chachamaru/docs-hardening-parity)を参照してください。
...
| Codex CLI | `supported` | [`scripts/setup-codex.sh --user`](https://github.com/Chachamaru127/claude-code-harness/blob/2b2b74805321089bd9b660a1064fa97556299703/codex/README.md#option-1-script-recommended-user-based)。Harness 更新後に再実行し、Codex を再起動 |
| Cursor | `supported` | `scripts/setup-cursor.sh`。閉じ込めは Harness 側で行う（[詳細](/lib/09-harness/claude-code-harness-chachamaru/docs-CURSOR_INTEGRATION)） |
...
[有効化条件と境界](https://github.com/Chachamaru127/claude-code-harness/blob/2b2b74805321089bd9b660a1064fa97556299703/codex/README.md#codex-breezing-role-routing) を参照してください。
...
| 資料 | 内容 |
|---|---|
| [ツール別の入口](/lib/09-harness/claude-code-harness-chachamaru/docs-onboarding) | どのツールから始めるか |
| [導入経路](/lib/09-harness/claude-code-harness-chachamaru/docs-onboarding-install) | ツールごとの設定と対応範囲 |
| [移行チェック](/lib/09-harness/claude-code-harness-chachamaru/docs-onboarding-migration) | 既存環境への影響と戻し方 |
| [起動確認](/lib/09-harness/claude-code-harness-chachamaru/docs-onboarding-skill-trigger-acceptance) | 導入成功をどう確認するか |
| [対応一覧](/lib/09-harness/claude-code-harness-chachamaru/docs-tool-capability-matrix) | ホストごとの主張の全体表 |
| [配布範囲](/lib/09-harness/claude-code-harness-chachamaru/docs-distribution-scope) | 同梱、互換、開発専用の区別 |
| [ホスト間の安全差](/lib/09-harness/claude-code-harness-chachamaru/docs-hardening-parity) | ツールによる防御の違い |
| [全計画実行の根拠](/lib/09-harness/claude-code-harness-chachamaru/docs-evidence-work-all) | 成功と失敗の判定契約 |
| [モデルの使い分け](/lib/09-harness/claude-code-harness-chachamaru/docs-model-routing-policy) | 担当別のモデルと推論量、手動指定の優先順位 |
| [担当への依頼と引継ぎ](/lib/09-harness/claude-code-harness-chachamaru/docs-prompt-calibration) | 完成条件、根拠、修正指示、再開情報の渡し方 |
| [言語設定](/lib/09-harness/claude-code-harness-chachamaru/docs-i18n) | 出力言語の切り替え方 |
| [変更履歴](https://github.com/Chachamaru127/claude-code-harness/blob/2b2b74805321089bd9b660a1064fa97556299703/CHANGELOG.md) | 版ごとの変更点 |

## コントリビュート

Issue と PR を歓迎します。[CONTRIBUTING.md](https://github.com/Chachamaru127/claude-code-harness/blob/2b2b74805321089bd9b660a1064fa97556299703/CONTRIBUTING.md) を参照してください。
...
MIT ライセンス。[LICENSE.md](https://github.com/Chachamaru127/claude-code-harness/blob/2b2b74805321089bd9b660a1064fa97556299703/LICENSE.md) を参照してください。
