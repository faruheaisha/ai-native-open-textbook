...
2. **既存の運用実績**: CLAUDE.md 内では使われていない。pointer は常に `[.claude/rules/xxx.md](https://github.com/Chachamaru127/claude-code-harness/blob/2b2b74805321089bd9b660a1064fa97556299703/docs/path/README.md)` のマークダウンリンク形式
