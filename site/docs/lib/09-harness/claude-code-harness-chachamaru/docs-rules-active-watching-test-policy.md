---
title: "Active Watching Test Policy"
...
entryUrl: "https://github.com/Chachamaru127/claude-code-harness/blob/2b2b74805321089bd9b660a1064fa97556299703/docs/rules/active-watching-test-policy.md"
sourceRel: "docs/rules/active-watching-test-policy.md"
rawUrl: "/raw/09-harness/claude-code-harness-chachamaru/docs/rules/active-watching-test-policy.md"
sourceSha256: "52ee76f74375214e86b4231a19ba9fcb1dbc8f8d2cb4c26e95fec7f8d2ec506f"
pageSha256: "52ee76f74375214e86b4231a19ba9fcb1dbc8f8d2cb4c26e95fec7f8d2ec506f"
...
- [D40](https://github.com/Chachamaru127/claude-code-harness/blob/2b2b74805321089bd9b660a1064fa97556299703/.claude/memory/decisions.md) — tri-state health の設計判断（本規約の理論的根拠）
- [P29](https://github.com/Chachamaru127/claude-code-harness/blob/2b2b74805321089bd9b660a1064fa97556299703/.claude/memory/patterns.md) — dual hooks.json sync + CI gate（wiring 側の再発防止）
- [migration-policy.md](/lib/09-harness/claude-code-harness-chachamaru/docs-rules-migration-policy) — exclusion-based verification の姉妹規約（削除残骸 vs 依存不在）
- [test-quality.md](https://github.com/Chachamaru127/claude-code-harness/blob/2b2b74805321089bd9b660a1064fa97556299703/.claude/rules/test-quality.md) — テスト品質一般（形骸化テスト禁止）
- [implementation-quality.md](https://github.com/Chachamaru127/claude-code-harness/blob/2b2b74805321089bd9b660a1064fa97556299703/.claude/rules/implementation-quality.md) — 実装品質一般
