---
title: "Learn Claude Code -- 真の Agent のための Harness Engineering"
...
entryUrl: "https://github.com/shareAI-lab/learn-claude-code/blob/0dcafa2ae053a1ddd6a72f265431104b08a5aa13/README-ja.md"
sourceRel: "README-ja.md"
rawUrl: "/raw/09-harness/learn-claude-code/README-ja.md"
sourceSha256: "a037478b972e85603dfc325a1d3fcd926cd02689707b85dd16d24897f92b06f9"
pageSha256: "a037478b972e85603dfc325a1d3fcd926cd02689707b85dd16d24897f92b06f9"
...
| [s02](/lib/09-harness/learn-claude-code/s02_tool_use) | Tool Use | `TOOL_HANDLERS` / dispatch map / 並行性 |
| [s03](/lib/09-harness/learn-claude-code/s03_permission) | Permission | `PermissionRule` / 承認パイプライン |
| [s04](/lib/09-harness/learn-claude-code/s04_hooks) | Hooks | `PreToolUse` / `PostToolUse` / 拡張ポイント |
| [s05](/lib/09-harness/learn-claude-code/s05_todo_write) | TodoWrite | `TodoItem` / 計画してから実行 |
| [s06](/lib/09-harness/learn-claude-code/s06_subagent) | Subagent | `fresh messages[]` / コンテキスト分離 |
| [s07](/lib/09-harness/learn-claude-code/s07_skill_loading) | Skill Loading | `SkillLoader` / カタログ / オンデマンド注入 |
| [s08](/lib/09-harness/learn-claude-code/s08_context_compact) | Context Compact | budget / snip / micro / summary の 4 ステップ |
| [s09](/lib/09-harness/learn-claude-code/s09_memory) | Memory | selection / extraction / consolidation |
| [s10](/lib/09-harness/learn-claude-code/s10_task_system) | Task System | `TaskRecord` / `blockedBy` / ディスク永続化 |
| [s11](/lib/09-harness/learn-claude-code/s11_background_tasks) | Background Tasks | スレッド実行 / 通知キュー |
| [s12](/lib/09-harness/learn-claude-code/s12_cron_scheduler) | Cron Scheduler | 永続スケジューリング / セッション限定トリガー |
| [s13](/lib/09-harness/learn-claude-code/s13_agent_teams) | Agent Teams | 永続チームメイト / 原子的認領 / タスクに紐付く Worktree / 型付きプロトコル |
| [s14](/lib/09-harness/learn-claude-code/s14_mcp_plugin) | MCP Plugin | ツール発見 / 名前空間 / ツールプール組み立て |
| [s15](/lib/09-harness/learn-claude-code/s15_integrated_harness) | Integrated Harness | tools、runtime context、tasks、teams、scheduling、MCP を 1 つの loop へ |
| [s16](/lib/09-harness/learn-claude-code/s16_workflow_runtime) | Workflow Runtime | スクリプト編成 / lifecycle event / ジャーナル再開 |
| [s17](/lib/09-harness/learn-claude-code/s17_goal_loop) | Goal Loop | 目標ゲート / conversation の評価 / 自動継続 |
