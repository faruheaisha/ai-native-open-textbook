...
entryUrl: "https://github.com/shareAI-lab/learn-claude-code/blob/0dcafa2ae053a1ddd6a72f265431104b08a5aa13/README-zh.md"
sourceRel: "README-zh.md"
rawUrl: "/raw/09-harness/learn-claude-code/README-zh.md"
sourceSha256: "f8604ee2d70fb98a0138182e39418e47801960c5519e0252301a595272d5566c"
pageSha256: "f8604ee2d70fb98a0138182e39418e47801960c5519e0252301a595272d5566c"
...
| [s02](/lib/09-harness/learn-claude-code/s02_tool_use) | Tool Use | `TOOL_HANDLERS` / dispatch map / 并发 |
| [s03](/lib/09-harness/learn-claude-code/s03_permission) | Permission | `PermissionRule` / 审批管线 |
| [s04](/lib/09-harness/learn-claude-code/s04_hooks) | Hooks | `PreToolUse` / `PostToolUse` / 扩展点 |
| [s05](/lib/09-harness/learn-claude-code/s05_todo_write) | TodoWrite | `TodoItem` / 先计划后执行 |
| [s06](/lib/09-harness/learn-claude-code/s06_subagent) | Subagent | `fresh messages[]` / 上下文隔离 |
| [s07](/lib/09-harness/learn-claude-code/s07_skill_loading) | Skill Loading | `SkillLoader` / 技能目录 / 按需注入 |
| [s08](/lib/09-harness/learn-claude-code/s08_context_compact) | Context Compact | budget / snip / micro / summary 四步压缩 |
| [s09](/lib/09-harness/learn-claude-code/s09_memory) | Memory | selection / extraction / consolidation |
| [s10](/lib/09-harness/learn-claude-code/s10_task_system) | Task System | `TaskRecord` / `blockedBy` / 磁盘持久化 |
| [s11](/lib/09-harness/learn-claude-code/s11_background_tasks) | Background Tasks | 线程执行 / 通知队列 |
| [s12](/lib/09-harness/learn-claude-code/s12_cron_scheduler) | Cron Scheduler | 持久化调度 / 会话级触发 |
| [s13](/lib/09-harness/learn-claude-code/s13_agent_teams) | Agent Teams | 持久队友 / 原子认领 / 任务绑定的 Worktree / 类型协议 |
| [s14](/lib/09-harness/learn-claude-code/s14_mcp_plugin) | MCP Plugin | 工具发现 / 命名空间 / 工具池组装 |
| [s15](/lib/09-harness/learn-claude-code/s15_integrated_harness) | Agent Harness 集成 | 工具、运行时上下文、任务、团队、调度和 MCP 归到一个循环 |
| [s16](/lib/09-harness/learn-claude-code/s16_workflow_runtime) | Workflow Runtime | 脚本编排 / 生命周期事件 / journal 续跑 |
| [s17](/lib/09-harness/learn-claude-code/s17_goal_loop) | Goal Loop | 目标闸门 / 对话判断 / 自动续轮 |
...
阅读 `README.md` 理解核心思想，并逐步学习代码。复杂章节使用 `` 折叠深入内容 -- 想深入时再展开。简单章节有 0-1 张图，复杂章节会有更多。
