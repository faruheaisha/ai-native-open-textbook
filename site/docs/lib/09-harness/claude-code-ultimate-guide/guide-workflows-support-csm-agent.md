...
entryUrl: "https://github.com/FlorianBruniaux/claude-code-ultimate-guide/blob/af05b84fb6e32432dae2114ee2a72c44ef3d29b1/guide/workflows/support-csm-agent.md"
sourceRel: "guide/workflows/support-csm-agent.md"
rawUrl: "/raw/09-harness/claude-code-ultimate-guide/guide/workflows/support-csm-agent.md"
sourceSha256: "c6475195fb0bb5ec8b30ed07420288f733f1ad1c192ca482f0fbed76c89161c6"
pageSha256: "c6475195fb0bb5ec8b30ed07420288f733f1ad1c192ca482f0fbed76c89161c6"
...
| **Linear** | Linear MCP | Issues, projects, comments, cycles | Already documented in [mcp-servers-ecosystem.md](/lib/09-harness/claude-code-ultimate-guide/guide-ecosystem-mcp-servers-ecosystem/index#linear-mcp); reuse that setup for L3 |
...
- **PII handling.** Ticket content and CRM data both carry PII. Follow the data handling practices in [data-privacy.md](/lib/09-harness/claude-code-ultimate-guide/guide-security-data-privacy), and in particular don't let draft replies or diagnostic output land in logs or session transcripts that outlive the ticket.
...
- **Time to first response**: from ticket arrival to reply sent. See [team-metrics.md](/lib/09-harness/claude-code-ultimate-guide/guide-ops-team-metrics) for how to track this alongside other team throughput metrics.
...
- [Linear MCP](/lib/09-harness/claude-code-ultimate-guide/guide-ecosystem-mcp-servers-ecosystem/index#linear-mcp): already documented, reuse for L3

### Related Reading

- [MCP Servers Ecosystem](/lib/09-harness/claude-code-ultimate-guide/guide-ecosystem-mcp-servers-ecosystem/index): evaluation framework to apply to any new server before adoption
- [MCP vs CLI Decision Guide](/lib/09-harness/claude-code-ultimate-guide/guide-ecosystem-mcp-vs-cli): whether a given integration should be an MCP server or a simpler CLI/script

---

## See Also

- [event-driven-agents.md](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-event-driven-agents): trigger tracker updates from support signals, the reverse integration direction
- [mcp-servers-ecosystem.md](/lib/09-harness/claude-code-ultimate-guide/guide-ecosystem-mcp-servers-ecosystem/index): evaluation framework and Linear MCP setup
- [data-privacy.md](/lib/09-harness/claude-code-ultimate-guide/guide-security-data-privacy): PII handling practices referenced in [Security & Guardrails](#security--guardrails)
- [team-metrics.md](/lib/09-harness/claude-code-ultimate-guide/guide-ops-team-metrics): throughput metrics referenced in [Metrics to Track](#metrics-to-track)
