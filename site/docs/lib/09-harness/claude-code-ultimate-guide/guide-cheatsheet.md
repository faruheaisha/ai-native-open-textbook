...
entryUrl: "https://github.com/FlorianBruniaux/claude-code-ultimate-guide/blob/af05b84fb6e32432dae2114ee2a72c44ef3d29b1/guide/cheatsheet.md"
sourceRel: "guide/cheatsheet.md"
rawUrl: "/raw/09-harness/claude-code-ultimate-guide/guide/cheatsheet.md"
sourceSha256: "45b7ba82d487b999bbb5afbe855e8b159c615328ae8c43ef6e381026d17ca112"
pageSha256: "45b7ba82d487b999bbb5afbe855e8b159c615328ae8c43ef6e381026d17ca112"
...
The ~35 below are the daily drivers. Claude Code ships about 100 built-in commands: the complete list is in [§10.1 of the guide](/lib/09-harness/claude-code-ultimate-guide/guide-ultimate-guide/index#101-commands-table), and the always-current official reference is [code.claude.com/docs/en/commands](https://code.claude.com/docs/en/commands).
...
| **Cross-Session Messaging** | v2.1.224 | Sessions message each other across all your machines. `ListAgents` to discover, `SendMessage` to talk, `@name` to mention (v2.1.232). macOS, Linux, Windows (v2.1.234+). [Full guide →](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-cross-session-messaging) |
...
| **Tools** | 8 core: Bash, Read, Edit, Write, Grep, Glob, Agent, TodoWrite ([full 40-tool reference](/lib/09-harness/claude-code-ultimate-guide/guide-core-tools-reference)) |
...
**Deep dive**: [Architecture & Internals](/lib/09-harness/claude-code-ultimate-guide/guide-core-architecture/index)
...
> Full decision table with cost estimates: [Section 2.5 Model Selection & Thinking Guide](/lib/09-harness/claude-code-ultimate-guide/guide-ultimate-guide/index#25-model-selection--thinking-guide)
...
Full reference: [Dynamic Workflows](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-dynamic-workflows)
...
**Full doc**: [§9.22 Remote Control](/lib/09-harness/claude-code-ultimate-guide/guide-ultimate-guide/index#922-remote-control-mobile-access) | [Security notes](/lib/09-harness/claude-code-ultimate-guide/guide-security-security-hardening/index#remote-control-security)
...
**→ Full workflow**: [guide/workflows/task-management.md](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-task-management)
...
> Full workflows: [workflows/search-tools-mastery.md](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-search-tools-mastery)
