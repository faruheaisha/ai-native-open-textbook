...
entryUrl: "https://github.com/FlorianBruniaux/claude-code-ultimate-guide/blob/af05b84fb6e32432dae2114ee2a72c44ef3d29b1/guide/workflows/gstack-workflow.md"
sourceRel: "guide/workflows/gstack-workflow.md"
rawUrl: "/raw/09-harness/claude-code-ultimate-guide/guide/workflows/gstack-workflow.md"
sourceSha256: "0127fa032683db5c0e061ca9578a8c798a8242027363318c236d128837bfc22d"
pageSha256: "0127fa032683db5c0e061ca9578a8c798a8242027363318c236d128837bfc22d"
...
**Related**: [Plan Pipeline](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-plan-pipeline), [Plan-Driven Development](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-plan-driven)
...
|-----------|---------------|-------------|
| Complex feature, direction uncertain | `/plan-ceo-review` first | [Spec-First](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-spec-first) |
| Direction clear, architecture complex | `/plan-eng-review` | [Plan Pipeline](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-plan-pipeline) |
| Need independent validation of plan | [Plan Pipeline](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-plan-pipeline) `/plan-validate` | — |
...
| Want structured ADR learning loop | [Plan Pipeline](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-plan-pipeline) | — |

gstack is a linear gear sequence you control manually; [Plan Pipeline](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-plan-pipeline) is a more automated orchestration with ADR memory and parallel agent teams. For solo developers who want explicit control over each phase, gstack is faster to adopt.

---

## See Also

- [Plan Pipeline](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-plan-pipeline): Automated 3-command workflow with ADR learning loop
- [Plan-Driven Development](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-plan-driven): Fundamentals of planning before coding
- [Iterative Refinement](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-iterative-refinement): Quality improvement cycles
