...
entryUrl: "https://github.com/FlorianBruniaux/claude-code-ultimate-guide/blob/af05b84fb6e32432dae2114ee2a72c44ef3d29b1/guide/workflows/plan-pipeline.md"
sourceRel: "guide/workflows/plan-pipeline.md"
rawUrl: "/raw/09-harness/claude-code-ultimate-guide/guide/workflows/plan-pipeline.md"
sourceSha256: "72f75ea062853a2846a5a154f67a416f8fd1d4ffc7213d533f55e7a03ccd320c"
pageSha256: "72f75ea062853a2846a5a154f67a416f8fd1d4ffc7213d533f55e7a03ccd320c"
...
**Related**: [Plan-Driven Development](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-plan-driven), [Agent Teams](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-agent-teams/index), [Spec-First](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-spec-first)
...
- [Plan-Driven Development](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-plan-driven): native `/plan` mode, lighter alternative
- [Dual-Instance Planning](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-dual-instance-planning): simpler 2-instance pattern
- [Agent Teams](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-agent-teams/index): native parallel coordination (experimental)
- [Task Management](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-task-management): Tasks API for cross-session coordination
- [Spec-First Development](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-spec-first): CLAUDE.md as specification contract
- [ADR Writer Agent](/lib/09-harness/claude-code-ultimate-guide/examples-agents-adr-writer): standalone ADR generation
- [Plan Challenger Agent](/lib/09-harness/claude-code-ultimate-guide/examples-agents-plan-challenger): adversarial plan review
