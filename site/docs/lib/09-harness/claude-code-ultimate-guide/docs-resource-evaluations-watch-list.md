...
entryUrl: "https://github.com/FlorianBruniaux/claude-code-ultimate-guide/blob/af05b84fb6e32432dae2114ee2a72c44ef3d29b1/docs/resource-evaluations/watch-list.md"
sourceRel: "docs/resource-evaluations/watch-list.md"
rawUrl: "/raw/09-harness/claude-code-ultimate-guide/docs/resource-evaluations/watch-list.md"
sourceSha256: "acd8f0d2309416b71e530543286930982ab8429bef5d49181f5f1aae08bddea5"
pageSha256: "acd8f0d2309416b71e530543286930982ab8429bef5d49181f5f1aae08bddea5"
...
| [Fabro](https://github.com/fabro-sh/fabro) | Tool | 2026-03-17 | Graph-based workflow orchestrator for AI coding agents (Rust binary, zero deps, MIT). DOT graph pipelines + multi-model routing (CSS stylesheets) + Git checkpointing per stage (unique, no equivalent found) + Daytona cloud sandboxes. Direct Claude Code integration via `curl \| claude`. Score 3/5. Eval: [079](/lib/09-harness/claude-code-ultimate-guide/docs-resource-evaluations-079-fabro-workflow-orchestration) | >200 GitHub stars OR practitioner write-up from production use |
| [Rippletide Code](https://www.rippletide.com/dev) | Tool | 2026-03-17 | Hook-native runtime rule enforcement for Claude Code. Builds a Context Graph outside LLM context window, uses PreToolUse hooks to block violations pre-execution. Addresses CLAUDE.md degradation at scale (40+ rules) and compaction-driven rule loss. Free beta (`npx rippletide-code`, no signup). Distinct from eval 072 (MCP/SaaS). Score 3/5. Eval: [081](/lib/09-harness/claude-code-ultimate-guide/docs-resource-evaluations-081-rippletide-code-rule-enforcement) | Public GitHub repo >100 stars OR independent practitioner write-up from production |

| [stacklit-cli](https://github.com/liza-mas/stacklit-cli) | Tool | 2026-06-10 | Go reimplementation of the documented stacklit concept (glincker/stacklit). Claims ~250 tokens codebase context, auto-configures Claude Code/Cursor/Aider. Same concept, different runtime (no npm/Node). Score 2/5. Eval: [liza-mas-token-saving-cli-tools.md](/lib/09-harness/claude-code-ultimate-guide/docs-resource-evaluations-liza-mas-token-saving-cli-tools) | >50 GitHub stars AND practitioner write-up from production use |
| [Switch](https://github.com/sandbox-quantum/switch) | Tool | 2026-08-27 | Matrix-based bus connecting heterogeneous agents (Claude Code, Codex, OpenCode) and humans in the same room, relayed into Slack/Teams/Discord/Telegram/Mattermost with owner-inheritance authz. Fills a real category gap (no comparable multi-platform bridge exists elsewhere in the guide) but pre-1.0 (0.21.0), 252 stars/6 weeks, bus factor close to 1 (80%), no independent production adopter found. Score 3/5. Eval: [switch-agent-human-chat-bridge.md](/lib/09-harness/claude-code-ultimate-guide/docs-resource-evaluations-switch-agent-human-chat-bridge) | Tagged `1.0.0` release, OR independently documented production deployment (not SandboxAQ/Flint AI), OR a second comparable chat-bridge tool appears (enabling a comparison table) |
