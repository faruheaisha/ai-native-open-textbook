...
entryUrl: "https://github.com/FlorianBruniaux/claude-code-ultimate-guide/blob/af05b84fb6e32432dae2114ee2a72c44ef3d29b1/guide/core/visual-reference.md"
sourceRel: "guide/core/visual-reference.md"
rawUrl: "/raw/09-harness/claude-code-ultimate-guide/guide/core/visual-reference.md"
sourceSha256: "ea1875d70903b0bf3b7df44fc83edfcea8092948930889bf5f468ac15ba4d242"
pageSha256: "ea1875d70903b0bf3b7df44fc83edfcea8092948930889bf5f468ac15ba4d242"
...
For detailed docs → [Ultimate Guide](/lib/09-harness/claude-code-ultimate-guide/guide-ultimate-guide/index) | [Cheatsheet](/lib/09-harness/claude-code-ultimate-guide/guide-cheatsheet)

> **Interactive Mermaid diagrams available**: For 40 interactive diagrams covering model selection, agent lifecycle, memory hierarchy, multi-agent patterns, security threats, and more, see **[guide/diagrams/](/lib/09-harness/claude-code-ultimate-guide/guide-diagrams)**. This file contains ASCII versions of key concepts.
...
These ASCII diagrams cover selected Claude Code concepts. For the harness taxonomy, use the three figures on the [Agent Harness Map](/lib/09-harness/claude-code-ultimate-guide/guide-ecosystem-agent-harness-landscape/index): strict and broad scope, the four layers, and the selection funnel. [Agent Harness Engineering](/lib/09-harness/claude-code-ultimate-guide/guide-core-agent-harness/index) explains the model, runtime harness, repository harness, and orchestrator. [Agent Tools: Beyond Claude Code](/lib/09-harness/claude-code-ultimate-guide/guide-ecosystem-agentic-tools/index) covers frameworks and control planes. Use [Agent Evaluation](/lib/09-harness/claude-code-ultimate-guide/guide-roles-agent-evaluation), [Session Observability](/lib/09-harness/claude-code-ultimate-guide/guide-ops-observability), and [Security Hardening](/lib/09-harness/claude-code-ultimate-guide/guide-security-security-hardening/index) to test, inspect, and constrain the chosen design. Definitions are in the [glossary](/lib/09-harness/claude-code-ultimate-guide/guide-core-glossary).
...
→ Source: [ultimate-guide.md:1335](/lib/09-harness/claude-code-ultimate-guide/guide-ultimate-guide/index)
...
→ Source: [ultimate-guide.md:760](/lib/09-harness/claude-code-ultimate-guide/guide-ultimate-guide/index)
...
→ Source: [ultimate-guide.md:277](/lib/09-harness/claude-code-ultimate-guide/guide-ultimate-guide/index)
...
→ Source: [reference.yaml](https://github.com/FlorianBruniaux/claude-code-ultimate-guide/blob/af05b84fb6e32432dae2114ee2a72c44ef3d29b1/machine-readable/reference.yaml) (decide section)
...
→ Source: [architecture.md:84](/lib/09-harness/claude-code-ultimate-guide/guide-core-architecture/index)
...
→ Source: [ultimate-guide.md:6327](/lib/09-harness/claude-code-ultimate-guide/guide-ultimate-guide/index)
...
→ Source: [data-privacy.md:24](/lib/09-harness/claude-code-ultimate-guide/guide-security-data-privacy)
...
→ Source: [security-hardening.md:33](/lib/09-harness/claude-code-ultimate-guide/guide-security-security-hardening/index)
...
→ Source: [sandbox-isolation.md:87](/lib/09-harness/claude-code-ultimate-guide/guide-security-sandbox-isolation)
...
→ Source: [search-tools-mastery.md:75](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-search-tools-mastery)
...
→ Source: [ultimate-guide.md:1182](/lib/09-harness/claude-code-ultimate-guide/guide-ultimate-guide/index)
...
→ Source: [adoption-approaches.md:51](/lib/09-harness/claude-code-ultimate-guide/guide-roles-adoption-approaches)
...
→ Source: [methodologies.md:24](/lib/09-harness/claude-code-ultimate-guide/guide-core-methodologies)
...
→ Source: [ai-ecosystem.md:155](/lib/09-harness/claude-code-ultimate-guide/guide-ecosystem-ai-ecosystem/index)
...
→ Source: [iterative-refinement.md:354](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-iterative-refinement)
...
→ Source: [pdf-generation.md:58](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-pdf-generation)
...
> Source: [workflows/tdd-with-claude.md:78](/lib/09-harness/claude-code-ultimate-guide/guide-workflows-tdd-with-claude)
...
> Source: [learning-with-ai.md:208](/lib/09-harness/claude-code-ultimate-guide/guide-roles-learning-with-ai/index)
...
> Source: [security-hardening.md:24/205/345](/lib/09-harness/claude-code-ultimate-guide/guide-security-security-hardening/index)
...
> Source: [security-hardening.md:347](/lib/09-harness/claude-code-ultimate-guide/guide-security-security-hardening/index)

---

*Back to [Guide README](/lib/09-harness/claude-code-ultimate-guide/guide) | [Cheatsheet](/lib/09-harness/claude-code-ultimate-guide/guide-cheatsheet) | [Main README](/lib/09-harness/claude-code-ultimate-guide/guide)*
