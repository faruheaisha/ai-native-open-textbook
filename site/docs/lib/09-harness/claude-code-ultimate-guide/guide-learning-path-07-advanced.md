...
entryUrl: "https://github.com/FlorianBruniaux/claude-code-ultimate-guide/blob/af05b84fb6e32432dae2114ee2a72c44ef3d29b1/guide/learning-path/07-advanced.md"
sourceRel: "guide/learning-path/07-advanced.md"
rawUrl: "/raw/09-harness/claude-code-ultimate-guide/guide/learning-path/07-advanced.md"
sourceSha256: "a8d8b99d28f4d2a44f930a03754d8106b98ac285bd3403119ac206da1f36f26f"
pageSha256: "a8d8b99d28f4d2a44f930a03754d8106b98ac285bd3403119ac206da1f36f26f"
...
Before choosing a team pattern, separate the layers: the model produces tokens, a runtime harness owns a session's model-and-tool loop, the repository harness supplies instructions and verification, and an orchestrator coordinates sessions. [Agent Harness Engineering](/lib/09-harness/claude-code-ultimate-guide/guide-core-agent-harness/index) explains that model; the [Agent Harness Map](/lib/09-harness/claude-code-ultimate-guide/guide-ecosystem-agent-harness-landscape/index) compares loop-owning runtimes and keeps the broader directory separate. Use [Agent Tools: Beyond Claude Code](/lib/09-harness/claude-code-ultimate-guide/guide-ecosystem-agentic-tools/index) for frameworks and control planes, the [glossary](/lib/09-harness/claude-code-ultimate-guide/guide-core-glossary) for terms, [Agent Evaluation](/lib/09-harness/claude-code-ultimate-guide/guide-roles-agent-evaluation) to score the result, [Session Observability](/lib/09-harness/claude-code-ultimate-guide/guide-ops-observability) to inspect execution, and [Security Hardening](/lib/09-harness/claude-code-ultimate-guide/guide-security-security-hardening/index) before running work unattended.
