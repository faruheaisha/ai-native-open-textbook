...
entryUrl: "https://github.com/FlorianBruniaux/claude-code-ultimate-guide/blob/af05b84fb6e32432dae2114ee2a72c44ef3d29b1/guide/ops/ai-traceability.md"
sourceRel: "guide/ops/ai-traceability.md"
rawUrl: "/raw/09-harness/claude-code-ultimate-guide/guide/ops/ai-traceability.md"
sourceSha256: "f27545649712476b090fcd0a5cbcb14ce423de292f191132216449f231997e61"
pageSha256: "f27545649712476b090fcd0a5cbcb14ce423de292f191132216449f231997e61"
...
See [Security Hardening](/lib/09-harness/claude-code-ultimate-guide/guide-security-security-hardening/index) for full guidance.
...
|-----------------|----------------|-----------------|
| "Show your AI usage policy" | `docs/ai-usage-charter.md` | See [charter template](/lib/09-harness/claude-code-ultimate-guide/examples-scripts-ai-usage-charter-template) |
| "Show access controls for AI tools" | `.claude/settings.json` (permissions.deny) | Committed to each project repo |
| "Show third-party AI component vetting" | `.claude/mcp-registry.yaml` | See [registry template](https://github.com/FlorianBruniaux/claude-code-ultimate-guide/blob/af05b84fb6e32432dae2114ee2a72c44ef3d29b1/examples/scripts/mcp-registry-template.yaml) |
...
**Practical tip**: Run `./scripts/claude-governance-audit.sh` (see [enterprise-governance.md §5.3](/lib/09-harness/claude-code-ultimate-guide/guide-security-enterprise-governance#53-compliance-checking)) before each audit to verify controls are in place and generate a baseline report.
