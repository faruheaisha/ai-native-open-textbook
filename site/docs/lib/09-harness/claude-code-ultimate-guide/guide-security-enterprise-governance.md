...
entryUrl: "https://github.com/FlorianBruniaux/claude-code-ultimate-guide/blob/af05b84fb6e32432dae2114ee2a72c44ef3d29b1/guide/security/enterprise-governance.md"
sourceRel: "guide/security/enterprise-governance.md"
rawUrl: "/raw/09-harness/claude-code-ultimate-guide/guide/security/enterprise-governance.md"
sourceSha256: "0b9f6adad2fe7a20a3f56b63d65a843e1ce87acbe3313d685b85c208d2eb0d1f"
pageSha256: "0b9f6adad2fe7a20a3f56b63d65a843e1ce87acbe3313d685b85c208d2eb0d1f"
...
>
> **Scope**: Org-level governance (policies, approval workflows, tiers, compliance). For individual dev security (injection defense, MCP vetting, CVEs), see [security-hardening.md](/lib/09-harness/claude-code-ultimate-guide/guide-security-security-hardening/index). For the 6 non-negotiable production rules, see [production-safety.md](/lib/09-harness/claude-code-ultimate-guide/guide-security-production-safety).
...
Individual MCP vetting (the 5-minute audit) is covered in [security-hardening.md §1.1](/lib/09-harness/claude-code-ultimate-guide/guide-security-security-hardening/index#11-mcp-vetting-workflow). This section covers the organizational workflow: how new MCPs get approved, deployed, and monitored across your team.
...
The trade-off is real and should be weighed against the registry's own maturity, not against Executor's marketing. A one-person project (93% of commits by a single contributor, measured 2026-07-29) at a pre-1.0 version is a different risk profile than a YAML file your own team owns and can read end to end in ten minutes. Treat Executor as what a hand-rolled registry eventually converges toward once it needs multi-agent sharing and credential indirection, not as a drop-in replacement for the workflow above. Full evaluation, including the vision-versus-shipped-code gap and the bus-factor detail: [`docs/resource-evaluations/executor-integration-governance-layer.md`](/lib/09-harness/claude-code-ultimate-guide/docs-resource-evaluations-executor-integration-governance-layer).
...
**Additional tool for regulated environments**: Consider Entire CLI for full session audit trails with approval gates. See [AI Traceability §5.1](/lib/09-harness/claude-code-ultimate-guide/guide-ops-ai-traceability#51-entire-cli) for details and a go/no-go evaluation checklist.
...
**For full compliance audit trails with approval gates**, consider Entire CLI. It captures complete session context (prompts, reasoning, tool calls, file diffs) with cryptographic linking to git commits. See [AI Traceability §5.1](/lib/09-harness/claude-code-ultimate-guide/guide-ops-ai-traceability#51-entire-cli) for setup and evaluation criteria. This is one tool among several options; evaluate against your specific compliance requirements.
...
The observability layer for governance is covered in [observability.md](/lib/09-harness/claude-code-ultimate-guide/guide-ops-observability). For compliance specifically, these monitoring queries are most relevant:
...
- [Security Hardening](/lib/09-harness/claude-code-ultimate-guide/guide-security-security-hardening/index): Individual dev security: MCP CVEs, injection defense, 5-min audit
- [Production Safety Rules](/lib/09-harness/claude-code-ultimate-guide/guide-security-production-safety): 6 non-negotiable rules for prod teams (ports, DB safety, infra lock)
- [Data Privacy Guide](/lib/09-harness/claude-code-ultimate-guide/guide-security-data-privacy): What data Claude Code sends to Anthropic, retention policies
- [AI Traceability](/lib/09-harness/claude-code-ultimate-guide/guide-ops-ai-traceability): Attribution policies, Entire CLI, git-ai, compliance frameworks
- [Observability](/lib/09-harness/claude-code-ultimate-guide/guide-ops-observability): Session monitoring, cost tracking, activity audit queries
- [Adoption Approaches](/lib/09-harness/claude-code-ultimate-guide/guide-roles-adoption-approaches): Team rollout patterns, CLAUDE.md strategies
- [MCP Registry Template](https://github.com/FlorianBruniaux/claude-code-ultimate-guide/blob/af05b84fb6e32432dae2114ee2a72c44ef3d29b1/examples/scripts/mcp-registry-template.yaml): Ready-to-use registry format
- [Governance Hook](https://github.com/FlorianBruniaux/claude-code-ultimate-guide/blob/af05b84fb6e32432dae2114ee2a72c44ef3d29b1/examples/hooks/bash/governance-enforcement-hook.sh): Hook validating config against policy
- [AI Usage Charter Template](/lib/09-harness/claude-code-ultimate-guide/examples-scripts-ai-usage-charter-template): Charter template ready to adapt
...
*Version 1.0.0 | March 2026 | Part of [Claude Code Ultimate Guide](/lib/09-harness/claude-code-ultimate-guide/guide)*
