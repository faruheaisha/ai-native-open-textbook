...
`/goal`、`/loop`、Auto Mode 三件套也补上了，细节在 [第 15 章：自治与续跑](https://github.com/Windy3f3f3f3f/claude-code-from-scratch/blob/0b452360866433fde0dc77cd37ada9d303546592/docs/docs/15-autonomy.md)。它们让 agent 能跨很多 turn、在无人盯着的情况下继续往前走：`/goal` 用一个独立评估器把停止条件追到达成或判定不可能，`/loop` 让主模型按间隔或自定节奏排下一次运行，Auto Mode 用一个读脱敏对话记录的分类器代替危险操作的确认框。提示词逐字取自泄露实锤，机制上做了几处教学简化：Auto Mode 的两段式分类流程已经复现，只是省了真实客户端的 stop_sequences、thinking-token 那些外围细节；`/loop` 用会话内定时器代替了 KAIROS 常驻进程。本章下面「扩展方向」里原本对这类能力的设想，可以对照第 15 章看已经落地到什么程度。
...
|------|--------|----------------------|
| Agent 循环 | [Ch1: Agent Loop](https://github.com/Windy3f3f3f3f/claude-code-from-scratch/blob/0b452360866433fde0dc77cd37ada9d303546592/docs/docs/01-agent-loop.md) | [系统主循环](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop) |
| 工具系统 | [Ch2: 工具系统](https://github.com/Windy3f3f3f3f/claude-code-from-scratch/blob/0b452360866433fde0dc77cd37ada9d303546592/docs/docs/02-tools.md) | [工具系统](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/04-tool-system) |
| 上下文管理 | [Ch7: 上下文管理](https://github.com/Windy3f3f3f3f/claude-code-from-scratch/blob/0b452360866433fde0dc77cd37ada9d303546592/docs/docs/07-context.md) | [上下文工程](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering) |
| 权限安全 | [Ch6: 权限与安全](https://github.com/Windy3f3f3f3f/claude-code-from-scratch/blob/0b452360866433fde0dc77cd37ada9d303546592/docs/docs/06-permissions.md) | [权限与安全](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/10-permission-security) |
| 记忆系统 | [Ch8: 记忆系统](https://github.com/Windy3f3f3f3f/claude-code-from-scratch/blob/0b452360866433fde0dc77cd37ada9d303546592/docs/docs/08-memory.md) | [记忆系统](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/08-memory-system) |
| 技能系统 | [Ch9: 技能系统](https://github.com/Windy3f3f3f3f/claude-code-from-scratch/blob/0b452360866433fde0dc77cd37ada9d303546592/docs/docs/09-skills.md) | [技能系统](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/09-skills-system) |
| Plan Mode | [Ch10: Plan Mode](https://github.com/Windy3f3f3f3f/claude-code-from-scratch/blob/0b452360866433fde0dc77cd37ada9d303546592/docs/docs/10-plan-mode.md) | — |
| 多 Agent | [Ch11: 多 Agent](https://github.com/Windy3f3f3f3f/claude-code-from-scratch/blob/0b452360866433fde0dc77cd37ada9d303546592/docs/docs/11-multi-agent.md) | [多 Agent 架构](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/07-multi-agent) |
| MCP 集成 | [Ch12: MCP 集成](https://github.com/Windy3f3f3f3f/claude-code-from-scratch/blob/0b452360866433fde0dc77cd37ada9d303546592/docs/docs/12-mcp.md) | — |
| 自治与续跑 | [Ch15: 自治与续跑](https://github.com/Windy3f3f3f3f/claude-code-from-scratch/blob/0b452360866433fde0dc77cd37ada9d303546592/docs/docs/15-autonomy.md) | [自治 /goal /loop](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/17-autonomy-goal-loop) · [Auto Mode](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/18-auto-mode) · [动态工作流](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/19-dynamic-workflows) |
