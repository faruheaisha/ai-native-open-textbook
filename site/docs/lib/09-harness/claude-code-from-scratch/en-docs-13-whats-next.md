...
entryUrl: "https://github.com/Windy3f3f3f3f/claude-code-from-scratch/blob/0b452360866433fde0dc77cd37ada9d303546592/en/docs/13-whats-next.md"
sourceRel: "en/docs/13-whats-next.md"
rawUrl: "/raw/09-harness/claude-code-from-scratch/en/docs/13-whats-next.md"
sourceSha256: "37dc49fa37739ce4412984cd7f6db63134b896e82cf05ffaeb56ab788ee84267"
pageSha256: "37dc49fa37739ce4412984cd7f6db63134b896e82cf05ffaeb56ab788ee84267"
...
|-------|--------------|----------------------|
| Agent loop | [Ch1: Agent Loop](/lib/09-harness/claude-code-from-scratch/en-docs-01-agent-loop) | [System Main Loop](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop) |
| Tool system | [Ch2: Tool System](/lib/09-harness/claude-code-from-scratch/en-docs-02-tools) | [Tool System](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/04-tool-system) |
| Context management | [Ch7: Context Management](/lib/09-harness/claude-code-from-scratch/en-docs-07-context) | [Context Engineering](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering) |
| Permission security | [Ch6: Permissions and Security](/lib/09-harness/claude-code-from-scratch/en-docs-06-permissions) | [Permissions and Security](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/10-permission-security) |
| Memory system | [Ch8: Memory System](/lib/09-harness/claude-code-from-scratch/en-docs-08-memory) | [Memory System](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/08-memory-system) |
| Skills system | [Ch9: Skills System](/lib/09-harness/claude-code-from-scratch/en-docs-09-skills) | [Skills System](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/09-skills-system) |
| Plan Mode | [Ch10: Plan Mode](/lib/09-harness/claude-code-from-scratch/en-docs-10-plan-mode) | -- |
| Multi-Agent | [Ch11: Multi-Agent](/lib/09-harness/claude-code-from-scratch/en-docs-11-multi-agent) | [Multi-Agent Architecture](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/07-multi-agent) |
| MCP integration | [Ch12: MCP Integration](/lib/09-harness/claude-code-from-scratch/en-docs-12-mcp) | -- |
| Autonomy & continuation | [Ch15: Autonomy & Continuation](/lib/09-harness/claude-code-from-scratch/en-docs-15-autonomy) | [Autonomy /goal /loop](https://windy3f3f3f3f.github.io/how-claude-code-works/#/en/docs/17-autonomy-goal-loop) · [Auto Mode](https://windy3f3f3f3f.github.io/how-claude-code-works/#/en/docs/18-auto-mode) · [Dynamic Workflows](https://windy3f3f3f3f.github.io/how-claude-code-works/#/en/docs/19-dynamic-workflows) |
