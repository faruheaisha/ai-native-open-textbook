...
entryUrl: "https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/references/project-harness/agent-verify-loop.md"
sourceRel: "references/project-harness/agent-verify-loop.md"
rawUrl: "/raw/09-harness/better-harness/references/project-harness/agent-verify-loop.md"
sourceSha256: "19f07e99281977b112df49f308c78bc7e7833901f6085fa9b45231a9e56a6387"
pageSha256: "19f07e99281977b112df49f308c78bc7e7833901f6085fa9b45231a9e56a6387"
...
- The trigger and probe are understood, but the real environment is
  ...
  [Verification Environment Design](/lib/09-harness/better-harness/references-project-harness-verification-environment) to select and
...
Use [Verification Environment Design](/lib/09-harness/better-harness/references-project-harness-verification-environment) to state the
...
[UI and System Drivers](/lib/09-harness/better-harness/references-project-harness-ui-and-system-drivers) to pick the injection point
...
[Verification Environment Design](/lib/09-harness/better-harness/references-project-harness-verification-environment) for the rung and
gate definitions.
...
- **An empty run fails.** A run that executed zero of its matched cases is not
  ...
  [Verification Environment Design](/lib/09-harness/better-harness/references-project-harness-verification-environment): the runner
...
2. **Localize** with the cheapest sufficient diagnostics, escalating to
   ...
   [UI and System Drivers](/lib/09-harness/better-harness/references-project-harness-ui-and-system-drivers) for choosing a driver by
...
[Agent-Friendly CLI](/lib/09-harness/better-harness/references-project-harness-friendly-cli) for contract, surface, and projection
...
2. **Extract the probe.** Turn the manual checks from step 1 into the
   ...
   with [Verification Environment Design](/lib/09-harness/better-harness/references-project-harness-verification-environment),
...
[Loop Blueprint](/lib/09-harness/better-harness/references-loop-engineering-loop-blueprint): run the probe
