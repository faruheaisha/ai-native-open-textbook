...
entryUrl: "https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/i18n/zh-Hans/docusaurus-plugin-content-docs/current/troubleshooting.md"
sourceRel: "docs/i18n/zh-Hans/docusaurus-plugin-content-docs/current/troubleshooting.md"
rawUrl: "/raw/09-harness/better-harness/docs/i18n/zh-Hans/docusaurus-plugin-content-docs/current/troubleshooting.md"
sourceSha256: "f210cea6ea319668dbb303ddf6b0575a677bcc2d7c7d516a66e2b157f4710eb7"
pageSha256: "f210cea6ea319668dbb303ddf6b0575a677bcc2d7c7d516a66e2b157f4710eb7"
...
| 宿主 | 最小受支持检查 |
| --- | --- |
| [Claude Code](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/i18n/zh-Hans/docusaurus-plugin-content-docs/current/installation/README.md#claude-code) | 运行 `claude plugin details better-harness@better-harness`；详情中应包含 `Skills (1) better-harness`。 |
| [Codex](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/i18n/zh-Hans/docusaurus-plugin-content-docs/current/installation/README.md#codex) | Desktop 在 **Settings > Plugins** 中检查；CLI 运行 `codex plugin list --marketplace better-harness`。 |
| [Qoder](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/i18n/zh-Hans/docusaurus-plugin-content-docs/current/installation/README.md#qoder) | Desktop 已内置；手动安装 CLI 插件后运行 `qodercli plugin list`；生命周期计划不会输出已经漂移的安装语法。 |
| [Cursor](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/i18n/zh-Hans/docusaurus-plugin-content-docs/current/installation/README.md#cursor) | 运行 `better-harness plugin status --host cursor --surface agent`；在本机 Cursor help 合同完成核对前，安装保持不可用。 |
| [Qwen Code](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/i18n/zh-Hans/docusaurus-plugin-content-docs/current/installation/README.md#qwen-code) | 运行 `qwen extensions list` 并确认其中包含 Better Harness，然后开启新会话并运行报告提示词。 |
| [GitHub Copilot](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/i18n/zh-Hans/docusaurus-plugin-content-docs/current/installation/README.md#github-copilot) | 运行 `copilot plugin list` 和 `copilot skill list`；两处都应包含 `better-harness`。 |
