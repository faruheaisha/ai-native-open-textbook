...
indexed in [Architecture Decision Records](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/adrs/README.md). The
[directory-structure ADR](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/adrs/directory-structure.md) owns directory status;
the [developer-experience-system ADR](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/adrs/developer-experience-system.md) owns
...
- Bridge persisted Harness runs into Inspector through the `harness-run`
  ...
  two contracts. See [ADR-0003](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/adrs/harness-run-evidence-bridge.md).
...
- Start from the [ADR index](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/adrs/README.md). The directory-structure ADR is
...
- Read the
  [Developer Experience System ADR](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/adrs/developer-experience-system.md) before
