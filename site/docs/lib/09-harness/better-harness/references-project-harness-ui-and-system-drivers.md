...
entryUrl: "https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/references/project-harness/ui-and-system-drivers.md"
sourceRel: "references/project-harness/ui-and-system-drivers.md"
rawUrl: "/raw/09-harness/better-harness/references/project-harness/ui-and-system-drivers.md"
sourceSha256: "5cb2fd3a089e07e63e92026ecdb728112cae85b623266d017f21f467f440ed8d"
pageSha256: "5cb2fd3a089e07e63e92026ecdb728112cae85b623266d017f21f467f440ed8d"
...
[Agent Verify Loop](/lib/09-harness/better-harness/references-project-harness-agent-verify-loop) Scenario Families answer *what is
verified*. The [Verification Environment](/lib/09-harness/better-harness/references-project-harness-verification-environment)
...
([Agent Verify Loop](/lib/09-harness/better-harness/references-project-harness-agent-verify-loop)); nor dependency fidelity, the
environment contract, oracle independence, or authorization boundaries
([Verification Environment](/lib/09-harness/better-harness/references-project-harness-verification-environment)).
...
[Agent Verify Loop](/lib/09-harness/better-harness/references-project-harness-agent-verify-loop) post-verdict sequence.
...
[Agent-Friendly CLI](/lib/09-harness/better-harness/references-project-harness-friendly-cli) for that contract.
...
[Agent Verify Loop](/lib/09-harness/better-harness/references-project-harness-agent-verify-loop). Before such a run may report
`pass`, it needs an independent oracle plus a known-bad control, per the
oracle-independence requirements in
[Verification Environment](/lib/09-harness/better-harness/references-project-harness-verification-environment). A model-judged
...
- the case `trigger` field records the drive adapter and the correlation
  handle, per the [Agent Verify Loop](/lib/09-harness/better-harness/references-project-harness-agent-verify-loop) skeleton shape;
