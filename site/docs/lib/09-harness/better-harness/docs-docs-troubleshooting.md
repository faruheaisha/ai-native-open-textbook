...
entryUrl: "https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/docs/troubleshooting.md"
sourceRel: "docs/docs/troubleshooting.md"
rawUrl: "/raw/09-harness/better-harness/docs/docs/troubleshooting.md"
sourceSha256: "d2eb771de20f16a484bbfc4848b9841415e5210ad7264612c08f900a61897c5b"
pageSha256: "d2eb771de20f16a484bbfc4848b9841415e5210ad7264612c08f900a61897c5b"
...
| --- | --- |
| [Claude Code](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/docs/installation/README.md#claude-code) | Run `claude plugin details better-harness@better-harness`; the details should include `Skills (1) better-harness`. |
| [Codex](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/docs/installation/README.md#codex) | In Desktop, check **Settings > Plugins**. In the CLI, run `codex plugin list --marketplace better-harness`. |
| [Qoder](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/docs/installation/README.md#qoder) | The Desktop version is built in. For a manual CLI install, run `qodercli plugin list`; lifecycle planning does not emit the stale install syntax. |
| [Cursor](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/docs/installation/README.md#cursor) | Inspect `better-harness plugin status --host cursor --surface agent`; installation remains unavailable until the local Cursor help contract is reconciled. |
| [Qwen Code](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/docs/installation/README.md#qwen-code) | Run `qwen extensions list` and confirm it includes Better Harness, then start a new session and run the report prompt. |
| [GitHub Copilot](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/docs/installation/README.md#github-copilot) | Run `copilot plugin list` and `copilot skill list`; both should include `better-harness`. |
