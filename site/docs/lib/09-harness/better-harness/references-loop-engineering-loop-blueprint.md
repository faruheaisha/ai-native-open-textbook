---
title: "Loop Blueprint Reference"
...
entryUrl: "https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/references/loop-engineering/loop-blueprint.md"
sourceRel: "references/loop-engineering/loop-blueprint.md"
rawUrl: "/raw/09-harness/better-harness/references/loop-engineering/loop-blueprint.md"
sourceSha256: "f52677a90e3c08f583db2cad7e0ea7ca67af7cd33ab197df74586127ad2c9d08"
pageSha256: "f52677a90e3c08f583db2cad7e0ea7ca67af7cd33ab197df74586127ad2c9d08"
...
Use this reference after [Loop Discovery](/lib/09-harness/better-harness/references-loop-engineering-loop-discovery) has evaluated one
...
- [Loop Discovery](/lib/09-harness/better-harness/references-loop-engineering-loop-discovery) owns recurrence proof, runtime fit, and
  the primary owner decision.
- [Loop Spec Card](/lib/09-harness/better-harness/references-loop-engineering-loop-spec-card) owns
  `WHEN -> SEE -> DO -> CHECK -> STOP -> LEAVE` semantics and evidence rules.
- [Operating Patterns](/lib/09-harness/better-harness/references-loop-engineering-patterns) owns scenario composition.
- [Loop Primitives](/lib/09-harness/better-harness/references-loop-engineering-loop-primitives) owns supporting primitive selection.
- [Automation Readiness](/lib/09-harness/better-harness/references-loop-engineering-automation-readiness) owns scheduled, event-driven,
  and background readiness.
- [Loop State Ledger](/lib/09-harness/better-harness/references-loop-engineering-loop-state-ledger) owns durable state fields.
- [Learning Loop Patterns](/lib/09-harness/better-harness/references-loop-engineering-learning-loop-patterns) owns longitudinal
...
Read [Loop Spec Card](/lib/09-harness/better-harness/references-loop-engineering-loop-spec-card) completely. Preserve its canonical
...
- Read [Operating Patterns](/lib/09-harness/better-harness/references-loop-engineering-patterns) when the orchestration needs a
  scheduled-inspection, event-response, goal-completion, proactive-discovery,
  system-improvement, or composed pattern.
- Read [Loop Primitives](/lib/09-harness/better-harness/references-loop-engineering-loop-primitives) when the supporting primitive mix
  is unclear.
- Read [Automation Readiness](/lib/09-harness/better-harness/references-loop-engineering-automation-readiness) for every scheduled,
  event-driven, or background proposal.
- Read [Loop State Ledger](/lib/09-harness/better-harness/references-loop-engineering-loop-state-ledger) when work pauses, recurs, spans
  runs or agents, carries approval, or compares results over time.
- Read [Learning Loop Patterns](/lib/09-harness/better-harness/references-loop-engineering-learning-loop-patterns) before a recurring
...
- durable artifact and independent verifier; when the verifier must cover a
  ...
  [Agent Verify Loop](/lib/09-harness/better-harness/references-project-harness-agent-verify-loop);
- state and replay addendum from [Loop State Ledger](/lib/09-harness/better-harness/references-loop-engineering-loop-state-ledger),
