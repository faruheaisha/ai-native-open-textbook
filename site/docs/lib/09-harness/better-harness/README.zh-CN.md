...
entryUrl: "https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/README.zh-CN.md"
sourceRel: "README.zh-CN.md"
rawUrl: "/raw/09-harness/better-harness/README.zh-CN.md"
sourceSha256: "978ba30bf173b9912bc432c5aff121073830ddf7d3db9924fb3755e184e7e7aa"
pageSha256: "978ba30bf173b9912bc432c5aff121073830ddf7d3db9924fb3755e184e7e7aa"
...
[文档](https://qoderai.github.io/better-harness/zh-Hans/docs/introduction)
...
[安装指南](/lib/09-harness/better-harness/docs-docs-installation)和[公开宿主适配矩阵](/lib/09-harness/better-harness/docs-docs-hosts-adapter-matrix)中；
...
[宿主适配器矩阵](/lib/09-harness/better-harness/docs-adapters)。
...
每项发现都包含影响、预期输出、范围明确的修复方案与验收检查。
  ...
  （<a href="https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/assets/demo/better-harness-report.html">源文件</a>）。</sub>
...
[查看演示录制方式](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/dev/terminal-demo/README.md)。
...
[![智能体工作闭环：从任务理解到经验沉淀的五个维度](/mirror/8b/8b098643d4d71f3631c4dcc533471610ff751deb.svg)](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/models/agent-work-loop.md)
...
- **工程实践** —— 覆盖
  [会话证据、项目 Harness、智能体定制和闭环工程](/lib/09-harness/better-harness/references)
  的证据与判断指南。
- **评估模型** —— 以任务为中心的
  [智能体工作闭环](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/models/agent-work-loop.md)，包括证据状态、发现、评分边界和纵向验证。
- **可运行实现** —— 规范的
  [`/better-harness` 工作流](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/skills/better-harness/SKILL.md)、证据收集器、分析器、渲染器和轻量
  [宿主适配器](/lib/09-harness/better-harness/docs-adapters)。
...
[![Better Harness 架构：宿主集成、三个独立证据智能体、一个主智能体进行统一分析、输出发现、生成宿主产物并实施修复](/mirror/8f/8fb7a5c1fead81e6f67be8ce0d7122118935171f.svg)](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/lib/09-harness/better-harness/docs-ARCHITECTURE/README.md)
...
![Codex 添加插件 Marketplace 的对话框，包含仓库、Git ref 和可选的 sparse paths](/mirror/aa/aa91ac56d13232a2d383cb7088fb641d9158dc23.webp)
...
- **Qwen Code** —— [安装指南](/lib/09-harness/better-harness/docs-docs-installation#qwen-code)
  （`qwen extensions install QoderAI/better-harness`）。
- **Pi** —— [宿主适配器矩阵](/lib/09-harness/better-harness/docs-docs-hosts-adapter-matrix#pi)
  （`pi install <source>` 或 `pi -e <source>`）。当 `PI_CODING_AGENT_DIR` 指向 OMP
  的 agent 目录时，同一适配器也能读取
  [Oh My Pi (OMP)](/lib/09-harness/better-harness/docs-docs-hosts-adapter-matrix#oh-my-pi-omp) 会话。
- **Kimi Code** —— [宿主适配器矩阵](/lib/09-harness/better-harness/docs-adapters)
  （`.kimi-plugin/plugin.json` 插件安装）。
- **WorkBuddy** —— [宿主适配器矩阵](/lib/09-harness/better-harness/docs-docs-hosts-adapter-matrix#workbuddy)。
- **Grok** —— [宿主适配器矩阵](/lib/09-harness/better-harness/docs-docs-hosts-adapter-matrix#grok)。
...
| 可贡献的内容 | 从这里开始 | 示例 |
| --- | --- | --- |
| 工作流指导与工程实践 | [`skills/`](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/skills/README.md) 或 [`references/`](/lib/09-harness/better-harness/references) | 为某种语言、框架、审查模式或重复出现的智能体工作流添加有来源支撑的指南。 |
| 评估模型与可执行分析 | [`models/`](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/models/README.md) 或 [`scripts/`](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/scripts/README.md) | 添加由证据支持的评估视角、检测器，或带 fixture 和测试的智能体友好分析命令。 |
| 交付控制与宿主支持 | [`hooks/`](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/hooks/README.md) 或[新增 Coding Agent 指南](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/adapters/contributing-new-coding-agent.md) | 添加范围明确的生命周期检查，或记录并验证另一种 Coding Agent 宿主的证据支持情况。 |
| 报告与视觉语言 | [`templates/reporting/`](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/templates/reporting/README.md) 或 [`templates/style/`](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/templates/style/README.md) | 添加报告模式、可复用的报告契约，或带验证证据的纯指令式视觉样式。 |
| 示例与运行模型 | [`case-studies/`](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/case-studies/README.md) | 分享经过脱敏且以证据为边界的示例，展示团队如何应用 Agent Work Loop 分析与交付实践。 |

开始贡献：

1. 阅读[社区扩展地图](/lib/09-harness/better-harness/docs-community)，找到规范的归属位置并了解相应契约。
2. 按照[贡献指南](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/CONTRIBUTING.md)设置项目并确定变更范围。
3. 如需新增宿主支持，请遵循[新增 Coding Agent 贡献指南](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/docs/adapters/contributing-new-coding-agent.md)，
   并更新[宿主适配器矩阵](/lib/09-harness/better-harness/docs-adapters)。
