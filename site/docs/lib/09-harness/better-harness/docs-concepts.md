...
See [../models/agent-work-loop.md](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/models/agent-work-loop.md). Learning Capture
...
until you need diagnosis. See [../models/routing.md](https://github.com/QoderAI/better-harness/blob/e1538c15a98856b3349f365d951f4fa0bcc33f24/models/routing.md).
...
- Extend Better Harness: [community.md](/lib/09-harness/better-harness/docs-community) (start with its two common surfaces).
- Architecture and routing: [ARCHITECTURE.md](/lib/09-harness/better-harness/docs-ARCHITECTURE).
