...
entryUrl: "https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/site/src/content/blog/strands-agents-1-0.mdx"
sourceRel: "site/src/content/blog/strands-agents-1-0.mdx"
rawUrl: "/raw/09-harness/strands-harness-sdk/site/src/content/blog/strands-agents-1-0.mdx"
sourceSha256: "ba2f1bfac963d9bdc7aa89889cf07fb2437e1e1923fdad446c72ed79d52bd00b"
pageSha256: "ba2f1bfac963d9bdc7aa89889cf07fb2437e1e1923fdad446c72ed79d52bd00b"
...
The [agents-as-tools](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/docs/user-guide/concepts/multi-agent/agents-as-tools/README.md) pattern transforms specialized agents into intelligent tools that other agents can call, enabling hierarchical delegation where agents acting as the orchestrator dynamically consult domain experts without giving up control of the request. This mirrors how human teams work—a project manager doesn't need to know everything, they just need to know which specialist to consult for each task.
...
A [Swarm](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/docs/user-guide/concepts/multi-agent/swarm/README.md) creates autonomous agent teams that dynamically coordinate through shared memory, allowing multiple specialists to collaborate on complex tasks. Think of it as a brainstorming session where experts build on each other's ideas, with the team self-organizing to deliver the best collective result.
...
Learn more about [Swarms](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/docs/user-guide/concepts/multi-agent/swarm/README.md) in the Strands documentation.

### Graphs: Deterministic Workflow Control

[Graphs](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/docs/user-guide/concepts/multi-agent/graph/README.md) let you define explicit agent workflows with conditional routing and decision points, helpful for processes that require specific steps, approvals, or quality gates. Like a well-designed assembly line or approval chain, graphs ensure agents work through predefined business rules in the correct order every time.
...
Learn more about [Graphs](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/docs/user-guide/concepts/multi-agent/graph/README.md) in the Strands documentation.
...
Learn more about [Native Async Support](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/docs/user-guide/concepts/streaming/async-iterators/README.md) in the documentation.
