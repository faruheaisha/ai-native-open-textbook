...
This document provides guidance for AI agents working on the Strands Agents documentation site (the `site/` directory). For human contributor guidelines, see [CONTRIBUTING.md](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/site/CONTRIBUTING.md).
...
**For human contributors**: See [CONTRIBUTING.md](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/site/CONTRIBUTING.md) for setup, testing, and contribution guidelines.

## Team Process Documents

When working on SDK features or documentation, familiarize yourself with these team processes:

* **[Feature Lifecycle Process](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/team/FEATURE_LIFECYCLE.md)**: How features are added, versioned, deprecated, and graduated from experimental status
* **[API Bar Raising](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/team/API_BAR_RAISING.md)**: Standards for API design quality
* **[Decisions](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/team/DECISIONS.md)**: Key architectural and design decisions
* **[Tenets](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/team/TENETS.md)**: Core principles guiding SDK development
...
TypeScript formatting and import organization follow the same conventions as the TypeScript SDK; see [strands-ts/AGENTS.md](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/strands-ts/AGENTS.md). Prettier enforces formatting (no semicolons, single quotes, 120-character lines, 2-space indent, ES5 trailing commas); order imports as external dependencies, then internal modules, then type-only imports.

One site-specific exception: files under `src/content/docs/` are limited to 90 characters per line, including template literal contents (not enforced by Prettier). See [.agents/references/mdx-authoring.md](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/.agents/references/mdx-authoring.md).

### Code Examples in Documentation Pages

When adding or editing code examples in documentation pages, you MUST follow [.agents/references/mdx-authoring.md](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/.agents/references/mdx-authoring.md). It is the authoritative reference for `<Tabs>`/`<Tab>` usage, `--8<--` snippet inclusion, snippet naming and scoping, callouts, frontmatter fields, line length, and validation commands.

For the underlying Astro/Starlight implementation (the snippets plugin, custom components, frontmatter banners), see [SITE-ARCHITECTURE.md](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/site/SITE-ARCHITECTURE.md).
...
- [TypeScript SDK](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/strands-ts/README.md)
