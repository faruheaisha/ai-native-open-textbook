...
entryUrl: "https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/site/src/content/blog/strands-physical-ai.mdx"
sourceRel: "site/src/content/blog/strands-physical-ai.mdx"
rawUrl: "/raw/09-harness/strands-harness-sdk/site/src/content/blog/strands-physical-ai.mdx"
sourceSha256: "264ca71e54bdbfe1e78cdc6c54e56691ecd91c06dfb240ea8743ca25e5ca6d06"
pageSha256: "264ca71e54bdbfe1e78cdc6c54e56691ecd91c06dfb240ea8743ca25e5ca6d06"
...
This year has been transformative for agentic AI at AWS. We [launched Strands Agents in May 2025](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/blog/introducing-strands-agents/README.md), bringing a simple developer experience and [model-driven approach](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/blog/strands-agents-model-driven-approach/README.md) to agent development. In July, [we released version 1.0](https://aws.amazon.com/blogs/opensource/introducing-strands-agents-1-0-production-ready-multi-agent-orchestration-made-simple/) with multi-agent orchestration capabilities and [introduced Amazon Bedrock AgentCore](https://aws.amazon.com/blogs/aws/introducing-amazon-bedrock-agentcore-securely-deploy-and-operate-ai-agents-at-any-scale/) to accelerate AI agents to production at scale. At re:Invent 2025, we expanded Strands with the [TypeScript SDK](https://github.com/strands-agents/sdk-typescript), [evaluations](https://github.com/strands-agents/evals), [bidirectional streaming for voice agents](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/docs/user-guide/concepts/bidirectional-streaming/quickstart/README.md), and [steering for guiding agents within boundaries](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/docs/user-guide/concepts/plugins/steering/README.md). Today, we're exploring how these capabilities extend to the edge and physical AI, where agents don't just process information but work alongside us in the physical world.

![Robot demonstration](/mirror/71/71bece35857a45e85de813e8f7840ae1a64e3d04.webp)
...
![Edge-cloud continuum diagram](/mirror/1a/1a90099f3316627c40cc37f1e1f829a7eba4a926.png)
...
![Cloud capabilities diagram](/mirror/4b/4b4220fe60be57f3da704a31129e16ccfd3c2aea.png)
...
A simple starting point is running models locally on edge devices. With Strands' [Ollama provider](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/docs/user-guide/concepts/model-providers/ollama/README.md), you can run open-source models like Qwen3-VL directly on edge hardware. Strands also supports [llama.cpp](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/docs/user-guide/concepts/model-providers/llamacpp/README.md) for high-performance inference with quantized models, and [MLX](https://github.com/cagataycali/strands-mlx) for running models on Apple Silicon:
...
![VLA model architecture diagram](/mirror/03/030df740dcbd166fea2942e5be88ec77809c9141.png)
...
![Boston Dynamics Spot diagram](/mirror/92/927dd8edb6239d85a07b8eae5aedf90950e0a2a7.png)

### Bridging edge and cloud

Edge agents can delegate complex reasoning to the cloud when needed. VLA models provide millisecond-level control for physical actions, but when the system encounters situations requiring deeper reasoning – like planning multi-step tasks or making decisions based on historical patterns – it can consult more powerful cloud-based agents using the [agents-as-tools](https://github.com/strands-agents/harness-sdk/blob/7bda6c70e71cd07279470268c3d3b3f4b36adf53/docs/user-guide/concepts/multi-agent/agents-as-tools/README.md) pattern:
...
![Fleet learning diagram](/mirror/a8/a81399463122cb589d1c812be32d848ca7039b47.png)
...
Get started today:
* [Strands Agents](/lib/09-harness/strands-harness-sdk/overview)
