...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/ci/reporting-and-artifacts.md"
sourceRel: "skills/playwright/ci/reporting-and-artifacts.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/ci/reporting-and-artifacts.md"
sourceSha256: "2dce9a66321d802e9ffac82eba477c3bb41af7e48d523704e189686d83de9bf2"
pageSha256: "2dce9a66321d802e9ffac82eba477c3bb41af7e48d523704e189686d83de9bf2"
...
| -------------------- | ---------------- | --------- | ------------------------- |
| HTML report          | Always           | 14 days   | <code v-pre>if: ${{ !cancelled() }}</code> |
...
| JUnit XML            | Always           | 14 days   | <code v-pre>if: ${\{ !cancelled() }}</code> |
| Blob report          | Always (sharded) | 1 day     | <code v-pre>if: ${{ !cancelled() }}</code> |
...
| Only uploading artifacts on failure    | No report when tests pass; can't verify results      | Upload with <code v-pre>if: ${\{ !cancelled() }}</code> (always)                  |
...
- [ci/ci-github-actions.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-ci-github-actions) -- artifact upload in GitHub Actions
- [ci/ci-gitlab.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-ci-gitlab) -- artifact configuration in GitLab
- [ci/parallel-and-sharding.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-parallel-and-sharding) -- blob reporter for sharded runs
- [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration) -- trace, screenshot, video settings
- [core/debugging.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-debugging) -- using traces and screenshots for debugging
