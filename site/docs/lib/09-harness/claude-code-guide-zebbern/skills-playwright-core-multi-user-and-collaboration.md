---
title: "Multi-User and Collaboration Testing"
...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/multi-user-and-collaboration.md"
sourceRel: "skills/playwright/core/multi-user-and-collaboration.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/core/multi-user-and-collaboration.md"
sourceSha256: "4e39e02c21ac6933c395db2cdb4efa0978f044f1027e5ad43b5dd41839b4a5a6"
pageSha256: "4e39e02c21ac6933c395db2cdb4efa0978f044f1027e5ad43b5dd41839b4a5a6"
...
> **Prerequisites**: [core/fixtures-and-hooks.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-fixtures-and-hooks), [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration)
...
- [core/fixtures-and-hooks.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-fixtures-and-hooks) -- wrap multi-user contexts in fixtures
- [core/websockets-and-realtime.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-websockets-and-realtime) -- test the transport layer beneath collaboration features
- [core/test-data-management.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-test-data-management) -- set up shared resources (rooms, documents) before multi-user tests
- [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration) -- configure `storageState` per project for different user roles
