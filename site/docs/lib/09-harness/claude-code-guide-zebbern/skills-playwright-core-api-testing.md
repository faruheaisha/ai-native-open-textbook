...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/api-testing.md"
sourceRel: "skills/playwright/core/api-testing.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/core/api-testing.md"
sourceSha256: "38eaf62dbcb35123ca89ffac848084bbbde8de6daaf031d0d205292101411c06"
pageSha256: "38eaf62dbcb35123ca89ffac848084bbbde8de6daaf031d0d205292101411c06"
...
> **Prerequisites**: [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration) for `baseURL` setup, [core/fixtures-and-hooks.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-fixtures-and-hooks) for custom fixture patterns.
...
- [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration) — `baseURL`, `extraHTTPHeaders`, and `webServer` config
- [core/fixtures-and-hooks.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-fixtures-and-hooks) — custom fixture patterns for reusable API clients
- [core/authentication.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-authentication) — auth patterns including token-based API auth
- [core/network-mocking.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-network-mocking) — mocking API responses in E2E tests (opposite of this guide)
- [core/test-architecture.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-test-architecture) — when to use API tests vs E2E vs component tests
- [core/when-to-mock.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-when-to-mock) — when to hit real APIs vs mock them
