...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/error-index.md"
sourceRel: "skills/playwright/core/error-index.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/core/error-index.md"
sourceSha256: "0b1d0309ee1932c447c2c398c266a5e6d53fc6266a6d8f73abca726704cf32fd"
pageSha256: "0b1d0309ee1932c447c2c398c266a5e6d53fc6266a6d8f73abca726704cf32fd"
...
**Related**: [core/assertions-and-waiting.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-assertions-and-waiting), [core/multi-context-and-popups.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-multi-context-and-popups)
...
**Related**: [core/locators.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-locators), [core/assertions-and-waiting.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-assertions-and-waiting)
...
**Related**: [core/locators.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-locators), [core/locator-strategy.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-locator-strategy)
...
**Cause**: `fill()` only works on `<input>`, `<textarea>`, or elements with `contenteditable`. The locator resolved to a different element type (e.g., a ``, `<label>`, or the `<form>` itself).
...
- Custom components that wrap the actual `<input>` in a styled ``
...
**Related**: [core/locators.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-locators), [core/forms-and-validation.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-forms-and-validation)
...
**Related**: [core/locators.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-locators)
...
**Related**: [core/assertions-and-waiting.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-assertions-and-waiting), [core/debugging.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-debugging)
...
**Related**: [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration), [ci/ci-github-actions.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-ci-github-actions)
...
**Related**: [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration)
...
**Related**: [core/fixtures-and-hooks.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-fixtures-and-hooks)
...
**Related**: [core/assertions-and-waiting.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-assertions-and-waiting)
...
**Related**: [core/iframes-and-shadow-dom.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-iframes-and-shadow-dom)
...
**Related**: [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration), [core/debugging.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-debugging)
...
**Related**: [core/visual-regression.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-visual-regression)
...
**Related**: [ci/ci-github-actions.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-ci-github-actions), [ci/docker-and-containers.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-docker-and-containers)
...
**Related**: [core/network-mocking.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-network-mocking)
...
**Related**: [core/api-testing.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-api-testing), [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration)
...
**Related**: [core/authentication.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-authentication), [core/auth-flows.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-auth-flows)
...
**Related**: [core/assertions-and-waiting.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-assertions-and-waiting), [core/locators.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-locators)
...
**Related**: [ci/parallel-and-sharding.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-parallel-and-sharding), [core/multi-user-and-collaboration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-multi-user-and-collaboration)
...
**Related**: [core/locators.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-locators), [core/assertions-and-waiting.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-assertions-and-waiting), [migration/from-selenium.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-migration-from-selenium)
...
**Related**: [core/file-operations.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-file-operations), [core/file-upload-download.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-file-upload-download)
