...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/migration/from-cypress.md"
sourceRel: "skills/playwright/migration/from-cypress.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/migration/from-cypress.md"
sourceSha256: "7e8f2d70b58037f90b4e0f89afcab8398386cf70162ce260a80b1c698f3faf1b"
pageSha256: "7e8f2d70b58037f90b4e0f89afcab8398386cf70162ce260a80b1c698f3faf1b"
...
- [core/locators.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-locators) -- locator strategy for Playwright (replaces Cypress `cy.get()` patterns)
- [core/fixtures-and-hooks.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-fixtures-and-hooks) -- deep dive on fixtures (replaces Cypress custom commands)
- [core/assertions-and-waiting.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-assertions-and-waiting) -- web-first assertions (replaces Cypress `should` chains)
- [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration) -- playwright.config setup
- [core/authentication.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-authentication) -- auth patterns (replaces Cypress `cy.session()`)
- [core/network-mocking.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-network-mocking) -- route mocking (replaces Cypress `cy.intercept()`)
- [ci/ci-github-actions.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-ci-github-actions) -- CI setup for Playwright
