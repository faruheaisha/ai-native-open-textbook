...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/migration/from-selenium.md"
sourceRel: "skills/playwright/migration/from-selenium.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/migration/from-selenium.md"
sourceSha256: "7d91107608cdb8c59eaf2ba4fb55b4d35884edbaa5fc20d193a879c1fb1ca385"
pageSha256: "7d91107608cdb8c59eaf2ba4fb55b4d35884edbaa5fc20d193a879c1fb1ca385"
...
> **Prerequisites**: [core/locators.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-locators), [core/assertions-and-waiting.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-assertions-and-waiting)
...
If your Selenium suite depends on execution order, you must fix that before migrating. See [core/test-organization.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-test-organization) for isolation strategies.
...
- [core/locators.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-locators) -- locator strategy priority and patterns
- [core/assertions-and-waiting.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-assertions-and-waiting) -- auto-waiting and web-first assertions in depth
- [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration) -- setting up `playwright.config`
- [core/page-object-model.md](https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/page-object-model.md) -- page object patterns for Playwright
- [core/fixtures-and-hooks.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-fixtures-and-hooks) -- fixtures system for test setup and isolation
- [core/test-organization.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-test-organization) -- organizing tests for parallel execution
- [migration/from-cypress.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-migration-from-cypress) -- migrating from Cypress instead
