...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/ci/global-setup-teardown.md"
sourceRel: "skills/playwright/ci/global-setup-teardown.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/ci/global-setup-teardown.md"
sourceSha256: "a8596e0a4063a868a2f977f74ccdcda2ca05af1eca179f5a43e5dc4496d64345"
pageSha256: "a8596e0a4063a868a2f977f74ccdcda2ca05af1eca179f5a43e5dc4496d64345"
...
- [core/fixtures-and-hooks.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-fixtures-and-hooks) -- per-test and per-worker fixtures (preferred over globalSetup for most cases)
- [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration) -- `globalSetup`, `globalTeardown`, `webServer` config
- [ci/projects-and-dependencies.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-projects-and-dependencies) -- setup projects with `dependencies`
- [core/authentication.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-authentication) -- authentication patterns using setup projects
- [core/test-data-management.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-test-data-management) -- seeding and managing test data
