...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/component-testing.md"
sourceRel: "skills/playwright/core/component-testing.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/core/component-testing.md"
sourceSha256: "8643dedb8eab57db502e1abc24cf476531c12cf63312df8397bfafa03c638b8b"
pageSha256: "8643dedb8eab57db502e1abc24cf476531c12cf63312df8397bfafa03c638b8b"
...
- [core/fixtures-and-hooks.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-fixtures-and-hooks) — fixtures work inside component tests the same way
- [core/visual-regression.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-visual-regression) — screenshot comparison patterns applicable to component tests
- [core/network-mocking.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-network-mocking) — `page.route()` works inside component tests for mocking API calls
- [core/test-architecture.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-test-architecture) — when to use component vs E2E vs API tests
- [core/react.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-react) — React-specific component testing setup
- [core/vue.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-vue) — Vue-specific component testing with slots and provide/inject
