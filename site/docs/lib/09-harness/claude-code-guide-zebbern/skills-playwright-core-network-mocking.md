...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/network-mocking.md"
sourceRel: "skills/playwright/core/network-mocking.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/core/network-mocking.md"
sourceSha256: "3a244a2dddc5932765890a33baad4bc2a9fd9cb46baf0ca0c5e9eb9a6fee02a1"
pageSha256: "3a244a2dddc5932765890a33baad4bc2a9fd9cb46baf0ca0c5e9eb9a6fee02a1"
...
- [core/when-to-mock.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-when-to-mock) -- decision framework for when to mock vs use real services
- [core/api-testing.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-api-testing) -- testing REST and GraphQL APIs directly (without a browser)
- [core/assertions-and-waiting.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-assertions-and-waiting) -- web-first assertions and `waitForResponse` patterns
- [core/authentication.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-authentication) -- mocking auth tokens and session state
- [core/error-and-edge-cases.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-error-and-edge-cases) -- error state testing patterns beyond network errors
- [core/service-workers-and-pwa.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-service-workers-and-pwa) -- handling service worker caching that interferes with mocks
