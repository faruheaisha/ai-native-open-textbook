...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/locators.md"
sourceRel: "skills/playwright/core/locators.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/core/locators.md"
sourceSha256: "d800910a9ce4115f8f3b3b1184d7f345dd9c66e2b8eb776a0afc5a158f5ab426"
pageSha256: "d800910a9ce4115f8f3b3b1184d7f345dd9c66e2b8eb776a0afc5a158f5ab426"
...
> **Prerequisites**: [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration)
...
**Use when**: Interacting with content inside `` or `<frame>` elements — payment widgets, embedded editors, third-party widgets.
...
| Navigation         | `getByRole('navigation', \{ name \})`            | `getByRole('navigation', \{ name: 'Main' \})`             | Matches `` with `aria-label`                              |
...
- [core/locator-strategy.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-locator-strategy) — deep-dive decision framework for choosing locator strategies at the project level
- [core/assertions-and-waiting.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-assertions-and-waiting) — pair locators with web-first assertions
- [pom/page-object-model.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-pom-page-object-model) — encapsulate locators in page objects
- [core/iframes-and-shadow-dom.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-iframes-and-shadow-dom) — advanced iframe and Shadow DOM patterns
- [core/i18n-and-localization.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-i18n-and-localization) — locator strategies for internationalized apps
