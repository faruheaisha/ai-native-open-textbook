...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/accessibility.md"
sourceRel: "skills/playwright/core/accessibility.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/core/accessibility.md"
sourceSha256: "b4c1086d520d86422f8697333bb783eac01632b9e58ebc0c2aafc423b9be77c4"
pageSha256: "b4c1086d520d86422f8697333bb783eac01632b9e58ebc0c2aafc423b9be77c4"
...
| Add `role="button"` to `` without keyboard support                | Creates a "button" that only works with a mouse. Screen reader announces it as a button, but Enter/Space does nothing. | Use `<button>` elements. If you must use a ``, add `tabindex="0"`, `role="button"`, and `keydown` handlers for Enter and Space |
...
| Use `aria-label` on non-interactive `` or `<span>`                | `aria-label` is ignored on elements without a role. Screen readers will not announce it.                               | Add an appropriate role (`role="region"`) or use `aria-labelledby` pointing to a visible heading                                    |
...
- [core/locators.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-locators) — role-based locators align with accessibility best practices
- [core/forms-and-validation.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-forms-and-validation) — form interaction patterns including accessible error handling
- [ci/ci-github-actions.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-ci-github-actions) — CI setup for running accessibility tests
- [core/i18n-and-localization.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-i18n-and-localization) — accessibility considerations for multilingual apps
- [core/component-testing.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-component-testing) — test individual component accessibility in isolation
