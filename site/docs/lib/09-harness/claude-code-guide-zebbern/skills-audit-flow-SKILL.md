...
- [scripts/audit.py](https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/audit-flow/scripts/audit.py) - CLI for all commands (init, list, show, export, validate, db-merge, git-setup, csv-\*)
- [COMMANDS.md](/lib/09-harness/claude-code-guide-zebbern/skills-audit-flow-COMMANDS) - Detailed SQL reference
- [EXAMPLES.md](/lib/09-harness/claude-code-guide-zebbern/skills-audit-flow-EXAMPLES) - Full examples with non-linear flows
- [schema.sql](https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/audit-flow/schema.sql) - Database schema
