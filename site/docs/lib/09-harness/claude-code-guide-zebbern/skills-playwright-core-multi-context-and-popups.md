---
title: "Multi-Context, Popups, and New Windows"
...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/multi-context-and-popups.md"
sourceRel: "skills/playwright/core/multi-context-and-popups.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/core/multi-context-and-popups.md"
sourceSha256: "eb9f380fd9a8faae637447038610f1bc4cb550b564c1f98b0a7ba79d6dabf264"
pageSha256: "eb9f380fd9a8faae637447038610f1bc4cb550b564c1f98b0a7ba79d6dabf264"
...
> **Prerequisites**: [core/assertions-and-waiting.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-assertions-and-waiting), [core/fixtures-and-hooks.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-fixtures-and-hooks)
...
**Avoid when**: You can bypass OAuth entirely by injecting auth tokens directly -- see [core/authentication.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-authentication).
...
- [core/authentication.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-authentication) -- bypassing OAuth popups with stored auth state
- [core/multi-user-and-collaboration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-multi-user-and-collaboration) -- multi-user real-time collaboration testing
- [core/file-operations.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-file-operations) -- file download handling without popups
- [core/third-party-integrations.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-third-party-integrations) -- mocking OAuth providers to avoid real popups
- [core/fixtures-and-hooks.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-fixtures-and-hooks) -- fixtures for multi-context setups
