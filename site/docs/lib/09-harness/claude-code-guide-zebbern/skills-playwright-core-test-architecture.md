---
title: "Test Architecture: E2E vs Component vs API"
...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/test-architecture.md"
sourceRel: "skills/playwright/core/test-architecture.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/core/test-architecture.md"
sourceSha256: "93a31a24cac270722fd0faa03a62c5c37748167fb9bc6d3533d04d00b811ea44"
pageSha256: "93a31a24cac270722fd0faa03a62c5c37748167fb9bc6d3533d04d00b811ea44"
...
- [core/test-organization.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-test-organization) -- file structure and naming conventions for each test type
- [core/api-testing.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-api-testing) -- deep-dive on Playwright's `request` API for HTTP testing
- [core/component-testing.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-component-testing) -- setting up and writing component tests with Playwright CT
- [core/authentication.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-authentication) -- auth flow testing patterns (E2E + `storageState` reuse)
- [core/when-to-mock.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-when-to-mock) -- when to mock network requests vs hit real services
- [pom/pom-vs-fixtures-vs-helpers.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-pom-pom-vs-fixtures-vs-helpers) -- organizing shared test logic across layers
