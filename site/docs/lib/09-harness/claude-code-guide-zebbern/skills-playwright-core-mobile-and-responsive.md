...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/mobile-and-responsive.md"
sourceRel: "skills/playwright/core/mobile-and-responsive.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/core/mobile-and-responsive.md"
sourceSha256: "b9db2f37569aa27692e2eb7fff6d8f1f6aeeb8288d1cf26826fa63d158d6dfd8"
pageSha256: "b9db2f37569aa27692e2eb7fff6d8f1f6aeeb8288d1cf26826fa63d158d6dfd8"
...
- [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration) -- project setup with device profiles and multi-project config
- [core/visual-regression.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-visual-regression) -- combine responsive testing with screenshot comparison across viewports
- [core/network-mocking.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-network-mocking) -- mock API responses alongside mobile testing
- [core/service-workers-and-pwa.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-service-workers-and-pwa) -- in-depth PWA testing beyond mobile context
- [core/performance-testing.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-performance-testing) -- comprehensive performance testing including mobile metrics
- [core/browser-apis.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-browser-apis) -- geolocation, permissions, and other browser APIs in detail
- [ci/projects-and-dependencies.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-projects-and-dependencies) -- advanced multi-project patterns for responsive testing matrices
