...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/iframes-and-shadow-dom.md"
sourceRel: "skills/playwright/core/iframes-and-shadow-dom.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/core/iframes-and-shadow-dom.md"
sourceSha256: "6de0421c5cdf14a62a23934f8c7ceddc215f5c836687940782f8ca00a48e8169"
pageSha256: "6de0421c5cdf14a62a23934f8c7ceddc215f5c836687940782f8ca00a48e8169"
...
> **When to use**: When your application embeds content in `` elements (payment widgets, third-party embeds, legacy modules) or uses Web Components with Shadow DOM (design systems, custom elements, Salesforce Lightning).
...
**Use when**: You need to interact with content inside an `` -- payment forms, embedded editors, captchas, third-party widgets.
...
test("use Frame API for URL checks and evaluate", async ({ page }) => {
  ...
  await page.frameLocator('iframe[name="analytics"]').getByRole("link", { name: "Reports" }).click()
...
| ------------------------------------ | ------------------------------------------------- | ------------------------------------------------- |
| Content inside ``            | `page.frameLocator('selector')`                   | Returns a scoped locator for the iframe document  |
...
- [core/locators.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-locators) -- locator fundamentals including frame and shadow DOM basics
- [core/browser-apis.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-browser-apis) -- testing browser APIs that may live inside iframes
- [core/canvas-and-webgl.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-canvas-and-webgl) -- canvas elements inside iframes or web components
- [core/debugging.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-debugging) -- using Playwright Inspector to identify iframe boundaries and shadow roots
