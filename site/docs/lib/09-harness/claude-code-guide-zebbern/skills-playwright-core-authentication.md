...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/authentication.md"
sourceRel: "skills/playwright/core/authentication.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/core/authentication.md"
sourceSha256: "72d6c7f2f006574eb093579c364b1575b1db06630ed7660e513ec4017ef34a20"
pageSha256: "72d6c7f2f006574eb093579c364b1575b1db06630ed7660e513ec4017ef34a20"
...
> **Prerequisites**: [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration), [core/fixtures-and-hooks.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-fixtures-and-hooks)
...
- [core/fixtures-and-hooks.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-fixtures-and-hooks) -- custom fixtures for auth setup and teardown
- [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration) -- `storageState`, projects, and global setup configuration
- [ci/global-setup-teardown.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-global-setup-teardown) -- global setup patterns and project dependencies
- [core/network-mocking.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-network-mocking) -- route interception patterns used in OAuth mocking
- [core/api-testing.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-api-testing) -- API request context used in API-based login
- [core/flaky-tests.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-flaky-tests) -- diagnosing auth-related flakiness
- [core/auth-flows.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-auth-flows) -- complete recipes for specific auth providers (Auth0, Okta, Firebase)
