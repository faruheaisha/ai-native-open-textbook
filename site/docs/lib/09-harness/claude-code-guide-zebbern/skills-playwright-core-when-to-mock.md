---
title: "When to Mock vs Use Real Services"
...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/when-to-mock.md"
sourceRel: "skills/playwright/core/when-to-mock.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/core/when-to-mock.md"
sourceSha256: "fd58a08a30fff345f2521cabd100ac6d8398416290e4c3f4864ba3e633191025"
pageSha256: "fd58a08a30fff345f2521cabd100ac6d8398416290e4c3f4864ba3e633191025"
...
- [core/network-mocking.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-network-mocking) -- detailed network interception patterns and API
- [core/api-testing.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-api-testing) -- testing your API directly with `request` context
- [core/authentication.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-authentication) -- when to mock auth vs test real login flows
- [core/fixtures-and-hooks.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-fixtures-and-hooks) -- building reusable mock fixtures
- [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration) -- `webServer`, `baseURL`, and project configuration
- [ci/ci-github-actions.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-ci-github-actions) -- CI setup for different test tiers
