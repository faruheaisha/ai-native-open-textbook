---
title: "Testing Angular Apps with Playwright"
...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/angular.md"
sourceRel: "skills/playwright/core/angular.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/core/angular.md"
sourceSha256: "5f0e4ea86e2dd4fa4769d0d7cdd5497924d909cab1442186d43c66d263e90053"
pageSha256: "5f0e4ea86e2dd4fa4769d0d7cdd5497924d909cab1442186d43c66d263e90053"
...
> **Prerequisites**: [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration), [core/locators.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-locators)
...
- [core/locators.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-locators) -- locator strategies for Angular Material and CDK components
- [core/assertions-and-waiting.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-assertions-and-waiting) -- auto-waiting assertions that replace Protractor's waitForAngular
- [core/forms-and-validation.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-forms-and-validation) -- form testing patterns for reactive and template-driven forms
- [core/accessibility.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-accessibility) -- accessibility testing for Angular Material components
- [core/authentication.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-authentication) -- authentication with Angular route guards
- [migration/from-selenium.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-migration-from-selenium) -- migration patterns applicable to Protractor (Protractor is built on Selenium)
- [core/test-architecture.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-test-architecture) -- when to use E2E vs unit tests with Angular TestBed
- [ci/ci-github-actions.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-ci-github-actions) -- CI setup with Angular build caching
