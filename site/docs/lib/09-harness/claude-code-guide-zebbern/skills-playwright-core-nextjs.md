---
title: "Testing Next.js Apps with Playwright"
...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/nextjs.md"
sourceRel: "skills/playwright/core/nextjs.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/core/nextjs.md"
sourceSha256: "f1b3932de817c04c9e54ed1385c4f3b5cb54bffb034dab7b1b493512f4f43eef"
pageSha256: "f1b3932de817c04c9e54ed1385c4f3b5cb54bffb034dab7b1b493512f4f43eef"
...
- [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration) -- base Playwright configuration patterns including `webServer`
- [core/authentication.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-authentication) -- authentication setup projects and `storageState` reuse
- [core/api-testing.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-api-testing) -- testing API routes directly with `request` context
- [core/network-mocking.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-network-mocking) -- mocking external APIs that Next.js API routes call
- [core/when-to-mock.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-when-to-mock) -- when to mock vs hit real services
- [core/react.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-react) -- React-specific patterns that apply to Next.js client components
- [ci/ci-github-actions.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-ci-github-actions) -- CI setup with `npm run build` caching for Next.js
