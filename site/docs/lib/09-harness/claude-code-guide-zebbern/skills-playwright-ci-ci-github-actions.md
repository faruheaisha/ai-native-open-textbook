...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/ci/ci-github-actions.md"
sourceRel: "skills/playwright/ci/ci-github-actions.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/ci/ci-github-actions.md"
sourceSha256: "a464d3e6021d58853e83b9d1d0032cb78e3a84ea580d726eeff31f26246cc743"
pageSha256: "a464d3e6021d58853e83b9d1d0032cb78e3a84ea580d726eeff31f26246cc743"
...
| Uploading artifacts only on failure         | No report when tests pass; can't verify results          | Use <code v-pre>if: ${{ !cancelled() }}</code> to always upload              |
...
- [ci/parallel-and-sharding.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-parallel-and-sharding) -- sharding strategies and blob report merging
- [ci/reporting-and-artifacts.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-reporting-and-artifacts) -- reporter configuration and artifact management
- [ci/docker-and-containers.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-docker-and-containers) -- container images for CI
- [ci/ci-gitlab.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-ci-gitlab) -- GitLab CI equivalent
- [ci/ci-other.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-ci-other) -- CircleCI, Azure DevOps, Jenkins
- [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration) -- CI-aware config settings
