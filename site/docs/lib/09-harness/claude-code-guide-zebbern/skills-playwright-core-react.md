---
title: "Testing React Apps with Playwright"
...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/react.md"
sourceRel: "skills/playwright/core/react.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/core/react.md"
sourceSha256: "dbea74cf2a12426025bd7e47a291024c2310ff8ceb7fba0f577c6ded7d2c8be3"
pageSha256: "dbea74cf2a12426025bd7e47a291024c2310ff8ceb7fba0f577c6ded7d2c8be3"
...
**Avoid when**: Your app uses server-side routing only (Next.js App Router handles this differently -- see [core/nextjs.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-nextjs)).
...
- [core/locators.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-locators) -- locator strategies that work with any React component library
- [core/assertions-and-waiting.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-assertions-and-waiting) -- auto-waiting assertions for React state changes
- [core/forms-and-validation.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-forms-and-validation) -- form testing patterns applicable to react-hook-form and Formik
- [core/component-testing.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-component-testing) -- in-depth component testing guide
- [core/accessibility.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-accessibility) -- testing ARIA patterns in React component libraries
- [core/test-architecture.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-test-architecture) -- when to use E2E vs component vs unit tests
- [core/nextjs.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-nextjs) -- Next.js-specific patterns for React apps with SSR
