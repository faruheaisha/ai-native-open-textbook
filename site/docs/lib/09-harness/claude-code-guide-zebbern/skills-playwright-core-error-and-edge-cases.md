...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/error-and-edge-cases.md"
sourceRel: "skills/playwright/core/error-and-edge-cases.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/core/error-and-edge-cases.md"
sourceSha256: "b816f6b790fb9ebe095a5496ca385b97140512071cdf97dcc0074dfd72dd93c5"
pageSha256: "b816f6b790fb9ebe095a5496ca385b97140512071cdf97dcc0074dfd72dd93c5"
...
> **Prerequisites**: [core/assertions-and-waiting.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-assertions-and-waiting), [core/network-mocking.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-network-mocking) for route interception
...
- [core/assertions-and-waiting.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-assertions-and-waiting) -- assertion strategies for error states
- [core/network-mocking.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-network-mocking) -- detailed network interception and mocking patterns
- [core/forms-and-validation.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-forms-and-validation) -- form validation error testing
- [core/flaky-tests.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-flaky-tests) -- fixing timing issues in error/edge case tests
- [core/service-workers-and-pwa.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-service-workers-and-pwa) -- offline-first and PWA testing patterns
- [core/multi-context-and-popups.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-multi-context-and-popups) -- testing concurrent browser contexts
