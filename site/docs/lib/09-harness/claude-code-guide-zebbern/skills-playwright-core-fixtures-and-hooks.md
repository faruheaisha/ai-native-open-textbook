...
entryUrl: "https://github.com/zebbern/claude-code-guide/blob/64c890fe74c3ccfad673dc9c71dc85b8dd2f4817/skills/playwright/core/fixtures-and-hooks.md"
sourceRel: "skills/playwright/core/fixtures-and-hooks.md"
rawUrl: "/raw/09-harness/claude-code-guide-zebbern/skills/playwright/core/fixtures-and-hooks.md"
sourceSha256: "647e78c5c3db6a4bc0f3b2c7c9e323cf5801e4162c4d840aa71889292aa38280"
pageSha256: "647e78c5c3db6a4bc0f3b2c7c9e323cf5801e4162c4d840aa71889292aa38280"
...
- [pom/page-object-model.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-pom-page-object-model) — Page objects are typically consumed via fixtures
- [core/test-organization.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-test-organization) — Where to put fixture files in the project tree
- [core/configuration.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-configuration) — Option fixtures are configured in `playwright.config`
- [core/authentication.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-core-authentication) — Auth state is the most common worker-scoped fixture
- [ci/global-setup-teardown.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-ci-global-setup-teardown) — For truly global (all-workers) setup, not per-worker
- [pom/pom-vs-fixtures-vs-helpers.md](/lib/09-harness/claude-code-guide-zebbern/skills-playwright-pom-pom-vs-fixtures-vs-helpers) — When to use each abstraction
