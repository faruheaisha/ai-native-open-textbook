...
entryUrl: "https://github.com/langchain-ai/deepagents/blob/d93ab3351bbf4c3687212f665094ccad100f2c08/libs/code/ARCHITECTURE.md"
sourceRel: "libs/code/ARCHITECTURE.md"
rawUrl: "/raw/09-harness/langchain-deepagents/libs/code/ARCHITECTURE.md"
sourceSha256: "0f3a06de2aad6c85bbd33f3e2d1bc9f352f3662b30a4376c98f62d7cb7aa5585"
pageSha256: "0f3a06de2aad6c85bbd33f3e2d1bc9f352f3662b30a4376c98f62d7cb7aa5585"
...
- For local setup and debugging, see [`DEVELOPMENT.md`](/lib/09-harness/langchain-deepagents/libs-code-DEVELOPMENT).
- For command behavior, see [`COMMANDS.md`](/lib/09-harness/langchain-deepagents/libs-code-COMMANDS).
- For lifecycle hooks (`hooks.json`), see [`HOOKS.md`](/lib/09-harness/langchain-deepagents/libs-code-HOOKS).
- For server-side Python extensions, see [`EXTENSIONS.md`](/lib/09-harness/langchain-deepagents/libs-code-EXTENSIONS).
- For cost estimates and local pricing overrides (`prices.json`), see
  [`PRICING.md`](/lib/09-harness/langchain-deepagents/libs-code-PRICING).
- For security boundaries, see [`THREAT_MODEL.md`](/lib/09-harness/langchain-deepagents/libs-code-THREAT_MODEL/index).
- For how a transient model failure is retried after output has already streamed,
  see [`STREAMING_RETRY_DESIGN.md`](https://github.com/langchain-ai/deepagents/blob/d93ab3351bbf4c3687212f665094ccad100f2c08/libs/code/STREAMING_RETRY_DESIGN.md).
- For package-specific coding conventions, see [`AGENTS.md`](https://github.com/langchain-ai/deepagents/blob/d93ab3351bbf4c3687212f665094ccad100f2c08/libs/code/AGENTS.md).
