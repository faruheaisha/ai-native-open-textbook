---
title: "Agentic Harness Patterns"
...
entryUrl: "https://github.com/keli-wen/agentic-harness-patterns-skill/blob/17549f55b84a94b1ff647ae4711be600fe8ae12f/skills/agentic-harness-patterns/SKILL.md"
sourceRel: "skills/agentic-harness-patterns/SKILL.md"
rawUrl: "/raw/09-harness/agentic-harness-patterns-skill/skills/agentic-harness-patterns/SKILL.md"
sourceSha256: "1e72510fb053a3ae9b86628dadd4026da6744c19a2e9425087919081f8622a63"
pageSha256: "1e72510fb053a3ae9b86628dadd4026da6744c19a2e9425087919081f8622a63"
...
**Go deeper:** [references/memory-persistence-pattern.md](/lib/09-harness/agentic-harness-patterns-skill/skills-agentic-harness-patterns-references-memory-persistence-pattern)
...
**Go deeper:** [references/skill-runtime-pattern.md](/lib/09-harness/agentic-harness-patterns-skill/skills-agentic-harness-patterns-references-skill-runtime-pattern)
...
**Go deeper:** [references/tool-registry-pattern.md](/lib/09-harness/agentic-harness-patterns-skill/skills-agentic-harness-patterns-references-tool-registry-pattern) | [references/permission-gate-pattern.md](/lib/09-harness/agentic-harness-patterns-skill/skills-agentic-harness-patterns-references-permission-gate-pattern)
...
**Go deeper:** [references/context-engineering-pattern.md](/lib/09-harness/agentic-harness-patterns-skill/skills-agentic-harness-patterns-references-context-engineering-pattern) (index) | [select](/lib/09-harness/agentic-harness-patterns-skill/skills-agentic-harness-patterns-references-context-engineering-select-pattern) | [compress](/lib/09-harness/agentic-harness-patterns-skill/skills-agentic-harness-patterns-references-context-engineering-compress-pattern) | [isolate](/lib/09-harness/agentic-harness-patterns-skill/skills-agentic-harness-patterns-references-context-engineering-isolate-pattern)
...
**Go deeper:** [references/agent-orchestration-pattern.md](/lib/09-harness/agentic-harness-patterns-skill/skills-agentic-harness-patterns-references-agent-orchestration-pattern)
...
**Go deeper:** [references/hook-lifecycle-pattern.md](/lib/09-harness/agentic-harness-patterns-skill/skills-agentic-harness-patterns-references-hook-lifecycle-pattern) | [references/task-decomposition-pattern.md](/lib/09-harness/agentic-harness-patterns-skill/skills-agentic-harness-patterns-references-task-decomposition-pattern) | [references/bootstrap-sequence-pattern.md](/lib/09-harness/agentic-harness-patterns-skill/skills-agentic-harness-patterns-references-bootstrap-sequence-pattern)
