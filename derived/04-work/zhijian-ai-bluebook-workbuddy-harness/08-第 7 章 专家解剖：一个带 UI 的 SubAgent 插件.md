...
![专家四件套与 UI 字段映射](/workbuddy-harness/fig-08.png)
...
```
<system-reminder>
<expert_selection state="active">
The user has selected the "数字生命卡兹克" expert...
Expert plugin path: ~/.workbuddy/plugins/marketplaces/experts/plugins/aihot/agents/aihot.md
（此处完整粘贴 agents/aihot.md 全文，含 frontmatter）
</expert_selection>
</system-reminder>
今天 AI 圈有什么新动态？
```
...
![专家接管的运行时链路](/workbuddy-harness/fig-09.png)
